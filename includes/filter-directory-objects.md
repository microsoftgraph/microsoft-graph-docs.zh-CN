...
| displayName                                   | ![默认支持][RDS]               | ![默认支持][RDS]               |                                            |                                            | ![需要高级查询参数。][AQP] |
| identifierUris/any(p:p)                       | ![默认支持][RDS]               | ![默认支持][RDS]               | ![默认支持][RDS]               | ![默认支持][RDS]               |                                            |
...
| tags/any(p:p)                                 | ![默认支持][RDS]               | ![默认支持][RDS]               | ![默认支持][RDS]               | ![默认支持][RDS]               |                                            |
...
| displayName                                      | ![默认支持][RDS]               | ![默认支持][RDS] |                                            |                                            | ![需要高级查询参数。][AQP] |
| extensionAttributes/extensionAttribute1-15       | ![需要高级查询参数。][AQP] | ![不支持][NS]         |                                            |                                            | ![需要高级查询参数。][AQP] |
...
| resourceBehaviorOptions/any(p:p)                           | ![默认支持][RDS]               | ![默认支持][RDS]               | ![默认支持][RDS]               | ![默认支持][RDS]               |                                            |
| resourceProvisioningOptions/any(p:p)                       | ![默认支持][RDS]               | ![默认支持][RDS]               | ![默认支持][RDS]               | ![默认支持][RDS]               |                                            |
...
| ----------------------------------- | ------------------------------------------ | ------------------------------------------ | ------------------------------------------ | ------------------------------------------ | ------------------------------------------ |
| accountEnabled                      | ![默认支持][RDS]               |                                            |                                            |                                            | ![不支持][NS]                       |
| alternativeNames/any (p：p)            | ![默认支持][RDS]               | ![默认支持][RDS]               | ![默认支持][RDS]               | ![默认支持][RDS]               |                                            |
| appId                               | ![默认支持][RDS]               |                                            |                                            |                                            | ![不支持][NS]                       |
...
| info/termsOfServiceUrl              | ![需要高级查询参数。][AQP] | ![不支持][NS]                       |                                            |                                            | ![不支持][NS]                       |
| keyCredentials/any(k:k/endDateTime) | ![需要高级查询参数。][AQP] |                                            | ![需要高级查询参数。][AQP] | ![需要高级查询参数。][AQP] | ![不支持][NS]                       |
| servicePrincipalNames/any (p：p)       | ![默认支持][RDS]               | ![默认支持][RDS]               | ![默认支持][RDS]               | ![默认支持][RDS]               |                                            |
| tags/any(p:p)                       | ![默认支持][RDS]               | ![默认支持][RDS]               | ![默认支持][RDS]               | ![默认支持][RDS]               |                                            |
...
| businessPhones/any (p：p)                                     | ![需要高级查询参数。][AQP] | ![需要高级查询参数。][AQP] | ![需要高级查询参数。][AQP] | ![需要高级查询参数。][AQP] |                                            |
...
| imAddresses/any (p：p)                                        | ![默认支持][RDS]               | ![默认支持][RDS]               | ![默认支持][RDS]               | ![默认支持][RDS]               |                                            |
