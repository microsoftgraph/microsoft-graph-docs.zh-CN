...
|minimumRamAllowedToPeerInGtesbytes|Int32|指定使用 1-100000 或 1-100000 Caching (最小 RAM 大小（) ）。 有效值为 1 到 100000|
|minimumDiskSizeAllowedToPeerInGtesbytes|Int32|指定使用 1-100000 Caching (1-100000) 。 有效值为 1 到 100000
...
|vpnPeerCaching|[enablement](../resources/intune-shared-enablement.md)|指定在通过 VPN 连接到域网络Caching设备是否允许参与对等连接。 可取值为：`notConfigured`、`enabled`、`disabled`。|
