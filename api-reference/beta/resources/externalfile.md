...
> [!CAUTION]
> `externalFile`类型已弃用。 开发人员不应使用此类型。 仍可使用 externalItem 类型对 [外部文件编制](externalitem.md) 索引。

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

通过连接索引的Microsoft 搜索[项](externalconnection.md)。 此类型派生自 [externalItem](externalitem.md) 类型。
...
| 内容          | String                   | 项目内容的纯文本表示形式。 此属性中的文本已编制全文索引。 可选。 |
