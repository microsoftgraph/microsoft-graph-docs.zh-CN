...
description: 通过在此配置文件中提供配置，你可以指示 Android for Work 设备连接到所需的 Wi-Fi 终结点。 通过指定终结点预期的身份验证Wi-Fi，可以使最终用户Wi-Fi无缝连接。 此配置文件提供的安全类型有限且比配置文件Enterprise Wi-Fi简单。
author: dougeby
...
通过在此配置文件中提供配置，你可以指示 Android for Work 设备连接到所需的 Wi-Fi 终结点。 通过指定终结点预期的身份验证Wi-Fi，可以使最终用户Wi-Fi无缝连接。 此配置文件提供的安全类型有限且比配置文件Enterprise Wi-Fi简单。
