...
ms.openlocfilehash: 83e492e58ec21d8a418496b2126fd514b4d01724
...
LocalSecurityOptionsInformationShownOnLockScreenType 的可能值

## <a name="members"></a>成员
|成员|值|说明|
|:---|:---|:---|
|notConfigured|0|未配置|
|userDisplayNameDomainUser|1|用户显示名称、域和用户名|
|userDisplayNameOnly|2|仅显示名称用户|
