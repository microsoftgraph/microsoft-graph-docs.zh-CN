---
title: aospDeviceOwnerCertificateProfileBase 资源类型
description: AOSP 设备所有者证书配置文件基础。
author: dougeby
...
ms.locfileid: "66667948"
---
# <a name="aospdeviceownercertificateprofilebase-resource-type"></a>aospDeviceOwnerCertificateProfileBase 资源类型
...
|方法|返回类型|说明|
|:---|:---|:---|
|[列出 aospDeviceOwnerCertificateProfileBases](../api/intune-deviceconfig-aospdeviceownercertificateprofilebase-list.md)|[aospDeviceOwnerCertificateProfileBase](../resources/intune-deviceconfig-aospdeviceownercertificateprofilebase.md) 集合|列出 [aospDeviceOwnerCertificateProfileBase](../resources/intune-deviceconfig-aospdeviceownercertificateprofilebase.md) 对象的属性和关系。|
|[获取 aospDeviceOwnerCertificateProfileBase](../api/intune-deviceconfig-aospdeviceownercertificateprofilebase-get.md)|[aospDeviceOwnerCertificateProfileBase](../resources/intune-deviceconfig-aospdeviceownercertificateprofilebase.md)|读取 [aospDeviceOwnerCertificateProfileBase 对象的](../resources/intune-deviceconfig-aospdeviceownercertificateprofilebase.md) 属性和关系。|
...
|subjectNameFormat|[subjectNameFormat](../resources/intune-deviceconfig-subjectnameformat.md)|证书使用者名称格式。 该集合最多可包含 500 个元素。 可取值为：`commonName`、`commonNameIncludingEmail`、`commonNameAsEmail`、`custom`、`commonNameAsIMEI`、`commonNameAsSerialNumber`、`commonNameAsAadDeviceId`、`commonNameAsIntuneDeviceId`、`commonNameAsDurableDeviceId`。|
...
|subjectAlternativeNameType|[subjectAlternativeNameType](../resources/intune-shared-subjectalternativenametype.md)|证书使用者可选名称类型。 该集合最多可包含 500 个元素。 可取值为：`none`、`emailAddress`、`userPrincipalName`、`customAzureADAttribute`、`domainNameService`、`universalResourceIdentifier`。|
...
|rootCertificate|[aospDeviceOwnerTrustedRootCertificate](../resources/intune-deviceconfig-aospdeviceownertrustedrootcertificate.md)|受信任的根证书。|
