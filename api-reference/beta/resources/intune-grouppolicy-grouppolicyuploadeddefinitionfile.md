...
description: 实体表示管理员上载 (XML) ADMX 管理模板。 ADMX 文件包含按类别路径分组策略定义及其位置的集合。 组策略定义文件还包含支持的语言，这些语言由与语言相关的 ADML 确定 (模板) 语言文件。
author: dougeby
...
实体表示管理员上载 (XML) ADMX 管理模板。 ADMX 文件包含按类别路径分组策略定义及其位置的集合。 组策略定义文件还包含支持的语言，这些语言由与语言相关的 ADML 确定 (模板) 语言文件。
