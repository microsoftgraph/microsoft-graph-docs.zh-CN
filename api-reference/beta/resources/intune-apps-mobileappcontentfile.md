...
|[Delete mobileAppContentFile](../api/intune-apps-mobileappcontentfile-delete.md)|None|删除 [mobileAppContentFile](../resources/intune-apps-mobileappcontentfile.md)。|
...
|[commit 操作](../api/intune-apps-mobileappcontentfile-commit.md)|None|提交给定应用的文件。|
