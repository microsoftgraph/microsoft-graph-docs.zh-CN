...
| 属性     | 类型   |说明|
|:---------------|:--------|:----------|
|allowedMemberTypes|String collection|指定此应用程序角色定义可以设置为"User"，或其他应用程序 （即正在访问此端口监控程序服务方案中的应用程序） 分配给用户和组设置到"应用程序"，或两者。|
|description|String|权限帮助管理应用程序分配中显示的文本和同意体验。|
...
|值|String|身份验证和访问令牌中指定应用程序应产生预期角色声明的值。|
