...
包含属性和 Windows Phone XAP 业务线应用程序继承的属性。
...
|方法|返回类型|说明|
|:---|:---|:---|
|[列表 windowsPhoneXAPs](../api/intune-apps-windowsphonexap-list.md)|[windowsPhoneXAP](../resources/intune-apps-windowsphonexap.md)集合|列出属性和[windowsPhoneXAP](../resources/intune-apps-windowsphonexap.md)对象之间的关系。|
|[获取 windowsPhoneXAP](../api/intune-apps-windowsphonexap-get.md)|[windowsPhoneXAP](../resources/intune-apps-windowsphonexap.md)|读取属性和[windowsPhoneXAP](../resources/intune-apps-windowsphonexap.md)对象的关系。|
...
|[删除 windowsPhoneXAP](../api/intune-apps-windowsphonexap-delete.md)|无|删除[windowsPhoneXAP](../resources/intune-apps-windowsphonexap.md)。|
