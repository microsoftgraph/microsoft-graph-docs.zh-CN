...
| cdnList | String collection | 提供当前资源资产的所有可用CDN提供程序的基本 URL 列表。 多个CDN提供程序同时用于读取请求的高可用性。 只读。 继承自 [organizationalBrandingProperties](organizationalbrandingproperties.md)。 |
...
|关系|类型|说明|
|:---|:---|:---|
| 本地化 | [organizationalBrandingLocalization](organizationalbrandinglocalization.md) 集合 | 根据区域设置添加不同的品牌。 |
