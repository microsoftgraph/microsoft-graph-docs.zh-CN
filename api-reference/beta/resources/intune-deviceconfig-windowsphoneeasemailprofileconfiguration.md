...
description: 通过在此配置文件中提供配置，可以指示Windows Phone上的本机电子邮件客户端与 Exchange 服务器通信并获取电子邮件、联系人、日历和任务。 此外，还可以指定要同步的电子邮件数以及设备同步的频率。
author: dougeby
...
通过在此配置文件中提供配置，可以指示Windows Phone上的本机电子邮件客户端与 Exchange 服务器通信并获取电子邮件、联系人、日历和任务。 此外，还可以指定要同步的电子邮件数以及设备同步的频率。
...
|方法|返回类型|说明|
|:---|:---|:---|
|[列出 windowsPhoneEASEmailProfileConfigurations](../api/intune-deviceconfig-windowsphoneeasemailprofileconfiguration-list.md)|[windowsPhoneEASEmailProfileConfiguration](../resources/intune-deviceconfig-windowsphoneeasemailprofileconfiguration.md) 集合|列出 [windowsPhoneEASEmailProfileConfiguration](../resources/intune-deviceconfig-windowsphoneeasemailprofileconfiguration.md) 对象的属性和关系。|
|[获取 windowsPhoneEASEmailProfileConfiguration](../api/intune-deviceconfig-windowsphoneeasemailprofileconfiguration-get.md)|[windowsPhoneEASEmailProfileConfiguration](../resources/intune-deviceconfig-windowsphoneeasemailprofileconfiguration.md)|读取 [windowsPhoneEASEmailProfileConfiguration](../resources/intune-deviceconfig-windowsphoneeasemailprofileconfiguration.md) 对象的属性和关系。|
...
|[删除 windowsPhoneEASEmailProfileConfiguration](../api/intune-deviceconfig-windowsphoneeasemailprofileconfiguration-delete.md)|None|删除 [windowsPhoneEASEmailProfileConfiguration](../resources/intune-deviceconfig-windowsphoneeasemailprofileconfiguration.md)。|
|[更新 windowsPhoneEASEmailProfileConfiguration](../api/intune-deviceconfig-windowsphoneeasemailprofileconfiguration-update.md)|[windowsPhoneEASEmailProfileConfiguration](../resources/intune-deviceconfig-windowsphoneeasemailprofileconfiguration.md)|更新 [windowsPhoneEASEmailProfileConfiguration 对象的](../resources/intune-deviceconfig-windowsphoneeasemailprofileconfiguration.md) 属性。|
