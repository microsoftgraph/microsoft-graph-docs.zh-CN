...
description: 通过在此配置文件中提供配置，你可以指示 Windows Phone 上的本机电子邮件客户端与 Exchange 服务器通信，并获取电子邮件、联系人、日历和任务。 此外，还可以指定要同步的电子邮件以及设备应同步的频繁时间。
author: dougeby
...
通过在此配置文件中提供配置，你可以指示 Windows Phone 上的本机电子邮件客户端与 Exchange 服务器通信，并获取电子邮件、联系人、日历和任务。 此外，还可以指定要同步的电子邮件以及设备应同步的频繁时间。
...
|[获取 windowsPhoneEASEmailProfileConfiguration](../api/intune-deviceconfig-windowsphoneeasemailprofileconfiguration-get.md)|[windowsPhoneEASEmailProfileConfiguration](../resources/intune-deviceconfig-windowsphoneeasemailprofileconfiguration.md)|读取 [windowsPhoneEASEmailProfileConfiguration 对象的属性和](../resources/intune-deviceconfig-windowsphoneeasemailprofileconfiguration.md) 关系。|
...
|[更新 windowsPhoneEASEmailProfileConfiguration](../api/intune-deviceconfig-windowsphoneeasemailprofileconfiguration-update.md)|[windowsPhoneEASEmailProfileConfiguration](../resources/intune-deviceconfig-windowsphoneeasemailprofileconfiguration.md)|更新 [windowsPhoneEASEmailProfileConfiguration 对象](../resources/intune-deviceconfig-windowsphoneeasemailprofileconfiguration.md) 的属性。|
