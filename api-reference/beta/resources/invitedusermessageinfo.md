...
|customizedMessageBody|字符串|不需要默认邮件时要发送的自定义邮件正文。|
|messageLanguage|字符串|要发送默认邮件的语言。 如果指定了 customizedMessageBody，则忽略此属性，并且使用 customizedMessageBody 发送邮件。 语言格式应为 ISO 639。 默认值为 en-US。|
