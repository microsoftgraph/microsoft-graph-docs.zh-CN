...
description: 此类包含适用于 Android for Work 的符合性设置。
author: dougeby
...
此类包含适用于 Android for Work 的符合性设置。
...
|[更新 androidForWorkCompliancePolicy](../api/intune-deviceconfig-androidforworkcompliancepolicy-update.md)|[androidForWorkCompliancePolicy](../resources/intune-deviceconfig-androidforworkcompliancepolicy.md)|更新 [androidForWorkCompliancePolicy 对象的](../resources/intune-deviceconfig-androidforworkcompliancepolicy.md) 属性。|
...
|securityRequiredAndroidSafetyNetEvaluationType|[androidSafetyNetEvaluationType](../resources/intune-deviceconfig-androidsafetynetevaluationtype.md)|需要特定的 SafetyNet 评估类型来实现符合性。 可取值为：`basic`、`hardwareBacked`。|
