...
| allowTeamworkReactions | 布尔值 | 指示是否Teams为会议启用响应。 |
...
| 关系 | 类型 | 说明 |
| ------------ | ---- | ----------- |
| meetingAttendanceReport | [meetingAttendanceReport](meetingAttendanceReport.md) | 联机会议与会者报告。 只读。 |
