...
| broadcastSettings     | [broadcastMeetingSettings](broadcastMeetingSettings.md)     | 设置实时事件相关的事件*                                                                                                                                                                                                                    |
...
>- \* 使用 **broadcastSettings** 属性创建实时事件是 beta 版，但存在重要限制。 有关详细信息，请参阅 [broadcastSettings](broadcastMeetingSettings.md)。
