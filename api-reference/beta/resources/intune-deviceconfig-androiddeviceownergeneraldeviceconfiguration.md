...
|kioskModeWiFiConfigurationEnabled|布尔|是否允许用户在展台模式下Wi-Fi自定义设置。|
...
|kioskModeManagedSettingsEntryDisabled|Boolean|是否以展台模式设置托管主屏幕上显示托管应用入口点。|
...
|passwordBlockKeyguard|布尔|指示是否禁用了键保护。|
