...
|passwordBlockKeyguardFeatures|[androidKeyguardFeature](../resources/intune-deviceconfig-androidkeyguardfeature.md) 集合|要阻止的设备键盘保护功能列表。 该集合最多可包含 7 个元素。|
...
|stayOnModes|[androidDeviceOwnerBatteryPluggedMode](../resources/intune-deviceconfig-androiddeviceownerbatterypluggedmode.md) 集合|设备显示器将保持打开状态的模式列表。 此集合最多可包含 4 个元素。|
