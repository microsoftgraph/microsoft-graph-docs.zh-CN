...
|workProfileBlockNotificationsWhileDeviceLocked|布尔值|指示阻止通知时设备锁定。|
|workProfileBlockAddingAccounts|布尔值|阻止用户添加/移除工作配置文件中的帐户。|
|workProfileBluetoothEnableContactSharing|布尔值|允许蓝牙设备访问企业联系人。|
|workProfileBlockScreenCapture|布尔值|阻止工作配置文件中的屏幕截图。|
|workProfileBlockCrossProfileCallerId|布尔值|阻止显示工作 profile 呼叫者 ID 个人配置文件中。|
|workProfileBlockCamera|布尔值|阻止工作 profile 摄像头。|
|workProfileBlockCrossProfileContactsSearch|布尔值|个人配置文件中，阻止工作 profile 联系人可用性。|
|workProfileBlockCrossProfileCopyPaste|布尔值|布尔值，指示设置不允许跨是否启用配置文件复制/粘贴。|
...
|workProfilePasswordBlockFingerprintUnlock|布尔值|指示是否阻止指纹解锁工作配置文件。|
|workProfilePasswordBlockTrustAgents|布尔值|指示阻止智能锁定和其他信任代理工作配置文件。|
