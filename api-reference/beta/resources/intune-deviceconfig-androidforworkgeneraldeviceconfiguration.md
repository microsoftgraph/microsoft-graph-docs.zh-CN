...
|[删除 androidForWorkGeneralDeviceConfiguration](../api/intune-deviceconfig-androidforworkgeneraldeviceconfiguration-delete.md)|None|删除 [androidForWorkGeneralDeviceConfiguration](../resources/intune-deviceconfig-androidforworkgeneraldeviceconfiguration.md)。|
|[更新 androidForWorkGeneralDeviceConfiguration](../api/intune-deviceconfig-androidforworkgeneraldeviceconfiguration-update.md)|[androidForWorkGeneralDeviceConfiguration](../resources/intune-deviceconfig-androidforworkgeneraldeviceconfiguration.md)|更新 [androidForWorkGeneralDeviceConfiguration 对象的](../resources/intune-deviceconfig-androidforworkgeneraldeviceconfiguration.md) 属性。|
...
|workProfileBlockCrossProfileCallerId|布尔|在个人配置文件中阻止显示工作配置文件调用方 ID。|
...
|workProfilePasswordRequiredType|[androidForWorkRequiredPasswordType](../resources/intune-deviceconfig-androidforworkrequiredpasswordtype.md)|所需的工作配置文件密码的类型。 可取值为：`deviceDefault`、`lowSecurityBiometric`、`required`、`atLeastNumeric`、`numericComplex`、`atLeastAlphabetic`、`atLeastAlphanumeric`、`alphanumericWithSymbols`。|
...
|vpnEnableAlwaysOnLockdownMode|Boolean|为始终开启 VPN 启用锁定模式。|
|workProfileAllowWidgets|Boolean|允许工作配置文件应用中的小组件。|
|workProfileBlockPersonalAppInstallsFromUnknownSources|Boolean|防止从个人配置文件中的未知源安装应用。|
