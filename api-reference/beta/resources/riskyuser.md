...
| 方法   | 返回类型|说明|
|:---------------|:--------|:----------|
|[列出 riskyUsers](../api/riskyusers-list.md) | [riskyUsers](riskyUser.md) |列出有风险的用户及其属性。|
|[获取 riskyUsers](../api/riskyusers-get.md) | [riskyUsers](riskyUser.md)|获取特定的有风险的用户及其属性。|
|[确认 riskyUsers 已泄露](../api/riskyusers-confirmcompromised.md)|确认有风险的用户受到威胁。|
|[消除 riskyUsers](../api/riskyusers-dismiss.md)|消除有风险的用户的风险。|
