...
|passwordBlockAutoFill|布尔|指示是否阻止"自动填充密码"功能。|
|passwordBlockProximityRequests|布尔|指示是否阻止从附近设备请求密码。|
|passwordBlockAirDropSharing|布尔|指示是否阻止与 AirDrop 密码功能共享密码。|
...
|classroomForceUnpromptedAppAndDeviceLock|布尔|指示是否允许教师在不提示学生的情况下锁定应用或设备。 需要通过 Apple School Manager 或 Apple Business Manager 注册 MDM。|
...
|addingGameCenterFriendsBlocked|布尔|是，禁止用户将好友添加到游戏中心。 适用于运行 macOS 版本 10.13 和更高版本的设备。|
