...
|deploymentChannel|[appleDeploymentChannel](../resources/intune-deviceconfig-appledeploymentchannel.md)|指示用于部署配置文件的通道。 可用选项为 DeviceChannel、UserChannel。 可取值为：`deviceChannel`、`userChannel`。|
