...
|allowUserDeleteMessages|布尔值|如果设置为 true, 则用户可以删除其邮件。|
|allowOwnerDeleteMessages|布尔值|如果设置为 true, 则所有者可以删除任何邮件。|
|allowTeamMentions|布尔值|如果设置为 true, 则允许 @team 提及。|
|allowChannelMentions|布尔值|如果设置为 true, 则允许 @channel 提及。|
