...
description: 用于提高 iOS 设备每天的设备签入速率的实验性配置文件。
author: dougeby
...
|[删除 iosExpeditedCheckinConfiguration](../api/intune-deviceconfig-iosexpeditedcheckinconfiguration-delete.md)|None|删除 [iosExpeditedCheckinConfiguration](../resources/intune-deviceconfig-iosexpeditedcheckinconfiguration.md)。|
|[更新 iosExpeditedCheckinConfiguration](../api/intune-deviceconfig-iosexpeditedcheckinconfiguration-update.md)|[iosExpeditedCheckinConfiguration](../resources/intune-deviceconfig-iosexpeditedcheckinconfiguration.md)|更新 [iosExpeditedCheckinConfiguration 对象的](../resources/intune-deviceconfig-iosexpeditedcheckinconfiguration.md) 属性。|
