...
|pinLowercaseCharactersUsage|[configurationUsage](../resources/intune-deviceconfig-configurationusage.md)|此值配置企业 PIN 中小写Windows Hello的使用。 可取值为：`blocked`、`required`、`allowed`、`notConfigured`。|
...
|pinRecoveryEnabled|Boolean|允许用户使用适用于 Business PIN 恢复服务Windows Hello PIN 的布尔值。|
