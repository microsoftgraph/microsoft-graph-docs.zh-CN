...
|[passwordlessmicrosoftauthenticatorauthenticationmethodconfiguration](passwordlessmicrosoftauthenticatorauthenticationmethodconfiguration.md) (弃) |定义可以使用无密码电话登录登录 Azure AD 的用户。|
