...
|id|String| 邮件的唯一标识符。 [!INCLUDE [outlook-beta-id](../../includes/outlook-immutable-id.md)] 只读。 |
...
|internetMessageId | String | 由 [RFC5322](https://www.ietf.org/rfc/rfc5322.txt) 指定格式的邮件 ID。仅当 **isDraft** 为 true 时可以更新。|
