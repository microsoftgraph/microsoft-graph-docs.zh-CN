...
|[列出所有托管图像](../api/chatmessagehostedimage-list-hostedimages.md) | [hostedImage](../resources/chatmessagehostedimage.md)集合| 获取聊天消息中的所有托管图像。|
|[获取托管图像](../api/chatmessagehostedimage-get.md) | [hostedImage](../resources/chatmessagehostedimage.md) | 从聊天消息中获取托管的图像。|
|[获取承载的图像字节](../api/chatmessagehostedimage-getbytes.md) | 二进制图像数据 | 从聊天消息中获取托管图像的二进制图像数据。|
