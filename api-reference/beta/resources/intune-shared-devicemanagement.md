...
- 电信业务管理合作伙伴
- 事件疑难解答
- Windows Information Protection摘要
...
|**设备配置**|
|intuneAccountId|Guid|Intune租户的帐户 ID|
...
|**نهج المجموعة Analytics**|
|groupPolicyObjectFiles|[groupPolicyObjectFile](../resources/intune-gpanalyticsservice-grouppolicyobjectfile.md) 集合|已上载نهج المجموعة对象文件的列表。|
|**载入**|
...
|managementConditionStatements|[managementConditionStatement](../resources/intune-fencing-managementconditionstatement.md) 集合|与公司的设备管理相关的管理条件声明。|
|**نهج المجموعة Analytics**|
|groupPolicyMigrationReports|[groupPolicyMigrationReport](../resources/intune-gpanalyticsservice-grouppolicymigrationreport.md) 集合|迁移نهج المجموعة列表。|
|**MicrosoftTunnel**|
...
|**Windows 信息保护**|
|intuneBrandingProfiles|[intuneBrandingProfile](../resources/intune-wip-intunebrandingprofile.md) 集合|Intune AAD 组创建品牌配置文件|
