...
|属性|类型|说明|
|:---|:---|:---|
|呼叫者|String|策略规则目标的调用方。 允许的值包括：、`None`、`EndUser``Admin`。|
...
|operations|字符串集合|策略规则目标的操作。 允许的值为：、`All`、`Deactivate``Activate`、、`Assign`、`Update`、`Extend``Remove`、`Renew`。|
