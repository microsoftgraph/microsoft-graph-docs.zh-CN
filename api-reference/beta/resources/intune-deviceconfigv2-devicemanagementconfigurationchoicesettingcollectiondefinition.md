...
|defaultOptionId|String|从[DeviceManagementConfigurationChoiceSettingDefinition](../resources/intune-deviceconfigv2-devicemanagementconfigurationchoicesettingdefinition.md)继承的选项设置的默认选项|
