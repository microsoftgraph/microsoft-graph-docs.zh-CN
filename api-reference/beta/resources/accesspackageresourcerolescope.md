...
在 [Azure AD 权利](entitlementmanagement-root.md)管理中，访问包资源角色作用域是一个对资源内的作用域和该范围中该资源中的角色的引用。  访问包将具有其目录中与该访问包相关的资源的访问包资源角色作用域。  当主题收到访问包分配时，将在每个访问包资源角色作用域的该作用域中为主题设置角色。
