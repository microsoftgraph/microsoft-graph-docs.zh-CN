...
|osStatus|[cloudPcDeviceImageOsStatus](#cloudpcdeviceimageosstatus-values)|此映像的操作系统状态。 可取值为：`supported`、`supportedWithWarning`、`unknownFutureValue`。|
...
|状态|[cloudPcDeviceImageStatus](#cloudpcdeviceimagestatus-values)|云电脑上映像的状态。 可取值为：`pending`、`ready`、`failed`。|
...
### <a name="cloudpcdeviceimageosstatus-values"></a>cloudPcDeviceImageOsStatus 值
