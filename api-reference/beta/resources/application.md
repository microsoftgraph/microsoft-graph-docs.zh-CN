...
| [Get federatedIdentityCredential](../api/federatedidentitycredential-get.md) | [federatedIdentityCredential](../resources/federatedidentitycredential.md) | 检索联合标识凭据的属性。 |
| [Update federatedIdentityCredential](../api/federatedidentitycredential-update.md) | 无 | 更新应用程序对象的联合标识凭据。 |
| [Delete federatedIdentityCredential](../api/federatedidentitycredential-delete.md) | 无 | 从应用程序对象中删除联合标识凭据。 |
|**Owners**| | |
