...
|minimumAutoInstallClassification|[updateClassification](../resources/intune-deviceconfig-updateclassification.md)|要自动安装的最小更新分类。 可能的值是：`userDefined`、`recommendedAndImportant`、`important`、`none`。|
|updatesMinimumAutoInstallClassification|[updateClassification](../resources/intune-deviceconfig-updateclassification.md)|要自动安装的最小更新分类。 可取值为：`userDefined`、`recommendedAndImportant`、`important`、`none`。|
