...
- 仅供 Microsoft 团队持久聊天。 此功能按层次结构由[通道](../resources/channel.md)、 [chatThread](../resources/chatthread.md)和[chatMessage](../resources/chatmessage.md)资源来表示。
- 组对话是仅适用于 Office 365 组。 此功能按层次结构由[对话](../resources/conversation.md)、 [conversationThread](../resources/conversationthread.md)，和[发布](../resources/post.md)资源来表示。 
- [列表加入团队](../api/user-list-joinedteams.md)方法仅适用于 Microsoft 团队。
- [呼叫和联机会议 Api](./calls-api-overview.md)仅适用于 Microsoft 团队。
