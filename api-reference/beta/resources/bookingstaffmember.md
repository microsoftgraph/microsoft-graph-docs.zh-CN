...
| 属性     | 类型   |说明|
|:---------------|:--------|:----------|
|availabilityIsAffectedByPersonalCalendar|布尔|如果为 True，则表示如果教职员工成员是 Office 365 用户，则在预定前，预订 API 将验证教职员工成员在 Office 365 的个人日历中的可用性。 |
...
|useBusinessHours|布尔|如果为 True，则表示教职员工成员的可用性是在企业的**businessHours**属性中指定的。 False 表示可用性由教职员工成员的**workingHours**属性设置决定。|
