...
> 它允许你使用 Microsoft Graph管理通过已弃用Azure AD Graph (或[) 添加Azure AD 连接](/azure/active-directory/hybrid/whatis-azure-ad-connect)。
...
|isSyncedFromOnPremises|布尔| 指示是否使用此扩展属性从本地 active directory Azure AD 连接。 只读。 |
