...
适用于 Android 的工作 EAS 电子邮件配置文件的基准
...
|将 identitycertificate|[androidForWorkCertificateProfileBase](../resources/intune-deviceconfig-androidforworkcertificateprofilebase.md)|标识证书。|
