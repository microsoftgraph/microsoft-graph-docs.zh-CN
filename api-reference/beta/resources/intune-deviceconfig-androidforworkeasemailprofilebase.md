...
|方法|返回类型|说明|
|:---|:---|:---|
|[列表 androidForWorkEasEmailProfileBases](../api/intune-deviceconfig-androidforworkeasemailprofilebase-list.md)|[androidForWorkEasEmailProfileBase](../resources/intune-deviceconfig-androidforworkeasemailprofilebase.md)集合|列出属性和[androidForWorkEasEmailProfileBase](../resources/intune-deviceconfig-androidforworkeasemailprofilebase.md)对象之间的关系。|
|[获取 androidForWorkEasEmailProfileBase](../api/intune-deviceconfig-androidforworkeasemailprofilebase-get.md)|[androidForWorkEasEmailProfileBase](../resources/intune-deviceconfig-androidforworkeasemailprofilebase.md)|读取属性和[androidForWorkEasEmailProfileBase](../resources/intune-deviceconfig-androidforworkeasemailprofilebase.md)对象的关系。|
...
|hostName|String|Exchange 位置 (URL) 的邮件应用程序连接到。|
|requireSsl|布尔值|指示使用 SSL。|
