---
title: userExperienceAnalyticsCloudIdentityDevicesSummary 资源类型
description: 用户体验分析从任意位置云标识设备摘要工作。
author: dougeby
...
用户体验分析从任意位置云标识设备摘要工作。

## <a name="properties"></a>属性
|属性|类型|说明|
|:---|:---|:---|
|deviceWithoutCloudIdentityCount|Int32|非云标识的设备计数。|
