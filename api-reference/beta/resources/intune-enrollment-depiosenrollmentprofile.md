...
description: DepIOSEnrollmentProfile 资源表示特定于 iOS 配置的 Apple 设备注册计划 (DEP) 注册配置文件。 在相应的设备可以通过 DEP 注册之前，必须将此类配置文件分配给 Apple DEP 序列号。
author: dougeby
...
DepIOSEnrollmentProfile 资源表示特定于 iOS 配置的 Apple 设备注册计划 (DEP) 注册配置文件。 在相应的设备可以通过 DEP 注册之前，必须将此类配置文件分配给 Apple DEP 序列号。
...
|[更新 depIOSEnrollmentProfile](../api/intune-enrollment-depiosenrollmentprofile-update.md)|[depIOSEnrollmentProfile](../resources/intune-enrollment-depiosenrollmentprofile.md)|更新 [depIOSEnrollmentProfile 对象的](../resources/intune-enrollment-depiosenrollmentprofile.md) 属性。|
