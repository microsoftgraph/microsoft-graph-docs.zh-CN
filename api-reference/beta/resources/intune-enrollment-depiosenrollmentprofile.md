...
|enableSingleAppEnrollmentMode|Boolean|通知设备启用单应用模式, 并在注册过程中应用应用锁定。 默认值为 false。 若要设置此属性, 必须设置 "enableAuthenticationViaCompanyPortal" 和 "companyPortalVppTokenId"。|
