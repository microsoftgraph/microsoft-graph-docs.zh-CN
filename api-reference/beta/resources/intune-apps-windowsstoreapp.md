...
description: 包含适用于应用商店应用Windows继承的属性。
author: dougeby
...
|方法|返回类型|说明|
|:---|:---|:---|
|[列出 windowsStoreApps](../api/intune-apps-windowsstoreapp-list.md)|[windowsStoreApp](../resources/intune-apps-windowsstoreapp.md) 集合|列出 [windowsStoreApp](../resources/intune-apps-windowsstoreapp.md) 对象的属性和关系。|
|[获取 windowsStoreApp](../api/intune-apps-windowsstoreapp-get.md)|[windowsStoreApp](../resources/intune-apps-windowsstoreapp.md)|读取 [windowsStoreApp](../resources/intune-apps-windowsstoreapp.md) 对象的属性和关系。|
|[创建 windowsStoreApp](../api/intune-apps-windowsstoreapp-create.md)|[windowsStoreApp](../resources/intune-apps-windowsstoreapp.md)|创建新的 [windowsStoreApp](../resources/intune-apps-windowsstoreapp.md) 对象。|
|[删除 windowsStoreApp](../api/intune-apps-windowsstoreapp-delete.md)|无|删除 [windowsStoreApp](../resources/intune-apps-windowsstoreapp.md)。|
|[更新 windowsStoreApp](../api/intune-apps-windowsstoreapp-update.md)|[windowsStoreApp](../resources/intune-apps-windowsstoreapp.md)|更新 [windowsStoreApp 对象](../resources/intune-apps-windowsstoreapp.md) 的属性。|
...
|appStoreUrl|String|应用商店Windows URL。|
