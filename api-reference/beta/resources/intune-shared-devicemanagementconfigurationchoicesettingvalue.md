...
|value|String|选择设置值：OptionDefinition ItemId。|
|children|[deviceManagementConfigurationSettingInstance](../resources/intune-shared-devicemanagementconfigurationsettinginstance.md) 集合|子设置。|
