...
|方法|返回类型|说明|
|:---|:---|:---|
|[列出 windowsAppX](../api/intune-apps-windowsappx-list.md)|[windowsAppX](../resources/intune-apps-windowsappx.md) 集合|列出 [windowsAppX 对象的属性和](../resources/intune-apps-windowsappx.md) 关系。|
