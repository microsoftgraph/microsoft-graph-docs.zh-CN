...
|sectionsUrl|String|导航属性的 `sections` URL，该属性返回节组中的所有节。 只读。|
...
|sections|[onenoteSection](onenotesection.md) 集合|分区组中的各个部分。 只读。 可为 Null。|

## <a name="methods"></a>方法

| 方法           | 返回类型    |说明|
|:---------------|:--------|:----------|
|[获取分区组](../api/sectiongroup-get.md) | [sectionGroup](sectiongroup.md) |读取节组的属性和关系。|
|[创建分区组](../api/sectiongroup-post-sectiongroups.md) |[sectionGroup](sectiongroup.md)| 通过发布到指定节组的 sectionGroups 集合来创建节组。|
|[列出分区组](../api/sectiongroup-list-sectiongroups.md) |[sectionGroup](sectiongroup.md) 集合| 获取指定节组中节组的集合。|
|[创建分区](../api/sectiongroup-post-sections.md) |[onenoteSection](onenotesection.md)| 通过发布到指定节组中的节集合来创建节。|
|[列出节](../api/sectiongroup-list-sections.md) |[onenoteSection](onenotesection.md) 集合| 获取指定节组中节的集合。|
