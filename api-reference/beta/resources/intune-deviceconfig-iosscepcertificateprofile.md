...
|[更新 iosScepCertificateProfile](../api/intune-deviceconfig-iosscepcertificateprofile-update.md)|[iosScepCertificateProfile](../resources/intune-deviceconfig-iosscepcertificateprofile.md)|更新 [iosScepCertificateProfile 对象的](../resources/intune-deviceconfig-iosscepcertificateprofile.md) 属性。|
...
|renewalThresholdPercentage|Int32|证书续订阈值百分比。 从 [iosCertificateProfileBase](../resources/intune-deviceconfig-ioscertificateprofilebase.md) 继承的有效值 1 到 99|
...
|subjectAlternativeNameType|[subjectAlternativeNameType](../resources/intune-shared-subjectalternativenametype.md)|证书使用者可选名称类型。 继承自 [iosCertificateProfileBase](../resources/intune-deviceconfig-ioscertificateprofilebase.md)。 可取值为：`none`、`emailAddress`、`userPrincipalName`、`customAzureADAttribute`、`domainNameService`、`universalResourceIdentifier`。|
...
|customSubjectAlternativeNames|[customSubjectAlternativeName](../resources/intune-deviceconfig-customsubjectalternativename.md) 集合|自定义使用者可选名称设置。 OnPremisesUserPrincipalName 变量是支持，以及此处所述的其他变量： https://go.microsoft.com/fwlink/?LinkId=2027630。 该集合最多可包含 500 个元素。|
