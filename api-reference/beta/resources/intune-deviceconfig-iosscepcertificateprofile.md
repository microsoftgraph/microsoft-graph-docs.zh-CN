...
|方法|返回类型|说明|
|:---|:---|:---|
|[列表 iosScepCertificateProfiles](../api/intune-deviceconfig-iosscepcertificateprofile-list.md)|[iosScepCertificateProfile](../resources/intune-deviceconfig-iosscepcertificateprofile.md)集合|列出属性和[iosScepCertificateProfile](../resources/intune-deviceconfig-iosscepcertificateprofile.md)对象之间的关系。|
|[获取 iosScepCertificateProfile](../api/intune-deviceconfig-iosscepcertificateprofile-get.md)|[iosScepCertificateProfile](../resources/intune-deviceconfig-iosscepcertificateprofile.md)|读取属性和[iosScepCertificateProfile](../resources/intune-deviceconfig-iosscepcertificateprofile.md)对象的关系。|
