---
title: windowsWebApp 资源类型
description: 包含Windows Web 应用的属性和继承属性。
author: dougeby
...
ms.locfileid: "65858685"
---
# <a name="windowswebapp-resource-type"></a>windowsWebApp 资源类型
...
|方法|返回类型|说明|
|:---|:---|:---|
|[列出 windowsWebApps](../api/intune-apps-windowswebapp-list.md)|[windowsWebApp](../resources/intune-apps-windowswebapp.md) 集合|列出 [windowsWebApp](../resources/intune-apps-windowswebapp.md) 对象的属性和关系。|
|[获取 windowsWebApp](../api/intune-apps-windowswebapp-get.md)|[windowsWebApp](../resources/intune-apps-windowswebapp.md)|读取 [windowsWebApp](../resources/intune-apps-windowswebapp.md) 对象的属性和关系。|
|[创建 windowsWebApp](../api/intune-apps-windowswebapp-create.md)|[windowsWebApp](../resources/intune-apps-windowswebapp.md)|创建新的 [windowsWebApp](../resources/intune-apps-windowswebapp.md) 对象。|
|[删除 windowsWebApp](../api/intune-apps-windowswebapp-delete.md)|None|删除 [windowsWebApp](../resources/intune-apps-windowswebapp.md)。|
|[更新 windowsWebApp](../api/intune-apps-windowswebapp-update.md)|[windowsWebApp](../resources/intune-apps-windowswebapp.md)|更新 [windowsWebApp](../resources/intune-apps-windowswebapp.md) 对象的属性。|
