...
**todoTask**表示可跟踪和完成的任务（如一段工作或个人项目）。 

**todoTask**总是包含在[todoTaskList 中](todotasklist.md)。 它包括与 [linkedResource 对象集合的](./linkedResource.md) 关系，用于跟踪任务的一个或多个源。

此资源支持以下内容：
* 将数据添加为开放扩展 [中的自定义属性](/graph/extensibility-overview)。
...
|[更新任务](../api/todotask-update.md)|[todoTask](../resources/todotask.md)|更新 [todoTask 对象的](../resources/todotask.md) 属性。|
...
|关系|类型|说明|
|:---|:---|:---|
|extensions|[扩展](extension.md)集合| 为任务定义的开放扩展集合。 可为 Null。|
