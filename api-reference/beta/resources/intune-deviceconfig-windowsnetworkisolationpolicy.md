...
|enterpriseIPRanges|[ipRange](../resources/intune-shared-iprange.md) 集合|设置可定义企业网络中计算机的企业 IP 范围。 来自这些计算机的数据将被视为企业的一部分并受保护。 这些位置将被视为要共享的企业数据的安全目标。 该集合最多可包含 500 个元素。|
