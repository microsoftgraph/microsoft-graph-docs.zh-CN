...
|[删除 userExperienceAnalyticsAppHealthApplicationPerformance](../api/intune-devices-userexperienceanalyticsapphealthapplicationperformance-delete.md)|无|删除用户 [ExperienceAnalyticsAppHealthApplicationPerformance](../resources/intune-devices-userexperienceanalyticsapphealthapplicationperformance.md)。|
...
|allOrgsHealthScore|双精度|跨所有组织的应用程序的中值运行状况分数。 有效值 -1.79769313486232E+308 到 1.79769313486232E+308。|
...
|appUsageDuration|Int32|应用程序的总使用时间（以分钟数表示）。 有效值 -2147483648 到 2147483647|
|appCrashCount|Int32|应用崩溃的数量。 有效值 -2147483648 到 2147483647|
