...
|connectionType|String|媒体终结点使用的网络类型。 可取值为：`unknown`、`wired`、`wifi`、`mobile`、`tunnel`、`unknownFutureValue`。|
...
|wifiBand|String|媒体终结点使用的 WiFi 波段。 可取值为：`unknown`、`frequency24GHz`、`frequency50GHz`。|
...
|wifiRadioType|String|媒体终结点使用的 WiFi 无线电的类型。 可取值为：`unknown`、`wifi80211a`、`wifi80211b`、`wifi80211g`、`wifi80211n`、`wifi80211ac`、`wifi80211ax`、`unknownFutureValue`。|
