...
|[了 getmobileappcount 函数](../api/intune-shared-mobileapp-getmobileappcount.md)|Int64|尚未记录|
...
|[getRelatedAppStates 函数](../api/intune-shared-mobileapp-getrelatedappstates.md)|mobileAppRelationshipState 集合|尚未记录|
|**策略集**|
...
|assignments|mobileAppAssignment 集合|此移动应用的组分配的列表。|
|installSummary|mobileAppInstallSummary|移动应用安装摘要。|
|deviceStatuses|mobileAppInstallStatus 集合|此移动应用程序的安装状态列表。|
|userStatuses|[userAppInstallStatus](../resources/intune-apps-userappinstallstatus.md)集合|此移动应用程序的安装状态列表。|
|相互|mobileAppRelationship 集合|此移动应用的关系列表。|
