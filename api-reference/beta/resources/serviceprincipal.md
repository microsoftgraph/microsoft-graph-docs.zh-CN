...
|publishedPermissionScopes|[permissionScope](permissionscope.md) 集合|应用程序公开的委派权限。 有关详细信息，请参阅 [应用程序](application.md)实体上的 **api** 属性的 **oauth2PermissionScopes** 属性。 不可为 null。 <br/>**注意：** 此属性在 v1.0 中命名为 **oauth2PermissionScopes**。|
