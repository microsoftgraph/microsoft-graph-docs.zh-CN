...
|appStoreBlocked|布尔|指示是否阻止用户使用 App Store。 需要受监督设备的 iOS 13 及更高版本。|
...
|kioskModeAllowRingerSwitch|布尔|指示在展台模式下是否允许使用响铃开关。 此属性的功能对于 OS 默认值是多余的，已弃用。 请改用 KioskModeBlockRingerSwitch。|
