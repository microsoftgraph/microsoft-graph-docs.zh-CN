...
|airPrintBlocked|布尔值|指示在 iOS 11.0 (是否阻止 AirPrint) 。|
...
|cellularBlockPersonalHotspotModification|布尔值|指示是否阻止用户在 iOS 12.2 或更高版本 (个人热点设置) 。|
|continuousPathKeyboardBlocked|布尔值|指示在 iOS 13 或更高版本的设备受监督时是否 (连续路径) 。|
