...
|deviceUpdateStates|[windowsUpdateState](../resources/intune-deviceconfig-windowsupdatestate.md)集合|Windows update for business configuration 设备状态。|
