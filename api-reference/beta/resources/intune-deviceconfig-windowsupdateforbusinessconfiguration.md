...
|[extendFeatureUpdatesPause 操作](../api/intune-deviceconfig-windowsupdateforbusinessconfiguration-extendfeatureupdatespause.md)|None|为 Windows Update for Business 振铃扩展功能更新暂停。|
|[extendQualityUpdatesPause 操作](../api/intune-deviceconfig-windowsupdateforbusinessconfiguration-extendqualityupdatespause.md)|None|为 Windows Update for Business 振铃扩展质量更新暂停。|
