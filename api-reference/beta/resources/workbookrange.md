...
| 方法           | 返回类型    |说明|
|:---------------|:--------|:----------|
|[获取区域](../api/range-get.md) | [workbookRange](workbookrange.md) |读取 range 对象的属性和关系。|
|[更新](../api/range-update.md) | [workbookRange](workbookrange.md)   |更新 Range 对象。 |
|[Boundingrect](../api/range-boundingrect.md)|[workbookRange](workbookrange.md)|获取包含指定区域的最小 range 对象。例如，“B2:C5”和“D10:E15”的 GetBoundingRect 为“B2:E16”。|
|[单元格](../api/range-cell.md)|[workbookRange](workbookrange.md)|根据行和列编号获取包含单个单元格的 range 对象。单元格可以位于父区域外部，只要其保持在工作表网格内即可。返回的单元格位于相对于区域左上角的单元格的位置。|
|[列](../api/range-column.md)|[workbookRange](workbookrange.md)|获取范围中包含的列。|
...
|[行](../api/range-row.md)|[区域](workbookrange.md)|获取范围中包含的行。|
...
| 关系 | 类型   |说明|
|:---------------|:--------|:----------|
|format|[workbookRangeFormat](workbookrangeformat.md)|返回一个格式对象，其中封装了区域的字体、填充、边框、对齐方式和其他属性。只读。|
|sort|[workbookRangeSort](workbookrangesort.md)|包含当前区域的工作表。只读。|
|worksheet|[workbookWorksheet](workbookworksheet.md)|包含当前区域的工作表。只读。|
