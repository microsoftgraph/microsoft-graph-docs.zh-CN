...
|[List directReports](../api/orgcontact-list-directreports.md) |[directoryObject](directoryobject.md) 集合| 列出该联系人的直接下属。|
...
|[getMemberGroups](../api/orgcontact-getmembergroups.md)|String 集合| 返回指定的联系人所在的所有组。 |
...
| id                           | 字串符号                                                     | 此组织联系人的的唯一标识符。                                                                                                                                                                                                                                                                                                                             |
| imAddresses                  | String 集合                          | 为此组织联系人的 IM 地址列表。 现在联系人只能有一个 SIP 地址。                                                                                                                                                                                                                        |
...
| 关系 | 类型   |说明|
|:---------------|:--------|:----------|
|directReports|[directoryObject](directoryobject.md) 集合| 联系人的直接下属。 （用户和其管理器属性设置为此联系人的联系人。） 只读的。 可为空。|
