...
description: 设备注册过程中出现Azure AD，该错误阻止服务在更新管理中注册设备或将内容部署到设备。
author: aarononeal
...
设备注册过程中出现Azure AD，该错误[](../resources/windowsupdates-azureaddevice.md)阻止服务在更新管理中注册设备或将内容部署到设备。
