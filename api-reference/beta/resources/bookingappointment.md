...
|optOutOfCustomerEmail|Boolean|True 表示此约会的 [bookingCustomer](bookingcustomer.md) 不希望收到此约会的确认。|
...
|staffMemberIds|String collection|此约会中计划的每位 [bookingStaffMember](bookingstaffmember.md) 的 ID。|
