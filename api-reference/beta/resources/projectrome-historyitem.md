...
|id | String | 必填。 客户端集的**historyItem**对象的 GUID。|
|startedDateTime | DateTimeOffset | 必填。 **HistoryItem** （活动会话）启动时的 UTC 日期时间。 对于时间线历史记录是必需的。|
...
|关系 | 类型 | 说明|
|:------------|:-----|:-----------|
|activity| [活动](../resources/projectrome-activity.md) | 可选。 NavigationProperty/包含;指向关联活动的导航属性。|
