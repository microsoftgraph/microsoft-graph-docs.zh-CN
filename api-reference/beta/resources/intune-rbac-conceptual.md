...
description: 列出用于 Intune Graph的 Microsoft Graph API (REST) ，该 REST (为租户组织定义 (RBAC) 。
...
- [标识](intune-rbac-identity.md)
- [标识集](intune-rbac-identityset.md)
- [操作审批策略](intune-rbac-operationapprovalpolicy.md)
- [操作审批策略平台](intune-rbac-operationapprovalpolicyplatform.md)
- [操作审批策略集](intune-rbac-operationapprovalpolicyset.md)
- [操作审批策略类型](intune-rbac-operationapprovalpolicytype.md)
- [操作审批请求](intune-rbac-operationapprovalrequest.md)
- [操作审批请求实体状态](intune-rbac-operationapprovalrequestentitystatus.md)
- [操作审批请求状态](intune-rbac-operationapprovalrequeststatus.md)
