...
description: 表示自定义版本的本地化策略文件使用条款协议在Azure Active Directory (Azure AD) 。 它包含有关协议文件的元数据 (例如，名称、语言以及它是否是协议文件的默认) 。
...
表示租户使用自定义版本管理的协议条款文件的自定义Azure Active Directory (Azure AD) 。 它包含有关协议文件的元数据 (例如，名称、语言以及它是否是协议文件的默认) 。
