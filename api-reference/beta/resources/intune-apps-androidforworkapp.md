...
description: 包含 Android for Work 应用程序的属性和 (AFW) 属性。
author: dougeby
...
包含 Android for Work 应用程序的属性和 (AFW) 属性。
...
|[获取 androidForWorkApp](../api/intune-apps-androidforworkapp-get.md)|[androidForWorkApp](../resources/intune-apps-androidforworkapp.md)|读取 [androidForWorkApp 对象的属性和](../resources/intune-apps-androidforworkapp.md) 关系。|
...
|[删除 androidForWorkApp](../api/intune-apps-androidforworkapp-delete.md)|无|删除 [androidForWorkApp](../resources/intune-apps-androidforworkapp.md)。|
|[更新 androidForWorkApp](../api/intune-apps-androidforworkapp-update.md)|[androidForWorkApp](../resources/intune-apps-androidforworkapp.md)|更新 [androidForWorkApp 对象](../resources/intune-apps-androidforworkapp.md) 的属性。|
