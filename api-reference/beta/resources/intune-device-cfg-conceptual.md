...
description: 列出用于为租户组织配置设备 (REST) Intune终结点的 Microsoft 图形 API。
author: dougeby
...
- [Android 设备所有者符合性策略](intune-deviceconfig-androiddeviceownercompliancepolicy.md)
...
- [Android 设备所有者派生凭据身份验证配置](intune-deviceconfig-androiddeviceownerderivedcredentialauthenticationconfiguration.md)
...
- [Android 设备所有者所需的密码解锁](intune-deviceconfig-androiddeviceownerrequiredpasswordunlock.md)
...
- [面向 Android 设备所有者用户的消息](intune-deviceconfig-androiddeviceowneruserfacingmessage.md)
...
- [Android 安全网评估类型](intune-deviceconfig-androidsafetynetevaluationtype.md)
...
- [Aosp 设备所有者符合性策略](intune-deviceconfig-aospdeviceownercompliancepolicy.md)
...
- [Aosp 设备所有者受信任的根证书](intune-deviceconfig-aospdeviceownertrustedrootcertificate.md)
...
- [Apple 部署通道](intune-deviceconfig-appledeploymentchannel.md)
- [Apple 设备功能配置基础](intune-deviceconfig-appledevicefeaturesconfigurationbase.md)
- [Apple 加速检查配置基础](intune-deviceconfig-appleexpeditedcheckinconfigurationbase.md)
- [Apple 使用者名称格式](intune-deviceconfig-applesubjectnameformat.md)
- [Apple VPN 始终处于配置中](intune-deviceconfig-applevpnalwaysonconfiguration.md)
...
- [凭据单一登录扩展插件](intune-deviceconfig-credentialsinglesignonextension.md)
...
- [设备符合性策略脚本](intune-deviceconfig-devicecompliancepolicyscript.md)
...
- [设备符合性脚本错误](intune-deviceconfig-devicecompliancescripterror.md)
- [设备符合性脚本 rul 运算符](intune-deviceconfig-devicecompliancescriptruloperator.md)
- [设备符合性脚本规则](intune-deviceconfig-devicecompliancescriptrule.md)
- [设备符合性脚本规则数据类型](intune-deviceconfig-devicecompliancescriptruledatatype.md)
- [设备符合性脚本规则错误](intune-deviceconfig-devicecompliancescriptruleerror.md)
- [设备符合性脚本规则验证错误](intune-deviceconfig-devicecompliancescriptrulesvalidationerror.md)
- [设备符合性脚本验证结果](intune-deviceconfig-devicecompliancescriptvalidationresult.md)
...
- [设备配置分配意向](intune-deviceconfig-deviceconfigassignmentintent.md)
...
- [迪菲地狱人组](intune-deviceconfig-diffiehellmangroup.md)
...
- [已上传的组策略类别](intune-grouppolicy-grouppolicyuploadedcategory.md)
- [组策略上传的定义](intune-grouppolicy-grouppolicyuploadeddefinition.md)
- [组策略上传的定义文件](intune-grouppolicy-grouppolicyuploadeddefinitionfile.md)
- [组策略上传的定义文件状态](intune-grouppolicy-grouppolicyuploadeddefinitionfilestatus.md)
- [组策略上传的语言文件](intune-grouppolicy-grouppolicyuploadedlanguagefile.md)
- [已上传的组策略演示文稿](intune-grouppolicy-grouppolicyuploadedpresentation.md)
...
- [引入源](intune-grouppolicy-ingestionsource.md)
...
- [iOS 凭据单一登录扩展插件](intune-deviceconfig-ioscredentialsinglesignonextension.md)
- [iOS 自定义配置](intune-deviceconfig-ioscustomconfiguration.md)
- [iOS 派生凭据身份验证配置](intune-deviceconfig-iosderivedcredentialauthenticationconfiguration.md)
...
- [iOS 通知预览版可见性](intune-deviceconfig-iosnotificationpreviewvisibility.md)
...
- [键类型化值对](intune-deviceconfig-keytypedvaluepair.md)
...
- [macOS 关联的域项](intune-deviceconfig-macosassociateddomainsitem.md)
...
- [在预加密的有效负载上](intune-raimportcerts-onpremencryptedpayload.md)
...
- [使用 d m a 类型进行安全启动](intune-deviceconfig-securebootwithdmatype.md)
...
- [时序参数](intune-raimportcerts-timeseriesparameter.md)
...
- [VPN 死对等检测率](intune-deviceconfig-vpndeadpeerdetectionrate.md)
