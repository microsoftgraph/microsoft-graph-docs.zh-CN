...
| 方法   | 返回类型|说明|
|:---------------|:--------|:----------|
|[列表 secureScoreControlProfiles](../api/securescorecontrolprofiles-list.md) | [secureScoreControlProfiles](securescorecontrolprofiles.md) |读取属性和 secureScoreControlProfiles 对象的元数据。|
...
|   controlStateUpdates |   字符串  |   标志指示其中租户具有标记控件 （忽略，第三方，审阅） （支持[更新](../api/securescorecontrolprofiles-update.md)）。 |
|   tenantNote |    字符串  |   租户可以设置每个控件注释 （支持[更新](../api/securescorecontrolprofiles-update.md)）。 |
|   assignedTo |    字符串  |   租户可以为控件分配 （支持[更新](../api/securescorecontrolprofiles-update.md)） 个人。 |
|   updatedBy | 字符串  |   修订的作者到控件的状态的用户主体名称。 |
