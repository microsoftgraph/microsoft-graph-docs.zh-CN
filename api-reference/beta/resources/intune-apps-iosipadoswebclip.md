---
title: iosiPadOSWebClip 资源类型
description: 包含iOS Web 应用的属性和继承属性。
author: dougeby
...
ms.locfileid: "65858520"
---
# <a name="iosipadoswebclip-resource-type"></a>iosiPadOSWebClip 资源类型
...
|方法|返回类型|说明|
|:---|:---|:---|
|[列出 iosiPadOSWebClips](../api/intune-apps-iosipadoswebclip-list.md)|[iosiPadOSWebClip](../resources/intune-apps-iosipadoswebclip.md) 集合|列出 [iosiPadOSWebClip](../resources/intune-apps-iosipadoswebclip.md) 对象的属性和关系。|
|[获取 iosiPadOSWebClip](../api/intune-apps-iosipadoswebclip-get.md)|[iosiPadOSWebClip](../resources/intune-apps-iosipadoswebclip.md)|读取 [iosiPadOSWebClip](../resources/intune-apps-iosipadoswebclip.md) 对象的属性和关系。|
|[创建 iosiPadOSWebClip](../api/intune-apps-iosipadoswebclip-create.md)|[iosiPadOSWebClip](../resources/intune-apps-iosipadoswebclip.md)|创建新的 [iosiPadOSWebClip](../resources/intune-apps-iosipadoswebclip.md) 对象。|
|[删除 iosiPadOSWebClip](../api/intune-apps-iosipadoswebclip-delete.md)|None|删除 [iosiPadOSWebClip](../resources/intune-apps-iosipadoswebclip.md)。|
|[更新 iosiPadOSWebClip](../api/intune-apps-iosipadoswebclip-update.md)|[iosiPadOSWebClip](../resources/intune-apps-iosipadoswebclip.md)|更新 [iosiPadOSWebClip 对象的](../resources/intune-apps-iosipadoswebclip.md) 属性。|
...
|useManagedBrowser|Boolean|是否使用托管浏览器。 如果为 true，则需要在受Intune保护的浏览器中打开应用。 如果为 false，则不需要在受Intune保护的浏览器中打开应用。|
...
|关系|[mobileAppRelationship](../resources/intune-apps-mobileapprelationship.md) 集合|此应用的直接关系集。 继承自 [mobileApp](../resources/intune-shared-mobileapp.md)|
