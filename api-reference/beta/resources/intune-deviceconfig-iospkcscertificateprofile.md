...
|方法|返回类型|说明|
|:---|:---|:---|
|[列表 iosPkcsCertificateProfiles](../api/intune-deviceconfig-iospkcscertificateprofile-list.md)|[iosPkcsCertificateProfile](../resources/intune-deviceconfig-iospkcscertificateprofile.md)集合|列出属性和[iosPkcsCertificateProfile](../resources/intune-deviceconfig-iospkcscertificateprofile.md)对象之间的关系。|
|[获取 iosPkcsCertificateProfile](../api/intune-deviceconfig-iospkcscertificateprofile-get.md)|[iosPkcsCertificateProfile](../resources/intune-deviceconfig-iospkcscertificateprofile.md)|读取属性和[iosPkcsCertificateProfile](../resources/intune-deviceconfig-iospkcscertificateprofile.md)对象的关系。|
...
|certificationAuthorityName|String|PKCS 证书颁发机构的名称。|
