...
description: 表示与Azure AD联合的租户中域的配置。
author: akgoel23
...
表示与Azure AD联合的租户中域的配置。 使用此资源在使用 Azure AD 设置联合身份验证时配置联合身份验证设置。 有关联合身份验证的信息，[请参阅什么是与Azure AD联合？](/azure/active-directory/hybrid/whatis-fed)
...
|方法|返回类型|说明|
|:---|:---|:---|
|[创建 internalDomainFederation](../api/domain-post-federationconfiguration.md)|[internalDomainFederation](../resources/internaldomainfederation.md)|创建新的 [internalDomainFederation](../resources/internaldomainfederation.md) 对象。|
...
|[删除 internalDomainFederation](../api/internaldomainfederation-delete.md)|None|删除 [internalDomainFederation](../resources/internaldomainfederation.md) 对象。|
...
|displayName|字符串|联合标识提供者 (IdP) 的显示名称。 继承自 [identityProviderBase](../resources/identityproviderbase.md)。|
...
|id|字符串|联合标识提供者的标识符。 继承自 [entity](../resources/entity.md)。|
...
|metadataExchangeUri|字符串|用于从丰富的客户端应用程序进行身份验证的元数据交换终结点的 URI。 继承自 [samlOrWsFedProvider](../resources/samlorwsfedprovider.md)。|
...
|passiveSignInUri|字符串|登录到Azure AD服务时，基于 Web 的客户端会定向到的 URI。 继承自 [samlOrWsFedProvider](../resources/samlorwsfedprovider.md)。|
