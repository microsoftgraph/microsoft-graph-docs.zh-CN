...
|[List](../api/table-list.md) | [表](table.md) 集合 |获取 table 对象的集合。 |
|[Add](../api/tablecollection-add.md)|[表](table.md)|创建一个新表。区域源地址确定将在其下添加表的工作表。如果无法添加表（例如，由于地址无效，或者表与另一个表重叠），将抛出错误。|
