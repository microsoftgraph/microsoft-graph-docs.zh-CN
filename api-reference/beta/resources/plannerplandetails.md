...
|sharedWith|[plannerUserIds](planneruserids.md)|与之共享此计划的用户 Id 集。 如果使用的是 Microsoft 365 组，请使用组 API 来管理组成员身份，以共享 [组的](group.md) 计划。 您还可以将组的现有成员添加到此集合中，但不需要使其访问组拥有的计划。 |
