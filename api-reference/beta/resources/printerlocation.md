...
|子|String 集合|打印机所在的次级单位层次结构。 元素应按层次结构顺序排列。 例如，如果一个校园分成不同的部分，则层次结构可能如下所示： `["East Wing", "Block A"]`|
|城市|String|打印机所在的城市。|
...
|组织|String 集合|打印机所属的组织层次结构。 元素应按层次结构顺序排列。|
|细分|String 集合|打印机所在的细分。 元素应按层次结构顺序排列。|
