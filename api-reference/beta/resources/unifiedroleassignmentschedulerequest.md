...
description: 表示通过 Azure AD 角色分配执行活动 Privileged Identity Management。
author: shauliu1
...
表示通过 Azure AD 角色分配活动Azure Active Directory (请求) Privileged Identity Management。
