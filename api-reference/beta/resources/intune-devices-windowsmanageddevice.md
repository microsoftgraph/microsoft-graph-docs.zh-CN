...
|deviceCategory|deviceCategory|继承自[managedDevice](../resources/intune-devices-manageddevice.md)的设备类别|
...
|users|用户集合|与托管设备关联的主要用户。 继承自[managedDevice](../resources/intune-devices-manageddevice.md)|
