...
UnsupportedDeviceConfiguration entity 无法映射到另一个模型兼容的子类型的 deviceConfiguration 时使用。
...
|方法|返回类型|说明|
|:---|:---|:---|
|[列表 unsupportedDeviceConfigurations](../api/intune-deviceconfig-unsupporteddeviceconfiguration-list.md)|[unsupportedDeviceConfiguration](../resources/intune-deviceconfig-unsupporteddeviceconfiguration.md)集合|列出属性和[unsupportedDeviceConfiguration](../resources/intune-deviceconfig-unsupporteddeviceconfiguration.md)对象之间的关系。|
|[获取 unsupportedDeviceConfiguration](../api/intune-deviceconfig-unsupporteddeviceconfiguration-get.md)|[unsupportedDeviceConfiguration](../resources/intune-deviceconfig-unsupporteddeviceconfiguration.md)|读取属性和[unsupportedDeviceConfiguration](../resources/intune-deviceconfig-unsupporteddeviceconfiguration.md)对象的关系。|
...
|originalEntityTypeName|String|否则将返回的实体的类型。|
|详细信息|[unsupportedDeviceConfigurationDetail](../resources/intune-deviceconfig-unsupporteddeviceconfigurationdetail.md)集合|说明为什么实体不受支持的详细信息。 该集合最多可包含 1000 个元素。|
