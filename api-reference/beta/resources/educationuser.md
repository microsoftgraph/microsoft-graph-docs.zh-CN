...
| externalSource    | `educationExternalSource`                             | 创建此用户的位置。 可能的值是：`sis` 或 `manual`。                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| onPremisesInfo    | [educationOnPremisesInfo](educationonpremisesinfo.md) | 用于将 AAD 用户与其对应的 Active Directory 相关联的其他信息。                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| relatedContacts   | [relatedContact]集合                           | 与用户相关的相关记录。 可能的关系`parent`为`relative`、 `aide` `doctor` `guardian` `child`、 `other`、、、、`unknownFutureValue`                                                                                                                                                                                                                                                                                                                                                                       |

>[!IMPORTANT]
>使用委派权限作用域时，Graph 将仅返回一组有限的属性`id`： `primaryRole`、 `accountEnabled`、 `displayName` `givenName` `surname` `userPrincipalName`、、、、 `userType`、 `onPremisesInfo`、。 如果您的应用程序需要其他属性，则必须使用应用程序权限范围。
