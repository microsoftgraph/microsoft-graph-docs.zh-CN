...
|[创建 outlookTaskFolder](../api/outlookuser-post-taskfolders.md) |[outlookTaskFolder](outlooktaskfolder.md)| 创建任务文件夹中的默认任务组 (`My Tasks`) 的用户的邮箱。|
|[列表 taskFolders](../api/outlookuser-list-taskfolders.md) |[outlookTaskFolder](outlooktaskfolder.md)集合| 获取用户的邮箱中的所有 Outlook 任务文件夹。|
