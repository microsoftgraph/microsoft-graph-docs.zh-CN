...
|localPortRanges|[numberRange](../resources/intune-deviceconfig-numberrange.md)集合|仅当 protocol 为 TCP 或 UDP （6或17）时，才能设置本地端口范围。 该集合最多可包含 500 个元素。|
|remotePortRanges|[numberRange](../resources/intune-deviceconfig-numberrange.md)集合|仅当 protocol 为 TCP 或 UDP （6或17）时，才能设置远程端口范围。 该集合最多可包含 500 个元素。|
