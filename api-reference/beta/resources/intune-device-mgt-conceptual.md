...
- [Chrome o s 设备属性](intune-devices-chromeosdeviceproperty.md)
- [云电脑连接问题](intune-devices-cloudpcconnectivityissue.md)
- [组合设备摘要](intune-devices-comanageddevicessummary.md)
- [符合共同管理条件的设备](intune-devices-comanagementeligibledevice.md)
- [符合共同管理条件的设备摘要](intune-devices-comanagementeligibledevicessummary.md)
- [符合共同管理条件的类型](intune-devices-comanagementeligibletype.md)
- [合规性状态](intune-devices-compliancestate.md)
- [Configuration Manager 操作](intune-devices-configurationmanageraction.md)
- [Configuration Manager 操作交付状态](intune-devices-configurationmanageractiondeliverystatus.md)
- [Configuration Manager 操作结果](intune-devices-configurationmanageractionresult.md)
...
- [设备范围操作](intune-devices-devicescopeaction.md)
- [设备范围操作结果](intune-devices-devicescopeactionresult.md)
- [设备范围操作状态](intune-devices-devicescopeactionstatus.md)
- [设备范围运算符](intune-devices-devicescopeoperator.md)
- [设备范围参数](intune-devices-devicescopeparameter.md)
- [设备范围状态](intune-devices-devicescopestatus.md)
...
- [Insight 值双倍](intune-devices-insightvaluedouble.md)
- [Insight 值 int](intune-devices-insightvalueint.md)
...
- [Oem 保修](intune-devices-oemwarranty.md)
- [载入时 Oem 保修信息](intune-devices-oemwarrantyinformationonboarding.md)
...
- [轮换 BitLocker 密钥设备操作结果](intune-devices-rotatebitlockerkeysdeviceactionresult.md)
...
- [用户体验分析设备范围](intune-devices-userexperienceanalyticsdevicescope.md)
...
- [用户体验分析见解值](intune-devices-userexperienceanalyticsinsightvalue.md)
...
- [用户体验分析摘要](intune-devices-userexperienceanalyticssummarizedby.md)
...
- [用户体验分析在设备摘要的任何位置起作用](intune-devices-userexperienceanalyticsworkfromanywheredevicessummary.md)
