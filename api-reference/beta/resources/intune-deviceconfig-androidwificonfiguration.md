...
description: 通过提供此配置文件中的配置，可以指示 Android 设备连接到所需的Wi-Fi终结点。 通过指定Wi-Fi终结点所需的身份验证方法和安全类型，可以使最终用户的Wi-Fi连接无缝。 此配置文件提供比企业Wi-Fi配置文件更有限、更简单的安全类型。
author: dougeby
...
通过提供此配置文件中的配置，可以指示 Android 设备连接到所需的Wi-Fi终结点。 通过指定Wi-Fi终结点所需的身份验证方法和安全类型，可以使最终用户的Wi-Fi连接无缝。 此配置文件提供比企业Wi-Fi配置文件更有限、更简单的安全类型。
...
|[删除 androidWiFiConfiguration](../api/intune-deviceconfig-androidwificonfiguration-delete.md)|None|删除 [androidWiFiConfiguration](../resources/intune-deviceconfig-androidwificonfiguration.md)。|
|[更新 androidWiFiConfiguration](../api/intune-deviceconfig-androidwificonfiguration-update.md)|[androidWiFiConfiguration](../resources/intune-deviceconfig-androidwificonfiguration.md)|更新 [androidWiFiConfiguration 对象的](../resources/intune-deviceconfig-androidwificonfiguration.md) 属性。|
