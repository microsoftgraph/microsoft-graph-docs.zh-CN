...
| **存储桶**               | <ul><li>包含在通过计划的 **SharedWith** 集合与用户共享的计划中</li></ul>                                                                                                 |
...
* **createdBy** 属性将仅显示在新创建的对象上。
* 新创建的 **plannerTask** 对象后会有其相应的 **plannerTaskDetails** 对象。
* 新创建的 **的 plannerPlan** 对象后会有其相应的 **plannerPlanDetails** 对象。
...
| MaximumFavoritePlansForUser   | [plannerUser](planneruser.md) 资源上的 **favoritePlanReferences** 属性包含的值太多。                                                                                            |
| MaximumRecentPlansForUser     | [plannerUser](planneruser.md) 资源上的 **recentPlanReferences** 属性包含的值太多。                                                                                              |
