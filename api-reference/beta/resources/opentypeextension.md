...
| [已弃用的基本任务 () ](basetask.md) | Beta |
| [已弃用 (基本任务列表) ](basetasklist.md) | Beta |
| [日历事件](event.md) \* | GA |
| 组[日历事件](event.md) | GA |
| 组对话线程[帖子](post.md) | GA |
| [设备](device.md) | GA |
...
| 方法 | 返回类型 | 说明 |
|:---------------|:--------|:----------|
|[创建](../api/opentypeextension-post-opentypeextension.md) | [openTypeExtension](opentypeextension.md) (现有资源实例) 或新的 [baseTask](basetask.md)、[baseTaskList](basetasklist.md)[联系](contact.md)人、[事件](event.md)、[消息](message.md)、[帖子](post.md)、[todoTask](todotask.md) 或 [todoTaskList](todotasklist.md)，其中包含 openTypeExtension 对象。 | 在现有的或新的资源实例中创建 openTypeExtension 对象。|
