...
|[获取 organizationalBranding](../api/organizationalbranding-get.md) | [organizationalbranding](organizationalbranding.md) | 获取默认组织品牌对象。 |
|[更新 organizationalBranding](../api/organizationalbranding-update.md) | [organizationalbranding](organizationalbranding.md) | 更新默认组织品牌对象。 |
|[删除 organizationalBranding](../api/organizationalbranding-update.md) | [organizationalbranding](organizationalbranding.md) | 删除默认组织品牌对象。 |
|[列出 organizationalBrandingLocalization](../api/organizationalbrandinglocalization-get.md) | [organizationalBrandingLocalization](organizationalbrandinglocalization.md) 集合 | 检索租户中所有本地化品牌对象。 |
|[获取 organizationalBrandingLocalization](../api/organizationalbrandinglocalization-get.md) | [organizationalBrandingLocalization](organizationalbrandinglocalization.md) | 读取本地化品牌对象的属性。 |
|[更新 organizationalBranding](../api/organizationalbranding-update.md) | [organizationalbranding](organizationalbranding.md) | 更新本地化品牌对象。 |
|[删除 organizationalBranding](../api/organizationalbranding-update.md) | [organizationalbranding](organizationalbranding.md) | 删除本地化品牌对象。 |
