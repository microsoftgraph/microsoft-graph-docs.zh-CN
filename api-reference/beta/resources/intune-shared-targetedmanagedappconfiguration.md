...
|**移动应用管理 (MAM)**|
|[分配操作](../api/intune-shared-targetedmanagedappconfiguration-assign.md)|None|尚未记录|
|[targetApps 操作](../api/intune-shared-targetedmanagedappconfiguration-targetapps.md)|None|尚未记录|
|**策略集**|
