...
|[删除 aospDeviceOwnerScepCertificateProfile](../api/intune-deviceconfig-aospdeviceownerscepcertificateprofile-delete.md)|无|删除 [aospDeviceOwnerScepCertificateProfile](../resources/intune-deviceconfig-aospdeviceownerscepcertificateprofile.md)。|
|[更新 aospDeviceOwnerScepCertificateProfile](../api/intune-deviceconfig-aospdeviceownerscepcertificateprofile-update.md)|[aospDeviceOwnerScepCertificateProfile](../resources/intune-deviceconfig-aospdeviceownerscepcertificateprofile.md)|更新 [aospDeviceOwnerScepCertificateProfile 对象](../resources/intune-deviceconfig-aospdeviceownerscepcertificateprofile.md) 的属性。|
