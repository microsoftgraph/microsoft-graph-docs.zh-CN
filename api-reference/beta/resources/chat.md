...
|[获取所有聊天消息](../api/chats-getallmessages.md)| [chat](chat.md) 集合| 从用户参与的所有聊天获取消息，包括一对一聊天、群聊和会议聊天。 |
...
|[从聊天中卸载应用](../api/chat-delete-installedapps.md) | 无 | 从 () 关联的会议 (卸载应用程序) 。|
...
|group               | 1      | 指示聊天是群聊。 可以针对 (聊天至少更新两) 名单大小。 稍后可以删除/添加成员。|
