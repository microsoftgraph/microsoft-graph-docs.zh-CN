...
### <a name="defaultmfamethodtype-values"></a>defaultMfaMethodType 值 
...
### <a name="clientcredentialtype-values"></a>clientCredentialType 值 
...
### <a name="educationfeedbackresourceoutcomestatus-values"></a>educationFeedbackResourceOutcomeStatus 值
|成员|
|:---|
|notPublished|
|pendingPublish|
...
| emailAsAlternateId        | Email作为备用 ID      |
...
| 使用    | 2     | 数据正在使用中。 文件在客户端应用程序（如 Microsoft Office）中打开。 |
...
|成员    |值    |Description |
|:---------|:--------|:----------- |
|团队      |0        |指示 Teams 应用可以在团队中安装，并有权访问该团队的数据。|
|groupChat |1        |指示 Teams 应用可以在群聊中安装，并有权访问该组聊天的数据。|
...
### <a name="submissioncategory-values"></a>submissionCategory 值 
...
### <a name="submissionclientsource-values"></a>submissionClientSource 值 
...
### <a name="submissioncontenttype-values"></a>submissionContentType 值 
...
### <a name="submissionresultcategory-values"></a>submissionResultCategory 值 
...
### <a name="submissionsource-values"></a>submissionSource 值 
...
### <a name="tenantallowblocklistaction-values"></a>tenantAllowBlockListAction 值 
...
### <a name="tenantallowblocklistentrytype-values"></a>tenantAllowBlockListEntryType 值 
