...
|[获取 iosikEv2VpnConfiguration](../api/intune-deviceconfig-iosikev2vpnconfiguration-get.md)|[iosikEv2VpnConfiguration](../resources/intune-deviceconfig-iosikev2vpnconfiguration.md)|读取 [iosikEv2VpnConfiguration 对象的属性和](../resources/intune-deviceconfig-iosikev2vpnconfiguration.md) 关系。|
...
|userDomain|String|仅 Zscaler。 输入静态域，以在 Zscaler 应用中预填充登录字段。 如果此域留空，将Azure Active Directory用户域名。 继承自 [iosVpnConfiguration](../resources/intune-deviceconfig-iosvpnconfiguration.md)|
