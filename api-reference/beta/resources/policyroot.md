...
| authenticationMethodsPolicy               | [authenticationMethodsPolicy](authenticationmethodspolicy.md)                                             | 身份验证方法和允许使用它们登录并执行 MFA (多重身份验证的用户) MFA Azure Active Directory (Azure AD) 。 |
| authorizationPolicy                       | [authorizationPolicy](authorizationpolicy.md) 集合                                                  | 控制授权Azure AD的策略。                                                                                                            |
