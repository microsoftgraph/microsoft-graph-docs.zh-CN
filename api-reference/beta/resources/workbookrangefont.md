...
| 方法           | 返回类型    |说明|
|:---------------|:--------|:----------|
|[获取 workbookRangeFont](../api/rangefont-get.md) | [workbookRangeFont](workbookrangefont.md) |读取 rangeFont 对象的属性和关系。|
|[更新](../api/rangefont-update.md) | [workbookRangeFont](workbookrangefont.md)   |更新 RangeFont 对象。 |
