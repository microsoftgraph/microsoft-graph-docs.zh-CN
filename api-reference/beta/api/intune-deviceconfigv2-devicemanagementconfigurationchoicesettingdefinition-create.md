...
在请求正文中，为 deviceManagementConfigurationChoiceSettingDefinition 对象提供 JSON 表示形式。

下表显示了创建 deviceManagementConfigurationChoiceSettingDefinition 时所需的属性。
...
如果成功，此方法在响应正文中返回 `201 Created` 响应代码和 [deviceManagementConfigurationChoiceSettingDefinition](../resources/intune-deviceconfigv2-devicemanagementconfigurationchoicesettingdefinition.md) 对象。
