...
ms.locfileid: "58804734"
---
# <a name="create-devicemanagementconfigurationchoicesettingdefinition"></a>创建 deviceManagementConfigurationChoiceSettingDefinition
...
创建新的 [deviceManagementConfigurationChoiceSettingDefinition](../resources/intune-deviceconfigv2-devicemanagementconfigurationchoicesettingdefinition.md) 对象。
...
在请求正文中，提供 deviceManagementConfigurationChoiceSettingDefinition 对象的 JSON 表示形式。

下表显示创建 deviceManagementConfigurationChoiceSettingDefinition 时所需的属性。
...
如果成功，此方法在响应正文中返回 响应代码和 `201 Created` [deviceManagementConfigurationChoiceSettingDefinition](../resources/intune-deviceconfigv2-devicemanagementconfigurationchoicesettingdefinition.md) 对象。
