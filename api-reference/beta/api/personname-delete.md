---
title: 删除 personName
description: 从用户配置文件中删除 personName 对象。
...
ms.locfileid: "60985590"
---
# <a name="delete-personname"></a>删除 personName

命名空间：microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

从用户配置文件中删除 [personName](../resources/personname.md) [对象](../resources/profile.md)。
