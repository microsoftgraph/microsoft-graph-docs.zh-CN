...
ms.locfileid: "54233439"
---
# <a name="getrolescopetagsbyid-action"></a>getRoleScopeTagsById 操作
...
如果成功，此操作在响应 `200 OK` 正文中返回 响应代码和 [roleScopeTag](../resources/intune-rbac-rolescopetag.md) 集合。
