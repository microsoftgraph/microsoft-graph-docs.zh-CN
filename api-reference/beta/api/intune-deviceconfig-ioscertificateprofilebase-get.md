...
---
# <a name="get-ioscertificateprofilebase"></a>获取 iosCertificateProfileBase
...
读取 [iosCertificateProfileBase 对象的属性和](../resources/intune-deviceconfig-ioscertificateprofilebase.md) 关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [iosCertificateProfileBase](../resources/intune-deviceconfig-ioscertificateprofilebase.md) 对象。
