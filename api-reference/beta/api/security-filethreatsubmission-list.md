---
title: 列出 fileThreatSubmissions
description: 获取 fileThreatSubmission 对象及其属性的列表。
author: caigen
...
ms.locfileid: "66856531"
---
# <a name="list-filethreatsubmissions"></a>列出 fileThreatSubmissions
命名空间：microsoft.graph.security

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

获取 [fileThreatSubmission](../resources/security-filethreatsubmission.md) 对象及其属性的列表。
...
如果成功，此方法在响应正文中返回 `200 OK` 响应代码和 [fileThreatSubmission](../resources/security-filethreatsubmission.md) 对象集合。
