...
更新 [enrollmentRestrictionsConfigurationPolicySetItem 对象](../resources/intune-policyset-enrollmentrestrictionsconfigurationpolicysetitem.md) 的属性。
...
下表显示创建 [enrollmentRestrictionsConfigurationPolicySetItem 时所需的属性](../resources/intune-policyset-enrollmentrestrictionsconfigurationpolicysetitem.md)。
...
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [enrollmentRestrictionsConfigurationPolicySetItem](../resources/intune-policyset-enrollmentrestrictionsconfigurationpolicysetitem.md) 对象。
