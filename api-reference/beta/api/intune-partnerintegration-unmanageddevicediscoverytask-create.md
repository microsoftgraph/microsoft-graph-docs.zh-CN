...
---
# <a name="create-unmanageddevicediscoverytask"></a>创建 unmanagedDeviceDiscoveryTask
...
创建新的 [unmanagedDeviceDiscoveryTask](../resources/intune-partnerintegration-unmanageddevicediscoverytask.md) 对象。
...
在请求正文中，提供 unmanagedDeviceDiscoveryTask 对象的 JSON 表示形式。

下表显示创建 unmanagedDeviceDiscoveryTask 时所需的属性。
...
|creatorNotes|String|创建者的注释。 继承自 [deviceAppManagementTask](../resources/intune-partnerintegration-deviceappmanagementtask.md)|
...
|unmanagedDevices|[unmanagedDevice](../resources/intune-partnerintegration-unmanageddevice.md) 集合|在网络中发现非托管设备。|



## <a name="response"></a>响应
如果成功，此方法在响应正文中返回响应代码和 `201 Created` [unmanagedDeviceDiscoveryTask](../resources/intune-partnerintegration-unmanageddevicediscoverytask.md) 对象。
