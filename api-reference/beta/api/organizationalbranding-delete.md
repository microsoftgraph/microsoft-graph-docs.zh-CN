...
ms.locfileid: "59997028"
---
# <a name="delete-organizationalbranding"></a>Delete organizationalBranding
命名空间：microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

删除默认组织的品牌对象。 若要删除 [organizationalBranding](../resources/organizationalbranding.md) 对象，必须先 (Stream) 类型的所有图像。
