...
ms.locfileid: "63338246"
---
# <a name="update-bookmark"></a>更新书签
命名空间：microsoft.graph.search

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

更新 [书签对象的属性](../resources/search-bookmark.md) 。
...
在请求正文中，提供书签对象的 JSON [表示](../resources/search-bookmark.md) 形式。 提供应更新的相关字段的值。 请求正文中未包含的现有属性将保留其以前的值或根据其他属性值的更改重新计算。 为了实现最佳性能，不得添加未变化的现有值。
...
|languageTags|String 集合|可查看此书签的一个或多个国家/地区的列表。|
