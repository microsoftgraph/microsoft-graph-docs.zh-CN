---
title: 更新 deviceManagementComplianceActionItem
description: 更新 deviceManagementComplianceActionItem 对象的属性。
author: dougeby
...
更新 [deviceManagementComplianceActionItem 对象](../resources/intune-deviceconfigv2-devicemanagementcomplianceactionitem.md) 的属性。
...
在请求正文中，提供 [deviceManagementComplianceActionItem](../resources/intune-deviceconfigv2-devicemanagementcomplianceactionitem.md) 对象的 JSON 表示形式。

下表显示创建 [deviceManagementComplianceActionItem 时所需的属性](../resources/intune-deviceconfigv2-devicemanagementcomplianceactionitem.md)。
...
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [deviceManagementComplianceActionItem](../resources/intune-deviceconfigv2-devicemanagementcomplianceactionitem.md) 对象。
