...
ms.locfileid: "54199520"
---
# <a name="create-macosmicrosoftedgeapp"></a>创建 macOSMicrosoftEdgeApp
...
创建新的 [macOSMicrosoftEdgeApp](../resources/intune-apps-macosmicrosoftedgeapp.md) 对象。
...
在请求正文中，提供 macOSMicrosoftEdgeApp 对象的 JSON 表示形式。

下表显示创建 macOSMicrosoftEdgeApp 时所需的属性。
...
如果成功，此方法在响应正文中返回 响应代码和 `201 Created` [macOSMicrosoftEdgeApp](../resources/intune-apps-macosmicrosoftedgeapp.md) 对象。
