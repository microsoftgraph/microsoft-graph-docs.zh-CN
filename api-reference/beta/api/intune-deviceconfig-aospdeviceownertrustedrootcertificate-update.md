---
title: 更新 aospDeviceOwnerTrustedRootCertificate
description: 更新 aospDeviceOwnerTrustedRootCertificate 对象的属性。
author: dougeby
...
ms.locfileid: "64630287"
---
# <a name="update-aospdeviceownertrustedrootcertificate"></a>更新 aospDeviceOwnerTrustedRootCertificate
...
更新 [aospDeviceOwnerTrustedRootCertificate 对象](../resources/intune-deviceconfig-aospdeviceownertrustedrootcertificate.md) 的属性。
...
在请求正文中，提供 [aospDeviceOwnerTrustedRootCertificate](../resources/intune-deviceconfig-aospdeviceownertrustedrootcertificate.md) 对象的 JSON 表示形式。

下表显示创建 [aospDeviceOwnerTrustedRootCertificate 时所需的属性](../resources/intune-deviceconfig-aospdeviceownertrustedrootcertificate.md)。
...
如果成功，此方法在响应 `200 OK` 正文中返回 响应代码和更新的 [aospDeviceOwnerTrustedRootCertificate](../resources/intune-deviceconfig-aospdeviceownertrustedrootcertificate.md) 对象。
