...
在[了 chatmessage](../resources/chatmessage.md)中检索[承载的图像](../resources/chatmessagehostedimage.md)。
...
如果成功, 此方法在响应`200 OK`正文中返回响应代码和[托管的 image](../resources/chatmessagehostedimage.md)对象。
