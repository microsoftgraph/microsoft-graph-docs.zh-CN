...
读取 [deviceConfigurationUserStateSummary 对象的属性和](../resources/intune-deviceconfig-deviceconfigurationuserstatesummary.md) 关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [deviceConfigurationUserStateSummary](../resources/intune-deviceconfig-deviceconfigurationuserstatesummary.md) 对象。
