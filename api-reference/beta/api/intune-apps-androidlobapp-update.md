...
---
# <a name="update-androidlobapp"></a>更新 androidLobApp

> **重要说明：**/测试版下的 Microsoft Graph Api 可能会发生变化;不支持生产使用。

> **注意：** 适用于 Intune 的 Microsoft Graph API 需要租户的[活动 Intune 许可证](https://go.microsoft.com/fwlink/?linkid=839381)。

更新 [androidLobApp](../resources/intune-apps-androidlobapp.md) 对象的属性。
...
在请求正文中，提供 [androidLobApp](../resources/intune-apps-androidlobapp.md) 对象的 JSON 表示形式。

下表显示了创建 [androidLobApp](../resources/intune-apps-androidlobapp.md) 时所需的属性。
...
如果成功，此方法会在响应正文中返回 `200 OK` 响应代码和更新的 [androidLobApp](../resources/intune-apps-androidlobapp.md)  对象。
