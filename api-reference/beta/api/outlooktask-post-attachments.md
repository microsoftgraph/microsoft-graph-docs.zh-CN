...
使用此 API 可将[附件](../resources/attachment.md)添加到[outlookTask](../resources/outlooktask.md)。 附件可以是文件（ [fileAttachment](../resources/fileattachment.md)类型）或 Outlook 项目（[itemAttachment](../resources/itemattachment.md)类型）。
