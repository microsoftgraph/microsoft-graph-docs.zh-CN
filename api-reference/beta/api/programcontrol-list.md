...
ms.locfileid: "65819984"
---
# <a name="list-programcontrols-deprecated"></a>列出已弃用的 programControls () 
...
在 Azure AD [访问评审](../resources/accessreviews-root.md) 功能中，列出租户中所有程序的所有 [programControl](../resources/programcontrol.md) 对象。
