---
title: 获取 urlThreatSubmission
description: 读取 urlThreatSubmission 对象的属性和关系。
author: caigen
...
ms.locfileid: "66856549"
---
# <a name="get-urlthreatsubmission"></a>获取 urlThreatSubmission
命名空间：microsoft.graph.security

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

读取 [urlThreatSubmission](../resources/security-urlthreatsubmission.md) 对象的属性和关系。
...
如果成功，此方法在响应正文中返回 `200 OK` 响应代码和 [urlThreatSubmission](../resources/security-urlthreatsubmission.md) 对象。
