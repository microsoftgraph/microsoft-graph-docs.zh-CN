...
|eventName|String|与疑难解答事件对应的事件名称。 它是一个可选字段 继承 [自 deviceManagementTroubleshootingEvent](../resources/intune-troubleshooting-devicemanagementtroubleshootingevent.md)|
