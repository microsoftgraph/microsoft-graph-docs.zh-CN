...
---
# <a name="get-anonymousipriskevent-deprecated"></a>获取已弃 (anonymousIpRiskEvent) 
...
检索 anonymousipriskevent 对象的属性和关系。
...
如果成功，此方法在响应正文的值中返回响应代码和 `200 OK` [anonymousIpRiskEvent](../resources/anonymousipriskevent.md) 对象。
## <a name="example"></a>示例
##### <a name="request"></a>请求
下面是一个请求示例。
<!-- {
