...
更新 [windowsDriverUpdateProfile 对象](../resources/intune-softwareupdate-windowsdriverupdateprofile.md) 的属性。
...
在请求正文中，提供 [windowsDriverUpdateProfile](../resources/intune-softwareupdate-windowsdriverupdateprofile.md) 对象的 JSON 表示形式。

下表显示创建 [windowsDriverUpdateProfile 时所需的属性](../resources/intune-softwareupdate-windowsdriverupdateprofile.md)。
