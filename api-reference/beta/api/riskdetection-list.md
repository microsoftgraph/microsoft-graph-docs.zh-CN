...
检索 **riskDetection 对象集合** 的属性。

>[!NOTE]
>你必须拥有Azure AD Premium P1 P2 许可证才能使用风险检测 API。
...
以下示例演示如何使用 获取风险级别为中等或风险事件类型为不固定Features 的风险检测集合，这表示登录位于不熟悉或异常的位置。 `$filter`
