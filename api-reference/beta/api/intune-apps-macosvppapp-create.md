...
创建新的[macOsVppApp](../resources/intune-apps-macosvppapp.md)对象。
...
在请求正文中, 提供 macOsVppApp 对象的 JSON 表示形式。

下表显示创建 macOsVppApp 时所需的属性。
...
如果成功, 此方法在响应`201 Created`正文中返回响应代码和[macOsVppApp](../resources/intune-apps-macosvppapp.md)对象。
