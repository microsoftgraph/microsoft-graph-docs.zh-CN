...
ms.locfileid: "58790995"
---
# <a name="list-devicecompliancescriptdevicestates"></a>列出 deviceComplianceScriptDeviceStates
...
列出 [deviceComplianceScriptDeviceState 对象的属性和](../resources/intune-devices-devicecompliancescriptdevicestate.md) 关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [deviceComplianceScriptDeviceState](../resources/intune-devices-devicecompliancescriptdevicestate.md) 对象集合。
