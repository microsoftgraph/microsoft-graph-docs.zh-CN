...
ms.locfileid: "58818651"
---
# <a name="get-devicemanagementintentuserstate"></a>获取 deviceManagementIntentUserState
...
读取 [deviceManagementIntentUserState 对象的属性和](../resources/intune-deviceintent-devicemanagementintentuserstate.md) 关系。
...
如果成功，此方法在响应 `200 OK` 正文中返回 响应代码和 [deviceManagementIntentUserState](../resources/intune-deviceintent-devicemanagementintentuserstate.md) 对象。
