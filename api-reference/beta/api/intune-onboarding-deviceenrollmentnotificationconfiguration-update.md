---
title: 更新 deviceEnrollmentNotificationConfiguration
description: 更新 deviceEnrollmentNotificationConfiguration 对象的属性。
author: dougeby
...
ms.locfileid: "65213029"
---
# <a name="update-deviceenrollmentnotificationconfiguration"></a>更新 deviceEnrollmentNotificationConfiguration
...
更新 [deviceEnrollmentNotificationConfiguration 对象的](../resources/intune-onboarding-deviceenrollmentnotificationconfiguration.md) 属性。
...
在请求正文中，为 [deviceEnrollmentNotificationConfiguration](../resources/intune-onboarding-deviceenrollmentnotificationconfiguration.md) 对象提供 JSON 表示形式。

下表显示了创建 [deviceEnrollmentNotificationConfiguration](../resources/intune-onboarding-deviceenrollmentnotificationconfiguration.md) 时所需的属性。
...
如果成功，此方法在响应正文中返回 `200 OK` 响应代码和更新的 [deviceEnrollmentNotificationConfiguration](../resources/intune-onboarding-deviceenrollmentnotificationconfiguration.md) 对象。
