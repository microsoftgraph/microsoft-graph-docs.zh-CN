...
检索电子数据展示 [reviewSetQuery 对象的属性和](../resources/ediscovery-reviewsetquery.md) 关系。
...
如果成功，此方法在响应正文中返回响应代码和请求的 `200 OK` [microsoft.graph.ediscovery.reviewSetQuery](../resources/ediscovery-reviewsetquery.md) 对象。
