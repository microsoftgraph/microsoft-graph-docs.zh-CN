...
更新租户中现有学校 [数据同步](../resources/educationsynchronizationprofile.md) 配置文件的属性。
...
如果成功，此方法在响应 `202, Accepted` 正文中返回 响应代码和 [synchronizationProfile](../resources/educationsynchronizationprofile.md) 对象。
