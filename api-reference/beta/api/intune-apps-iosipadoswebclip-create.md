---
title: 创建 iosiPadOSWebClip
description: 创建新的 iosiPadOSWebClip 对象。
author: dougeby
...
ms.locfileid: "65858555"
---
# <a name="create-iosipadoswebclip"></a>创建 iosiPadOSWebClip
...
创建新的 [iosiPadOSWebClip](../resources/intune-apps-iosipadoswebclip.md) 对象。
...
在请求正文中，为 iosiPadOSWebClip 对象提供 JSON 表示形式。

下表显示了创建 iosiPadOSWebClip 时所需的属性。
...
如果成功，此方法在响应正文中返回 `201 Created` 响应代码和 [iosiPadOSWebClip](../resources/intune-apps-iosipadoswebclip.md) 对象。
