...
ms.locfileid: "61344797"
---
# <a name="get-devicemanagementconfigurationsetting"></a>获取 deviceManagementConfigurationSetting
...
读取 [deviceManagementConfigurationSetting 对象的属性和](../resources/intune-deviceconfigv2-devicemanagementconfigurationsetting.md) 关系。
...
如果成功，此方法在响应 `200 OK` 正文中返回 响应代码和 [deviceManagementConfigurationSetting](../resources/intune-deviceconfigv2-devicemanagementconfigurationsetting.md) 对象。
