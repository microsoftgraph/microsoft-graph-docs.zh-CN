...
ms.locfileid: "61344230"
---
# <a name="get-devicecompliancescript"></a>获取 deviceComplianceScript
...
读取 [deviceComplianceScript 对象的属性和](../resources/intune-devices-devicecompliancescript.md) 关系。
...
如果成功，此方法在响应 `200 OK` 正文中返回 响应代码和 [deviceComplianceScript](../resources/intune-devices-devicecompliancescript.md) 对象。
