...
|preferredDataLocation|String|组的首选数据Microsoft 365位置。 若要更新此属性，必须为呼叫用户分配以下 Azure AD 角色之一： <br><ul><li> 全局管理员 <li> 用户帐户管理员 <li> 合作伙伴层 1 或第 2 层支持 <li>目录编写器 <li> Exchange管理员 <li> SharePoint管理员 </ul> <br/>有关此属性详细信息，请参阅 OneDrive [Online 多地理位置](/sharepoint/dev/solution-guidance/multigeo-introduction)。|
...
> [!IMPORTANT]
>
> + 若要更新以下属性，您必须在其自己的 PATCH 请求中指定这些属性，而不包括上表中列出的其他属性：allowExternalSenders、autoSubscribeNewMembers、hideFromAddressLists、hideFromOutlookClients、isSubscribedByMail、unseenCount 。      
>
