...
ms.locfileid: "58793671"
---
# <a name="create-devicemanagementconfigurationchoicesettingcollectiondefinition"></a>创建 deviceManagementConfigurationChoiceSettingCollectionDefinition
...
创建新的 [deviceManagementConfigurationChoiceSettingCollectionDefinition](../resources/intune-deviceconfigv2-devicemanagementconfigurationchoicesettingcollectiondefinition.md) 对象。
...
在请求正文中，提供 deviceManagementConfigurationChoiceSettingCollectionDefinition 对象的 JSON 表示形式。

下表显示创建 deviceManagementConfigurationChoiceSettingCollectionDefinition 时所需的属性。
...
如果成功，此方法在响应正文中返回 响应代码和 `201 Created` [deviceManagementConfigurationChoiceSettingCollectionDefinition](../resources/intune-deviceconfigv2-devicemanagementconfigurationchoicesettingcollectiondefinition.md) 对象。
