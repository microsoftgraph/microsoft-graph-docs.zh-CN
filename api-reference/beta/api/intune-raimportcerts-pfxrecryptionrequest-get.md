...
---
# <a name="get-pfxrecryptionrequest"></a>获取 pfxRecryptionRequest
...
如果成功, 此方法在响应`200 OK`正文中返回响应代码和[pfxRecryptionRequest](../resources/intune-raimportcerts-pfxrecryptionrequest.md)对象。
