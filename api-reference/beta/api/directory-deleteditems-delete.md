...
从 [已删除的项](../resources/directory.md)中永久删除项。

目前，删除的项目功能仅支持 [应用程序](../resources/application.md)、 [servicePrincipal](../resources/serviceprincipal.md)、 [组](../resources/group.md)和 [用户](../resources/user.md) 资源。 使用此 API，可以永久删除已删除项中的项。 但当某个项目永久删除后，将 **无法** 还原。
