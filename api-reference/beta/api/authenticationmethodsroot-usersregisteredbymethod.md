...
如果成功，此函数在响应正文中返回 `200 OK` 响应代码和 [userRegistrationMethodSummary](../resources/userregistrationmethodsummary.md) 。
