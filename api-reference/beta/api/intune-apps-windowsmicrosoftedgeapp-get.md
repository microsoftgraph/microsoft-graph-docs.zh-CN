...
读取 [windowsMicrosoftEdgeApp 对象的属性和](../resources/intune-apps-windowsmicrosoftedgeapp.md) 关系。
...
如果成功，此方法在响应 `200 OK` 正文中返回 响应代码和 [windowsMicrosoftEdgeApp](../resources/intune-apps-windowsmicrosoftedgeapp.md) 对象。
