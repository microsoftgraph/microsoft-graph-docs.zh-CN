...
更新 [androidPkcsCertificateProfile 对象](../resources/intune-deviceconfig-androidpkcscertificateprofile.md) 的属性。
...
下表显示创建 [androidPkcsCertificateProfile 时所需的属性](../resources/intune-deviceconfig-androidpkcscertificateprofile.md)。
...
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [androidPkcsCertificateProfile](../resources/intune-deviceconfig-androidpkcscertificateprofile.md) 对象。
