---
title: 创建 macOSDmgApp
description: 创建新的 macOSDmgApp 对象。
author: dougeby
...
ms.locfileid: "61712132"
---
# <a name="create-macosdmgapp"></a>创建 macOSDmgApp
...
创建新的 [macOSDmgApp](../resources/intune-apps-macosdmgapp.md) 对象。
...
在请求正文中，提供 macOSDmgApp 对象的 JSON 表示形式。

下表显示创建 macOSDmgApp 时所需的属性。
...
如果成功，此方法在响应 `201 Created` 正文中返回 响应 [代码和 macOSDmgApp](../resources/intune-apps-macosdmgapp.md) 对象。
