...
从用户日历事件、邮件、[](../resources/event.md)任务Outlook[](../resources/message.md)[或](../resources/outlooktask.md)帖子中删除[附件](../resources/post.md)。
...
| [outlookTask](../resources/outlooktask.md) |  Tasks.ReadWrite | Tasks.ReadWrite | 不支持 |
