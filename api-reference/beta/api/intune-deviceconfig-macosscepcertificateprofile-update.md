...
更新 [macOSScepCertificateProfile 对象](../resources/intune-deviceconfig-macosscepcertificateprofile.md) 的属性。
...
下表显示创建 [macOSScepCertificateProfile 时所需的属性](../resources/intune-deviceconfig-macosscepcertificateprofile.md)。
...
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [macOSScepCertificateProfile](../resources/intune-deviceconfig-macosscepcertificateprofile.md) 对象。
