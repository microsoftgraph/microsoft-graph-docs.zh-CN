...
description: 获取与 todoTask 的 checklistItems 导航属性关联的 checklistItem 资源。
author: avijityadav
...
获取与 [todoTask](../resources/todoTask.md) 的 **checklistItems** 导航属性关联的 [checklistItem](../resources/checklistitem.md) 资源。
