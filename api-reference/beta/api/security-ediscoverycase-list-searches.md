...
ms.locfileid: "66092887"
---
# <a name="list-ediscoverysearch"></a>列出 ediscoverySearch
...
如果成功，此方法在响应正文中返回 `200 OK` 响应代码和 [ediscoverySearch](../resources/security-ediscoverysearch.md) 对象集合。
