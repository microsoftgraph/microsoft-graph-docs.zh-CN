...
description: 从用户配置文件中删除 languageProficiency 对象。
...
从用户配置文件中删除 [languageProficiency](../resources/languageproficiency.md) [对象](../resources/profile.md)。
