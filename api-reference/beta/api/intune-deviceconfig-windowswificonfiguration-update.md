...
更新 [windowsWifiConfiguration 对象](../resources/intune-deviceconfig-windowswificonfiguration.md) 的属性。
...
如果成功，此方法在响应正文中返回 响应代码和更新 `200 OK` 的 [windowsWifiConfiguration](../resources/intune-deviceconfig-windowswificonfiguration.md) 对象。
