...
ms.locfileid: "58782782"
---
# <a name="get-userexperienceanalyticsdevicewithoutcloudidentity"></a>获取 userExperienceAnalyticsDeviceWithoutCloudIdentity
...
读取 [userExperienceAnalyticsDeviceWithoutCloudIdentity](../resources/intune-devices-userexperienceanalyticsdevicewithoutcloudidentity.md) 对象的属性和关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [userExperienceAnalyticsDeviceWithoutCloudIdentity](../resources/intune-devices-userexperienceanalyticsdevicewithoutcloudidentity.md) 对象。
