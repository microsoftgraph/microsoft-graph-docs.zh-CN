...
---
# <a name="get-policyset"></a>获取 policySet
...
读取 policySet 对象 [的属性和](../resources/intune-policyset-policyset.md) 关系。
...
如果成功，此方法在响应 `200 OK` 正文中返回 响应代码和 [policySet](../resources/intune-policyset-policyset.md) 对象。
