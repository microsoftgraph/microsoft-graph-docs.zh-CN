...
---
# <a name="delete-unitsofmeasure"></a>删除 unitsOfMeasure

命名空间：microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

从 Dynamics 365 Business Central 中删除度量单位对象。
...
|If-Match       |必填。 如果包含此请求标头并且提供的 eTag 与 **unitsOfMeasure** 上的当前标记不匹配，则 **unitsOfMeasure** 将不会更新。 |
