...
ms.locfileid: "48726610"
---
# <a name="removelanguagefiles-action"></a><span data-ttu-id="8b545-103">removeLanguageFiles 操作</span><span class="sxs-lookup"><span data-stu-id="8b545-103">removeLanguageFiles action</span></span>
...
<span data-ttu-id="8b545-107">尚未记录</span><span class="sxs-lookup"><span data-stu-id="8b545-107">Not yet documented</span></span>
...
|:---|:---|
|<span data-ttu-id="8b545-113">委派（工作或学校帐户）</span><span class="sxs-lookup"><span data-stu-id="8b545-113">Delegated (work or school account)</span></span>|<span data-ttu-id="8b545-114">DeviceManagementConfiguration.ReadWrite.All</span><span class="sxs-lookup"><span data-stu-id="8b545-114">DeviceManagementConfiguration.ReadWrite.All</span></span>|
...
|<span data-ttu-id="8b545-117">应用程序</span><span class="sxs-lookup"><span data-stu-id="8b545-117">Application</span></span>|<span data-ttu-id="8b545-118">DeviceManagementConfiguration.ReadWrite.All</span><span class="sxs-lookup"><span data-stu-id="8b545-118">DeviceManagementConfiguration.ReadWrite.All</span></span>|
...
<span data-ttu-id="8b545-128">在请求正文中，提供参数的 JSON 表示形式。</span><span class="sxs-lookup"><span data-stu-id="8b545-128">In the request body, supply JSON representation of the parameters.</span></span>

<span data-ttu-id="8b545-129">下表显示了可用于此操作的参数。</span><span class="sxs-lookup"><span data-stu-id="8b545-129">The following table shows the parameters that can be used with this action.</span></span>
...
|:---|:---|:---|
|<span data-ttu-id="8b545-133">groupPolicyUploadedLanguageFiles</span><span class="sxs-lookup"><span data-stu-id="8b545-133">groupPolicyUploadedLanguageFiles</span></span>|<span data-ttu-id="8b545-134">[groupPolicyUploadedLanguageFile](../resources/intune-grouppolicy-grouppolicyuploadedlanguagefile.md) 集合</span><span class="sxs-lookup"><span data-stu-id="8b545-134">[groupPolicyUploadedLanguageFile](../resources/intune-grouppolicy-grouppolicyuploadedlanguagefile.md) collection</span></span>|<span data-ttu-id="8b545-135">尚未记录</span><span class="sxs-lookup"><span data-stu-id="8b545-135">Not yet documented</span></span>|



## <a name="response"></a><span data-ttu-id="8b545-136">响应</span><span class="sxs-lookup"><span data-stu-id="8b545-136">Response</span></span>
<span data-ttu-id="8b545-137">如果成功，此操作返回 `204 No Content` 响应代码。</span><span class="sxs-lookup"><span data-stu-id="8b545-137">If successful, this action returns a `204 No Content` response code.</span></span>

## <a name="example"></a><span data-ttu-id="8b545-138">示例</span><span class="sxs-lookup"><span data-stu-id="8b545-138">Example</span></span>

### <a name="request"></a><span data-ttu-id="8b545-139">请求</span><span class="sxs-lookup"><span data-stu-id="8b545-139">Request</span></span>
<span data-ttu-id="8b545-140">下面是一个请求示例。</span><span class="sxs-lookup"><span data-stu-id="8b545-140">Here is an example of the request.</span></span>
``` http
...
### <a name="response"></a><span data-ttu-id="8b545-141">响应</span><span class="sxs-lookup"><span data-stu-id="8b545-141">Response</span></span>
<span data-ttu-id="8b545-p102">下面是一个响应示例。注意：为了简单起见，可能会将此处所示的响应对象截断。将从实际调用中返回所有属性。</span><span class="sxs-lookup"><span data-stu-id="8b545-p102">Here is an example of the response. Note: The response object shown here may be truncated for brevity. All of the properties will be returned from an actual call.</span></span>
``` http
