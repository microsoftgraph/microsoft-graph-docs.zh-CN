...
列出 [appleVppTokenTroubleshootingEvent 对象的属性和](../resources/intune-troubleshooting-applevpptokentroubleshootingevent.md) 关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [appleVppTokenTroubleshootingEvent](../resources/intune-troubleshooting-applevpptokentroubleshootingevent.md) 对象集合。
