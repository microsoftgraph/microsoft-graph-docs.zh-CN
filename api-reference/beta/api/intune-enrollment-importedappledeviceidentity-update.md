...
更新 [importedAppleDeviceIdentity 对象](../resources/intune-enrollment-importedappledeviceidentity.md) 的属性。
...
下表显示创建 [importedAppleDeviceIdentity 时所需的属性](../resources/intune-enrollment-importedappledeviceidentity.md)。
...
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [importedAppleDeviceIdentity](../resources/intune-enrollment-importedappledeviceidentity.md) 对象。
