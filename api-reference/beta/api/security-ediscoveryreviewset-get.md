---
title: 获取 ediscoveryReviewSet
description: 读取 ediscoveryReviewSet 对象的属性和关系。
author: SeunginLyu
...
---
# <a name="get-ediscoveryreviewset"></a>获取 ediscoveryReviewSet
命名空间：microsoft.graph.security

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

读取 [ediscoveryReviewSet](../resources/security-ediscoveryreviewset.md) 对象的属性和关系。
...
如果成功，此方法在响应正文中返回 `200 OK` 响应代码和 [ediscoveryReviewSet](../resources/security-ediscoveryreviewset.md) 对象。
