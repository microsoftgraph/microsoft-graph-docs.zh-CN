...
| onPremisesPublishing    | [onPremisesPublishing](../resources/onpremisespublishing.md)                | 表示用于为本地应用程序配置 [AZURE AD 应用程序代理](https://aka.ms/whyappproxy) 的属性集。 此属性只能在创建应用程序后进行设置。                                                                                                                                                                                                                                                                                                                                                       |
