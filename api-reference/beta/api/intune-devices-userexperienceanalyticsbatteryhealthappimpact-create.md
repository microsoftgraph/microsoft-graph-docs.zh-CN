---
title: 创建 userExperienceAnalyticsBatteryHealthAppImpact
description: 创建新的 userExperienceAnalyticsBatteryHealthAppImpact 对象。
author: dougeby
...
创建新的 [userExperienceAnalyticsBatteryHealthAppImpact](../resources/intune-devices-userexperienceanalyticsbatteryhealthappimpact.md) 对象。
...
在请求正文中，提供 userExperienceAnalyticsBatteryHealthAppImpact 对象的 JSON 表示形式。

下表显示创建 userExperienceAnalyticsBatteryHealthAppImpact 时所需的属性。
...
如果成功，此方法在响应正文中返回 响应代码和 `201 Created` [userExperienceAnalyticsBatteryHealthAppImpact](../resources/intune-devices-userexperienceanalyticsbatteryhealthappimpact.md) 对象。
