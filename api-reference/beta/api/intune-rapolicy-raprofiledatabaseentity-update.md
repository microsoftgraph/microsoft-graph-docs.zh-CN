...
---
# <a name="update-raprofiledatabaseentity"></a>更新 raProfileDatabaseEntity
...
更新[raProfileDatabaseEntity](../resources/intune-rapolicy-raprofiledatabaseentity.md)对象的属性。
...
在请求正文中，提供[raProfileDatabaseEntity](../resources/intune-rapolicy-raprofiledatabaseentity.md)对象的 JSON 表示形式。

下表显示创建[raProfileDatabaseEntity](../resources/intune-rapolicy-raprofiledatabaseentity.md)时所需的属性。
...
如果成功，此方法 `200 OK` 在响应正文中返回响应代码和更新的[raProfileDatabaseEntity](../resources/intune-rapolicy-raprofiledatabaseentity.md)对象。
