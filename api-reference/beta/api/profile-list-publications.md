...
从用户的 [配置文件检索 itemPublication](../resources/itempublication.md) 对象 [列表](../resources/profile.md)。
...
如果成功，此方法在 `200 OK` 响应正文中返回响应代码和 [itemPublication](../resources/itempublication.md) 对象集合。
