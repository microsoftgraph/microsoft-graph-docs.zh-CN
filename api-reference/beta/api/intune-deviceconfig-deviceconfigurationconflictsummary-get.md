...
读取 [deviceConfigurationConflictSummary 对象的属性和](../resources/intune-deviceconfig-deviceconfigurationconflictsummary.md) 关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [deviceConfigurationConflictSummary](../resources/intune-deviceconfig-deviceconfigurationconflictsummary.md) 对象。
