...
ms.locfileid: "58806717"
---
# <a name="get-windows10xcertificateprofile"></a>获取 windows10XCertificateProfile
...
读取 [windows10XCertificateProfile](../resources/intune-rapolicy-windows10xcertificateprofile.md) 对象的属性和关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [windows10XCertificateProfile](../resources/intune-rapolicy-windows10xcertificateprofile.md) 对象。
