---
title: 获取 userExperienceAnalyticsBatteryHealthOsPerformance
description: 读取 userExperienceAnalyticsBatteryHealthOsPerformance 对象的属性和关系。
author: dougeby
...
ms.locfileid: "61345231"
---
# <a name="get-userexperienceanalyticsbatteryhealthosperformance"></a>获取 userExperienceAnalyticsBatteryHealthOsPerformance
...
读取 [userExperienceAnalyticsBatteryHealthOsPerformance](../resources/intune-devices-userexperienceanalyticsbatteryhealthosperformance.md) 对象的属性和关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [userExperienceAnalyticsBatteryHealthOsPerformance](../resources/intune-devices-userexperienceanalyticsbatteryhealthosperformance.md) 对象。
