...
读取 [deviceComanagementAuthorityConfiguration 对象的属性和](../resources/intune-onboarding-devicecomanagementauthorityconfiguration.md) 关系。
...
如果成功，此方法在响应 `200 OK` 正文中返回 响应代码和 [deviceComanagementAuthorityConfiguration](../resources/intune-onboarding-devicecomanagementauthorityconfiguration.md) 对象。
