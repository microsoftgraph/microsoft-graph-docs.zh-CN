...
检索 [publishedResource 对象](../resources/publishedresource.md) 的列表。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [publishedResource](../resources/publishedresource.md) 对象集合。
