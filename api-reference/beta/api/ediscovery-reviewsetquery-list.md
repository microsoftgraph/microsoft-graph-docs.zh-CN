...
检索电子数据展示 [reviewSetQuery 对象](../resources/ediscovery-reviewsetquery.md) 的列表。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [microsoft.graph.ediscovery.reviewSetQuery](../resources/ediscovery-reviewsetquery.md) 对象集合。
