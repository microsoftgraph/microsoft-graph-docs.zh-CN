...
使用此 API 创建新[privilegedRoleAssignment](../resources/privilegedroleassignment.md)。
...
如果成功，此方法返回`201 Created`响应正文中的响应代码和[privilegedRoleAssignment](../resources/privilegedroleassignment.md)对象。
