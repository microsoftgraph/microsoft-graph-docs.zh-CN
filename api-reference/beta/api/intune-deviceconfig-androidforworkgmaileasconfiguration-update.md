...
更新 [androidForWorkGmailEasConfiguration 对象](../resources/intune-deviceconfig-androidforworkgmaileasconfiguration.md) 的属性。
...
下表显示创建 [androidForWorkGmailEasConfiguration 时所需的属性](../resources/intune-deviceconfig-androidforworkgmaileasconfiguration.md)。
...
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [androidForWorkGmailEasConfiguration](../resources/intune-deviceconfig-androidforworkgmaileasconfiguration.md) 对象。
