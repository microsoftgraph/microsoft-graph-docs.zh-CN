...
ms.locfileid: "58796689"
---
# <a name="getstate-function"></a>getState 函数
...
如果成功，此函数在响应 `200 OK` 正文中返回 响应代码和[assignmentFilterState。](../resources/intune-policyset-assignmentfilterstate.md)
