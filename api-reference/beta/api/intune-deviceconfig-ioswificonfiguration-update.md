...
下表显示创建 [iosWiFiConfiguration](../resources/intune-deviceconfig-ioswificonfiguration.md)时所需的属性。
...
|disableMacAddressRandomization|Boolean|如果设置为 true，则强制设备使用此 Wi-Fi 配置文件进行连接，以提供实际 Wi-Fi MAC 地址，而不是随机 MAC 地址。 适用于 iOS 14 和更高版本。|
|preSharedKey|String|这是 WPA 个人 Wi-Fi 网络的预共享密钥。|



## <a name="response"></a>响应
如果成功，此方法 `200 OK` 在响应正文中返回响应代码和更新的 [iosWiFiConfiguration](../resources/intune-deviceconfig-ioswificonfiguration.md) 对象。
