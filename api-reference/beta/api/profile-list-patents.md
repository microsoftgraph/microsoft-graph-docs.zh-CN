...
---
# <a name="list-patents"></a>列出性

命名空间：microsoft.graph

从用户的 [配置文件检索 itemPatent](../resources/itempatent.md) 对象 [列表](../resources/profile.md)。
...
如果成功，此方法在响应 `200 OK` 正文中返回响应代码和 [itemPatent](../resources/itempatent.md) 对象集合。
