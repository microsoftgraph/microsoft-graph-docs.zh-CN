---
title: 列出专利
description: 从专利导航属性获取 itempatents。
...
ms.locfileid: "62136959"
---
# <a name="list-patents"></a>列出专利

命名空间：microsoft.graph

从用户配置文件中检索 [itemPatent](../resources/itempatent.md) 对象 [的列表](../resources/profile.md)。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [itemPatent](../resources/itempatent.md) 对象集合。
