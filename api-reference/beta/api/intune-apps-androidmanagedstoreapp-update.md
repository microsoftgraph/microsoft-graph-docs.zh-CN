...
更新 [androidManagedStoreApp 对象](../resources/intune-apps-androidmanagedstoreapp.md) 的属性。
...
下表显示创建 [androidManagedStoreApp 时所需的属性](../resources/intune-apps-androidmanagedstoreapp.md)。
...
|isPrivate|布尔值|指示应用是否仅适用于给定企业的用户。|
|isSystemApp|布尔值|指示应用是否是预安装的系统应用。|
...
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [androidManagedStoreApp](../resources/intune-apps-androidmanagedstoreapp.md) 对象。
