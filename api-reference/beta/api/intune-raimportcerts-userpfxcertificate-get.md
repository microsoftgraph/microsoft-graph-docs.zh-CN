...
读取 [userPFXCertificate 对象的属性和](../resources/intune-raimportcerts-userpfxcertificate.md) 关系。
...
如果成功，此方法在响应 `200 OK` 正文中返回 响应代码和 [userPFXCertificate](../resources/intune-raimportcerts-userpfxcertificate.md) 对象。
