---
title: 获取 aospDeviceOwnerTrustedRootCertificate
description: 读取 aospDeviceOwnerTrustedRootCertificate 对象的属性和关系。
author: dougeby
...
ms.locfileid: "64629286"
---
# <a name="get-aospdeviceownertrustedrootcertificate"></a>获取 aospDeviceOwnerTrustedRootCertificate
...
读取 [aospDeviceOwnerTrustedRootCertificate 对象的属性和](../resources/intune-deviceconfig-aospdeviceownertrustedrootcertificate.md) 关系。
...
如果成功，此方法在响应正文中返回 响应 `200 OK` 代码和 [aospDeviceOwnerTrustedRootCertificate](../resources/intune-deviceconfig-aospdeviceownertrustedrootcertificate.md) 对象。
