...
更新 [depEnrollmentProfile 对象](../resources/intune-enrollment-depenrollmentprofile.md) 的属性。
...
下表显示创建 [depEnrollmentProfile 时所需的属性](../resources/intune-enrollment-depenrollmentprofile.md)。
...
如果成功，此方法在响应 `200 OK` 正文中返回 响应代码和更新的 [depEnrollmentProfile](../resources/intune-enrollment-depenrollmentprofile.md) 对象。
