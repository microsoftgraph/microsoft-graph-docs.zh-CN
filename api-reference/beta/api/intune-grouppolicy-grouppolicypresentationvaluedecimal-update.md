...
更新 [groupPolicyPresentationValueDecimal 对象](../resources/intune-grouppolicy-grouppolicypresentationvaluedecimal.md) 的属性。
...
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [groupPolicyPresentationValueDecimal](../resources/intune-grouppolicy-grouppolicypresentationvaluedecimal.md) 对象。
