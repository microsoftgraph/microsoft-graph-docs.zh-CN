...
在请求正文中，为 [windowsUpdateState](../resources/intune-shared-windowsupdatestate.md) 对象提供 JSON 表示形式。

下表显示了创建 [windowsUpdateState](../resources/intune-shared-windowsupdatestate.md) 时所需的属性。
...
如果成功，此方法在响应正文中返回 `200 OK` 响应代码和更新的 [windowsUpdateState](../resources/intune-shared-windowsupdatestate.md) 对象。
