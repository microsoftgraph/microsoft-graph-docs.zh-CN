...
从用户配置文件中检索 [personName](../resources/personname.md) 对象 [的列表](../resources/profile.md)。
...
如果成功，此方法在响应 `200 OK` 正文中返回 响应代码和 [personName](../resources/personname.md) 对象集合。
