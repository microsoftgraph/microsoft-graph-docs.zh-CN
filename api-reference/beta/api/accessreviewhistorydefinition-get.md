...
按其 [标识符检索 accessReviewHistoryDefinition](../resources/accessreviewhistorydefinition.md) 对象。 返回访问评审历史记录定义对象的所有属性。 如果下载链接仍然有效，它将与定义一起返回。 如果定义是 30 天或更久，则返回 404 错误。
