...
---
# <a name="create-ioslobappprovisioningconfigurationpolicysetitem"></a>创建 iosLobAppProvisioningConfigurationPolicySetItem
...
创建新的 [iosLobAppProvisioningConfigurationPolicySetItem](../resources/intune-policyset-ioslobappprovisioningconfigurationpolicysetitem.md) 对象。
...
在请求正文中，提供 iosLobAppProvisioningConfigurationPolicySetItem 对象的 JSON 表示形式。

下表显示创建 iosLobAppProvisioningConfigurationPolicySetItem 时所需的属性。
...
如果成功，此方法在响应正文中返回 响应代码和 `201 Created` [iosLobAppProvisioningConfigurationPolicySetItem](../resources/intune-policyset-ioslobappprovisioningconfigurationpolicysetitem.md) 对象。
