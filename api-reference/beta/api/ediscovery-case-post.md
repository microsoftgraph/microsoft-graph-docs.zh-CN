...
>[!NOTE]
>从 2021 年 9 月开始，此 API 将创建大案例类型。 若要了解有关大案例的更多信息，请参阅在 Advanced eDiscovery[中Advanced eDiscovery。](/microsoft-365/compliance/advanced-ediscovery-large-cases) 有关详细信息，请参阅对高级[电子](https://go.microsoft.com/fwlink/?linkid=2172604)数据展示Microsoft 365 API 博客文章的更改。
