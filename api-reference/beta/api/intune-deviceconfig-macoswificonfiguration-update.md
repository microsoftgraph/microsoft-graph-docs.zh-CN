...
更新 [macOSWiFiConfiguration 对象](../resources/intune-deviceconfig-macoswificonfiguration.md) 的属性。
...
下表显示创建 [macOSWiFiConfiguration 时所需的属性](../resources/intune-deviceconfig-macoswificonfiguration.md)。
...
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [macOSWiFiConfiguration](../resources/intune-deviceconfig-macoswificonfiguration.md) 对象。
