...
读取 [ndesConnector 对象的属性和](../resources/intune-deviceconfig-ndesconnector.md) 关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [ndesConnector](../resources/intune-deviceconfig-ndesconnector.md) 对象。
