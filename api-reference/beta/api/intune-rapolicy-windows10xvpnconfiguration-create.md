...
ms.locfileid: "58784910"
---
# <a name="create-windows10xvpnconfiguration"></a>创建 windows10XVpnConfiguration
...
创建新的 [windows10XVpnConfiguration](../resources/intune-rapolicy-windows10xvpnconfiguration.md) 对象。
...
在请求正文中，提供 windows10XVpnConfiguration 对象的 JSON 表示形式。

下表显示创建 windows10XVpnConfiguration 时所需的属性。
...
如果成功，此方法在响应正文中返回 响应代码和 `201 Created` [windows10XVpnConfiguration](../resources/intune-rapolicy-windows10xvpnconfiguration.md) 对象。
