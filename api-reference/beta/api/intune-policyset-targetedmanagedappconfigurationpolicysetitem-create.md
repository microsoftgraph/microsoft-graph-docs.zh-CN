...
如果成功，此方法在响应`201 Created`正文中返回响应代码和[targetedManagedAppConfigurationPolicySetItem](../resources/intune-policyset-targetedmanagedappconfigurationpolicysetitem.md)对象。
