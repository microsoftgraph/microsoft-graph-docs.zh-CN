...
从 rules 导航属性获取 unifiedRoleManagementPolicyRule 资源。 若要检索适用于 Azure RBAC 的策略的规则，请使用适用于角色管理策略的 [Azure REST PIM API](/rest/api/authorization/role-management-policies/list-for-scope)。
