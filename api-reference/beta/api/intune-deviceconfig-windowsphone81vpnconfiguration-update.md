...
下表显示时创建[windowsPhone81VpnConfiguration](../resources/intune-deviceconfig-windowsphone81vpnconfiguration.md)所需的属性。
...
|enableSplitTunneling|布尔|启用拆分隧道的 VPN。 继承自[windows81VpnConfiguration](../resources/intune-deviceconfig-windows81vpnconfiguration.md)|
...
|bypassVpnOnCompanyWifi|布尔|在公司 Wi-fi 绕过 VPN。|
|bypassVpnOnHomeWifi|布尔|绕过 Wi-fi 主页上的 VPN。|
...
如果成功，此方法返回`200 OK`响应代码和响应正文中的更新的[windowsPhone81VpnConfiguration](../resources/intune-deviceconfig-windowsphone81vpnconfiguration.md)对象。
