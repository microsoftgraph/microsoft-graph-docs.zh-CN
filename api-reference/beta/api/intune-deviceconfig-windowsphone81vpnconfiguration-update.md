...
|loginGroupOrDomain|String|登录组或域时连接类型设置为 Dell 使 SonicWALL Mobile 连接。 继承自[windows81VpnConfiguration](../resources/intune-deviceconfig-windows81vpnconfiguration.md)|
