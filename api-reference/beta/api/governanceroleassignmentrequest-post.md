...
description: 创建角色分配请求，以表示要处理角色分配。 下表列出了操作。
...
本示例中，用户 nawu@contoso.com 活动"计费读取者"角色。
...
本示例中，管理员从"计费 nawu@contoso.com 用户角色中删除用户角色。
...
在此例中，管理员更新角色分配所有者 nawu@contoso.com 权限。
