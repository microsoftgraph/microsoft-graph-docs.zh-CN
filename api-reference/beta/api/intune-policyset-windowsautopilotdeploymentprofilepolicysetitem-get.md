...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [windowsAutopilotDeploymentProfilePolicySetItem](../resources/intune-policyset-windowsautopilotdeploymentprofilepolicysetitem.md) 对象。
