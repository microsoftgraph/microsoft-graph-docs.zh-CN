...
列出 [networkManagementCondition 对象的属性和](../resources/intune-fencing-networkmanagementcondition.md) 关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [networkManagementCondition](../resources/intune-fencing-networkmanagementcondition.md) 对象集合。
