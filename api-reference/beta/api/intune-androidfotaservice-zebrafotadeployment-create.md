---
title: 创建 zebraFotaDeployment
description: 创建新的 zebraFotaDeployment 对象。
author: dougeby
...
ms.locfileid: "65213118"
---
# <a name="create-zebrafotadeployment"></a>创建 zebraFotaDeployment
...
创建新的 [zebraFotaDeployment](../resources/intune-androidfotaservice-zebrafotadeployment.md) 对象。
...
在请求正文中，为 zebraFotaDeployment 对象提供 JSON 表示形式。

下表显示了创建 zebraFotaDeployment 时所需的属性。
...
如果成功，此方法在响应正文中返回 `201 Created` 响应代码和 [zebraFotaDeployment](../resources/intune-androidfotaservice-zebrafotadeployment.md) 对象。
