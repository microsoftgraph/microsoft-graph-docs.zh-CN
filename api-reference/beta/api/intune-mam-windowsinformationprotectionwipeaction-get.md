...
读取 [windowsInformationProtectionWipeAction 对象的属性和](../resources/intune-mam-windowsinformationprotectionwipeaction.md) 关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [windowsInformationProtectionWipeAction](../resources/intune-mam-windowsinformationprotectionwipeaction.md) 对象。
