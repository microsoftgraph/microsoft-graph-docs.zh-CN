...
从 case[对象获取 reviewSets](../resources/ediscovery-reviewset.md)[列表。](../resources/ediscovery-case.md)
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [microsoft.graph.ediscovery.reviewSet](../resources/ediscovery-reviewset.md) 对象集合。
