...
读取 [windows81TrustedRootCertificate 对象的属性和](../resources/intune-deviceconfig-windows81trustedrootcertificate.md) 关系。
...
如果成功，此方法在响应正文 `200 OK` 中返回 响应代码和 [windows81TrustedRootCertificate](../resources/intune-deviceconfig-windows81trustedrootcertificate.md) 对象。
