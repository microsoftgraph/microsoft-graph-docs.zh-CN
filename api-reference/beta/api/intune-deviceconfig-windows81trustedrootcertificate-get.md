...
如果成功，此方法在响应正文中返回 响应 `200 OK` 代码和 [windows81TrustedRootCertificate](../resources/intune-deviceconfig-windows81trustedrootcertificate.md) 对象。
