...
ms.locfileid: "54179933"
---
# <a name="get-macossoftwareupdateaccountsummary"></a>获取 macOSSoftwareUpdateAccountSummary
...
读取 [macOSSoftwareUpdateAccountSummary 对象的属性和](../resources/intune-deviceconfig-macossoftwareupdateaccountsummary.md) 关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [macOSSoftwareUpdateAccountSummary](../resources/intune-deviceconfig-macossoftwareupdateaccountsummary.md) 对象。
