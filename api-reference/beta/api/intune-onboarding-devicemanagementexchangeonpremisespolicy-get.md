...
读取 [deviceManagementExchangeOnPremisesPolicy 对象的](../resources/intune-onboarding-devicemanagementexchangeonpremisespolicy.md) 属性和关系。
...
如果成功，此方法在响应正文中返回 `200 OK` 响应代码和 [deviceManagementExchangeOnPremisesPolicy](../resources/intune-onboarding-devicemanagementexchangeonpremisespolicy.md) 对象。
