...
列出 [userAppInstallStatus](../resources/intune-apps-userappinstallstatus.md) 对象的属性和关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [userAppInstallStatus](../resources/intune-apps-userappinstallstatus.md) 对象集合。
