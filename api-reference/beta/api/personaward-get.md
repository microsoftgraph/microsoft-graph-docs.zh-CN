...
ms.locfileid: "62123218"
---
# <a name="get-personaward"></a>获取 personAward

命名空间：microsoft.graph

从用户配置文件中读取 [personAward](../resources/personaward.md) 对象的属性和 [关系](../resources/profile.md)。
...
如果成功，此方法在响应 `200 OK` 正文中返回 响应代码和 [personAward](../resources/personaward.md) 对象。
