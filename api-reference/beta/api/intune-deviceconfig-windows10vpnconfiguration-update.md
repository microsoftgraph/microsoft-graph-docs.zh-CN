...
下表显示时创建[windows10VpnConfiguration](../resources/intune-deviceconfig-windows10vpnconfiguration.md)所需的属性。
...
|singleSignOnIssuerHash|String|单一登录颁发者哈希值。|
...
|windowsInformationProtectionDomain|String|要与此连接关联的 Windows 的信息保护 (WIP) 域。|
...
如果成功，此方法返回`200 OK`响应代码和响应正文中的更新的[windows10VpnConfiguration](../resources/intune-deviceconfig-windows10vpnconfiguration.md)对象。
