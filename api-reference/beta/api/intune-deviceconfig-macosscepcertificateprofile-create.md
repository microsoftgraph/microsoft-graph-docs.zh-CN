...
---
# <a name="create-macosscepcertificateprofile"></a>创建 macOSScepCertificateProfile
...
创建新的 [macOSScepCertificateProfile](../resources/intune-deviceconfig-macosscepcertificateprofile.md) 对象。
...
在请求正文中，提供 macOSScepCertificateProfile 对象的 JSON 表示形式。

下表显示创建 macOSScepCertificateProfile 时所需的属性。
...
如果成功，此方法 `201 Created` 在响应正文中返回响应代码和 [macOSScepCertificateProfile](../resources/intune-deviceconfig-macosscepcertificateprofile.md) 对象。
