---
title: 列出 userExperienceAnalyticsBatteryHealthOsPerformances
description: 列出 userExperienceAnalyticsBatteryHealthOsPerformance 对象的属性和关系。
author: dougeby
...
ms.locfileid: "61345224"
---
# <a name="list-userexperienceanalyticsbatteryhealthosperformances"></a>列出 userExperienceAnalyticsBatteryHealthOsPerformances
...
列出 [userExperienceAnalyticsBatteryHealthOsPerformance](../resources/intune-devices-userexperienceanalyticsbatteryhealthosperformance.md) 对象的属性和关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [userExperienceAnalyticsBatteryHealthOsPerformance](../resources/intune-devices-userexperienceanalyticsbatteryhealthosperformance.md) 对象集合。
