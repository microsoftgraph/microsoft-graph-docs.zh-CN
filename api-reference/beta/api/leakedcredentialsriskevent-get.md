...
---
# <a name="get-leakedcredentialsriskevent-deprecated"></a>获取 leakedCredentialsRiskEvent (弃用) 
...
如果成功，此方法 `200 OK` 在响应正文中返回响应代码和 [leakedCredentialsRiskEvent](../resources/leakedcredentialsriskevent.md) 对象。
## <a name="example"></a>示例
##### <a name="request"></a>请求
下面是一个请求示例。
<!-- {
