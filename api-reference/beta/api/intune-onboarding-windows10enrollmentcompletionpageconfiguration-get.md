...
读取 [windows10EnrollmentCompletionPageConfiguration 对象的属性和](../resources/intune-onboarding-windows10enrollmentcompletionpageconfiguration.md) 关系。
...
如果成功，此方法在响应正文中返回 响应 `200 OK` 代码和 [windows10EnrollmentCompletionPageConfiguration](../resources/intune-onboarding-windows10enrollmentcompletionpageconfiguration.md) 对象。
