...
读取 [roleManagement 对象的属性和](../resources/intune-rbac-rolemanagement.md) 关系。
...
如果成功，此方法在响应 `200 OK` 正文中返回 响应代码和 [roleManagement](../resources/intune-rbac-rolemanagement.md) 对象。
