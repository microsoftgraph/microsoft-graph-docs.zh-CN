...
|maximumEAPOLStartMessages|Int32|指定在返回失败 (发送的 EAPOL (可扩展身份验证协议的最大数量) "开始"消息。 有效范围为 1-100。|
...
如果成功，此方法在响应正文中返回 响应 `201 Created` 代码和 [windowsWifiEnterpriseEAPConfiguration](../resources/intune-deviceconfig-windowswifienterpriseeapconfiguration.md) 对象。
