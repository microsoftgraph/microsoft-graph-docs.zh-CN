...
ms.locfileid: "58794179"
---
# <a name="delete-appleuserinitiatedenrollmentprofile"></a>删除 appleUserInitiatedEnrollmentProfile
...
删除 [appleUserInitiatedEnrollmentProfile](../resources/intune-enrollment-appleuserinitiatedenrollmentprofile.md)。
