---
title: 创建 userExperienceAnalyticsWorkFromAnywhereModelPerformance
description: 创建新的 userExperienceAnalyticsWorkFromAnywhereModelPerformance 对象。
author: dougeby
...
---
# <a name="create-userexperienceanalyticsworkfromanywheremodelperformance"></a>创建 userExperienceAnalyticsWorkFromAnywhereModelPerformance
...
创建新的 [userExperienceAnalyticsWorkFromAnywhereModelPerformance](../resources/intune-devices-userexperienceanalyticsworkfromanywheremodelperformance.md) 对象。
...
在请求正文中，提供 userExperienceAnalyticsWorkFromAnywhereModelPerformance 对象的 JSON 表示形式。

下表显示创建 userExperienceAnalyticsWorkFromAnywhereModelPerformance 时所需的属性。
...
如果成功，此方法在响应 `201 Created` 正文中返回 响应代码和 [userExperienceAnalyticsWorkFromAnywhereModelPerformance](../resources/intune-devices-userexperienceanalyticsworkfromanywheremodelperformance.md) 对象。
