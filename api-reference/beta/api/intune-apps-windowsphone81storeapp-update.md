...
更新 [windowsPhone81StoreApp 对象](../resources/intune-apps-windowsphone81storeapp.md) 的属性。
...
下表显示创建 [windowsPhone81StoreApp 时所需的属性](../resources/intune-apps-windowsphone81storeapp.md)。
...
如果成功，此方法在响应正文中返回 响应代码和更新 `200 OK` 的 [windowsPhone81StoreApp](../resources/intune-apps-windowsphone81storeapp.md) 对象。
