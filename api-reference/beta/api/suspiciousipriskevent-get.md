...
---
# <a name="get-suspiciousipriskevent-deprecated"></a>获取已弃 (的 suspiciousIpRiskEvent) 
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [suspiciousIpRiskEvent](../resources/suspiciousipriskevent.md) 对象。
## <a name="example"></a>示例
##### <a name="request"></a>请求
下面是一个请求示例。
<!-- {
