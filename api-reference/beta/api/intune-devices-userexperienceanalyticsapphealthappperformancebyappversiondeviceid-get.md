---
title: 获取 userExperienceAnalyticsAppHealthAppPerformanceByAppVersionDeviceId
description: 读取 userExperienceAnalyticsAppHealthAppPerformanceByAppVersionDeviceId 对象的属性和关系。
author: dougeby
...
ms.locfileid: "58259224"
---
# <a name="get-userexperienceanalyticsapphealthappperformancebyappversiondeviceid"></a>获取 userExperienceAnalyticsAppHealthAppPerformanceByAppVersionDeviceId
...
读取 [userExperienceAnalyticsAppHealthAppPerformanceByAppVersionDeviceId 对象的属性和](../resources/intune-devices-userexperienceanalyticsapphealthappperformancebyappversiondeviceid.md) 关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [userExperienceAnalyticsAppHealthAppPerformanceByAppVersionDeviceId](../resources/intune-devices-userexperienceanalyticsapphealthappperformancebyappversiondeviceid.md) 对象。
