...
检索 [accessPackageAssignmentResourceRole 对象](../resources/accesspackageassignmentresourcerole.md) 的列表。  生成的列表包括所有目录和访问包中调用方有权访问的所有分配的所有资源角色。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [accessPackageAssignmentResourceRole](../resources/accesspackageassignmentresourcerole.md) 对象集合。
