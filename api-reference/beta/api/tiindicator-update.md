...
|malwareFamilyNames|String collection|与指示器关联的恶意软件系列名称（如果存在）。 如果可以通过安全智能威胁中心找到，Microsoft 将尽可能Windows Defender Microsoft 恶意软件系列 [名称](https://www.microsoft.com/wdsi/threats)。|
