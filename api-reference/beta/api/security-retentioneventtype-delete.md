---
title: 删除 retentionEventType
description: 删除 retentionEventType 对象。
author: sseth
...
---
# <a name="delete-retentioneventtype"></a>删除 retentionEventType
命名空间：microsoft.graph.security

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

删除 [retentionEventType](../resources/security-retentioneventtype.md) 对象。
