---
title: 列出 zebraFotaArtifacts
description: 列出 zebraFotaArtifact 对象的属性和关系。
author: dougeby
...
ms.locfileid: "65213194"
---
# <a name="list-zebrafotaartifacts"></a>列出 zebraFotaArtifacts
...
列出 [zebraFotaArtifact](../resources/intune-androidfotaservice-zebrafotaartifact.md) 对象的属性和关系。
...
如果成功，此方法在响应正文中返回 `200 OK` 响应代码和 [zebraFotaArtifact](../resources/intune-androidfotaservice-zebrafotaartifact.md) 对象集合。
