...
更新 [androidManagedStoreAppConfigurationSchema 对象](../resources/intune-androidforwork-androidmanagedstoreappconfigurationschema.md) 的属性。
...
下表显示创建 [androidManagedStoreAppConfigurationSchema 时所需的属性](../resources/intune-androidforwork-androidmanagedstoreappconfigurationschema.md)。
...
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [androidManagedStoreAppConfigurationSchema](../resources/intune-androidforwork-androidmanagedstoreappconfigurationschema.md) 对象。
