---
title: 更新 windowsWiredNetworkConfiguration
description: 更新 windowsWiredNetworkConfiguration 对象的属性。
author: dougeby
...
ms.locfileid: "64631061"
---
# <a name="update-windowswirednetworkconfiguration"></a>更新 windowsWiredNetworkConfiguration
...
更新 [windowsWiredNetworkConfiguration 对象](../resources/intune-deviceconfig-windowswirednetworkconfiguration.md) 的属性。
...
在请求正文中，提供 [windowsWiredNetworkConfiguration](../resources/intune-deviceconfig-windowswirednetworkconfiguration.md) 对象的 JSON 表示形式。

下表显示创建 [windowsWiredNetworkConfiguration 时所需的属性](../resources/intune-deviceconfig-windowswirednetworkconfiguration.md)。
...
如果成功，此方法在响应 `200 OK` 正文中返回 响应代码和更新的 [windowsWiredNetworkConfiguration](../resources/intune-deviceconfig-windowswirednetworkconfiguration.md) 对象。
