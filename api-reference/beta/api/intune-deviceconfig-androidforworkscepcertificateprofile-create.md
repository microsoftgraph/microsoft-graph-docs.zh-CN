...
创建新的 [androidForWorkScepCertificateProfile](../resources/intune-deviceconfig-androidforworkscepcertificateprofile.md) 对象。
...
在请求正文中，提供 androidForWorkScepCertificateProfile 对象的 JSON 表示形式。

下表显示创建 androidForWorkScepCertificateProfile 时所需的属性。
...
如果成功，此方法在响应正文中返回 响应代码和 `201 Created` [androidForWorkScepCertificateProfile](../resources/intune-deviceconfig-androidforworkscepcertificateprofile.md) 对象。
