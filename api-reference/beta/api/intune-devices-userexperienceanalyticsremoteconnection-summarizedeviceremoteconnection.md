...
ms.locfileid: "58798579"
---
# <a name="summarizedeviceremoteconnection-function"></a>summarizeDeviceRemoteConnection 函数
...
如果成功，此函数在响应正文中返回 响应代码和 `200 OK` [userExperienceAnalyticsRemoteConnection](../resources/intune-devices-userexperienceanalyticsremoteconnection.md) 集合。
