---
title: 获取 zebraFotaDeployment
description: 读取 zebraFotaDeployment 对象的属性和关系。
author: dougeby
...
ms.locfileid: "65213039"
---
# <a name="get-zebrafotadeployment"></a>获取 zebraFotaDeployment
...
读取 [zebraFotaDeployment](../resources/intune-androidfotaservice-zebrafotadeployment.md) 对象的属性和关系。
...
如果成功，此方法在响应正文中返回 `200 OK` 响应代码和 [zebraFotaDeployment](../resources/intune-androidfotaservice-zebrafotadeployment.md) 对象。
