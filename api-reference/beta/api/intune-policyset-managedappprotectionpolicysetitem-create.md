...
ms.locfileid: "58789373"
---
# <a name="create-managedappprotectionpolicysetitem"></a>创建 managedAppProtectionPolicySetItem
...
创建新的 [managedAppProtectionPolicySetItem](../resources/intune-policyset-managedappprotectionpolicysetitem.md) 对象。
...
在请求正文中，提供 managedAppProtectionPolicySetItem 对象的 JSON 表示形式。

下表显示创建 managedAppProtectionPolicySetItem 时所需的属性。
...
如果成功，此方法在响应正文中返回 响应代码和 `201 Created` [managedAppProtectionPolicySetItem](../resources/intune-policyset-managedappprotectionpolicysetitem.md) 对象。
