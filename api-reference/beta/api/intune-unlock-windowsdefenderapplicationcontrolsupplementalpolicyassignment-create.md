...
在请求正文中，提供 windowsDefenderApplicationControlSupplementalPolicyAssignment 对象的 JSON 表示形式。

下表显示创建 windowsDefenderApplicationControlSupplementalPolicyAssignment 时所需的属性。
...
如果成功，此方法在响应正文中返回 响应代码和 `201 Created` [windowsDefenderApplicationControlSupplementalPolicyAssignment](../resources/intune-unlock-windowsdefenderapplicationcontrolsupplementalpolicyassignment.md) 对象。
