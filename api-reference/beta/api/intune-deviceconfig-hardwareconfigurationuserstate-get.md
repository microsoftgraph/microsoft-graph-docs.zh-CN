---
title: 获取 hardwareConfigurationUserState
description: 读取 hardwareConfigurationUserState 对象的属性和关系。
author: dougeby
...
ms.locfileid: "61345358"
---
# <a name="get-hardwareconfigurationuserstate"></a>获取 hardwareConfigurationUserState
...
读取 [hardwareConfigurationUserState 对象的属性和](../resources/intune-deviceconfig-hardwareconfigurationuserstate.md) 关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [hardwareConfigurationUserState](../resources/intune-deviceconfig-hardwareconfigurationuserstate.md) 对象。
