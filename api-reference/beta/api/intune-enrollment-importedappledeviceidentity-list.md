...
---
# <a name="list-importedappledeviceidentities"></a>列出 importedAppleDeviceIdentities
...
列出 [importedAppleDeviceIdentity 对象的属性和](../resources/intune-enrollment-importedappledeviceidentity.md) 关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [importedAppleDeviceIdentity](../resources/intune-enrollment-importedappledeviceidentity.md) 对象集合。
