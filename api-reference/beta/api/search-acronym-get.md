...
---
# <a name="get-acronym"></a>获取首字母缩略词
命名空间：microsoft.graph.search

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

读取首字母缩写词对象 [的属性和](../resources/search-acronym.md) 关系。
...
如果成功，此方法在响应`200 OK`正文中返回 响应代码[](../resources/search-acronym.md)和首字母缩写词对象。
