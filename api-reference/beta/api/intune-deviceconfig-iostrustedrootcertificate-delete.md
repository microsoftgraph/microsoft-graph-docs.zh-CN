...
---
# <a name="delete-iostrustedrootcertificate"></a>删除 iosTrustedRootCertificate
...
删除 [iosTrustedRootCertificate](../resources/intune-deviceconfig-iostrustedrootcertificate.md)。
