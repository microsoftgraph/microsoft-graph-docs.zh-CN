...
获取与源集合关联的其他 [dataSource](../resources/ediscovery-datasource.md) 对象的列表。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [microsoft.graph.ediscovery.dataSource](../resources/ediscovery-datasource.md) 对象集合。
