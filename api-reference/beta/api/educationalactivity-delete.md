...
description: 从用户配置文件中删除一个 educationalActivity 对象。
...
从 [用户配置文件中删除一个 educationalActivity](../resources/educationalactivity.md) [对象](../resources/profile.md)。
