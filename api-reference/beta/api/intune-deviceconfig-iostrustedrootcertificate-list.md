...
ms.locfileid: "59055260"
---
# <a name="list-iostrustedrootcertificates"></a>列出 iosTrustedRootCertificates
...
列出 [iosTrustedRootCertificate 对象的属性和](../resources/intune-deviceconfig-iostrustedrootcertificate.md) 关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [iosTrustedRootCertificate](../resources/intune-deviceconfig-iostrustedrootcertificate.md) 对象集合。
