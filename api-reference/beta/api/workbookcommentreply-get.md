...
检索 [workbookCommentReply 对象的属性和](../resources/workbookcommentreply.md) 关系。
...
如果成功，此方法在响应正文中返回 响应代码和请求的 `200 OK` [workbookCommentReply](../resources/workbookcommentreply.md) 对象。
