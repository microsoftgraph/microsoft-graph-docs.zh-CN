...
|参数|类型|说明|
|:---|:---|:---|
|assignments|[cloudPcUserSettingAssignment](../resources/cloudpcusersettingassignment.md) 集合 | 要分配给相应目标组的云电脑用户设置资源的集合。 目前Microsoft 365安全组Azure AD组和安全组。 |
