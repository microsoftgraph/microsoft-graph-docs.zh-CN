...
更新 [windows10PkcsCertificateProfile 对象](../resources/intune-deviceconfig-windows10pkcscertificateprofile.md) 的属性。
...
在请求正文中，提供 [windows10PkcsCertificateProfile](../resources/intune-deviceconfig-windows10pkcscertificateprofile.md) 对象的 JSON 表示形式。

下表显示创建 [windows10PkcsCertificateProfile 时所需的属性](../resources/intune-deviceconfig-windows10pkcscertificateprofile.md)。
...
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [windows10PkcsCertificateProfile](../resources/intune-deviceconfig-windows10pkcscertificateprofile.md) 对象。
