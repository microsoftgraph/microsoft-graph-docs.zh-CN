...
在请求正文中，为 windowsManagedDevice 对象提供 JSON 表示形式。
...
如果成功，此方法在响应正文中返回 `201 Created` 响应代码和 [windowsManagedDevice](../resources/intune-devices-windowsmanageddevice.md) 对象。
