...
更新 [rbacApplicationMultiple 对象](../resources/intune-rbac-rbacapplicationmultiple.md) 的属性。
...
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [rbacApplicationMultiple](../resources/intune-rbac-rbacapplicationmultiple.md) 对象。
