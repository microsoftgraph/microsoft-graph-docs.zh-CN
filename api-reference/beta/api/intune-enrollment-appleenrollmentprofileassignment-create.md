...
创建新的[appleEnrollmentProfileAssignment](../resources/intune-enrollment-appleenrollmentprofileassignment.md)对象。
...
在请求正文中，提供 appleEnrollmentProfileAssignment 对象的 JSON 表示形式。

下表显示创建 appleEnrollmentProfileAssignment 时所需的属性。
...
如果成功，此方法在响应`201 Created`正文中返回响应代码和[appleEnrollmentProfileAssignment](../resources/intune-enrollment-appleenrollmentprofileassignment.md)对象。
