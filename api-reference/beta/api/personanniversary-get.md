...
在用户的[配置文件](../resources/profile.md)中检索[personAnniversary](../resources/personanniversary.md)对象的属性和关系。
...
如果成功，此方法在响应`200 OK`正文中返回响应代码和请求的[personAnniversary](../resources/personanniversary.md)对象。
