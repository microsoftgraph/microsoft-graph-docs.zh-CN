...
更新 [windows10EnrollmentCompletionPageConfiguration 对象](../resources/intune-onboarding-windows10enrollmentcompletionpageconfiguration.md) 的属性。
...
下表显示创建 [windows10EnrollmentCompletionPageConfiguration 时所需的属性](../resources/intune-onboarding-windows10enrollmentcompletionpageconfiguration.md)。
...
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [windows10EnrollmentCompletionPageConfiguration](../resources/intune-onboarding-windows10enrollmentcompletionpageconfiguration.md) 对象。
