...
ms.locfileid: "27338883"
---
# <a name="get-windowsappx"></a><span data-ttu-id="4cc1b-103">获取 windowsAppX</span><span class="sxs-lookup"><span data-stu-id="4cc1b-103">Get windowsAppX</span></span>
...
<span data-ttu-id="4cc1b-107">读取属性和[windowsAppX](../resources/intune-apps-windowsappx.md)对象的关系。</span><span class="sxs-lookup"><span data-stu-id="4cc1b-107">Read properties and relationships of the [windowsAppX](../resources/intune-apps-windowsappx.md) object.</span></span>
...
|:---|:---|
|<span data-ttu-id="4cc1b-113">委派（工作或学校帐户）</span><span class="sxs-lookup"><span data-stu-id="4cc1b-113">Delegated (work or school account)</span></span>|<span data-ttu-id="4cc1b-114">DeviceManagementApps.ReadWrite.All、DeviceManagementApps.Read.All</span><span class="sxs-lookup"><span data-stu-id="4cc1b-114">DeviceManagementApps.ReadWrite.All, DeviceManagementApps.Read.All</span></span>|
...
<span data-ttu-id="4cc1b-132">如果成功，此方法返回`200 OK`响应正文中的响应代码和[windowsAppX](../resources/intune-apps-windowsappx.md)对象。</span><span class="sxs-lookup"><span data-stu-id="4cc1b-132">If successful, this method returns a `200 OK` response code and [windowsAppX](../resources/intune-apps-windowsappx.md) object in the response body.</span></span>
