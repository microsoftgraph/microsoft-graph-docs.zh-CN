...
列出 [appleVpnConfiguration 对象的属性和](../resources/intune-deviceconfig-applevpnconfiguration.md) 关系。
...
如果成功，此方法在响应正文中返回响应 `200 OK` 代码和 [appleVpnConfiguration](../resources/intune-deviceconfig-applevpnconfiguration.md) 对象集合。
