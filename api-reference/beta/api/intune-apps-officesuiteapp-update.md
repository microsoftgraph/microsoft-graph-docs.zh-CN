...
更新 [officeSuiteApp 对象](../resources/intune-apps-officesuiteapp.md) 的属性。
...
下表显示创建 [officeSuiteApp 时所需的属性](../resources/intune-apps-officesuiteapp.md)。
...
|productIds|[officeProductId](../resources/intune-apps-officeproductid.md) 集合|表示 Office365 套件 SKU 的产品 ID。 可能的值是：`o365ProPlusRetail`、`o365BusinessRetail`、`visioProRetail`、`projectProRetail`。|
...
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [officeSuiteApp](../resources/intune-apps-officesuiteapp.md) 对象。
