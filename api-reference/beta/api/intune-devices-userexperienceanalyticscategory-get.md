...
读取 [userExperienceAnalyticsCategory 对象的属性和](../resources/intune-devices-userexperienceanalyticscategory.md) 关系。
...
如果成功，此方法在响应正文中返回响应代码和 `200 OK` [userExperienceAnalyticsCategory](../resources/intune-devices-userexperienceanalyticscategory.md) 对象。
