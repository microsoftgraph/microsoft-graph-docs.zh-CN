...
读取 [enterpriseCodeSigningCertificate 对象的属性和](../resources/intune-apps-enterprisecodesigningcertificate.md) 关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [enterpriseCodeSigningCertificate](../resources/intune-apps-enterprisecodesigningcertificate.md) 对象。
