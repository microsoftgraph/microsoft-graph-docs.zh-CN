...
如果成功，此方法在响应正文中以 JSON 表示形式返回 响应代码和 `200 OK` [trustFrameworkPolicy](../resources/trustframeworkpolicy.md) 对象集合。

## <a name="example"></a>示例

以下示例检索所有 **trustFrameworkPolicies**。
