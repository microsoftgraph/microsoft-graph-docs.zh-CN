...
在请求正文中，提供 androidLobApp 对象的 JSON 表示形式。

下表显示了创建 androidLobApp 时所需的属性。
...
如果成功，此方法会在响应正文中返回 `201 Created` 响应代码和 [androidLobApp](../resources/intune-apps-androidlobapp.md) 对象。
