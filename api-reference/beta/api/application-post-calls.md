...
若要使用应用程序托管媒体加入会议，请通过 [AppHostedMediaConfig](../resources/apphostedmediaconfig.md) 更新媒体配置，如下所示，在以上提供的示例中。
...
显示名称是你想要在会议中显示的来宾标识的名称。 ID 可能是标识来宾标识的唯一 ID。
...
```
> **注意：** 来宾加入取决于会议租户设置。 应用程序可能会进入会议厅，等待用户通过。 此属性由 `isInLobby` 属性定义
