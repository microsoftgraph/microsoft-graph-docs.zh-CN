...
|advancedThreatProtectionRealTime|[enablement](../resources/intune-shared-enablement.md)|确定是否在 macOS 上启用 Microsoft Defender 终结点实时 (Microsoft Defender 高级威胁防护) Microsoft Defender。 可取值为：`notConfigured`、`enabled`、`disabled`。|
