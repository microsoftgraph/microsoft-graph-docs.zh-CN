...
检索用户配置文件中的 [itemEmail](../resources/itememail.md) 对象的属性和 [关系](../resources/profile.md)。
...
如果成功，此方法在响应 `200 OK` 正文中返回 响应代码和 [itemEmail](../resources/itememail.md) 对象。
