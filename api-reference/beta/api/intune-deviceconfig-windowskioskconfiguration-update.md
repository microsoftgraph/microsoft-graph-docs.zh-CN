...
更新 [windowsKioskConfiguration 对象](../resources/intune-deviceconfig-windowskioskconfiguration.md) 的属性。
...
下表显示创建 [windowsKioskConfiguration 时所需的属性](../resources/intune-deviceconfig-windowskioskconfiguration.md)。
...
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [windowsKioskConfiguration](../resources/intune-deviceconfig-windowskioskconfiguration.md) 对象。
