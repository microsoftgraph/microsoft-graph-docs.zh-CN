...
列出 [windowsPhone81AppX](../resources/intune-apps-windowsphone81appx.md) 对象的属性和关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [windowsPhone81AppX](../resources/intune-apps-windowsphone81appx.md) 对象集合。
