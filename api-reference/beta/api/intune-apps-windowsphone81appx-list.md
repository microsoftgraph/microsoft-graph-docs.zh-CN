...
列出 [windowsPhone81AppX 对象的属性和](../resources/intune-apps-windowsphone81appx.md) 关系。
...
如果成功，此方法在响应正文中返回响应代码和 `200 OK` [windowsPhone81AppX](../resources/intune-apps-windowsphone81appx.md) 对象集合。
