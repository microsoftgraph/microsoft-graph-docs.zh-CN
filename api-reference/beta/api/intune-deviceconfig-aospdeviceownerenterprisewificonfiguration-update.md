...
更新 [aospDeviceOwnerEnterpriseWiFiConfiguration 对象](../resources/intune-deviceconfig-aospdeviceownerenterprisewificonfiguration.md) 的属性。
...
在请求正文中，提供 [aospDeviceOwnerEnterpriseWiFiConfiguration](../resources/intune-deviceconfig-aospdeviceownerenterprisewificonfiguration.md) 对象的 JSON 表示形式。

下表显示创建 [aospDeviceOwnerEnterpriseWiFiConfiguration 时所需的属性](../resources/intune-deviceconfig-aospdeviceownerenterprisewificonfiguration.md)。
...
如果成功，此方法在响应 `200 OK` 正文中返回 响应代码和更新的 [aospDeviceOwnerEnterpriseWiFiConfiguration](../resources/intune-deviceconfig-aospdeviceownerenterprisewificonfiguration.md) 对象。
