...
创建新的 [b2xUserFlow](../resources/b2xuserflows.md) 对象。
...
在请求正文中，提供 [b2xUserFlow](../resources/b2xuserflows.md)的 JSON 表示形式。
...
如果成功，此方法将向 `201 Created` 为此请求创建的 [b2xUserFlow](../resources/b2xuserflows.md) 对象的 URI 返回响应代码和位置标头，并将 `B2X_1` 前缀添加到名称中。 如果失败，将返回 `4xx` 错误并显示具体详细信息。
