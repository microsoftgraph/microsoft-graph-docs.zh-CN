...
创建新的[macOSLobApp](../resources/intune-apps-macoslobapp.md)对象。
...
如果成功，此方法返回`201 Created`响应代码和响应正文中的[macOSLobApp](../resources/intune-apps-macoslobapp.md)对象。
