...
更新 [iosLobAppProvisioningConfigurationAssignment 对象](../resources/intune-apps-ioslobappprovisioningconfigurationassignment.md) 的属性。
...
在请求正文中，提供 [iosLobAppProvisioningConfigurationAssignment](../resources/intune-apps-ioslobappprovisioningconfigurationassignment.md) 对象的 JSON 表示形式。

下表显示创建 [iosLobAppProvisioningConfigurationAssignment 时所需的属性](../resources/intune-apps-ioslobappprovisioningconfigurationassignment.md)。
...
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [iosLobAppProvisioningConfigurationAssignment](../resources/intune-apps-ioslobappprovisioningconfigurationassignment.md) 对象。
