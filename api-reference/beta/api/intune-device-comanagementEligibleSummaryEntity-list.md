...
---
# <a name="list-comanagementeligiblesummaryentity"></a>列出 comanagementEligibleSummaryEntity

> **重要说明：**/Beta 版本下的 Microsoft Graph Api 可能会发生更改;不支持生产使用。

> **注意：** 适用于 Intune 的 Microsoft Graph API 需要适用于租户的[活动 Intune 许可证](https://go.microsoft.com/fwlink/?linkid=839381)。

列出 comanagementEligibleSummaryEntity 对象的属性和关系。
...
如果成功，此方法在响应`200 OK`正文中返回响应代码和 comanagementEligibleSummaryEntity 对象集合。
