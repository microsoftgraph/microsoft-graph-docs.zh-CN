...
更新[windowsUpdateState](../resources/intune-deviceconfig-windowsupdatestate.md)对象的属性。
...
在请求正文中, 提供[windowsUpdateState](../resources/intune-deviceconfig-windowsupdatestate.md)对象的 JSON 表示形式。

下表显示创建[windowsUpdateState](../resources/intune-deviceconfig-windowsupdatestate.md)时所需的属性。
...
如果成功, 此方法在响应`200 OK`正文中返回响应代码和更新的[windowsUpdateState](../resources/intune-deviceconfig-windowsupdatestate.md)对象。
