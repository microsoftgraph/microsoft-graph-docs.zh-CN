...
咨询转接意味着在转接之前，转接者可以通知要 (转接) 转接给被叫方。 这与直接转移呼叫相反。
...
### <a name="example-1-call-transfer-from-a-peer-to-peer-call"></a>示例 1：从对等呼叫转移呼叫
...
### <a name="example-2-consultative-transfer-from-a-peer-to-peer-call"></a>示例 2：从对等呼叫进行咨询转接
