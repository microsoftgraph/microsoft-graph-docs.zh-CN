...
这些示例显示传入呼叫在不同类型的转移通知中一直流动的流。

### <a name="example-1-call-transfer"></a>示例1：呼叫转移
...
> **注意：** 在媒体状态音频非活动状态发生之后或之前，接受的传输可能会发生。
...
### <a name="example-2-consultative-transfer"></a>示例2：咨询转移
