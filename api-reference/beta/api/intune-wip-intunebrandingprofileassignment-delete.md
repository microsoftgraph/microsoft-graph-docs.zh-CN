...
ms.locfileid: "39938297"
---
# <a name="delete-intunebrandingprofileassignment"></a><span data-ttu-id="53c6a-103">删除 intuneBrandingProfileAssignment</span><span class="sxs-lookup"><span data-stu-id="53c6a-103">Delete intuneBrandingProfileAssignment</span></span>
...
<span data-ttu-id="53c6a-106">删除[intuneBrandingProfileAssignment](../resources/intune-wip-intunebrandingprofileassignment.md)。</span><span class="sxs-lookup"><span data-stu-id="53c6a-106">Deletes a [intuneBrandingProfileAssignment](../resources/intune-wip-intunebrandingprofileassignment.md).</span></span>
...
|<span data-ttu-id="53c6a-116">Application</span><span class="sxs-lookup"><span data-stu-id="53c6a-116">Application</span></span>|<span data-ttu-id="53c6a-117">DeviceManagementApps.ReadWrite.All</span><span class="sxs-lookup"><span data-stu-id="53c6a-117">DeviceManagementApps.ReadWrite.All</span></span>|
...
|:---|:---|
|<span data-ttu-id="53c6a-122">授权</span><span class="sxs-lookup"><span data-stu-id="53c6a-122">Authorization</span></span>|<span data-ttu-id="53c6a-123">Bearer &lt;token&gt;。必需。</span><span class="sxs-lookup"><span data-stu-id="53c6a-123">Bearer &lt;token&gt; Required.</span></span>|
...
<span data-ttu-id="53c6a-127">请勿提供此方法的请求正文。</span><span class="sxs-lookup"><span data-stu-id="53c6a-127">Do not supply a request body for this method.</span></span>

## <a name="response"></a><span data-ttu-id="53c6a-128">响应</span><span class="sxs-lookup"><span data-stu-id="53c6a-128">Response</span></span>
<span data-ttu-id="53c6a-129">如果成功，此方法返回 `204 No Content` 响应代码。</span><span class="sxs-lookup"><span data-stu-id="53c6a-129">If successful, this method returns a `204 No Content` response code.</span></span>

## <a name="example"></a><span data-ttu-id="53c6a-130">示例</span><span class="sxs-lookup"><span data-stu-id="53c6a-130">Example</span></span>

### <a name="request"></a><span data-ttu-id="53c6a-131">请求</span><span class="sxs-lookup"><span data-stu-id="53c6a-131">Request</span></span>
<span data-ttu-id="53c6a-132">下面是一个请求示例。</span><span class="sxs-lookup"><span data-stu-id="53c6a-132">Here is an example of the request.</span></span>
``` http
...
### <a name="response"></a><span data-ttu-id="53c6a-133">响应</span><span class="sxs-lookup"><span data-stu-id="53c6a-133">Response</span></span>
<span data-ttu-id="53c6a-p102">下面是一个响应示例。注意：为了简单起见，可能会将此处所示的响应对象截断。将从实际调用中返回所有属性。</span><span class="sxs-lookup"><span data-stu-id="53c6a-p102">Here is an example of the response. Note: The response object shown here may be truncated for brevity. All of the properties will be returned from an actual call.</span></span>
``` http
