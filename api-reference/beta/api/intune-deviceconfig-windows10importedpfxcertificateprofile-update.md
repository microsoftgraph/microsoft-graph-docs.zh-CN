...
更新 [windows10ImportedPFXCertificateProfile 对象](../resources/intune-deviceconfig-windows10importedpfxcertificateprofile.md) 的属性。
...
下表显示创建 [windows10ImportedPFXCertificateProfile 时所需的属性](../resources/intune-deviceconfig-windows10importedpfxcertificateprofile.md)。
...
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [windows10ImportedPFXCertificateProfile](../resources/intune-deviceconfig-windows10importedpfxcertificateprofile.md) 对象。
