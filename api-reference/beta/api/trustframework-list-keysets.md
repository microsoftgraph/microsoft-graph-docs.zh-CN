...
检索[trustFrameworkKeySets](../resources/trustframeworkkeyset.md)的列表。
...
如果成功，此方法在响应`200 OK`正文中返回响应代码和[trustFrameworkKeySet](../resources/trustframeworkkeyset.md)对象集合。
