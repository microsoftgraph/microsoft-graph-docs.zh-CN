---
title: 删除 checklistItem
description: 删除 checklistItem 对象。
author: avijityadav
...
ms.locfileid: "66436748"
---
# <a name="delete-checklistitem"></a>删除 checklistItem
...
删除 [checklistItem](../resources/checklistitem.md) 对象。
...
### <a name="delete-a-checklistitem-associated-to-a-specified-todotask"></a>删除与指定 todoTask 关联的 checklistItem
...
```
### <a name="delete-a-checklistitem-associated-to-a-specified-basetask-deprecated"></a>删除与指定的 baseTask 关联的 checklistItem (已弃用) 
...
下面是一个用于删除与 **todoTask** 关联的 **checklistItem** 的示例。
...
下面是一个示例，用于删除与已弃用的 **baseTask** () 关联的 **checklistItem**。
