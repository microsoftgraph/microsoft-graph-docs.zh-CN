...
|style|string|表示表格样式的常量值。 可能的值是：`TableStyleLight1`通过、`TableStyleMedium1`通过`TableStyleMedium28``TableStyleLight21`、`TableStyleDark1`通过`TableStyleDark11`。 还可以指定工作簿中显示的用户定义的自定义样式。|

## <a name="response"></a>响应

如果成功，此方法在响应正文中返回 `200 OK` 响应代码和更新的 [表](../resources/workbooktable.md) 对象。
## <a name="example"></a>示例
### <a name="request"></a>请求
请求示例如下所示。
