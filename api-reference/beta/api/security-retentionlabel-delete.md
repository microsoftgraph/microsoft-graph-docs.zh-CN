---
title: 删除 retentionLabel
description: 删除 retentionLabel 对象。
author: sseth
...
---
# <a name="delete-retentionlabel"></a>删除 retentionLabel
命名空间：microsoft.graph.security

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

删除 [retentionLabel](../resources/security-retentionlabel.md) 对象。
