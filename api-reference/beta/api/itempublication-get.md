...
读取用户配置文件中的 [itemPublication](../resources/itempublication.md) 对象的属性和 [关系](../resources/profile.md)。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [itemPublication](../resources/itempublication.md) 对象。
