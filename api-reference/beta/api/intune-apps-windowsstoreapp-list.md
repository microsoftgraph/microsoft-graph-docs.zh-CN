...
列出 [windowsStoreApp](../resources/intune-apps-windowsstoreapp.md) 对象的属性和关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [windowsStoreApp](../resources/intune-apps-windowsstoreapp.md) 对象集合。
