---
title: 列出 resourceNamespaces
description: 获取 unifiedRbacResourceNamespace 对象及其属性的列表。
...
ms.locfileid: "63338380"
---
# <a name="list-resourcenamespaces"></a>列出 resourceNamespaces
命名空间：microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

获取 [unifiedRbacResourceNamespace](../resources/unifiedrbacresourcenamespace.md) 对象及其属性的列表。
...
此方法支持 和 `$filter` `$select` OData 查询参数来帮助自定义响应。 此方法支持 `$filter` **id 和** **name**。 若要了解一般信息，请参阅 [OData 查询参数](/graph/query-parameters)。
...
如果成功，此方法在响应 `200 OK` 正文中返回 响应代码和 [unifiedRbacResourceNamespace](../resources/unifiedrbacresourcenamespace.md) 对象集合。
