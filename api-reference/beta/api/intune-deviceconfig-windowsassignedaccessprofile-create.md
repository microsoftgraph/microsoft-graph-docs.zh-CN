...
创建新的[windowsAssignedAccessProfile](../resources/intune-deviceconfig-windowsassignedaccessprofile.md)对象。
...
在请求正文中，提供 windowsAssignedAccessProfile 对象的 JSON 表示形式。

下表显示时创建 windowsAssignedAccessProfile 所需的属性。
...
如果成功，此方法返回`201 Created`响应代码和响应正文中的[windowsAssignedAccessProfile](../resources/intune-deviceconfig-windowsassignedaccessprofile.md)对象。
