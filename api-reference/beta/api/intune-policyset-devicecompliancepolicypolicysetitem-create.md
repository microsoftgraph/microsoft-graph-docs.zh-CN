...
ms.locfileid: "58799554"
---
# <a name="create-devicecompliancepolicypolicysetitem"></a>创建 deviceCompliancePolicyPolicySetItem
...
创建新的 [deviceCompliancePolicyPolicySetItem](../resources/intune-policyset-devicecompliancepolicypolicysetitem.md) 对象。
...
在请求正文中，提供 deviceCompliancePolicyPolicySetItem 对象的 JSON 表示形式。

下表显示创建 deviceCompliancePolicyPolicySetItem 时所需的属性。
...
如果成功，此方法在响应正文中返回 响应代码和 `201 Created` [deviceCompliancePolicyPolicySetItem](../resources/intune-policyset-devicecompliancepolicypolicysetitem.md) 对象。
