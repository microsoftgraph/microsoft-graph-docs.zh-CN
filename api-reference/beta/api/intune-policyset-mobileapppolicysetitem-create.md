...
在请求正文中，提供 mobileAppPolicySetItem 对象的 JSON 表示形式。

下表显示创建 mobileAppPolicySetItem 时所需的属性。
...
如果成功，此方法在响应 `201 Created` 正文中返回 响应 [代码和 mobileAppPolicySetItem](../resources/intune-policyset-mobileapppolicysetitem.md) 对象。
