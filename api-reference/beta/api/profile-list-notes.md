...
从用户的 [配置文件中检索 personAnnotation](../resources/personinterest.md) 对象 [列表](../resources/profile.md)。
...
如果成功，此方法在响应 `200 OK` 正文中返回响应代码 [和一组 personAnnotation](../resources/personannotation.md) 对象。
