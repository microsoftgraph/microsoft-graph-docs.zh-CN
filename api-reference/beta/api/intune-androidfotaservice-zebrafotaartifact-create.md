---
title: 创建 zebraFotaArtifact
description: 创建新的 zebraFotaArtifact 对象。
author: dougeby
...
ms.locfileid: "65213011"
---
# <a name="create-zebrafotaartifact"></a>创建 zebraFotaArtifact
...
创建新的 [zebraFotaArtifact](../resources/intune-androidfotaservice-zebrafotaartifact.md) 对象。
...
在请求正文中，为 zebraFotaArtifact 对象提供 JSON 表示形式。

下表显示了创建 zebraFotaArtifact 时所需的属性。
...
如果成功，此方法在响应正文中返回 `201 Created` 响应代码和 [zebraFotaArtifact](../resources/intune-androidfotaservice-zebrafotaartifact.md) 对象。
