...
更新 [androidForWorkEnterpriseWiFiConfiguration 对象](../resources/intune-deviceconfig-androidforworkenterprisewificonfiguration.md) 的属性。
...
下表显示创建 [androidForWorkEnterpriseWiFiConfiguration 时所需的属性](../resources/intune-deviceconfig-androidforworkenterprisewificonfiguration.md)。
...
|networkName|字符串|网络名称 继承自 [androidForWorkWiFiConfiguration](../resources/intune-deviceconfig-androidforworkwificonfiguration.md)|
|ssid|字符串|这是广播到Wi-Fi网络的名称。 继承自 [androidForWorkWiFiConfiguration](../resources/intune-deviceconfig-androidforworkwificonfiguration.md)|
|connectAutomatically|布尔值|连接网络在范围内时自动运行。 如果设置为 true，将跳过用户提示，并自动将设备Wi-Fi网络。 继承自 [androidForWorkWiFiConfiguration](../resources/intune-deviceconfig-androidforworkwificonfiguration.md)|
...
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [androidForWorkEnterpriseWiFiConfiguration](../resources/intune-deviceconfig-androidforworkenterprisewificonfiguration.md) 对象。
