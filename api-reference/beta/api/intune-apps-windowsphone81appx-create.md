...
ms.locfileid: "58822052"
---
# <a name="create-windowsphone81appx"></a>创建 windowsPhone81AppX
...
创建新的 [windowsPhone81AppX](../resources/intune-apps-windowsphone81appx.md) 对象。
...
在请求正文中，提供 windowsPhone81AppX 对象的 JSON 表示形式。

下表显示创建 windowsPhone81AppX 时所需的属性。
...
如果成功，此方法在响应正文中返回 响应代码和 `201 Created` [windowsPhone81AppX](../resources/intune-apps-windowsphone81appx.md) 对象。
