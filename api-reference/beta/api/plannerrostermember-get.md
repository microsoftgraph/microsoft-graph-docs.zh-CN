...
ms.locfileid: "62120222"
---
# <a name="get-plannerrostermember"></a>获取 plannerRosterMember
命名空间：microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

读取 [plannerRosterMember](../resources/plannerrostermember.md) 对象的属性和关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [plannerRosterMember](../resources/plannerrostermember.md) 对象。
