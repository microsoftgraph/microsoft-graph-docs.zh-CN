...
若要开始跟踪更改，请发出一个请求，包括 directoryRole 资源上的增量函数。
...
如果成功，此方法在响应正文中返回 `200 OK` 响应代码和 [directoryRole](../resources/directoryrole.md) 集合对象。 响应还包括 nextLink URL 或 deltaLink URL。 
