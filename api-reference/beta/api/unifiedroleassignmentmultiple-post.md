...
如果成功，此方法在响应`201 Created`正文中返回响应代码和新的[unifiedRoleAssignmentMultiple](../resources/unifiedroleassignmentmultiple.md)对象。

## <a name="examples"></a>示例

### <a name="example-1-create-a-role-assignment-in-intune-over-two-scope-groups-which-are-azure-ad-objects"></a>示例1：在 Intune 中在两个作用域组（Azure AD 对象）上创建角色分配
...
- 若要允许在所有 Intune 设备上进行分配`allDevices` ，请使用**appScopeIds**中的值。
- 若要允许所有 Intune 许可用户的工作分配， `allLicensedUsers`请使用**appScopeIds**中的值。
- 若要允许在所有 Intune 设备和许可的用户上进行`/`分配，请使用**directoryScopeIds**中的值。
