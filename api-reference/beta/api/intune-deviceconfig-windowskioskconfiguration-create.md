...
|kioskBrowserEnableNavigationButtons|布尔|启用展台浏览器的导航按钮 (向前/向后) 。 默认情况下，导航按钮处于禁用状态。|
...
如果成功，此方法 `201 Created` 在响应正文中返回响应代码和 [windowsKioskConfiguration](../resources/intune-deviceconfig-windowskioskconfiguration.md) 对象。
