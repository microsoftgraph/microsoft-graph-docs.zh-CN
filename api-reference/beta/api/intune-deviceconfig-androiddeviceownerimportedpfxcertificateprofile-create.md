...
ms.locfileid: "54181942"
---
# <a name="create-androiddeviceownerimportedpfxcertificateprofile"></a>创建 androidDeviceOwnerImportedPFXCertificateProfile
...
创建新的 [androidDeviceOwnerImportedPFXCertificateProfile](../resources/intune-deviceconfig-androiddeviceownerimportedpfxcertificateprofile.md) 对象。
...
在请求正文中，提供 androidDeviceOwnerImportedPFXCertificateProfile 对象的 JSON 表示形式。

下表显示创建 androidDeviceOwnerImportedPFXCertificateProfile 时所需的属性。
...
如果成功，此方法在响应正文中返回 响应代码和 `201 Created` [androidDeviceOwnerImportedPFXCertificateProfile](../resources/intune-deviceconfig-androiddeviceownerimportedpfxcertificateprofile.md) 对象。
