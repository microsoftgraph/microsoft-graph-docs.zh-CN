...
更新 [androidForWorkTrustedRootCertificate 对象](../resources/intune-deviceconfig-androidforworktrustedrootcertificate.md) 的属性。
...
下表显示创建 [androidForWorkTrustedRootCertificate 时所需的属性](../resources/intune-deviceconfig-androidforworktrustedrootcertificate.md)。
...
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [androidForWorkTrustedRootCertificate](../resources/intune-deviceconfig-androidforworktrustedrootcertificate.md) 对象。
