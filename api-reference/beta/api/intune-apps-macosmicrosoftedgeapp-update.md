...
ms.locfileid: "59062185"
---
# <a name="update-macosmicrosoftedgeapp"></a>更新 macOSMicrosoftEdgeApp
...
更新 [macOSMicrosoftEdgeApp 对象](../resources/intune-apps-macosmicrosoftedgeapp.md) 的属性。
...
在请求正文中，提供 [macOSMicrosoftEdgeApp](../resources/intune-apps-macosmicrosoftedgeapp.md) 对象的 JSON 表示形式。

下表显示创建 [macOSMicrosoftEdgeApp](../resources/intune-apps-macosmicrosoftedgeapp.md)时所需的属性。
...
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [macOSMicrosoftEdgeApp](../resources/intune-apps-macosmicrosoftedgeapp.md) 对象。
