...
---
# <a name="create-androiddeviceownervpnconfiguration"></a>创建 androidDeviceOwnerVpnConfiguration
...
创建新的 [androidDeviceOwnerVpnConfiguration](../resources/intune-deviceconfig-androiddeviceownervpnconfiguration.md) 对象。
...
在请求正文中，提供 androidDeviceOwnerVpnConfiguration 对象的 JSON 表示形式。

下表显示创建 androidDeviceOwnerVpnConfiguration 时所需的属性。
...
|role|String|将连接类型设置为"脉冲安全"时的角色。 继承自 [vpnConfiguration](../resources/intune-deviceconfig-vpnconfiguration.md)|
|realm|String|连接类型设置为"脉冲安全"时的领域。 继承自 [vpnConfiguration](../resources/intune-deviceconfig-vpnconfiguration.md)|
...
|customKeyValueData|[keyValuePair](../resources/intune-shared-keyvaluepair.md) 集合|用于定义特定于 VPN 提供程序的键/值对的自定义数据。 此集合最多可包含 25 个元素。|



## <a name="response"></a>响应
如果成功，此方法在响应正文中返回响应代码和 `201 Created` [androidDeviceOwnerVpnConfiguration](../resources/intune-deviceconfig-androiddeviceownervpnconfiguration.md) 对象。
