...
---
# <a name="list-services"></a>列表服务

 > **重要说明：** Microsoft Graph 中 /beta 版本下的 API 是预览版，可能会发生变化。 不支持在生产应用程序中使用这些 API。
 
指定[bookingbusiness](../resources/bookingbusiness.md)中获取[bookingService](../resources/bookingservice.md)对象的列表。
...
如果成功，此方法返回`200 OK`响应代码和响应正文中的[bookingService](../resources/bookingservice.md)对象的集合。
## <a name="example"></a>示例
##### <a name="request"></a>请求
下面展示了示例请求。
<!-- {
