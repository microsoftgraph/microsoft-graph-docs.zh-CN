...
在请求正文中，提供 [delegatedAdminAccessAssignment](../resources/delegatedadminaccessassignment.md) 对象的 JSON 表示形式。

在创建 **delegatedAdminAccessAssignment** 时，可以指定以下属性。
...
如果成功，此方法在响应 `201 Created` 正文中返回 响应代码和 [delegatedAdminAccessAssignment](../resources/delegatedadminaccessassignment.md) 对象。 响应 **中的 Location** 标头指向已创建的 **delegatedAdminAccessAssignment** 对象。
