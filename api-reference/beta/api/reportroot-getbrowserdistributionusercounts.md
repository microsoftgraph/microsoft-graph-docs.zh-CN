...
description: 获取一个报告，该报告提供在选定时段内使用 Microsoft Edge、Microsoft Edge 旧版 和 Internet Explorer 访问 Microsoft 365 服务的用户总数。
...
获取一个报告，该报告提供在选定时段内使用 Microsoft Edge、Microsoft Edge 旧版 和 Internet Explorer 访问 Microsoft 365 服务的用户总数。
