...
---
# <a name="list-macossoftwareupdatecategorysummaries"></a>列出 macOSSoftwareUpdateCategorySummaries
...
列出 [macOSSoftwareUpdateCategorySummary 对象的属性和](../resources/intune-deviceconfig-macossoftwareupdatecategorysummary.md) 关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [macOSSoftwareUpdateCategorySummary](../resources/intune-deviceconfig-macossoftwareupdatecategorysummary.md) 对象集合。
