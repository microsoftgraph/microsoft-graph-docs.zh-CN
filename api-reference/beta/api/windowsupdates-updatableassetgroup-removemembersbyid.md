...
从 [updatableAssetGroup 中删除相同类型的成员](../resources/windowsupdates-updatableassetgroup.md)。

您还可以使用 [removeMembers 方法](windowsupdates-updatableassetgroup-removemembers.md) 删除成员。
