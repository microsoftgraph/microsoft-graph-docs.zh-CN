...
对于 Azure AD 租户，提供程序可以是 [socialIdentityProviders](../resources/socialidentityprovider.md) 或 [builtinIdentityProviders](../resources/builtinidentityprovider.md) 对象。
