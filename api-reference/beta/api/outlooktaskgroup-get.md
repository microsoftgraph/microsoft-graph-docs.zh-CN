...
ms.locfileid: "61004659"
---
# <a name="get-outlooktaskgroup-deprecated"></a>获取已 (outlookTaskGroup) 
...
如果成功，此方法在响应 `200 OK` 正文中返回 响应代码和 [outlookTaskGroup](../resources/outlooktaskgroup.md) 对象。
## <a name="example"></a>示例
##### <a name="request"></a>请求
下面是一个请求示例。
