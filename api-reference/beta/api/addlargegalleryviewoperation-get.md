---
title: 获取 addLargeGalleryViewOperation
description: 获取将大型库视图添加到调用的操作的状态。
author: navali-msft
...
ms.locfileid: "65017032"
---
# <a name="get-addlargegalleryviewoperation"></a>获取 addLargeGalleryViewOperation

命名空间：microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

获取将大型库视图添加到调用的 [操作](../resources/addlargegalleryviewoperation.md) 的状态。
...
如果成功，此方法在响应正文中返回 `200 OK` 响应代码和 [addLargeGalleryViewOperation](../resources/addlargegalleryviewoperation.md) 对象。
