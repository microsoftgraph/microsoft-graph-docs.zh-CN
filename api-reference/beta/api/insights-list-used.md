...
### <a name="example-2-return-the-most-recently-viewed-documents-that-the-signed-in-user-might-or-might-not-have-modified"></a>示例2：返回已登录用户可能已修改或可能尚未修改的最近查看过的文档 
