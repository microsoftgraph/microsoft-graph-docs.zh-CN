...
下表显示时创建 officeClientConfigurationAssignment 所需的属性。
...
如果成功，此方法返回`200 Created`响应代码和响应正文中的[officeClientConfigurationAssignment](../resources/intune-cirrus-officeclientconfigurationassignment.md)对象。
