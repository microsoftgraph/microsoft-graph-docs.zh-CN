...
---
# <a name="list-responsibilities"></a>列表责任
命名空间：microsoft.graph

从用户的[配置文件](../resources/profile.md)中检索[personResponsibility](../resources/personresponsibility.md)对象的列表。
...
如果成功，此方法 `200 OK` 在响应正文中返回响应代码和 [personResponsibility](../resources/personresponsibility.md) 对象集合。
