...
|passwordBlockIrisUnlock|布尔|指示是否阻止 iri 解锁。|
...
|workProfilePasswordBlockIrisUnlock|布尔|指示是否阻止对工作配置文件的 iri 解除锁定。|
...
|workProfileAllowWidgets|布尔|允许来自工作配置文件应用程序的小部件。|
|workProfileBlockPersonalAppInstallsFromUnknownSources|布尔|阻止从个人配置文件中的未知源进行应用程序安装。|



## <a name="response"></a>响应
如果成功，此方法 `200 OK` 在响应正文中返回响应代码和更新的 [androidForWorkGeneralDeviceConfiguration](../resources/intune-deviceconfig-androidforworkgeneraldeviceconfiguration.md) 对象。
