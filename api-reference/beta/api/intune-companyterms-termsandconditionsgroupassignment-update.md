...
更新 [termsAndConditionsGroupAssignment 对象](../resources/intune-companyterms-termsandconditionsgroupassignment.md) 的属性。
...
下表显示创建 [termsAndConditionsGroupAssignment 时所需的属性](../resources/intune-companyterms-termsandconditionsgroupassignment.md)。
...
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [termsAndConditionsGroupAssignment](../resources/intune-companyterms-termsandconditionsgroupassignment.md) 对象。
