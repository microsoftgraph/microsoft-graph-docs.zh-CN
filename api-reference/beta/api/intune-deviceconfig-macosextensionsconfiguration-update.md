...
更新 [macOSExtensionsConfiguration 对象](../resources/intune-deviceconfig-macosextensionsconfiguration.md) 的属性。
...
下表显示创建 [macOSExtensionsConfiguration 时所需的属性](../resources/intune-deviceconfig-macosextensionsconfiguration.md)。
...
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [macOSExtensionsConfiguration](../resources/intune-deviceconfig-macosextensionsconfiguration.md) 对象。
