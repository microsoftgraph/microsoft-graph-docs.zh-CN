...
更新 [macOSExtensionsConfiguration](../resources/intune-deviceconfig-macosextensionsconfiguration.md) 对象的属性。
...
在请求正文中，提供 [macOSExtensionsConfiguration](../resources/intune-deviceconfig-macosextensionsconfiguration.md) 对象的 JSON 表示形式。

下表显示创建 [macOSExtensionsConfiguration](../resources/intune-deviceconfig-macosextensionsconfiguration.md)时所需的属性。
...
|kernelExtensionOverridesAllowed|布尔|如果设置为 true，则用户可以批准配置文件配置文件未明确允许的其他内核扩展。|
...
|systemExtensionsAllowedTeamIdentifiers|String collection|获取或设置允许的团队标识符的列表。 任何指定的团队标识符签名的系统扩展都将获得批准。|
...
如果成功，此方法 `200 OK` 在响应正文中返回响应代码和更新的 [macOSExtensionsConfiguration](../resources/intune-deviceconfig-macosextensionsconfiguration.md) 对象。
