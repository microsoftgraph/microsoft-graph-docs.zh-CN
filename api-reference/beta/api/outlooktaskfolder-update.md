...
ms.locfileid: "62089670"
---
# <a name="update-outlooktaskfolder-deprecated"></a>更新 outlooktaskfolder (已弃) 
...
如果成功，此方法在响应 `200 OK` 正文中返回 响应代码和更新的 [outlookTaskFolder](../resources/outlooktaskfolder.md) 对象。
## <a name="example"></a>示例
##### <a name="request"></a>请求
下面的示例将指定任务文件夹的名称更改为 `Charity work` 。
