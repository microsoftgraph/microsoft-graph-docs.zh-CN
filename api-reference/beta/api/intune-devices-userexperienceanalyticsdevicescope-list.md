---
title: 列出 userExperienceAnalyticsDeviceScopes
description: 列出 userExperienceAnalyticsDeviceScope 对象的属性和关系。
author: dougeby
...
ms.locfileid: "65857923"
---
# <a name="list-userexperienceanalyticsdevicescopes"></a>列出 userExperienceAnalyticsDeviceScopes
...
列出 [userExperienceAnalyticsDeviceScope](../resources/intune-devices-userexperienceanalyticsdevicescope.md) 对象的属性和关系。
...
如果成功，此方法在响应正文中返回 `200 OK` 响应代码和 [userExperienceAnalyticsDeviceScope](../resources/intune-devices-userexperienceanalyticsdevicescope.md) 对象的集合。
