...
下表显示创建 androidPkcsCertificateProfile 时所需的属性。
...
如果成功，此方法 `201 Created` 在响应正文中返回响应代码和 [androidPkcsCertificateProfile](../resources/intune-deviceconfig-androidpkcscertificateprofile.md) 对象。
