...
更新 [iosVppAppAssignedLicense 对象](../resources/intune-apps-iosvppappassignedlicense.md) 的属性。
...
下表显示创建 [iosVppAppAssignedLicense 时所需的属性](../resources/intune-apps-iosvppappassignedlicense.md)。
...
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [iosVppAppAssignedLicense](../resources/intune-apps-iosvppappassignedlicense.md) 对象。
