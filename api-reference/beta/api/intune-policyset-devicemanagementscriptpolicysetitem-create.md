...
ms.locfileid: "59096758"
---
# <a name="create-devicemanagementscriptpolicysetitem"></a>创建 deviceManagementScriptPolicySetItem
...
创建新的 [deviceManagementScriptPolicySetItem](../resources/intune-policyset-devicemanagementscriptpolicysetitem.md) 对象。
...
在请求正文中，提供 deviceManagementScriptPolicySetItem 对象的 JSON 表示形式。

下表显示创建 deviceManagementScriptPolicySetItem 时所需的属性。
...
如果成功，此方法在响应正文中返回 响应代码和 `201 Created` [deviceManagementScriptPolicySetItem](../resources/intune-policyset-devicemanagementscriptpolicysetitem.md) 对象。
