...
---
# <a name="delete-macosenterprisewificonfiguration"></a><span data-ttu-id="5391b-103">删除 macOSEnterpriseWiFiConfiguration</span><span class="sxs-lookup"><span data-stu-id="5391b-103">Delete macOSEnterpriseWiFiConfiguration</span></span>
...
<span data-ttu-id="5391b-107">删除 [macOSEnterpriseWiFiConfiguration](../resources/intune-deviceconfig-macosenterprisewificonfiguration.md)。</span><span class="sxs-lookup"><span data-stu-id="5391b-107">Deletes a [macOSEnterpriseWiFiConfiguration](../resources/intune-deviceconfig-macosenterprisewificonfiguration.md).</span></span>
...
<span data-ttu-id="5391b-128">请勿提供此方法的请求正文。</span><span class="sxs-lookup"><span data-stu-id="5391b-128">Do not supply a request body for this method.</span></span>

## <a name="response"></a><span data-ttu-id="5391b-129">响应</span><span class="sxs-lookup"><span data-stu-id="5391b-129">Response</span></span>
<span data-ttu-id="5391b-130">如果成功，此方法返回 `204 No Content` 响应代码。</span><span class="sxs-lookup"><span data-stu-id="5391b-130">If successful, this method returns a `204 No Content` response code.</span></span>

## <a name="example"></a><span data-ttu-id="5391b-131">示例</span><span class="sxs-lookup"><span data-stu-id="5391b-131">Example</span></span>

### <a name="request"></a><span data-ttu-id="5391b-132">请求</span><span class="sxs-lookup"><span data-stu-id="5391b-132">Request</span></span>
<span data-ttu-id="5391b-133">下面是一个请求示例。</span><span class="sxs-lookup"><span data-stu-id="5391b-133">Here is an example of the request.</span></span>
``` http
DELETE https://graph.microsoft.com/beta/deviceManagement/deviceConfigurations/{deviceConfigurationId}
```

### <a name="response"></a><span data-ttu-id="5391b-134">响应</span><span class="sxs-lookup"><span data-stu-id="5391b-134">Response</span></span>
<span data-ttu-id="5391b-p102">下面是一个响应示例。注意：为了简单起见，可能会将此处所示的响应对象截断。将从实际调用中返回所有属性。</span><span class="sxs-lookup"><span data-stu-id="5391b-p102">Here is an example of the response. Note: The response object shown here may be truncated for brevity. All of the properties will be returned from an actual call.</span></span>
``` http
