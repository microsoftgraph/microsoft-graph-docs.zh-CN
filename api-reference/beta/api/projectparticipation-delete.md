...
description: 从用户配置文件中删除 projectParticipation 对象。
...
ms.locfileid: "60996951"
---
# <a name="delete-projectparticipation"></a>删除 projectParticipation

命名空间：microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

从 [用户配置文件中删除 projectParticipation](../resources/projectparticipation.md) [对象](../resources/profile.md)。
