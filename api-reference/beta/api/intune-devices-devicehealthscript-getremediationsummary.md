...
如果成功，此函数在响应正文中返回 响应代码和 `200 OK` [deviceHealthScriptRemediationSummary。](../resources/intune-devices-devicehealthscriptremediationsummary.md)
