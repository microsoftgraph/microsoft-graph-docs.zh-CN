...
获取与[sourceCollection](../resources/ediscovery-sourcecollection.md)关联的[非custodialDataSource](../resources/ediscovery-noncustodialdatasource.md)的列表。
