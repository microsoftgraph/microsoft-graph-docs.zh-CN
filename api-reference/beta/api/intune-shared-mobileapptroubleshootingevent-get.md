...
description: 介绍支持多个工作流的 Microsoft 图形 API for Intune 的 Get mobileAppTroubleshootingEvent 方法。
...
如果成功，此方法在响应正文中返回 `200 OK` 响应代码和 [mobileAppTroubleshootingEvent](../resources/intune-shared-mobileapptroubleshootingevent.md) 对象。
