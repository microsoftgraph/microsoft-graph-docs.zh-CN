...
<span data-ttu-id="ac2f0-162">下面是输出 CSV 的示例。</span><span class="sxs-lookup"><span data-stu-id="ac2f0-162">The following is an example that outputs CSV.</span></span>
