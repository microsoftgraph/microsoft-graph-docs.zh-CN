---
title: 更新 aospDeviceOwnerPkcsCertificateProfile
description: 更新 aospDeviceOwnerPkcsCertificateProfile 对象的属性。
author: dougeby
...
---
# <a name="update-aospdeviceownerpkcscertificateprofile"></a>更新 aospDeviceOwnerPkcsCertificateProfile
...
更新 [aospDeviceOwnerPkcsCertificateProfile 对象](../resources/intune-deviceconfig-aospdeviceownerpkcscertificateprofile.md) 的属性。
...
在请求正文中，提供 [aospDeviceOwnerPkcsCertificateProfile](../resources/intune-deviceconfig-aospdeviceownerpkcscertificateprofile.md) 对象的 JSON 表示形式。

下表显示创建 [aospDeviceOwnerPkcsCertificateProfile 时所需的属性](../resources/intune-deviceconfig-aospdeviceownerpkcscertificateprofile.md)。
...
如果成功，此方法在响应 `200 OK` 正文中返回 响应代码和更新的 [aospDeviceOwnerPkcsCertificateProfile](../resources/intune-deviceconfig-aospdeviceownerpkcscertificateprofile.md) 对象。
