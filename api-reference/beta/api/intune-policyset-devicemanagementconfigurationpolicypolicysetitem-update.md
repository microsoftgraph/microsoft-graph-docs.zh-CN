---
title: 更新 deviceManagementConfigurationPolicyPolicySetItem
description: 更新 deviceManagementConfigurationPolicyPolicySetItem 对象的属性。
author: dougeby
...
---
# <a name="update-devicemanagementconfigurationpolicypolicysetitem"></a>更新 deviceManagementConfigurationPolicyPolicySetItem
...
更新 [deviceManagementConfigurationPolicyPolicySetItem 对象](../resources/intune-policyset-devicemanagementconfigurationpolicypolicysetitem.md) 的属性。
...
在请求正文中，提供 [deviceManagementConfigurationPolicyPolicySetItem](../resources/intune-policyset-devicemanagementconfigurationpolicypolicysetitem.md) 对象的 JSON 表示形式。

下表显示创建 [deviceManagementConfigurationPolicyPolicySetItem 时所需的属性](../resources/intune-policyset-devicemanagementconfigurationpolicypolicysetitem.md)。

|属性|类型|说明|
|:---|:---|:---|
|id|字符串|PolicySetItem 的键。 继承自 [policySetItem](../resources/intune-policyset-policysetitem.md)|
...
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [deviceManagementConfigurationPolicyPolicySetItem](../resources/intune-policyset-devicemanagementconfigurationpolicypolicysetitem.md) 对象。
