...
如果成功，此方法在响应正文中返回响应代码和请求的 `200 OK` [unifiedRoleAssignment](../resources/unifiedroleassignment.md) 对象。
...
### <a name="example-2-get-details-of-a-role-assignment-with-expand"></a>示例 2：获取角色分配的详细信息 `$expand`
