...
创建新的 [deviceManagementStringSettingInstance](../resources/intune-deviceintent-devicemanagementstringsettinginstance.md) 对象。
...
在请求正文中，提供 deviceManagementStringSettingInstance 对象的 JSON 表示形式。

下表显示创建 deviceManagementStringSettingInstance 时所需的属性。
...
如果成功，此方法在响应正文中返回 响应代码和 `201 Created` [deviceManagementStringSettingInstance](../resources/intune-deviceintent-devicemanagementstringsettinginstance.md) 对象。
