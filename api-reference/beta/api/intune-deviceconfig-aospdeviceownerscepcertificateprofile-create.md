---
title: 创建 aospDeviceOwnerScepCertificateProfile
description: 创建新的 aospDeviceOwnerScepCertificateProfile 对象。
author: dougeby
...
ms.locfileid: "64631051"
---
# <a name="create-aospdeviceownerscepcertificateprofile"></a>创建 aospDeviceOwnerScepCertificateProfile
...
创建新的 [aospDeviceOwnerScepCertificateProfile](../resources/intune-deviceconfig-aospdeviceownerscepcertificateprofile.md) 对象。
...
在请求正文中，提供 aospDeviceOwnerScepCertificateProfile 对象的 JSON 表示形式。

下表显示创建 aospDeviceOwnerScepCertificateProfile 时所需的属性。
...
如果成功，此方法在响应正文中返回 响应 `201 Created` 代码和 [aospDeviceOwnerScepCertificateProfile](../resources/intune-deviceconfig-aospdeviceownerscepcertificateprofile.md) 对象。
