...
更新[windowsPhone81AppX](../resources/intune-apps-windowsphone81appx.md)对象的属性。
...
下表显示时创建[windowsPhone81AppX](../resources/intune-apps-windowsphone81appx.md)所需的属性。
...
如果成功，此方法返回`200 OK`响应代码和响应正文中的更新的[windowsPhone81AppX](../resources/intune-apps-windowsphone81appx.md)对象。
