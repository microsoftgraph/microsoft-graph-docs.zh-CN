...
ms.locfileid: "59093426"
---
# <a name="update-windowsphone81appx"></a>更新 windowsPhone81AppX
...
更新 [windowsPhone81AppX 对象](../resources/intune-apps-windowsphone81appx.md) 的属性。
...
在请求正文中，提供 [windowsPhone81AppX](../resources/intune-apps-windowsphone81appx.md) 对象的 JSON 表示形式。

下表显示创建 [windowsPhone81AppX](../resources/intune-apps-windowsphone81appx.md)时所需的属性。
...
如果成功，此方法在响应正文中返回 响应代码和更新 `200 OK` 的 [windowsPhone81AppX](../resources/intune-apps-windowsphone81appx.md) 对象。
