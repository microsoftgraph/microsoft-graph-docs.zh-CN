...
下表显示创建 [windowsPhone81AppX 时所需的属性](../resources/intune-apps-windowsphone81appx.md)。
...
如果成功，此方法在响应正文中返回响应代码和更新 `200 OK` 的 [windowsPhone81AppX](../resources/intune-apps-windowsphone81appx.md) 对象。
