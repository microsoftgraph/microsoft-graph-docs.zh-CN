...
---
# <a name="update-windowsphone81appx"></a>更新了 windowsphone81appx
...
更新[了 windowsphone81appx](../resources/intune-apps-windowsphone81appx.md)对象的属性。
...
在请求正文中，提供[了 windowsphone81appx](../resources/intune-apps-windowsphone81appx.md)对象的 JSON 表示形式。

下表显示创建[了 windowsphone81appx](../resources/intune-apps-windowsphone81appx.md)时所需的属性。
...
如果成功，此方法在响应`200 OK`正文中返回响应代码和更新的[了 windowsphone81appx](../resources/intune-apps-windowsphone81appx.md)对象。
