---
title: 列出 hardwareConfigurationDeviceStates
description: 列出 hardwareConfigurationDeviceState 对象的属性和关系。
author: dougeby
...
ms.locfileid: "61345447"
---
# <a name="list-hardwareconfigurationdevicestates"></a>列出 hardwareConfigurationDeviceStates
...
列出 [hardwareConfigurationDeviceState 对象的属性和](../resources/intune-deviceconfig-hardwareconfigurationdevicestate.md) 关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [hardwareConfigurationDeviceState](../resources/intune-deviceconfig-hardwareconfigurationdevicestate.md) 对象集合。
