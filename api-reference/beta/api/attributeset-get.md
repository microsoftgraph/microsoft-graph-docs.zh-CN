---
title: 获取 attributeSet
description: 读取 attributeSet 对象的属性和关系。
author: rolyon
...
读取 [attributeSet](../resources/attributeset.md) 对象的属性和关系。
...
如果成功，此方法在响应 `200 OK` 正文中返回 响应代码和 [attributeSet](../resources/attributeset.md) 对象。
