---
title: getDevicesScheduledToRetire 函数
description: 尚未记录
author: dougeby
...
ms.locfileid: "65210036"
---
# <a name="getdevicesscheduledtoretire-function"></a>getDevicesScheduledToRetire 函数
...
如果成功，此函数在响应正文中返回 `200 OK` 响应代码和 [retireScheduledManagedDevice](../resources/intune-deviceconfig-retirescheduledmanageddevice.md) 集合。
