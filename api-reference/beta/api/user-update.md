...
|mail|String|用户的 SMTP 地址，例如， `jeff@contoso.onmicrosoft.com`。 对于 Azure AD B2C 帐户，此属性最多只能使用唯一 SMTP 地址更新十次。 对此属性的更改也将更新用户的 **proxyAddresses** 集合，以便将该值包含为 SMTP 地址。|
