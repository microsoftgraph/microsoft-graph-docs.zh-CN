...
下表显示了可以在用户[配置文件](../resources/profile.md)中的新[personWebsite](../resources/personwebsite.md)对象内设置的属性。
...
如果成功，此方法 `201, Created` 在响应正文中返回响应代码和新的 [personWebsite](../resources/personwebsite.md) 对象。
