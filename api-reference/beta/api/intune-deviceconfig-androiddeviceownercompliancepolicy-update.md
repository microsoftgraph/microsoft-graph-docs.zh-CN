...
更新 [androidDeviceOwnerCompliancePolicy 对象](../resources/intune-deviceconfig-androiddeviceownercompliancepolicy.md) 的属性。
...
下表显示创建 [androidDeviceOwnerCompliancePolicy 时所需的属性](../resources/intune-deviceconfig-androiddeviceownercompliancepolicy.md)。
...
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [androidDeviceOwnerCompliancePolicy](../resources/intune-deviceconfig-androiddeviceownercompliancepolicy.md) 对象。
