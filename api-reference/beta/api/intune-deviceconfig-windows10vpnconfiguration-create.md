...
|OnlyAssociatedAppsCanUseConnection|布尔|只有关联的应用可以使用每个应用 VPN (连接) 。|
...
如果成功，此方法在响应正文中返回响应代码和 `201 Created` [windows10VpnConfiguration](../resources/intune-deviceconfig-windows10vpnconfiguration.md) 对象。
