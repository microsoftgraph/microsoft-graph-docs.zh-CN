...
|onlyAssociatedAppsCanUseConnection|布尔|仅关联的应用程序可以使用连接 (每个应用 VPN)。|
|windowsInformationProtectionDomain|字符串|与此连接关联的 Windows 信息保护 (WIP) 域。|
...
如果成功, 此方法在响应`201 Created`正文中返回响应代码和[windows10VpnConfiguration](../resources/intune-deviceconfig-windows10vpnconfiguration.md)对象。
