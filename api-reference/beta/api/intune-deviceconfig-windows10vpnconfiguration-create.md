...
|windowsInformationProtectionDomain|String|Windows 信息 (WIP) 此连接关联的域。|
...
如果成功，此方法在响应正文中返回 响应代码和 `201 Created` [windows10VpnConfiguration](../resources/intune-deviceconfig-windows10vpnconfiguration.md) 对象。
