...
---
# <a name="delete-macosscepcertificateprofile"></a><span data-ttu-id="d238b-103">删除 macOSScepCertificateProfile</span><span class="sxs-lookup"><span data-stu-id="d238b-103">Delete macOSScepCertificateProfile</span></span>
...
<span data-ttu-id="d238b-106">删除[macOSScepCertificateProfile](../resources/intune-deviceconfig-macosscepcertificateprofile.md)。</span><span class="sxs-lookup"><span data-stu-id="d238b-106">Deletes a [macOSScepCertificateProfile](../resources/intune-deviceconfig-macosscepcertificateprofile.md).</span></span>
...
|:---|:---|
|<span data-ttu-id="d238b-112">委派（工作或学校帐户）</span><span class="sxs-lookup"><span data-stu-id="d238b-112">Delegated (work or school account)</span></span>|<span data-ttu-id="d238b-113">DeviceManagementConfiguration.ReadWrite.All</span><span class="sxs-lookup"><span data-stu-id="d238b-113">DeviceManagementConfiguration.ReadWrite.All</span></span>|
...
<span data-ttu-id="d238b-127">请勿提供此方法的请求正文。</span><span class="sxs-lookup"><span data-stu-id="d238b-127">Do not supply a request body for this method.</span></span>

## <a name="response"></a><span data-ttu-id="d238b-128">响应</span><span class="sxs-lookup"><span data-stu-id="d238b-128">Response</span></span>
<span data-ttu-id="d238b-129">如果成功，此方法返回 `204 No Content` 响应代码。</span><span class="sxs-lookup"><span data-stu-id="d238b-129">If successful, this method returns a `204 No Content` response code.</span></span>

## <a name="example"></a><span data-ttu-id="d238b-130">示例</span><span class="sxs-lookup"><span data-stu-id="d238b-130">Example</span></span>

### <a name="request"></a><span data-ttu-id="d238b-131">请求</span><span class="sxs-lookup"><span data-stu-id="d238b-131">Request</span></span>
<span data-ttu-id="d238b-132">下面是一个请求示例。</span><span class="sxs-lookup"><span data-stu-id="d238b-132">Here is an example of the request.</span></span>
``` http
DELETE https://graph.microsoft.com/beta/deviceManagement/deviceConfigurations/{deviceConfigurationId}
```

### <a name="response"></a><span data-ttu-id="d238b-133">响应</span><span class="sxs-lookup"><span data-stu-id="d238b-133">Response</span></span>
