...
获取新建、更新或删除的应用程序，而无需执行整个资源集合的完整读取。 有关详细信息 [，请参阅使用增量](/graph/delta-query-overview) 查询。
...
如果成功，此方法在 `200 OK` 响应正文中返回 [响应](../resources/application.md) 代码和应用程序集合对象。 该响应还包括 nextLink URL 或 deltaLink URL。 
