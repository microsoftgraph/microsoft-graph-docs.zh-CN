---
title: 应用程序：delta
description: 获取新创建、更新或删除的应用程序，而无需对整个资源集合执行完整读取。 有关详细信息，请参阅使用 Delta 查询。
...
获取新创建、更新或删除的应用程序，而无需对整个资源集合执行完整读取。 有关详细信息，请参阅 [使用 Delta 查询](/graph/delta-query-overview) 。
...
若要开始跟踪更改，请发出一个请求，包括应用程序资源上的增量函数。 
...
如果成功，此方法在响应正文中返回 `200 OK` 响应代码和 [应用程序](../resources/application.md) 集合对象。 响应还包括 nextLink URL 或 deltaLink URL。 
