...
删除 [delegatedAdminRelationship](../resources/delegatedadminrelationship.md) 对象。 只有当关系的状态为"已创建"时，才能删除该关系。 
...
|名称|说明|
|:---|:---|
|If-Match|If-match： {etag}. 要删除的 **delegatedAdminRelationship** 的上次已知 ETag 值。 从 LIST 或 GET 操作检索 ETag 值。 必需。|
