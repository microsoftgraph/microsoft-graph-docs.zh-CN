---
title: 列出 learningContents
description: 获取 learningContent 对象及其属性的列表。
author: malabikaroy
...
ms.locfileid: "66883256"
---
# <a name="list-learningcontents"></a>列出 learningContents
命名空间：microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

获取 [learningContent](../resources/learningcontent.md) 资源及其属性的列表。

此列表表示Viva Learning中指定提供程序内容的元数据。
...
如果成功，此方法在响应正文中返回 `200 OK` 响应代码和 [learningContent](../resources/learningcontent.md) 对象集合。
