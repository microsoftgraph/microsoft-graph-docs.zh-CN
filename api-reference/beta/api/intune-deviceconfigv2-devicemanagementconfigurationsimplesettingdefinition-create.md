...
---
# <a name="create-devicemanagementconfigurationsimplesettingdefinition"></a>创建 deviceManagementConfigurationSimpleSettingDefinition
...
创建新的 [deviceManagementConfigurationSimpleSettingDefinition](../resources/intune-deviceconfigv2-devicemanagementconfigurationsimplesettingdefinition.md) 对象。
...
在请求正文中，提供 deviceManagementConfigurationSimpleSettingDefinition 对象的 JSON 表示形式。

下表显示创建 deviceManagementConfigurationSimpleSettingDefinition 时所需的属性。
...
如果成功，此方法在响应正文中返回 响应代码和 `201 Created` [deviceManagementConfigurationSimpleSettingDefinition](../resources/intune-deviceconfigv2-devicemanagementconfigurationsimplesettingdefinition.md) 对象。
