---
title: 列出 operationalInsightsConnections
description: 获取 operationalInsightsConnection 对象及其属性的列表。
author: aarononeal
...
ms.locfileid: "66856710"
---
# <a name="list-operationalinsightsconnections"></a>列出 operationalInsightsConnections
命名空间：microsoft.graph.windowsUpdates

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

获取 [operationalInsightsConnection](../resources/windowsupdates-operationalinsightsconnection.md) 对象及其属性的列表。
...
如果成功，此方法在响应正文中返回 `200 OK` 响应代码和 [operationalInsightsConnection](../resources/windowsupdates-operationalinsightsconnection.md) 对象集合。
