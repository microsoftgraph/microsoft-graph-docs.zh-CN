...
## <a name="http-request"></a><span data-ttu-id="3f303-119">HTTP 请求</span><span class="sxs-lookup"><span data-stu-id="3f303-119">HTTP Request</span></span>
<!-- {
  "blockType": "ignored"
}
-->
...
|<span data-ttu-id="3f303-145">supportsScopeTags</span><span class="sxs-lookup"><span data-stu-id="3f303-145">supportsScopeTags</span></span>|<span data-ttu-id="3f303-146">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-146">Boolean</span></span>|<span data-ttu-id="3f303-147">指示基础设备配置是否支持分配范围标记。</span><span class="sxs-lookup"><span data-stu-id="3f303-147">Indicates whether or not the underlying Device Configuration supports the assignment of scope tags.</span></span> <span data-ttu-id="3f303-148">当此值为 false 且实体对作用域用户不可见时，不允许分配给 ScopeTags 属性。</span><span class="sxs-lookup"><span data-stu-id="3f303-148">Assigning to the ScopeTags property is not allowed when this value is false and entities will not be visible to scoped users.</span></span> <span data-ttu-id="3f303-149">这适用于在 Silverlight 中创建的旧版策略，可通过在 Azure 门户中删除和重新创建策略来解决。</span><span class="sxs-lookup"><span data-stu-id="3f303-149">This occurs for Legacy policies created in Silverlight and can be resolved by deleting and recreating the policy in the Azure Portal.</span></span> <span data-ttu-id="3f303-150">此属性是只读的。</span><span class="sxs-lookup"><span data-stu-id="3f303-150">This property is read-only.</span></span> <span data-ttu-id="3f303-151">继承自 [deviceConfiguration](../resources/intune-shared-deviceconfiguration.md)</span><span class="sxs-lookup"><span data-stu-id="3f303-151">Inherited from [deviceConfiguration](../resources/intune-shared-deviceconfiguration.md)</span></span>|
...
|<span data-ttu-id="3f303-269">classroomAppForceUnpromptedScreenObservation</span><span class="sxs-lookup"><span data-stu-id="3f303-269">classroomAppForceUnpromptedScreenObservation</span></span>|<span data-ttu-id="3f303-270">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-270">Boolean</span></span>|<span data-ttu-id="3f303-271">指示是否自动授予 Classroom 应用上托管课程的教师权限，以便在设备处于监督模式时查看学生的屏幕且不会出现提示。</span><span class="sxs-lookup"><span data-stu-id="3f303-271">Indicates whether or not to automatically give permission to the teacher of a managed course on the Classroom app to view a student's screen without prompting when the device is in supervised mode.</span></span>|
...
|<span data-ttu-id="3f303-333">gamingBlockGameCenterFriends</span><span class="sxs-lookup"><span data-stu-id="3f303-333">gamingBlockGameCenterFriends</span></span>|<span data-ttu-id="3f303-334">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-334">Boolean</span></span>|<span data-ttu-id="3f303-335">指示是否阻止用户在 Game Center 中拥有好友。</span><span class="sxs-lookup"><span data-stu-id="3f303-335">Indicates whether or not to block the user from having friends in Game Center.</span></span> <span data-ttu-id="3f303-336">需要适用于 iOS 13 及更高版本的受监督设备。</span><span class="sxs-lookup"><span data-stu-id="3f303-336">Requires a supervised device for iOS 13 and later.</span></span>|
...
|<span data-ttu-id="3f303-366">iCloudBlockPhotoLibrary</span><span class="sxs-lookup"><span data-stu-id="3f303-366">iCloudBlockPhotoLibrary</span></span>|<span data-ttu-id="3f303-367">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-367">Boolean</span></span>|<span data-ttu-id="3f303-368">指示是否阻止 iCloud 照片库。</span><span class="sxs-lookup"><span data-stu-id="3f303-368">Indicates whether or not to block iCloud Photo Library.</span></span>|
...
|<span data-ttu-id="3f303-400">keyboardBlockSpellCheck</span><span class="sxs-lookup"><span data-stu-id="3f303-400">keyboardBlockSpellCheck</span></span>|<span data-ttu-id="3f303-401">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-401">Boolean</span></span>|<span data-ttu-id="3f303-402">指示设备处于监督模式时是否阻止键盘拼写检查（iOS 8.1.3 及更高版本）。</span><span class="sxs-lookup"><span data-stu-id="3f303-402">Indicates whether or not to block keyboard spell-checking when the device is in supervised mode (iOS 8.1.3 and later).</span></span>|
...
|<span data-ttu-id="3f303-502">lockScreenBlockNotificationView</span><span class="sxs-lookup"><span data-stu-id="3f303-502">lockScreenBlockNotificationView</span></span>|<span data-ttu-id="3f303-503">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-503">Boolean</span></span>|<span data-ttu-id="3f303-504">指示是否阻止用户在锁定屏幕上使用通知视图。</span><span class="sxs-lookup"><span data-stu-id="3f303-504">Indicates whether or not to block the user from using the notification view on the lock screen.</span></span>|
...
|<span data-ttu-id="3f303-555">passcodeBlockFingerprintModification</span><span class="sxs-lookup"><span data-stu-id="3f303-555">passcodeBlockFingerprintModification</span></span>|<span data-ttu-id="3f303-556">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-556">Boolean</span></span>|<span data-ttu-id="3f303-557">在监督模式下阻止修改已注册的 Touch ID 指纹。</span><span class="sxs-lookup"><span data-stu-id="3f303-557">Block modification of registered Touch ID fingerprints when in supervised mode.</span></span>|
|<span data-ttu-id="3f303-558">passcodeBlockModification</span><span class="sxs-lookup"><span data-stu-id="3f303-558">passcodeBlockModification</span></span>|<span data-ttu-id="3f303-559">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-559">Boolean</span></span>|<span data-ttu-id="3f303-560">指示是否允许在受监督的设备中修改密码（iOS 9.0 及更高版本）。</span><span class="sxs-lookup"><span data-stu-id="3f303-560">Indicates whether or not to allow passcode modification on the supervised device (iOS 9.0 and later).</span></span>|
|<span data-ttu-id="3f303-561">passcodeBlockSimple</span><span class="sxs-lookup"><span data-stu-id="3f303-561">passcodeBlockSimple</span></span>|<span data-ttu-id="3f303-562">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-562">Boolean</span></span>|<span data-ttu-id="3f303-563">指示是否阻止简单密码。</span><span class="sxs-lookup"><span data-stu-id="3f303-563">Indicates whether or not to block simple passcodes.</span></span>|
|<span data-ttu-id="3f303-564">passcodeExpirationDays</span><span class="sxs-lookup"><span data-stu-id="3f303-564">passcodeExpirationDays</span></span>|<span data-ttu-id="3f303-565">Int32</span><span class="sxs-lookup"><span data-stu-id="3f303-565">Int32</span></span>|<span data-ttu-id="3f303-566">密码过期前的天数。</span><span class="sxs-lookup"><span data-stu-id="3f303-566">Number of days before the passcode expires.</span></span> <span data-ttu-id="3f303-567">有效值为 1 至 65535</span><span class="sxs-lookup"><span data-stu-id="3f303-567">Valid values 1 to 65535</span></span>|
|<span data-ttu-id="3f303-568">passcodeMinimumLength</span><span class="sxs-lookup"><span data-stu-id="3f303-568">passcodeMinimumLength</span></span>|<span data-ttu-id="3f303-569">Int32</span><span class="sxs-lookup"><span data-stu-id="3f303-569">Int32</span></span>|<span data-ttu-id="3f303-570">密码的最小长度。</span><span class="sxs-lookup"><span data-stu-id="3f303-570">Minimum length of passcode.</span></span> <span data-ttu-id="3f303-571">有效值为 4 至 14</span><span class="sxs-lookup"><span data-stu-id="3f303-571">Valid values 4 to 14</span></span>|
|<span data-ttu-id="3f303-572">passcodeMinutesOfInactivityBeforeLock</span><span class="sxs-lookup"><span data-stu-id="3f303-572">passcodeMinutesOfInactivityBeforeLock</span></span>|<span data-ttu-id="3f303-573">Int32</span><span class="sxs-lookup"><span data-stu-id="3f303-573">Int32</span></span>|<span data-ttu-id="3f303-574">需要密码之前的不活动分钟数。</span><span class="sxs-lookup"><span data-stu-id="3f303-574">Minutes of inactivity before a passcode is required.</span></span>|
|<span data-ttu-id="3f303-575">passcodeMinutesOfInactivityBeforeScreenTimeout</span><span class="sxs-lookup"><span data-stu-id="3f303-575">passcodeMinutesOfInactivityBeforeScreenTimeout</span></span>|<span data-ttu-id="3f303-576">Int32</span><span class="sxs-lookup"><span data-stu-id="3f303-576">Int32</span></span>|<span data-ttu-id="3f303-577">屏幕超时之前的不活动分钟数。</span><span class="sxs-lookup"><span data-stu-id="3f303-577">Minutes of inactivity before the screen times out.</span></span>|
|<span data-ttu-id="3f303-578">passcodeMinimumCharacterSetCount</span><span class="sxs-lookup"><span data-stu-id="3f303-578">passcodeMinimumCharacterSetCount</span></span>|<span data-ttu-id="3f303-579">Int32</span><span class="sxs-lookup"><span data-stu-id="3f303-579">Int32</span></span>|<span data-ttu-id="3f303-580">密码必须包含的字符集数。</span><span class="sxs-lookup"><span data-stu-id="3f303-580">Number of character sets a passcode must contain.</span></span> <span data-ttu-id="3f303-581">有效值为 0 至 4</span><span class="sxs-lookup"><span data-stu-id="3f303-581">Valid values 0 to 4</span></span>|
|<span data-ttu-id="3f303-582">passcodePreviousPasscodeBlockCount</span><span class="sxs-lookup"><span data-stu-id="3f303-582">passcodePreviousPasscodeBlockCount</span></span>|<span data-ttu-id="3f303-583">Int32</span><span class="sxs-lookup"><span data-stu-id="3f303-583">Int32</span></span>|<span data-ttu-id="3f303-584">要阻止的以前密码的数量。</span><span class="sxs-lookup"><span data-stu-id="3f303-584">Number of previous passcodes to block.</span></span> <span data-ttu-id="3f303-585">有效值为 1 至 24</span><span class="sxs-lookup"><span data-stu-id="3f303-585">Valid values 1 to 24</span></span>|
|<span data-ttu-id="3f303-586">passcodeSignInFailureCountBeforeWipe</span><span class="sxs-lookup"><span data-stu-id="3f303-586">passcodeSignInFailureCountBeforeWipe</span></span>|<span data-ttu-id="3f303-587">Int32</span><span class="sxs-lookup"><span data-stu-id="3f303-587">Int32</span></span>|<span data-ttu-id="3f303-588">擦除设备前允许登录失败的次数。</span><span class="sxs-lookup"><span data-stu-id="3f303-588">Number of sign in failures allowed before wiping the device.</span></span> <span data-ttu-id="3f303-589">有效值为 2 至 11</span><span class="sxs-lookup"><span data-stu-id="3f303-589">Valid values 2 to 11</span></span>|
|<span data-ttu-id="3f303-590">passcodeRequiredType</span><span class="sxs-lookup"><span data-stu-id="3f303-590">passcodeRequiredType</span></span>|[<span data-ttu-id="3f303-591">requiredPasswordType</span><span class="sxs-lookup"><span data-stu-id="3f303-591">requiredPasswordType</span></span>](../resources/intune-deviceconfig-requiredpasswordtype.md)|<span data-ttu-id="3f303-592">必需的密码类型。</span><span class="sxs-lookup"><span data-stu-id="3f303-592">Type of passcode that is required.</span></span> <span data-ttu-id="3f303-593">可取值为：`deviceDefault`、`alphanumeric`、`numeric`。</span><span class="sxs-lookup"><span data-stu-id="3f303-593">Possible values are: `deviceDefault`, `alphanumeric`, `numeric`.</span></span>|
|<span data-ttu-id="3f303-594">passcodeRequired</span><span class="sxs-lookup"><span data-stu-id="3f303-594">passcodeRequired</span></span>|<span data-ttu-id="3f303-595">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-595">Boolean</span></span>|<span data-ttu-id="3f303-596">指示是否需要密码。</span><span class="sxs-lookup"><span data-stu-id="3f303-596">Indicates whether or not to require a passcode.</span></span>|
|<span data-ttu-id="3f303-597">podcastsBlocked</span><span class="sxs-lookup"><span data-stu-id="3f303-597">podcastsBlocked</span></span>|<span data-ttu-id="3f303-598">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-598">Boolean</span></span>|<span data-ttu-id="3f303-599">指示在受监督的设备上是否阻止用户使用播客（iOS 8.0 及更高版本）。</span><span class="sxs-lookup"><span data-stu-id="3f303-599">Indicates whether or not to block the user from using podcasts on the supervised device (iOS 8.0 and later).</span></span>|
|<span data-ttu-id="3f303-600">proximityBlockSetupToNewDevice</span><span class="sxs-lookup"><span data-stu-id="3f303-600">proximityBlockSetupToNewDevice</span></span>|<span data-ttu-id="3f303-601">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-601">Boolean</span></span>|<span data-ttu-id="3f303-602">指示是否启用提示以使用受监督的设备设置附近设备。</span><span class="sxs-lookup"><span data-stu-id="3f303-602">Indicates whether or not to enable the prompt to setup nearby devices with a supervised device.</span></span>|
|<span data-ttu-id="3f303-603">safariBlockAutofill</span><span class="sxs-lookup"><span data-stu-id="3f303-603">safariBlockAutofill</span></span>|<span data-ttu-id="3f303-604">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-604">Boolean</span></span>|<span data-ttu-id="3f303-605">指示在 Safari 中是否阻止用户使用自动填充。</span><span class="sxs-lookup"><span data-stu-id="3f303-605">Indicates whether or not to block the user from using Auto fill in Safari.</span></span> <span data-ttu-id="3f303-606">需要适用于 iOS 13 及更高版本的受监督设备。</span><span class="sxs-lookup"><span data-stu-id="3f303-606">Requires a supervised device for iOS 13 and later.</span></span>|
|<span data-ttu-id="3f303-607">safariBlockJavaScript</span><span class="sxs-lookup"><span data-stu-id="3f303-607">safariBlockJavaScript</span></span>|<span data-ttu-id="3f303-608">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-608">Boolean</span></span>|<span data-ttu-id="3f303-609">指示在 Safari 中是否阻止 JavaScript。</span><span class="sxs-lookup"><span data-stu-id="3f303-609">Indicates whether or not to block JavaScript in Safari.</span></span>|
|<span data-ttu-id="3f303-610">safariBlockPopups</span><span class="sxs-lookup"><span data-stu-id="3f303-610">safariBlockPopups</span></span>|<span data-ttu-id="3f303-611">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-611">Boolean</span></span>|<span data-ttu-id="3f303-612">指示在 Safari 中是否阻止弹出窗口。</span><span class="sxs-lookup"><span data-stu-id="3f303-612">Indicates whether or not to block popups in Safari.</span></span>|
|<span data-ttu-id="3f303-613">safariBlocked</span><span class="sxs-lookup"><span data-stu-id="3f303-613">safariBlocked</span></span>|<span data-ttu-id="3f303-614">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-614">Boolean</span></span>|<span data-ttu-id="3f303-615">指示是否阻止用户使用 Safari。</span><span class="sxs-lookup"><span data-stu-id="3f303-615">Indicates whether or not to block the user from using Safari.</span></span> <span data-ttu-id="3f303-616">需要适用于 iOS 13 及更高版本的受监督设备。</span><span class="sxs-lookup"><span data-stu-id="3f303-616">Requires a supervised device for iOS 13 and later.</span></span>|
|<span data-ttu-id="3f303-617">safariCookieSettings</span><span class="sxs-lookup"><span data-stu-id="3f303-617">safariCookieSettings</span></span>|[<span data-ttu-id="3f303-618">webBrowserCookieSettings</span><span class="sxs-lookup"><span data-stu-id="3f303-618">webBrowserCookieSettings</span></span>](../resources/intune-deviceconfig-webbrowsercookiesettings.md)|<span data-ttu-id="3f303-619">Safari 的 Cookie 设置。</span><span class="sxs-lookup"><span data-stu-id="3f303-619">Cookie settings for Safari.</span></span> <span data-ttu-id="3f303-620">可取值为：`browserDefault`、`blockAlways`、`allowCurrentWebSite`、`allowFromWebsitesVisited`、`allowAlways`。</span><span class="sxs-lookup"><span data-stu-id="3f303-620">Possible values are: `browserDefault`, `blockAlways`, `allowCurrentWebSite`, `allowFromWebsitesVisited`, `allowAlways`.</span></span>|
|<span data-ttu-id="3f303-621">safariManagedDomains</span><span class="sxs-lookup"><span data-stu-id="3f303-621">safariManagedDomains</span></span>|<span data-ttu-id="3f303-622">String 集合</span><span class="sxs-lookup"><span data-stu-id="3f303-622">String collection</span></span>|<span data-ttu-id="3f303-623">与此处列出的模式匹配的 URL 将被视为托管。</span><span class="sxs-lookup"><span data-stu-id="3f303-623">URLs matching the patterns listed here will be considered managed.</span></span>|
|<span data-ttu-id="3f303-624">safariPasswordAutoFillDomains</span><span class="sxs-lookup"><span data-stu-id="3f303-624">safariPasswordAutoFillDomains</span></span>|<span data-ttu-id="3f303-625">String 集合</span><span class="sxs-lookup"><span data-stu-id="3f303-625">String collection</span></span>|<span data-ttu-id="3f303-626">用户只能通过匹配此处列出的模式的 URL 将密码保存在 Safari 中。</span><span class="sxs-lookup"><span data-stu-id="3f303-626">Users can save passwords in Safari only from URLs matching the patterns listed here.</span></span> <span data-ttu-id="3f303-627">适用于处于监督模式下的设备（iOS 9.3 及更高版本）。</span><span class="sxs-lookup"><span data-stu-id="3f303-627">Applies to devices in supervised mode (iOS 9.3 and later).</span></span>|
|<span data-ttu-id="3f303-628">safariRequireFraudWarning</span><span class="sxs-lookup"><span data-stu-id="3f303-628">safariRequireFraudWarning</span></span>|<span data-ttu-id="3f303-629">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-629">Boolean</span></span>|<span data-ttu-id="3f303-630">指示在 Safari 中是否需要诈骗警告。</span><span class="sxs-lookup"><span data-stu-id="3f303-630">Indicates whether or not to require fraud warning in Safari.</span></span>|
|<span data-ttu-id="3f303-631">screenCaptureBlocked</span><span class="sxs-lookup"><span data-stu-id="3f303-631">screenCaptureBlocked</span></span>|<span data-ttu-id="3f303-632">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-632">Boolean</span></span>|<span data-ttu-id="3f303-633">指示是否阻止用户进行屏幕截图。</span><span class="sxs-lookup"><span data-stu-id="3f303-633">Indicates whether or not to block the user from taking Screenshots.</span></span>|
|<span data-ttu-id="3f303-634">siriBlocked</span><span class="sxs-lookup"><span data-stu-id="3f303-634">siriBlocked</span></span>|<span data-ttu-id="3f303-635">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-635">Boolean</span></span>|<span data-ttu-id="3f303-636">指示是否阻止用户使用 Siri。</span><span class="sxs-lookup"><span data-stu-id="3f303-636">Indicates whether or not to block the user from using Siri.</span></span>|
|<span data-ttu-id="3f303-637">siriBlockedWhenLocked</span><span class="sxs-lookup"><span data-stu-id="3f303-637">siriBlockedWhenLocked</span></span>|<span data-ttu-id="3f303-638">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-638">Boolean</span></span>|<span data-ttu-id="3f303-639">指示锁定时是否阻止用户使用 Siri。</span><span class="sxs-lookup"><span data-stu-id="3f303-639">Indicates whether or not to block the user from using Siri when locked.</span></span>|
|<span data-ttu-id="3f303-640">siriBlockUserGeneratedContent</span><span class="sxs-lookup"><span data-stu-id="3f303-640">siriBlockUserGeneratedContent</span></span>|<span data-ttu-id="3f303-641">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-641">Boolean</span></span>|<span data-ttu-id="3f303-642">指示在受监督的设备上使用时是否阻止 Siri 查询用户生成的内容。</span><span class="sxs-lookup"><span data-stu-id="3f303-642">Indicates whether or not to block Siri from querying user-generated content when used on a supervised device.</span></span>|
|<span data-ttu-id="3f303-643">siriRequireProfanityFilter</span><span class="sxs-lookup"><span data-stu-id="3f303-643">siriRequireProfanityFilter</span></span>|<span data-ttu-id="3f303-644">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-644">Boolean</span></span>|<span data-ttu-id="3f303-645">指示是否阻止 Siri 在受监督的设备上口述或说出亵渎语言。</span><span class="sxs-lookup"><span data-stu-id="3f303-645">Indicates whether or not to prevent Siri from dictating, or speaking profane language on supervised device.</span></span>|
|<span data-ttu-id="3f303-646">softwareUpdatesEnforcedDelayInDays</span><span class="sxs-lookup"><span data-stu-id="3f303-646">softwareUpdatesEnforcedDelayInDays</span></span>|<span data-ttu-id="3f303-647">Int32</span><span class="sxs-lookup"><span data-stu-id="3f303-647">Int32</span></span>|<span data-ttu-id="3f303-648">设置对受监督设备取消软件更新的天数。</span><span class="sxs-lookup"><span data-stu-id="3f303-648">Sets how many days a software update will be delyed for a supervised device.</span></span> <span data-ttu-id="3f303-649">有效值为 0 至 90</span><span class="sxs-lookup"><span data-stu-id="3f303-649">Valid values 0 to 90</span></span>|
|<span data-ttu-id="3f303-650">softwareUpdatesForceDelayed</span><span class="sxs-lookup"><span data-stu-id="3f303-650">softwareUpdatesForceDelayed</span></span>|<span data-ttu-id="3f303-651">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-651">Boolean</span></span>|<span data-ttu-id="3f303-652">指示设备在监督模式下时是否延迟软件更新的用户可见性。</span><span class="sxs-lookup"><span data-stu-id="3f303-652">Indicates whether or not to delay user visibility of software updates when the device is in supervised mode.</span></span>|
|<span data-ttu-id="3f303-653">spotlightBlockInternetResults</span><span class="sxs-lookup"><span data-stu-id="3f303-653">spotlightBlockInternetResults</span></span>|<span data-ttu-id="3f303-654">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-654">Boolean</span></span>|<span data-ttu-id="3f303-655">指示是否阻止 Spotlight 搜索在受监督的设备上返回 Internet 搜索结果。</span><span class="sxs-lookup"><span data-stu-id="3f303-655">Indicates whether or not to block Spotlight search from returning internet results on supervised device.</span></span>|
|<span data-ttu-id="3f303-656">voiceDialingBlocked</span><span class="sxs-lookup"><span data-stu-id="3f303-656">voiceDialingBlocked</span></span>|<span data-ttu-id="3f303-657">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-657">Boolean</span></span>|<span data-ttu-id="3f303-658">指示是否阻止语音拨号。</span><span class="sxs-lookup"><span data-stu-id="3f303-658">Indicates whether or not to block voice dialing.</span></span>|
|<span data-ttu-id="3f303-659">wallpaperBlockModification</span><span class="sxs-lookup"><span data-stu-id="3f303-659">wallpaperBlockModification</span></span>|<span data-ttu-id="3f303-660">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-660">Boolean</span></span>|<span data-ttu-id="3f303-661">指示是否允许在受监督的设备上修改墙纸（iOS 9.0 及更高版本）。</span><span class="sxs-lookup"><span data-stu-id="3f303-661">Indicates whether or not to allow wallpaper modification on supervised device (iOS 9.0 and later) .</span></span>|
|<span data-ttu-id="3f303-662">wiFiConnectOnlyToConfiguredNetworks</span><span class="sxs-lookup"><span data-stu-id="3f303-662">wiFiConnectOnlyToConfiguredNetworks</span></span>|<span data-ttu-id="3f303-663">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-663">Boolean</span></span>|<span data-ttu-id="3f303-664">指示设备处于监督模式时是否强制设备仅使用配置文件中的 Wi-Fi 网络。</span><span class="sxs-lookup"><span data-stu-id="3f303-664">Indicates whether or not to force the device to use only Wi-Fi networks from configuration profiles when the device is in supervised mode.</span></span>|
|<span data-ttu-id="3f303-665">classroomForceRequestPermissionToLeaveClasses</span><span class="sxs-lookup"><span data-stu-id="3f303-665">classroomForceRequestPermissionToLeaveClasses</span></span>|<span data-ttu-id="3f303-666">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-666">Boolean</span></span>|<span data-ttu-id="3f303-667">指示通过 Classroom 参加非托管课程的学生在尝试离开 iOS 11.3 及更高版本的 (课程时是否将请求教师) 。</span><span class="sxs-lookup"><span data-stu-id="3f303-667">Indicates whether a student enrolled in an unmanaged course via Classroom will request permission from the teacher when attempting to leave the course (iOS 11.3 and later).</span></span>|
|<span data-ttu-id="3f303-668">keychainBlockCloudSync</span><span class="sxs-lookup"><span data-stu-id="3f303-668">keychainBlockCloudSync</span></span>|<span data-ttu-id="3f303-669">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-669">Boolean</span></span>|<span data-ttu-id="3f303-670">指示是否阻止 iCloud 密钥链同步。</span><span class="sxs-lookup"><span data-stu-id="3f303-670">Indicates whether or not iCloud keychain synchronization is blocked.</span></span> <span data-ttu-id="3f303-671">需要适用于 iOS 13 及更高版本的受监督设备。</span><span class="sxs-lookup"><span data-stu-id="3f303-671">Requires a supervised device for iOS 13 and later.</span></span>|
|<span data-ttu-id="3f303-672">pkiBlockOTAUpdates</span><span class="sxs-lookup"><span data-stu-id="3f303-672">pkiBlockOTAUpdates</span></span>|<span data-ttu-id="3f303-673">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-673">Boolean</span></span>|<span data-ttu-id="3f303-674">指示是否阻止非空 PKI 更新。</span><span class="sxs-lookup"><span data-stu-id="3f303-674">Indicates whether or not over-the-air PKI updates are blocked.</span></span> <span data-ttu-id="3f303-675">如果此限制设置为 false，将不会在 iOS 7.0 (禁用 CRL 和 OCSP 检查) 。</span><span class="sxs-lookup"><span data-stu-id="3f303-675">Setting this restriction to false does not disable CRL and OCSP checks (iOS 7.0 and later).</span></span>|
|<span data-ttu-id="3f303-676">privacyForceLimitAdTracking</span><span class="sxs-lookup"><span data-stu-id="3f303-676">privacyForceLimitAdTracking</span></span>|<span data-ttu-id="3f303-677">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-677">Boolean</span></span>|<span data-ttu-id="3f303-678">指示广告跟踪是否受限。 (iOS 7.0 及更高版本) 。</span><span class="sxs-lookup"><span data-stu-id="3f303-678">Indicates if ad tracking is limited.(iOS 7.0 and later).</span></span>|
|<span data-ttu-id="3f303-679">enterpriseBookBlockBackup</span><span class="sxs-lookup"><span data-stu-id="3f303-679">enterpriseBookBlockBackup</span></span>|<span data-ttu-id="3f303-680">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-680">Boolean</span></span>|<span data-ttu-id="3f303-681">指示是否阻止企业书籍备份。</span><span class="sxs-lookup"><span data-stu-id="3f303-681">Indicates whether or not Enterprise book back up is blocked.</span></span>|
|<span data-ttu-id="3f303-682">enterpriseBookBlockMetadataSync</span><span class="sxs-lookup"><span data-stu-id="3f303-682">enterpriseBookBlockMetadataSync</span></span>|<span data-ttu-id="3f303-683">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-683">Boolean</span></span>|<span data-ttu-id="3f303-684">指示是否阻止企业书籍备注和突出显示同步。</span><span class="sxs-lookup"><span data-stu-id="3f303-684">Indicates whether or not Enterprise book notes and highlights sync is blocked.</span></span>|
|<span data-ttu-id="3f303-685">airPrintBlocked</span><span class="sxs-lookup"><span data-stu-id="3f303-685">airPrintBlocked</span></span>|<span data-ttu-id="3f303-686">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-686">Boolean</span></span>|<span data-ttu-id="3f303-687">指示 iOS 11.0 (是否阻止 AirPrint) 。</span><span class="sxs-lookup"><span data-stu-id="3f303-687">Indicates whether or not AirPrint is blocked (iOS 11.0 and later).</span></span>|
|<span data-ttu-id="3f303-688">airPrintBlockCredentialsStorage</span><span class="sxs-lookup"><span data-stu-id="3f303-688">airPrintBlockCredentialsStorage</span></span>|<span data-ttu-id="3f303-689">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-689">Boolean</span></span>|<span data-ttu-id="3f303-690">指示在 iOS 11.0 及更高版本 (是否阻止用于 Airprint 的用户名和密码的密钥链) 。</span><span class="sxs-lookup"><span data-stu-id="3f303-690">Indicates whether or not keychain storage of username and password for Airprint is blocked (iOS 11.0 and later).</span></span>|
|<span data-ttu-id="3f303-691">airPrintForceTrustedTLS</span><span class="sxs-lookup"><span data-stu-id="3f303-691">airPrintForceTrustedTLS</span></span>|<span data-ttu-id="3f303-692">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-692">Boolean</span></span>|<span data-ttu-id="3f303-693">指示在 iOS 11.0 及更高版本中，TLS 打印通信 (信任证书) 。</span><span class="sxs-lookup"><span data-stu-id="3f303-693">Indicates if trusted certificates are required for TLS printing communication (iOS 11.0 and later).</span></span>|
|<span data-ttu-id="3f303-694">airPrintBlockiBeaconDiscovery</span><span class="sxs-lookup"><span data-stu-id="3f303-694">airPrintBlockiBeaconDiscovery</span></span>|<span data-ttu-id="3f303-695">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-695">Boolean</span></span>|<span data-ttu-id="3f303-696">指示是否阻止 iBeacon 发现 AirPrint 打印机。</span><span class="sxs-lookup"><span data-stu-id="3f303-696">Indicates whether or not iBeacon discovery of AirPrint printers is blocked.</span></span> <span data-ttu-id="3f303-697">这可以防止恶意的 AirPrint Bluetooth信号对 iOS 11.0 (及更高版本的网络通信进行网络钓鱼) 。</span><span class="sxs-lookup"><span data-stu-id="3f303-697">This prevents spurious AirPrint Bluetooth beacons from phishing for network traffic (iOS 11.0 and later).</span></span>|
|<span data-ttu-id="3f303-698">filesNetworkDriveAccessBlocked</span><span class="sxs-lookup"><span data-stu-id="3f303-698">filesNetworkDriveAccessBlocked</span></span>|<span data-ttu-id="3f303-699">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-699">Boolean</span></span>|<span data-ttu-id="3f303-700">指示设备是否可以使用 SMB 协议中的服务器消息块访问网络 (或其他) 资源。</span><span class="sxs-lookup"><span data-stu-id="3f303-700">Indicates if devices can access files or other resources on a network server using the Server Message Block (SMB) protocol.</span></span> <span data-ttu-id="3f303-701">适用于运行 iOS 和 iPadOS 版本 13.0 及更高版本的设备。</span><span class="sxs-lookup"><span data-stu-id="3f303-701">Available for devices running iOS and iPadOS, versions 13.0 and later.</span></span>|
|<span data-ttu-id="3f303-702">filesUsbDriveAccessBlocked</span><span class="sxs-lookup"><span data-stu-id="3f303-702">filesUsbDriveAccessBlocked</span></span>|<span data-ttu-id="3f303-703">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-703">Boolean</span></span>|<span data-ttu-id="3f303-704">指示具有访问权限的设备能否连接到 USB 驱动器上并打开文件。</span><span class="sxs-lookup"><span data-stu-id="3f303-704">Indicates if sevices with access can connect to and open files on a USB drive.</span></span> <span data-ttu-id="3f303-705">适用于运行 iOS 和 iPadOS 版本 13.0 及更高版本的设备。</span><span class="sxs-lookup"><span data-stu-id="3f303-705">Available for devices running iOS and iPadOS, versions 13.0 and later.</span></span>|
|<span data-ttu-id="3f303-706">wifiPowerOnForced</span><span class="sxs-lookup"><span data-stu-id="3f303-706">wifiPowerOnForced</span></span>|<span data-ttu-id="3f303-707">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-707">Boolean</span></span>|<span data-ttu-id="3f303-708">指示设备是否Wi-Fi保持打开状态，即使设备处于飞行模式。</span><span class="sxs-lookup"><span data-stu-id="3f303-708">Indicates whether or not Wi-Fi remains on, even when device is in airplane mode.</span></span> <span data-ttu-id="3f303-709">适用于运行 iOS 和 iPadOS 版本 13.0 及更高版本的设备。</span><span class="sxs-lookup"><span data-stu-id="3f303-709">Available for devices running iOS and iPadOS, versions 13.0 and later.</span></span>|
|<span data-ttu-id="3f303-710">blockSystemAppRemoval</span><span class="sxs-lookup"><span data-stu-id="3f303-710">blockSystemAppRemoval</span></span>|<span data-ttu-id="3f303-711">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-711">Boolean</span></span>|<span data-ttu-id="3f303-712">指示在受监督的设备 (iOS 11.0 及更高版本上是否阻止从设备删除系统) 。</span><span class="sxs-lookup"><span data-stu-id="3f303-712">Indicates whether or not the removal of system apps from the device is blocked on a supervised device (iOS 11.0 and later).</span></span>|
|<span data-ttu-id="3f303-713">vpnBlockCreation</span><span class="sxs-lookup"><span data-stu-id="3f303-713">vpnBlockCreation</span></span>|<span data-ttu-id="3f303-714">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-714">Boolean</span></span>|<span data-ttu-id="3f303-715">指示在 iOS 11.0 (或更高版本中是否阻止创建 VPN) 。</span><span class="sxs-lookup"><span data-stu-id="3f303-715">Indicates whether or not the creation of VPN configurations is blocked (iOS 11.0 and later).</span></span>|
|<span data-ttu-id="3f303-716">appRemovalBlocked</span><span class="sxs-lookup"><span data-stu-id="3f303-716">appRemovalBlocked</span></span>|<span data-ttu-id="3f303-717">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-717">Boolean</span></span>|<span data-ttu-id="3f303-718">指示是否允许删除应用。</span><span class="sxs-lookup"><span data-stu-id="3f303-718">Indicates if the removal of apps is allowed.</span></span>|
|<span data-ttu-id="3f303-719">usbRestrictedModeBlocked</span><span class="sxs-lookup"><span data-stu-id="3f303-719">usbRestrictedModeBlocked</span></span>|<span data-ttu-id="3f303-720">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-720">Boolean</span></span>|<span data-ttu-id="3f303-721">指示是否允许在 iOS 11.4.1 (设备锁定时连接到 USB) 。</span><span class="sxs-lookup"><span data-stu-id="3f303-721">Indicates if connecting to USB accessories while the device is locked is allowed (iOS 11.4.1 and later).</span></span>|
|<span data-ttu-id="3f303-722">passwordBlockAutoFill</span><span class="sxs-lookup"><span data-stu-id="3f303-722">passwordBlockAutoFill</span></span>|<span data-ttu-id="3f303-723">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-723">Boolean</span></span>|<span data-ttu-id="3f303-724">指示是否允许在 iOS 12.0 (自动填充密码) 。</span><span class="sxs-lookup"><span data-stu-id="3f303-724">Indicates if the AutoFill passwords feature is allowed (iOS 12.0 and later).</span></span>|
|<span data-ttu-id="3f303-725">passwordBlockProximityRequests</span><span class="sxs-lookup"><span data-stu-id="3f303-725">passwordBlockProximityRequests</span></span>|<span data-ttu-id="3f303-726">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-726">Boolean</span></span>|<span data-ttu-id="3f303-727">指示是否阻止从 iOS 12.0 (及更高版本的附近设备请求) 。</span><span class="sxs-lookup"><span data-stu-id="3f303-727">Indicates whether or not to block requesting passwords from nearby devices (iOS 12.0 and later).</span></span>|
|<span data-ttu-id="3f303-728">passwordBlockAirDropSharing</span><span class="sxs-lookup"><span data-stu-id="3f303-728">passwordBlockAirDropSharing</span></span>|<span data-ttu-id="3f303-729">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-729">Boolean</span></span>|<span data-ttu-id="3f303-730">指示是否阻止使用 iOS 12.0 及更高版本的 AirDrop 密码功能共享) 。</span><span class="sxs-lookup"><span data-stu-id="3f303-730">Indicates whether or not to block sharing passwords with the AirDrop passwords feature iOS 12.0 and later).</span></span>|
|<span data-ttu-id="3f303-731">dateAndTimeForceSetAutomatically</span><span class="sxs-lookup"><span data-stu-id="3f303-731">dateAndTimeForceSetAutomatically</span></span>|<span data-ttu-id="3f303-732">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-732">Boolean</span></span>|<span data-ttu-id="3f303-733">指示日期和时间"自动设置"功能是否已启用，并且用户 (iOS 12.0 及更高版本) 。</span><span class="sxs-lookup"><span data-stu-id="3f303-733">Indicates whether or not the Date and Time "Set Automatically" feature is enabled and cannot be turned off by the user (iOS 12.0 and later).</span></span>|
|<span data-ttu-id="3f303-734">contactsAllowManagedToUnmanagedWrite</span><span class="sxs-lookup"><span data-stu-id="3f303-734">contactsAllowManagedToUnmanagedWrite</span></span>|<span data-ttu-id="3f303-735">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-735">Boolean</span></span>|<span data-ttu-id="3f303-736">指示托管应用是否可以将联系人写入 iOS 12.0 及更高版本 (非托管联系人) 。</span><span class="sxs-lookup"><span data-stu-id="3f303-736">Indicates whether or not managed apps can write contacts to unmanaged contacts accounts (iOS 12.0 and later).</span></span>|
|<span data-ttu-id="3f303-737">contactsAllowUnmanagedToManagedRead</span><span class="sxs-lookup"><span data-stu-id="3f303-737">contactsAllowUnmanagedToManagedRead</span></span>|<span data-ttu-id="3f303-738">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-738">Boolean</span></span>|<span data-ttu-id="3f303-739">指示非托管应用是否可以从 iOS 12.0 (或更高版本的托管联系人帐户) 。</span><span class="sxs-lookup"><span data-stu-id="3f303-739">Indicates whether or not unmanaged apps can read from managed contacts accounts (iOS 12.0 or later).</span></span>|
|<span data-ttu-id="3f303-740">cellularBlockPersonalHotspotModification</span><span class="sxs-lookup"><span data-stu-id="3f303-740">cellularBlockPersonalHotspotModification</span></span>|<span data-ttu-id="3f303-741">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-741">Boolean</span></span>|<span data-ttu-id="3f303-742">指示是否阻止用户修改 iOS 12.2 (或更高版本的个人热点) 。</span><span class="sxs-lookup"><span data-stu-id="3f303-742">Indicates whether or not to block the user from modifying the personal hotspot setting (iOS 12.2 or later).</span></span>|
|<span data-ttu-id="3f303-743">continuousPathKeyboardBlocked</span><span class="sxs-lookup"><span data-stu-id="3f303-743">continuousPathKeyboardBlocked</span></span>|<span data-ttu-id="3f303-744">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-744">Boolean</span></span>|<span data-ttu-id="3f303-745">指示在 iOS 13 或更高版本的设备受监督时 (连续路径) 。</span><span class="sxs-lookup"><span data-stu-id="3f303-745">Indicates whether or not to block the continuous path keyboard when the device is supervised (iOS 13 or later).</span></span>|
|<span data-ttu-id="3f303-746">findMyDeviceInFindMyAppBlocked</span><span class="sxs-lookup"><span data-stu-id="3f303-746">findMyDeviceInFindMyAppBlocked</span></span>|<span data-ttu-id="3f303-747">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-747">Boolean</span></span>|<span data-ttu-id="3f303-748">指示在 iOS 13 或更高版本中监督设备时 (查找我的) 。</span><span class="sxs-lookup"><span data-stu-id="3f303-748">Indicates whether or not to block Find My Device when the device is supervised (iOS 13 or later).</span></span>|
|<span data-ttu-id="3f303-749">findMyFriendsInFindMyAppBlocked</span><span class="sxs-lookup"><span data-stu-id="3f303-749">findMyFriendsInFindMyAppBlocked</span></span>|<span data-ttu-id="3f303-750">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-750">Boolean</span></span>|<span data-ttu-id="3f303-751">指示在 iOS 13 或更高版本中监督设备时是否 (查找我的好友) 。</span><span class="sxs-lookup"><span data-stu-id="3f303-751">Indicates whether or not to block Find My Friends when the device is supervised (iOS 13 or later).</span></span>|
|<span data-ttu-id="3f303-752">iTunesBlocked</span><span class="sxs-lookup"><span data-stu-id="3f303-752">iTunesBlocked</span></span>|<span data-ttu-id="3f303-753">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-753">Boolean</span></span>|<span data-ttu-id="3f303-754">指示是否阻止 iTunes 应用。</span><span class="sxs-lookup"><span data-stu-id="3f303-754">Indicates whether or not to block the iTunes app.</span></span> <span data-ttu-id="3f303-755">需要适用于 iOS 13 及更高版本的受监督设备。</span><span class="sxs-lookup"><span data-stu-id="3f303-755">Requires a supervised device for iOS 13 and later.</span></span>|
|<span data-ttu-id="3f303-756">sharedDeviceBlockTemporarySessions</span><span class="sxs-lookup"><span data-stu-id="3f303-756">sharedDeviceBlockTemporarySessions</span></span>|<span data-ttu-id="3f303-757">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-757">Boolean</span></span>|<span data-ttu-id="3f303-758">指示是否阻止 iOS 13.4 或更高版本上的共享 iPad (临时) 。</span><span class="sxs-lookup"><span data-stu-id="3f303-758">Indicates whether or not to block temporary sessions on Shared iPads (iOS 13.4 or later).</span></span>|
|<span data-ttu-id="3f303-759">appClipsBlocked</span><span class="sxs-lookup"><span data-stu-id="3f303-759">appClipsBlocked</span></span>|<span data-ttu-id="3f303-760">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-760">Boolean</span></span>|<span data-ttu-id="3f303-761">阻止用户添加任何应用剪辑并删除设备上的任何现有应用剪辑。</span><span class="sxs-lookup"><span data-stu-id="3f303-761">Prevents a user from adding any App Clips and removes any existing App Clips on the device.</span></span>|
|<span data-ttu-id="3f303-762">applePersonalizedAdsBlocked</span><span class="sxs-lookup"><span data-stu-id="3f303-762">applePersonalizedAdsBlocked</span></span>|<span data-ttu-id="3f303-763">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-763">Boolean</span></span>|<span data-ttu-id="3f303-764">如果为 true，限制 Apple 个性化广告。</span><span class="sxs-lookup"><span data-stu-id="3f303-764">Limits Apple personalized advertising when true.</span></span> <span data-ttu-id="3f303-765">在 iOS 14 及更高版本中可用。</span><span class="sxs-lookup"><span data-stu-id="3f303-765">Available in iOS 14 and later.</span></span>|
|<span data-ttu-id="3f303-766">nfcBlocked</span><span class="sxs-lookup"><span data-stu-id="3f303-766">nfcBlocked</span></span>|<span data-ttu-id="3f303-767">Boolean</span><span class="sxs-lookup"><span data-stu-id="3f303-767">Boolean</span></span>|<span data-ttu-id="3f303-768">禁用 NFC 以防止设备与其他支持 NFC 的设备配对。</span><span class="sxs-lookup"><span data-stu-id="3f303-768">Disable NFC to prevent devices from pairing with other NFC-enabled devices.</span></span> <span data-ttu-id="3f303-769">适用于运行 14.2 及更高版本的 iOS/iPadOS 设备。</span><span class="sxs-lookup"><span data-stu-id="3f303-769">Available for iOS/iPadOS devices running 14.2 and later.</span></span>|
|<span data-ttu-id="3f303-770">kioskModeAppType</span><span class="sxs-lookup"><span data-stu-id="3f303-770">kioskModeAppType</span></span>|[<span data-ttu-id="3f303-771">iosKioskModeAppType</span><span class="sxs-lookup"><span data-stu-id="3f303-771">iosKioskModeAppType</span></span>](../resources/intune-deviceconfig-ioskioskmodeapptype.md)|<span data-ttu-id="3f303-772">在展台模式下运行的应用类型。</span><span class="sxs-lookup"><span data-stu-id="3f303-772">Type of app to run in kiosk mode.</span></span> <span data-ttu-id="3f303-773">可取值为：`notConfigured`、`appStoreApp`、`managedApp`、`builtInApp`。</span><span class="sxs-lookup"><span data-stu-id="3f303-773">Possible values are: `notConfigured`, `appStoreApp`, `managedApp`, `builtInApp`.</span></span>|



## <a name="response"></a><span data-ttu-id="3f303-774">响应</span><span class="sxs-lookup"><span data-stu-id="3f303-774">Response</span></span>
<span data-ttu-id="3f303-775">如果成功，此方法在响应正文中返回 `200 OK` 响应代码和更新的 [iosGeneralDeviceConfiguration](../resources/intune-deviceconfig-iosgeneraldeviceconfiguration.md) 对象。</span><span class="sxs-lookup"><span data-stu-id="3f303-775">If successful, this method returns a `200 OK` response code and an updated [iosGeneralDeviceConfiguration](../resources/intune-deviceconfig-iosgeneraldeviceconfiguration.md) object in the response body.</span></span>

## <a name="example"></a><span data-ttu-id="3f303-776">示例</span><span class="sxs-lookup"><span data-stu-id="3f303-776">Example</span></span>

### <a name="request"></a><span data-ttu-id="3f303-777">请求</span><span class="sxs-lookup"><span data-stu-id="3f303-777">Request</span></span>
<span data-ttu-id="3f303-778">下面是一个请求示例。</span><span class="sxs-lookup"><span data-stu-id="3f303-778">Here is an example of the request.</span></span>
``` http
...
### <a name="response"></a><span data-ttu-id="3f303-779">响应</span><span class="sxs-lookup"><span data-stu-id="3f303-779">Response</span></span>
<span data-ttu-id="3f303-p159">下面是一个响应示例。注意：为了简单起见，可能会将此处所示的响应对象截断。将从实际调用中返回所有属性。</span><span class="sxs-lookup"><span data-stu-id="3f303-p159">Here is an example of the response. Note: The response object shown here may be truncated for brevity. All of the properties will be returned from an actual call.</span></span>
``` http
HTTP/1.1 200 OK
Content-Type: application/json
