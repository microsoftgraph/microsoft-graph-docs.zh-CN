---
title: 更新 macOSDmgApp
description: 更新 macOSDmgApp 对象的属性。
author: dougeby
...
ms.locfileid: "61712158"
---
# <a name="update-macosdmgapp"></a>更新 macOSDmgApp
...
更新 [macOSDmgApp 对象](../resources/intune-apps-macosdmgapp.md) 的属性。
...
在请求正文中，提供 [macOSDmgApp](../resources/intune-apps-macosdmgapp.md) 对象的 JSON 表示形式。

下表显示创建 [macOSDmgApp](../resources/intune-apps-macosdmgapp.md)时所需的属性。
...
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [macOSDmgApp](../resources/intune-apps-macosdmgapp.md) 对象。
