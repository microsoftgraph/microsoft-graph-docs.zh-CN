---
title: 列出 softwareOathMethods
description: 检索用户的软件OathAuthenticationMethods 对象及其属性的列表。
author: mmcla
...
ms.locfileid: "62116806"
---
# <a name="list-softwareoathmethods"></a>列出 softwareOathMethods
命名空间：microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

检索用户的软件 [的用户 SOFTWARE TOKEN 令牌身份验证方法](../resources/softwareoathauthenticationmethod.md) 对象及其属性的列表。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [softwareOathAuthenticationMethod](../resources/softwareoathauthenticationmethod.md) 对象集合。
