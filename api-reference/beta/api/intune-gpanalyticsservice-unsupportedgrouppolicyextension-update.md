...
更新 [unsupportedGroupPolicyExtension 对象](../resources/intune-gpanalyticsservice-unsupportedgrouppolicyextension.md) 的属性。
...
下表显示创建 [unsupportedGroupPolicyExtension 时所需的属性](../resources/intune-gpanalyticsservice-unsupportedgrouppolicyextension.md)。
...
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [unsupportedGroupPolicyExtension](../resources/intune-gpanalyticsservice-unsupportedgrouppolicyextension.md) 对象。
