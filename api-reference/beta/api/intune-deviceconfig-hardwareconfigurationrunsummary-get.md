---
title: 获取 hardwareConfigurationRunSummary
description: 读取 hardwareConfigurationRunSummary 对象的属性和关系。
author: dougeby
...
ms.locfileid: "61345430"
---
# <a name="get-hardwareconfigurationrunsummary"></a>获取 hardwareConfigurationRunSummary
...
读取 [hardwareConfigurationRunSummary 对象的属性和](../resources/intune-deviceconfig-hardwareconfigurationrunsummary.md) 关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [hardwareConfigurationRunSummary](../resources/intune-deviceconfig-hardwareconfigurationrunsummary.md) 对象。
