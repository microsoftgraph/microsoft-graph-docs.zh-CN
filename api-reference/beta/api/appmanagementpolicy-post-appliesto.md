...
| 权限类型                        | 权限（从最低特权到最高特权）                                                |
| :------------------------------------- | :--------------------------------------------------------- |
| 委派（工作或学校帐户）     | Application.Read.All 和 Policy.ReadWrite.ApplicationConfiguration |
| 委派（个人 Microsoft 帐户） | 不支持。                                             |
| 应用程序                            | Application.Read.All 和 Policy.ReadWrite.ApplicationConfiguration |
...
### <a name="example-1-assign-an-appmanagementpolicy-to-an-application-object"></a>示例 1：将 appManagementPolicy 分配给应用程序对象
...
### <a name="example-2-assign-an-appmanagementpolicy-to-a-service-principal-object"></a>示例 2：将 appManagementPolicy 分配给服务主体对象

#### <a name="request"></a>请求

下面是向服务主体分配 appManagementPolicy 的请求示例。
