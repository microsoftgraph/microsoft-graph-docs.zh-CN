...
在部署服务更新管理中注册相同类型的 [updatableAsset](../resources/windowsupdates-updatableasset.md) 资源。

您还可以使用 [enrollAssets 方法](windowsupdates-updatableasset-enrollassets.md) 注册资产。
