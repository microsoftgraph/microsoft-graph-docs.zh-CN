---
title: 列出 retentionEvents
description: 获取 retentionEvent 对象及其属性的列表。
author: sseth
...
---
# <a name="list-retentionevents"></a>列出 retentionEvents
命名空间：microsoft.graph.security

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

获取 [retentionEvent](../resources/security-retentionevent.md) 对象及其属性的列表。
...
此方法支持展开 OData 查询参数，以帮助自定义响应。 例如，若要获取事件类型，请使用 `$expand=retentionEventType`。 若要了解一般信息，请参阅 [OData 查询参数](/graph/query-parameters)。
...
如果成功，此方法在响应正文中返回 `200 OK` 响应代码和 [microsoft.graph.security.retentionEvent](../resources/security-retentionevent.md)  对象集合。
