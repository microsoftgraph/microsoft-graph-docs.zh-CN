...
如果成功，此方法在响应正文中返回 `200 OK` 响应代码和 [iosLobAppProvisioningConfiguration](../resources/intune-shared-ioslobappprovisioningconfiguration.md) 对象的集合。
