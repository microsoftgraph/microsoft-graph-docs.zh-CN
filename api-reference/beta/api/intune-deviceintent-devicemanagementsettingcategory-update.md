...
更新 [deviceManagementSettingCategory 对象](../resources/intune-deviceintent-devicemanagementsettingcategory.md) 的属性。
...
下表显示创建 [deviceManagementSettingCategory 时所需的属性](../resources/intune-deviceintent-devicemanagementsettingcategory.md)。
...
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [deviceManagementSettingCategory](../resources/intune-deviceintent-devicemanagementsettingcategory.md) 对象。
