...
ms.locfileid: "60981355"
---
# <a name="get-itempatent"></a>获取 itemPatent

命名空间：microsoft.graph

读取 [itemPatent](../resources/itempatent.md) 对象的属性和关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [itemPatent](../resources/itempatent.md) 对象。
