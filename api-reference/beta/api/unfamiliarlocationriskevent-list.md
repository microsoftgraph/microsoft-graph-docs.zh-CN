...
---
# <a name="list-unfamiliarlocationriskevents-deprecated"></a>列出不推荐 (的 unfamiliarLocationRiskEvents) 
...
如果成功，此方法在响应 `200 OK` 正文中返回 响应代码和 [unfamiliarLocationRiskEvent](../resources/unfamiliarlocationriskevent.md) 对象集合。
## <a name="example"></a>示例
##### <a name="request"></a>请求
下面是一个请求示例。
<!-- {
