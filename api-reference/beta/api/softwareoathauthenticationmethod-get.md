---
title: 获取 softwareOathAuthenticationMethod
description: 读取 softwareOathAuthenticationMethod 对象的属性和关系。
author: mmcla
...
ms.locfileid: "61020375"
---
# <a name="get-softwareoathauthenticationmethod"></a>获取 softwareOathAuthenticationMethod
命名空间：microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

检索用户的单个 Software [的一个 SOFTWARE 的一个，即 TOKEN 身份验证方法](../resources/softwareoathauthenticationmethod.md) 对象及其属性。
...
对于管理员正在操作其他用户的委派方案，管理员需要以下 [目录角色之一](/azure/active-directory/users-groups-roles/directory-assign-admin-roles#available-roles)：
* 全局读取者
* 身份验证管理员
* 特权身份验证管理员
* 全局管理员
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [softwareOathAuthenticationMethod](../resources/softwareoathauthenticationmethod.md) 对象。
