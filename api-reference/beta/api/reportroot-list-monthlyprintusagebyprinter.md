...
检索按打印机分组的每月打印使用情况摘要 [列表](../resources/printer.md)。
...
如果成功，此方法在响应 `200 OK` 正文中返回 响应代码和 [printUsageByPrinter](../resources/printUsageByPrinter.md) 对象集合。
## <a name="example"></a>示例
### <a name="request"></a>请求
下面展示了示例请求。
