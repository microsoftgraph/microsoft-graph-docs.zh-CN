...
ms.locfileid: "60982566"
---
# <a name="get-approvalstep"></a>获取审批步骤

命名空间：microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

检索 [approvalStep 对象](../resources/approvalstep.md) 的属性。
...
如果成功，此方法在响应 `200 OK` 正文中返回 响应代码和 [approvalStep](../resources/approvalstep.md) 对象。 但是，如果调用方没有正确的权限，该方法将返回 响应 `403 Forbidden` 代码。
