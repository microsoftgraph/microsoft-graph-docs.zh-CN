...
更新 [deviceManagementBooleanSettingInstance 对象](../resources/intune-deviceintent-devicemanagementbooleansettinginstance.md) 的属性。
...
下表显示创建 [deviceManagementBooleanSettingInstance 时所需的属性](../resources/intune-deviceintent-devicemanagementbooleansettinginstance.md)。
...
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [deviceManagementBooleanSettingInstance](../resources/intune-deviceintent-devicemanagementbooleansettinginstance.md) 对象。
