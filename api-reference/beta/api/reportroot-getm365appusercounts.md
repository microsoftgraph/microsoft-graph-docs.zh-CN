...
description: 获取一个报表，该报表提供组织中每个应用（Outlook、Word、Excel、PowerPoint、OneNote 和 Teams）的活动用户数的趋势。
...
获取一个报表，该报表提供组织中每个应用（Outlook、Word、Excel、PowerPoint、OneNote 和 Teams）的活动用户数的趋势。
