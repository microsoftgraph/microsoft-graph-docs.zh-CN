...
|属性|类型|说明|
|:---|:---|:---|
|id|字符串|尚未从[officeClientConfiguration](../resources/intune-cirrus-officeclientconfiguration.md)记录继承|
...
|说明|字符串|尚未从[officeClientConfiguration](../resources/intune-cirrus-officeclientconfiguration.md)记录继承|
|displayName|字符串|尚未从[officeClientConfiguration](../resources/intune-cirrus-officeclientconfiguration.md)记录继承|
