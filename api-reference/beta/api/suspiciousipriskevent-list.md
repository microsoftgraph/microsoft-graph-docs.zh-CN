...
---
# <a name="list-suspiciousipriskevents-deprecated"></a>列出 suspiciousIpRiskEvents (弃用) 
...
检索 suspiciousipriskevent 对象的列表。
...
如果成功，此方法 `200 OK` 在响应正文中返回响应代码和 [suspiciousIpRiskEvent](../resources/suspiciousipriskevent.md) 对象集合。
## <a name="example"></a>示例
##### <a name="request"></a>请求
下面是一个请求示例。
<!-- {
