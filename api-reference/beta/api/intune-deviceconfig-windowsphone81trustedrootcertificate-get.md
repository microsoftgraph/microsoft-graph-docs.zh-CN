...
读取 [windowsPhone81TrustedRootCertificate 对象的属性和](../resources/intune-deviceconfig-windowsphone81trustedrootcertificate.md) 关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [windowsPhone81TrustedRootCertificate](../resources/intune-deviceconfig-windowsphone81trustedrootcertificate.md) 对象。
