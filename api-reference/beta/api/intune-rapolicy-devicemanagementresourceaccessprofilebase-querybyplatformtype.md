...
如果成功，此操作在响应 `200 OK` 正文中返回iQueryable_1OfDeviceManagementResourceAccessProfileBase代码[](../resources/intune-rapolicy-iqueryable_1ofdevicemanagementresourceaccessprofilebase.md)和响应代码。
