---
title: 删除 ediscoveryHoldPolicy
description: 删除 ediscoveryHoldPolicy 对象。
author: SeunginLyu
...
ms.locfileid: "66837504"
---
# <a name="delete-ediscoveryholdpolicy"></a>删除 ediscoveryHoldPolicy
命名空间：microsoft.graph.security

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

删除 [ediscoveryHoldPolicy](../resources/security-ediscoveryholdpolicy.md) 对象。
