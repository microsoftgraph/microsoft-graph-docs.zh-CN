...
检索 [密码身份验证方法](../resources/passwordauthenticationmethod.md) 对象的列表。 这将只返回一个对象，因为用户只能有一个密码。
...
如果成功，此方法 `200 OK` 在响应正文中返回响应代码和 [passwordAuthenticationMethod](../resources/passwordauthenticationmethod.md) 对象集合。
