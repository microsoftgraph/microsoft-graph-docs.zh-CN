...
---
# <a name="list-b2cuserflows"></a>列出 b2cUserFlows

命名空间：microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

检索 [b2cUserFlow](../resources/b2cuserflows.md) 对象的列表。
...
如果成功，此方法 `200 OK` 在响应正文中返回响应代码和 [b2cUserFlow](../resources/b2cuserflows.md)  对象集合。

## <a name="examples"></a>示例

### <a name="example-1-list-all-b2cuserflows"></a>示例1：列出所有 b2cUserFlows
...
### <a name="example-2-list-all-b2cuserflows-and-expand-identityproviders"></a>示例2：列出所有 b2cUserFlows 并展开 identityProviders
