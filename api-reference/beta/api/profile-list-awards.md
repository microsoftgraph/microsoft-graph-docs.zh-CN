---
title: 列出奖励
description: 从导航属性获取 personAwards 集合。
...
ms.locfileid: "62108193"
---
# <a name="list-awards"></a>列出奖励

命名空间：microsoft.graph

从用户配置文件 [中检索 personAward](../resources/personaward.md) 对象 [的列表](../resources/profile.md)。
...
如果成功，此方法在响应 `200 OK` 正文中返回 响应代码和 [personAward](../resources/personaward.md) 对象集合。
