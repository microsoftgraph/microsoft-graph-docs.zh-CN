...
更新 [windowsStoreApp 对象](../resources/intune-apps-windowsstoreapp.md) 的属性。
...
如果成功，此方法在响应 `200 OK` 正文中返回 响应代码和更新的 [windowsStoreApp](../resources/intune-apps-windowsstoreapp.md) 对象。
