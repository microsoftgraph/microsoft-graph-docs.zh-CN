...
读取用户的[配置文件](../resources/profile.md)中的[personResponsibility](../resources/personresponsibility.md)对象的属性和关系。
...
如果成功，此方法 `200 OK` 在响应正文中返回响应代码和 [personResponsibility](../resources/personresponsibility.md) 对象。
