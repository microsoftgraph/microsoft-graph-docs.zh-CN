...
---
# <a name="get-devicemanagementdomainjoinconnector"></a>获取 deviceManagementDomainJoinConnector
...
读取 [deviceManagementDomainJoinConnector 对象的属性和](../resources/intune-odj-devicemanagementdomainjoinconnector.md) 关系。
...
如果成功，此方法在响应正文 `200 OK` 中返回 响应代码 [和 deviceManagementDomainJoinConnector](../resources/intune-odj-devicemanagementdomainjoinconnector.md) 对象。
