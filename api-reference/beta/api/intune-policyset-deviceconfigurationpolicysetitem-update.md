...
更新 [deviceConfigurationPolicySetItem 对象](../resources/intune-policyset-deviceconfigurationpolicysetitem.md) 的属性。
...
下表显示创建 [deviceConfigurationPolicySetItem 时所需的属性](../resources/intune-policyset-deviceconfigurationpolicysetitem.md)。
...
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [deviceConfigurationPolicySetItem](../resources/intune-policyset-deviceconfigurationpolicysetitem.md) 对象。
