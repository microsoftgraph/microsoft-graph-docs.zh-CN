---
title: 获取 oemWarrantyInformationOnboarding
description: 读取 oemWarrantyInformationOnboarding 对象的属性和关系。
author: dougeby
...
ms.locfileid: "62292280"
---
# <a name="get-oemwarrantyinformationonboarding"></a>获取 oemWarrantyInformationOnboarding
...
读取 [oemWarrantyInformationOnboarding 对象的属性和](../resources/intune-devices-oemwarrantyinformationonboarding.md) 关系。
...
如果成功，此方法在响应 `200 OK` 正文中返回 响应代码和 [oemWarrantyInformationOnboarding](../resources/intune-devices-oemwarrantyinformationonboarding.md) 对象。
