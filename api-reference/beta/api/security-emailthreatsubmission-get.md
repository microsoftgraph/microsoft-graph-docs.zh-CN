---
title: 获取 emailThreatSubmission
description: 读取 emailThreatSubmission 对象的属性和关系。
author: caigen
...
ms.locfileid: "66856535"
---
# <a name="get-emailthreatsubmission"></a>获取 emailThreatSubmission
命名空间：microsoft.graph.security

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

读取 [emailThreatSubmission](../resources/security-emailthreatsubmission.md) 对象的属性和关系。
...
如果成功，此方法在响应正文中返回 `200 OK` 响应代码和 [emailThreatSubmission](../resources/security-emailthreatsubmission.md) 对象。
