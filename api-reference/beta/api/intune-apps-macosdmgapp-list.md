---
title: 列出 macOSDmgApps
description: 列出 macOSDmgApp 对象的属性和关系。
author: dougeby
...
ms.locfileid: "61712162"
---
# <a name="list-macosdmgapps"></a>列出 macOSDmgApps
...
列出 [macOSDmgApp](../resources/intune-apps-macosdmgapp.md) 对象的属性和关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [macOSDmgApp](../resources/intune-apps-macosdmgapp.md) 对象集合。
