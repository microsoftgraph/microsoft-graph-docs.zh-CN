...
创建新的 [managedIOSLobApp](../resources/intune-apps-managedioslobapp.md) 对象。
...
在请求正文中，提供 managedIOSLobApp 对象的 JSON 表示形式。

下表显示创建 managedIOSLobApp 时所需的属性。
...
如果成功，此方法会在响应正文中返回 `201 Created` 响应代码和 [managedIOSLobApp](../resources/intune-apps-managedioslobapp.md) 对象。
