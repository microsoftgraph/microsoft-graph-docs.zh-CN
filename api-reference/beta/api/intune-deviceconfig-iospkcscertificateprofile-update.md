...
更新 [iosPkcsCertificateProfile 对象](../resources/intune-deviceconfig-iospkcscertificateprofile.md) 的属性。
...
下表显示创建 [iosPkcsCertificateProfile 时所需的属性](../resources/intune-deviceconfig-iospkcscertificateprofile.md)。
...
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [iosPkcsCertificateProfile](../resources/intune-deviceconfig-iospkcscertificateprofile.md) 对象。
