...
ms.locfileid: "58792265"
---
# <a name="update-windowsautopilotdeploymentprofilepolicysetitem"></a>更新 windowsAutopilotDeploymentProfilePolicySetItem
...
更新 [windowsAutopilotDeploymentProfilePolicySetItem 对象](../resources/intune-policyset-windowsautopilotdeploymentprofilepolicysetitem.md) 的属性。
...
在请求正文中，提供 [windowsAutopilotDeploymentProfilePolicySetItem](../resources/intune-policyset-windowsautopilotdeploymentprofilepolicysetitem.md) 对象的 JSON 表示形式。

下表显示创建 [windowsAutopilotDeploymentProfilePolicySetItem 时所需的属性](../resources/intune-policyset-windowsautopilotdeploymentprofilepolicysetitem.md)。
...
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [windowsAutopilotDeploymentProfilePolicySetItem](../resources/intune-policyset-windowsautopilotdeploymentprofilepolicysetitem.md) 对象。
