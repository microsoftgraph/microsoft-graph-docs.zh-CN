---
title: getOperationsRequiringApproval 函数
description: 尚未记录
author: dougeby
...
ms.locfileid: "60486833"
---
# <a name="getoperationsrequiringapproval-function"></a>getOperationsRequiringApproval 函数
...
如果成功，此函数在响应 `200 OK` 正文中返回 响应代码和 [operationApprovalPolicySet](../resources/intune-rbac-operationapprovalpolicyset.md) 集合。
