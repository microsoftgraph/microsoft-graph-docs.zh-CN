...
在用户的[配置文件](../resources/profile.md)中检索[userAccountInformation](../resources/useraccountinformation.md)对象的属性和关系。
...
如果成功，此方法 `200 OK` 在响应正文中返回响应代码和请求的 [userAccountInformation](../resources/useraccountinformation.md) 对象。
