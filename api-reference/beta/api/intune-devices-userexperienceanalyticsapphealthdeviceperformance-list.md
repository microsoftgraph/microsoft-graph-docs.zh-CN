...
ms.locfileid: "59018276"
---
# <a name="list-userexperienceanalyticsapphealthdeviceperformances"></a>列出 userExperienceAnalyticsAppHealthDevicePerformances
...
列出 [userExperienceAnalyticsAppHealthDevicePerformance 对象的属性和](../resources/intune-devices-userexperienceanalyticsapphealthdeviceperformance.md) 关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [userExperienceAnalyticsAppHealthDevicePerformance](../resources/intune-devices-userexperienceanalyticsapphealthdeviceperformance.md) 对象集合。
