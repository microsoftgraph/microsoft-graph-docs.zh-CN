...
更新 [windowsAppX 对象](../resources/intune-apps-windowsappx.md) 的属性。
...
在请求正文中，提供 [windowsAppX](../resources/intune-apps-windowsappx.md) 对象的 JSON 表示形式。

下表显示创建 [windowsAppX](../resources/intune-apps-windowsappx.md)时所需的属性。
...
如果成功，此方法在响应 `200 OK` 正文中返回 响应代码和更新的 [windowsAppX](../resources/intune-apps-windowsappx.md) 对象。
