...
---
# <a name="create-androiddeviceownerpkcscertificateprofile"></a>创建 androidDeviceOwnerPkcsCertificateProfile
...
创建新的 [androidDeviceOwnerPkcsCertificateProfile](../resources/intune-deviceconfig-androiddeviceownerpkcscertificateprofile.md) 对象。
...
在请求正文中，提供 androidDeviceOwnerPkcsCertificateProfile 对象的 JSON 表示形式。

下表显示创建 androidDeviceOwnerPkcsCertificateProfile 时所需的属性。
...
如果成功，此方法在响应正文中返回 响应代码和 `201 Created` [androidDeviceOwnerPkcsCertificateProfile](../resources/intune-deviceconfig-androiddeviceownerpkcscertificateprofile.md) 对象。
