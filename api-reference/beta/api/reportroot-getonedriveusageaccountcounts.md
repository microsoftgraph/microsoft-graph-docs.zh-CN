...
<span data-ttu-id="160c6-170">下面展示了示例响应。</span><span class="sxs-lookup"><span data-stu-id="160c6-170">The following is an example of the response.</span></span>
