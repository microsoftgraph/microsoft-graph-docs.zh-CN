---
title: 创建 windowsWebApp
description: 创建新的 windowsWebApp 对象。
author: dougeby
...
ms.locfileid: "65858534"
---
# <a name="create-windowswebapp"></a>创建 windowsWebApp
...
创建新的 [windowsWebApp](../resources/intune-apps-windowswebapp.md) 对象。
...
在请求正文中，为 windowsWebApp 对象提供 JSON 表示形式。

下表显示了创建 windowsWebApp 时所需的属性。
...
如果成功，此方法在响应正文中返回 `201 Created` 响应代码和 [windowsWebApp](../resources/intune-apps-windowswebapp.md) 对象。
