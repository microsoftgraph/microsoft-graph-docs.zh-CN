...
在请求正文中，提供一个 [patchContentCommand](../resources/patchcontentcommand.md) 对象数组，这些对象代表对页面的更改。 有关详细信息和示例，请参阅更新[OneNote页面内容](/graph/onenote-update-page)。
