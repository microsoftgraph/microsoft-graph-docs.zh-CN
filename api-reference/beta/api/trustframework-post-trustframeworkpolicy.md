...
description: 此操作在 B2C 租户中创建新的 trustFrameworkPolicy Azure AD对象。
...
在请求正文中，提供 [trustFrameworkPolicy 对象的](../resources/trustframeworkpolicy.md) XML 表示形式。 内容类型必须是 `application/xml`。

## <a name="response"></a>响应

如果成功，此方法在响应 `201 Created` 正文中返回 响应代码和 [trustFrameworkPolicy](../resources/trustframeworkpolicy.md) 对象。 如果失败，将返回 `4xx` 错误并显示具体详细信息。

## <a name="example"></a>示例

以下示例创建 **trustFrameworkPolicy**。
