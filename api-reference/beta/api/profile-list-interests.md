...
从用户的[配置文件](../resources/profile.md)中检索[personInterest](../resources/personinterest.md)对象的列表。
...
如果成功，此方法在响应`200 OK`正文中返回响应代码和[personInterest](../resources/personinterest.md)对象集合。
