---
title: 列出 userExperienceAnalyticsWorkFromAnywhereModelPerformances
description: 列出 userExperienceAnalyticsWorkFromAnywhereModelPerformance 对象的属性和关系。
author: dougeby
...
ms.locfileid: "62292279"
---
# <a name="list-userexperienceanalyticsworkfromanywheremodelperformances"></a>列出 userExperienceAnalyticsWorkFromAnywhereModelPerformances
...
列出 [userExperienceAnalyticsWorkFromAnywhereModelPerformance 对象的属性和](../resources/intune-devices-userexperienceanalyticsworkfromanywheremodelperformance.md) 关系。
...
如果成功，此方法在响应 `200 OK` 正文中返回 响应代码和 [userExperienceAnalyticsWorkFromAnywhereModelPerformance](../resources/intune-devices-userexperienceanalyticsworkfromanywheremodelperformance.md) 对象集合。
