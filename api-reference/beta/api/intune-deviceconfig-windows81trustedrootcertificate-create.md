...
下表显示创建 windows81TrustedRootCertificate 时所需的属性。
...
如果成功，此方法在响应正文中返回 响应 `201 Created` 代码和 [windows81TrustedRootCertificate](../resources/intune-deviceconfig-windows81trustedrootcertificate.md) 对象。
