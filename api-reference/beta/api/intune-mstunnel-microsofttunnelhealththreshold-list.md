...
列出 [microsoftTunnelHealthThreshold 对象的属性和](../resources/intune-mstunnel-microsofttunnelhealththreshold.md) 关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [microsoftTunnelHealthThreshold](../resources/intune-mstunnel-microsofttunnelhealththreshold.md) 对象集合。
