...
ms.locfileid: "54170998"
---
# <a name="get-microsofttunnelserver"></a>获取 microsoftTunnelServer
...
读取 [microsoftTunnelServer 对象的属性和](../resources/intune-mstunnel-microsofttunnelserver.md) 关系。
...
如果成功，此方法在响应 `200 OK` 正文中返回 响应代码和 [microsoftTunnelServer](../resources/intune-mstunnel-microsofttunnelserver.md) 对象。
