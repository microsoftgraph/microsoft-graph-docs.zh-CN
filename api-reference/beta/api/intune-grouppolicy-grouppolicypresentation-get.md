...
读取属性和[groupPolicyPresentation](../resources/intune-grouppolicy-grouppolicypresentation.md)对象的关系。
...
如果成功，此方法返回`200 OK`响应正文中的响应代码和[groupPolicyPresentation](../resources/intune-grouppolicy-grouppolicypresentation.md)对象。
