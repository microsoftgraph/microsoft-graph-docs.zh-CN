...
删除附加到[作业的特定 educationAssignmentResource。](../resources/educationassignmentresource.md) 只有班级中的教师可以删除资源。 向学生发布作业后，教师无法删除标记为"distributeToStudents"的资源。
