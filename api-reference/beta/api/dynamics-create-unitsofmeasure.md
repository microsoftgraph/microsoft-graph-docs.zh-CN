...
---
# <a name="create-unitsofmeasure"></a>创建 unitsOfMeasure
在 Dynamics 365 Business Central 中创建度量单位对象。
...
在请求正文中, 提供**unitsOfMeasure**对象的 JSON 表示形式。

## <a name="response"></a>响应
如果成功, 此方法在```201 Created```响应正文中返回响应代码和**unitsOfMeasure**对象。
