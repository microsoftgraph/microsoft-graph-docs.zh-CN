...
更新 [groupPolicyPresentationValueMultiText 对象](../resources/intune-grouppolicy-grouppolicypresentationvaluemultitext.md) 的属性。
...
|值|String collection|关联的演示文稿的非空字符串的集合。|



## <a name="response"></a>响应
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [groupPolicyPresentationValueMultiText](../resources/intune-grouppolicy-grouppolicypresentationvaluemultitext.md) 对象。
