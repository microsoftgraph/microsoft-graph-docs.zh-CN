...
更新 [groupPolicyPresentationComboBox 对象](../resources/intune-grouppolicy-grouppolicypresentationcombobox.md) 的属性。
...
下表显示创建 [groupPolicyPresentationComboBox 时所需的属性](../resources/intune-grouppolicy-grouppolicypresentationcombobox.md)。
...
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [groupPolicyPresentationComboBox](../resources/intune-grouppolicy-grouppolicypresentationcombobox.md) 对象。
