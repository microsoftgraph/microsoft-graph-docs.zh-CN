...
如果成功，此操作在响应正文中返回 响应代码和 `200 OK` [importedAppleDeviceIdentityResult](../resources/intune-enrollment-importedappledeviceidentityresult.md) 集合。
