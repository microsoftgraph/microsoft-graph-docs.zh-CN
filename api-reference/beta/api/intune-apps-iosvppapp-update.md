...
更新 [iosVppApp](../resources/intune-apps-iosvppapp.md) 对象的属性。
...
在请求正文中，提供 [iosVppApp](../resources/intune-apps-iosvppapp.md) 对象的 JSON 表示形式。

下表显示了创建 [iosVppApp](../resources/intune-apps-iosvppapp.md) 时所需的属性。
...
|bundleId|字符串|标识名称。|
|vppTokenId|字符串|与此应用程序关联的 VPP 令牌的标识符。|
|revokeLicenseActionResults|[iosVppAppRevokeLicensesActionResult](../resources/intune-apps-iosvppapprevokelicensesactionresult.md)集合|对此应用吊销许可证操作的结果。|



## <a name="response"></a>响应
如果成功，此方法在响应正文中返回 `200 OK` 响应代码和更新的 [iosVppApp](../resources/intune-apps-iosvppapp.md) 对象。
