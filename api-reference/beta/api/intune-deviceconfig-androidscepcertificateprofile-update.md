...
更新 [androidScepCertificateProfile 对象](../resources/intune-deviceconfig-androidscepcertificateprofile.md) 的属性。
...
下表显示创建 [androidScepCertificateProfile 时所需的属性](../resources/intune-deviceconfig-androidscepcertificateprofile.md)。
...
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [androidScepCertificateProfile](../resources/intune-deviceconfig-androidscepcertificateprofile.md) 对象。
