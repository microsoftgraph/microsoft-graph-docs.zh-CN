...
---
# <a name="update-androidworkprofilenineworkeasconfiguration"></a>更新 androidWorkProfileNineWorkEasConfiguration

> **重要说明:**/beta 版本下的 Microsoft Graph api 可能会发生更改;不支持生产使用。

> **注意:** 适用于 Intune 的 Microsoft Graph API 需要租户的[活动 Intune 许可证](https://go.microsoft.com/fwlink/?linkid=839381)。

更新[androidWorkProfileNineWorkEasConfiguration](../resources/intune-deviceconfig-androidworkprofilenineworkeasconfiguration.md)对象的属性。
...
在请求正文中, 提供[androidWorkProfileNineWorkEasConfiguration](../resources/intune-deviceconfig-androidworkprofilenineworkeasconfiguration.md)对象的 JSON 表示形式。

下表显示创建[androidWorkProfileNineWorkEasConfiguration](../resources/intune-deviceconfig-androidworkprofilenineworkeasconfiguration.md)时所需的属性。
...
|syncCalendar|布尔|切换同步日历。 如果设置为 false, 则表示设备上的日历处于关闭状态。|
|syncContacts|布尔|切换同步联系人。 如果设置为 false, 则设备上的联系人处于关闭状态。|
|syncTasks|布尔|切换同步任务。 如果设备上的 "设置为 false 任务" 处于关闭状态。|



## <a name="response"></a>响应
如果成功, 此方法在响应`200 OK`正文中返回响应代码和更新的[androidWorkProfileNineWorkEasConfiguration](../resources/intune-deviceconfig-androidworkprofilenineworkeasconfiguration.md)对象。
