...
下表显示时创建[androidWorkProfileNineWorkEasConfiguration](../resources/intune-deviceconfig-androidworkprofilenineworkeasconfiguration.md)所需的属性。
...
|requireSsl|布尔值|指示使用 SSL。 继承自[androidWorkProfileEasEmailProfileBase](../resources/intune-deviceconfig-androidworkprofileeasemailprofilebase.md)|
...
|syncCalendar|布尔值|同步日历的切换。 如果设置为 false 日历已在设备上关闭。|
|syncContacts|布尔值|切换同步联系人。 如果设置为 false 的联系人设备上关闭。|
|syncTasks|布尔值|同步任务的切换。 如果设置为 false 的任务在设备上关闭。|



## <a name="response"></a>响应
如果成功，此方法返回`200 OK`响应代码和响应正文中的更新的[androidWorkProfileNineWorkEasConfiguration](../resources/intune-deviceconfig-androidworkprofilenineworkeasconfiguration.md)对象。
