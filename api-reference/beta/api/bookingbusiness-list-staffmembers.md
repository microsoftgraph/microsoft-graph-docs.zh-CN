...
指定[bookingbusiness](../resources/bookingbusiness.md)中获取[bookingStaffMember](../resources/bookingstaffmember.md)对象的列表。
...
如果成功，此方法返回`200 OK`响应代码和响应正文中的[bookingStaffMember](../resources/bookingstaffmember.md)对象的集合。
## <a name="example"></a>示例
##### <a name="request"></a>请求
下面展示了示例请求。
<!-- {
