...
下表显示时创建 depIOSEnrollmentProfile 所需的属性。
...
|enableSingleAppEnrollmentMode|布尔|通知要启用单个应用程序模式并应用在注册期间应用锁的设备。 默认值为 false。 必须为要设置此属性设置 enableAuthenticationViaCompanyPortal' 和 'companyPortalVppTokenId。|



## <a name="response"></a>响应
如果成功，此方法返回`201 Created`响应代码和响应正文中的[depIOSEnrollmentProfile](../resources/intune-enrollment-depiosenrollmentprofile.md)对象。
