...
ms.locfileid: "59043026"
---
# <a name="create-aospdeviceownercompliancepolicy"></a>创建 aospDeviceOwnerCompliancePolicy
...
创建新的 [aospDeviceOwnerCompliancePolicy](../resources/intune-deviceconfig-aospdeviceownercompliancepolicy.md) 对象。
...
在请求正文中，提供 aospDeviceOwnerCompliancePolicy 对象的 JSON 表示形式。

下表显示创建 aospDeviceOwnerCompliancePolicy 时所需的属性。
...
如果成功，此方法在响应正文中返回 响应代码和 `201 Created` [aospDeviceOwnerCompliancePolicy](../resources/intune-deviceconfig-aospdeviceownercompliancepolicy.md) 对象。
