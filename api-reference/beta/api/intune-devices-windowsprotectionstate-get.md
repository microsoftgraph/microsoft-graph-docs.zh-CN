...
读取 [windowsProtectionState 对象的属性和](../resources/intune-devices-windowsprotectionstate.md) 关系。
...
如果成功，此方法在响应 `200 OK` 正文中返回 响应代码和 [windowsProtectionState](../resources/intune-devices-windowsprotectionstate.md) 对象。
