...
description: 触发SharePoint资源文件夹的创建，其中所有基于文件的资源 (Word、Excel 等) 应上载给定提交。
...
触发SharePoint资源文件夹的创建，其中所有基于文件的资源 (Word、Excel 等) 应上载给定提交。

请注意，文件必须位于此文件夹中才能添加为资源。 只有班级的学生才能确定要在给定提交级别资源文件夹中上传的文件。 
