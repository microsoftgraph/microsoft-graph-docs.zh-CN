...
ms.locfileid: "58797603"
---
# <a name="list-windows10xtrustedrootcertificates"></a>列出 windows10XTrustedRootCertificates
...
列出 [windows10XTrustedRootCertificate 对象的属性和](../resources/intune-rapolicy-windows10xtrustedrootcertificate.md) 关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [windows10XTrustedRootCertificate](../resources/intune-rapolicy-windows10xtrustedrootcertificate.md) 对象集合。
