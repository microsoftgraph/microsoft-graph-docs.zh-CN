...
取消设置之前在[应用程序上设置的 verifiedPublisher](../resources/verifiedPublisher.md)，[](../resources/application.md)删除所有已验证的发布者属性。 有关详细信息，请参阅Publisher[验证](/azure/active-directory/develop/publisher-verification-overview)。
