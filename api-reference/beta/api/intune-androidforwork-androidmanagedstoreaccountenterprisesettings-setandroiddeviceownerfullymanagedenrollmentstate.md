...
将 AndroidManagedStoreAccountEnterpriseSettings AndroidDeviceOwnerFullyManagedEnrollmentEnabled 设置为给定值。
...
|属性|类型|说明|
|:---|:---|:---|
|已启用|Boolean|要将 AndroidDeviceOwnerFullyManagedEnrollmentEnabled 设置为的值。|
