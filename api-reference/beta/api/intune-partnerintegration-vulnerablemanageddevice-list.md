...
ms.locfileid: "60479175"
---
# <a name="list-vulnerablemanageddevices"></a>列出 vulnerableManagedDevices
...
列出 [vulnerableManagedDevice 对象的属性和](../resources/intune-partnerintegration-vulnerablemanageddevice.md) 关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [vulnerableManagedDevice](../resources/intune-partnerintegration-vulnerablemanageddevice.md) 对象集合。
