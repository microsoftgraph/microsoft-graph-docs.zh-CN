---
title: 更新 iosiPadOSWebClip
description: 更新 iosiPadOSWebClip 对象的属性。
author: dougeby
...
ms.locfileid: "65858562"
---
# <a name="update-iosipadoswebclip"></a>更新 iosiPadOSWebClip
...
更新 [iosiPadOSWebClip 对象的](../resources/intune-apps-iosipadoswebclip.md) 属性。
...
在请求正文中，为 [iosiPadOSWebClip](../resources/intune-apps-iosipadoswebclip.md) 对象提供 JSON 表示形式。

下表显示了创建 [iosiPadOSWebClip](../resources/intune-apps-iosipadoswebclip.md) 时所需的属性。
...
如果成功，此方法在响应正文中返回 `200 OK` 响应代码和更新的 [iosiPadOSWebClip](../resources/intune-apps-iosipadoswebclip.md) 对象。
