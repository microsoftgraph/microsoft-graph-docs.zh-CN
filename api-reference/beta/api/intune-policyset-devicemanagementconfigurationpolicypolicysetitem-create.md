---
title: 创建 deviceManagementConfigurationPolicyPolicySetItem
description: 创建新的 deviceManagementConfigurationPolicyPolicySetItem 对象。
author: dougeby
...
ms.locfileid: "58804895"
---
# <a name="create-devicemanagementconfigurationpolicypolicysetitem"></a>创建 deviceManagementConfigurationPolicyPolicySetItem
...
创建新的 [deviceManagementConfigurationPolicyPolicySetItem](../resources/intune-policyset-devicemanagementconfigurationpolicypolicysetitem.md) 对象。
...
在请求正文中，提供 deviceManagementConfigurationPolicyPolicySetItem 对象的 JSON 表示形式。

下表显示创建 deviceManagementConfigurationPolicyPolicySetItem 时所需的属性。
...
如果成功，此方法在响应正文中返回 响应代码和 `201 Created` [deviceManagementConfigurationPolicyPolicySetItem](../resources/intune-policyset-devicemanagementconfigurationpolicypolicysetitem.md) 对象。
