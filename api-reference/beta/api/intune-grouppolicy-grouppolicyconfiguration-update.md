...
更新 [groupPolicyConfiguration 对象](../resources/intune-grouppolicy-grouppolicyconfiguration.md) 的属性。
...
下表显示创建 [groupPolicyConfiguration 时所需的属性](../resources/intune-grouppolicy-grouppolicyconfiguration.md)。
...
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [groupPolicyConfiguration](../resources/intune-grouppolicy-grouppolicyconfiguration.md) 对象。
