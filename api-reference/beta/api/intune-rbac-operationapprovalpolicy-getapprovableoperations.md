---
title: getApprovableOperations 函数
description: 尚未记录
author: dougeby
...
ms.locfileid: "65213009"
---
# <a name="getapprovableoperations-function"></a>getApprovableOperations 函数
...
如果成功，此函数在响应正文中返回 `200 OK` 响应代码和 [operationApprovalPolicySet](../resources/intune-rbac-operationapprovalpolicyset.md) 集合。
