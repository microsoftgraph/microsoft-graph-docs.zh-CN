---
title: 创建 hardwareConfigurationDeviceState
description: 创建新的 hardwareConfigurationDeviceState 对象。
author: dougeby
...
创建新的 [hardwareConfigurationDeviceState](../resources/intune-deviceconfig-hardwareconfigurationdevicestate.md) 对象。
...
在请求正文中，提供 hardwareConfigurationDeviceState 对象的 JSON 表示形式。

下表显示创建 hardwareConfigurationDeviceState 时所需的属性。
