...
获取与[频道](../resources/channel.md)共享的[团队](../resources/sharedwithchannelteaminfo.md)列表。 此操作仅允许 **具有 membershipType** 值的 `shared`通道执行。
...
如果成功，此方法在响应正文中返回 `200 OK` 响应代码和 [sharedWithChannelTeamInfo](../resources/sharedwithchannelteaminfo.md) 对象的集合。
