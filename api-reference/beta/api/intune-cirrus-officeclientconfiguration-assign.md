...
---
# <a name="office-client-configuration-assign--assign-action"></a>Office客户端配置分配操作
...
如果成功，此操作在响应正文中返回 响应代码和 `200 OK` [officeClientConfigurationAssignment](../resources/intune-cirrus-officeclientconfigurationassignment.md) 集合。
