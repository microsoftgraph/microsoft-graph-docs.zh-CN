...
更新 [macOSImportedPFXCertificateProfile 对象](../resources/intune-deviceconfig-macosimportedpfxcertificateprofile.md) 的属性。
...
下表显示创建 [macOSImportedPFXCertificateProfile 时所需的属性](../resources/intune-deviceconfig-macosimportedpfxcertificateprofile.md)。
...
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [macOSImportedPFXCertificateProfile](../resources/intune-deviceconfig-macosimportedpfxcertificateprofile.md) 对象。
