...
读取 [appleEnrollmentProfileAssignment 对象的属性和](../resources/intune-enrollment-appleenrollmentprofileassignment.md) 关系。
...
如果成功，此方法在响应 `200 OK` 正文中返回 响应代码和 [appleEnrollmentProfileAssignment](../resources/intune-enrollment-appleenrollmentprofileassignment.md) 对象。
