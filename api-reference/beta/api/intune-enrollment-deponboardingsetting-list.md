...
列出 [depOnboardingSetting 对象的属性和](../resources/intune-enrollment-deponboardingsetting.md) 关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [depOnboardingSetting](../resources/intune-enrollment-deponboardingsetting.md) 对象集合。
