---
title: 列出 zebraFotaDeployments
description: 列出 zebraFotaDeployment 对象的属性和关系。
author: dougeby
...
ms.locfileid: "65213036"
---
# <a name="list-zebrafotadeployments"></a>列出 zebraFotaDeployments
...
列出 [zebraFotaDeployment](../resources/intune-androidfotaservice-zebrafotadeployment.md) 对象的属性和关系。
...
如果成功，此方法在响应正文中返回 `200 OK` 响应代码和 [zebraFotaDeployment](../resources/intune-androidfotaservice-zebrafotadeployment.md) 对象集合。
