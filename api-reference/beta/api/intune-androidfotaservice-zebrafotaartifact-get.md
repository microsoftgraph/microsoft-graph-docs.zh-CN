---
title: 获取 zebraFotaArtifact
description: 读取 zebraFotaArtifact 对象的属性和关系。
author: dougeby
...
ms.locfileid: "65213021"
---
# <a name="get-zebrafotaartifact"></a>获取 zebraFotaArtifact
...
读取 [zebraFotaArtifact](../resources/intune-androidfotaservice-zebrafotaartifact.md) 对象的属性和关系。
...
如果成功，此方法在响应正文中返回 `200 OK` 响应代码和 [zebraFotaArtifact](../resources/intune-androidfotaservice-zebrafotaartifact.md) 对象。
