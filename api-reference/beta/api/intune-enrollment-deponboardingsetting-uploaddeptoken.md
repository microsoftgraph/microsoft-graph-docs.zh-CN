...
---
# <a name="uploaddeptoken-action"></a><span data-ttu-id="ca221-103">uploadDepToken 操作</span><span class="sxs-lookup"><span data-stu-id="ca221-103">uploadDepToken action</span></span>
...
<span data-ttu-id="ca221-107">上传新的设备注册程序令牌</span><span class="sxs-lookup"><span data-stu-id="ca221-107">Uploads a new Device Enrollment Program token</span></span>
...
|:---|:---|
|<span data-ttu-id="ca221-113">委派（工作或学校帐户）</span><span class="sxs-lookup"><span data-stu-id="ca221-113">Delegated (work or school account)</span></span>|<span data-ttu-id="ca221-114">DeviceManagementServiceConfig.ReadWrite.All</span><span class="sxs-lookup"><span data-stu-id="ca221-114">DeviceManagementServiceConfig.ReadWrite.All</span></span>|
...
|<span data-ttu-id="ca221-117">应用程序</span><span class="sxs-lookup"><span data-stu-id="ca221-117">Application</span></span>|<span data-ttu-id="ca221-118">DeviceManagementServiceConfig.ReadWrite.All</span><span class="sxs-lookup"><span data-stu-id="ca221-118">DeviceManagementServiceConfig.ReadWrite.All</span></span>|
...
<span data-ttu-id="ca221-128">在请求正文中，提供参数的 JSON 表示形式。</span><span class="sxs-lookup"><span data-stu-id="ca221-128">In the request body, supply JSON representation of the parameters.</span></span>

<span data-ttu-id="ca221-129">下表显示了可用于此操作的参数。</span><span class="sxs-lookup"><span data-stu-id="ca221-129">The following table shows the parameters that can be used with this action.</span></span>

|<span data-ttu-id="ca221-130">属性</span><span class="sxs-lookup"><span data-stu-id="ca221-130">Property</span></span>|<span data-ttu-id="ca221-131">类型</span><span class="sxs-lookup"><span data-stu-id="ca221-131">Type</span></span>|<span data-ttu-id="ca221-132">说明</span><span class="sxs-lookup"><span data-stu-id="ca221-132">Description</span></span>|
|:---|:---|:---|
|<span data-ttu-id="ca221-133">appleId</span><span class="sxs-lookup"><span data-stu-id="ca221-133">appleId</span></span>|<span data-ttu-id="ca221-134">String</span><span class="sxs-lookup"><span data-stu-id="ca221-134">String</span></span>|<span data-ttu-id="ca221-135">尚未记录</span><span class="sxs-lookup"><span data-stu-id="ca221-135">Not yet documented</span></span>|
|<span data-ttu-id="ca221-136">depToken</span><span class="sxs-lookup"><span data-stu-id="ca221-136">depToken</span></span>|<span data-ttu-id="ca221-137">String</span><span class="sxs-lookup"><span data-stu-id="ca221-137">String</span></span>|<span data-ttu-id="ca221-138">尚未记录</span><span class="sxs-lookup"><span data-stu-id="ca221-138">Not yet documented</span></span>|



## <a name="response"></a><span data-ttu-id="ca221-139">响应</span><span class="sxs-lookup"><span data-stu-id="ca221-139">Response</span></span>
<span data-ttu-id="ca221-140">如果成功，此操作返回 `204 No Content` 响应代码。</span><span class="sxs-lookup"><span data-stu-id="ca221-140">If successful, this action returns a `204 No Content` response code.</span></span>

## <a name="example"></a><span data-ttu-id="ca221-141">示例</span><span class="sxs-lookup"><span data-stu-id="ca221-141">Example</span></span>

### <a name="request"></a><span data-ttu-id="ca221-142">请求</span><span class="sxs-lookup"><span data-stu-id="ca221-142">Request</span></span>
<span data-ttu-id="ca221-143">下面是一个请求示例。</span><span class="sxs-lookup"><span data-stu-id="ca221-143">Here is an example of the request.</span></span>
``` http
...
### <a name="response"></a><span data-ttu-id="ca221-144">响应</span><span class="sxs-lookup"><span data-stu-id="ca221-144">Response</span></span>
