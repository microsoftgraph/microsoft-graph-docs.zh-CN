...
ms.locfileid: "59043157"
---
# <a name="update-androiddeviceownerscepcertificateprofile"></a>更新 androidDeviceOwnerScepCertificateProfile
...
更新 [androidDeviceOwnerScepCertificateProfile 对象](../resources/intune-deviceconfig-androiddeviceownerscepcertificateprofile.md) 的属性。
...
在请求正文中，提供 [androidDeviceOwnerScepCertificateProfile](../resources/intune-deviceconfig-androiddeviceownerscepcertificateprofile.md) 对象的 JSON 表示形式。

下表显示创建 [androidDeviceOwnerScepCertificateProfile 时所需的属性](../resources/intune-deviceconfig-androiddeviceownerscepcertificateprofile.md)。
...
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [androidDeviceOwnerScepCertificateProfile](../resources/intune-deviceconfig-androiddeviceownerscepcertificateprofile.md) 对象。
