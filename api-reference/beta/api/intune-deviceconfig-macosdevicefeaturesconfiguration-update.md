...
|shutDownDisabledWhileLoggedIn|Boolean|登录时是否禁用登录窗口上的"关闭"菜单项。|
...
|contentCachingPeerFilterRanges|[ipRange](../resources/intune-shared-iprange.md) 集合|自定义 IP 范围列表内容缓存将用于查询对等缓存中的内容。 该集合最多可包含 500 个元素。|
