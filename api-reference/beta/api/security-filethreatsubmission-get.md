---
title: 获取 fileThreatSubmission
description: 读取 fileThreatSubmission 对象的属性和关系。
author: caigen
...
ms.locfileid: "66856523"
---
# <a name="get-filethreatsubmission"></a>获取 fileThreatSubmission
命名空间：microsoft.graph.security

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

读取 [fileThreatSubmission](../resources/security-filethreatsubmission.md) 对象的属性和关系。
...
如果成功，此方法在响应正文中返回 `200 OK` 响应代码和 [fileThreatSubmission](../resources/security-filethreatsubmission.md) 对象。
