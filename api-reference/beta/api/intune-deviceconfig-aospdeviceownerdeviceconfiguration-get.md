...
读取 [aospDeviceOwnerDeviceConfiguration 对象的属性和](../resources/intune-deviceconfig-aospdeviceownerdeviceconfiguration.md) 关系。
...
如果成功，此方法在响应正文 `200 OK` 中返回 响应代码和 [aospDeviceOwnerDeviceConfiguration](../resources/intune-deviceconfig-aospdeviceownerdeviceconfiguration.md) 对象。
