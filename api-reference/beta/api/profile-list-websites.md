...
从用户配置文件中检索 [personWebsite](../resources/personwebsite.md) 对象 [的列表](../resources/profile.md)。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [personWebsite](../resources/personwebsite.md) 对象集合。
