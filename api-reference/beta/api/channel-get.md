...
|应用程序 | ChannelSettings、ChannelSettings、User.readbasic.all、ChannelSettings、 *, ChannelSettings.ReadWrite.Group* 、、group. all、group。 All、group。 all、all、all、all、all、All 和 all： all，all |
