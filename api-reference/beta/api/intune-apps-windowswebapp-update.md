---
title: 更新 windowsWebApp
description: 更新 windowsWebApp 对象的属性。
author: dougeby
...
ms.locfileid: "65858554"
---
# <a name="update-windowswebapp"></a>更新 windowsWebApp
...
更新 [windowsWebApp](../resources/intune-apps-windowswebapp.md) 对象的属性。
...
在请求正文中，为 [windowsWebApp](../resources/intune-apps-windowswebapp.md) 对象提供 JSON 表示形式。

下表显示了创建 [windowsWebApp](../resources/intune-apps-windowswebapp.md) 时所需的属性。
...
如果成功，此方法在响应正文中返回 `200 OK` 响应代码和更新的 [windowsWebApp](../resources/intune-apps-windowswebapp.md) 对象。
