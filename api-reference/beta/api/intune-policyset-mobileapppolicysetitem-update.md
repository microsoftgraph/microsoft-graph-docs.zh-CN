...
|intent|[installIntent](../resources/intune-shared-installintent.md)|MobileAppPolicySetItem 的安装意图。 可能的值是：`available`、`required`、`uninstall`、`availableWithoutEnrollment`。|
