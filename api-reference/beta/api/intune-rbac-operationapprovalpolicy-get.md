---
title: 获取 operationApprovalPolicy
description: 读取 operationApprovalPolicy 对象的属性和关系。
author: dougeby
...
ms.locfileid: "60487889"
---
# <a name="get-operationapprovalpolicy"></a>获取 operationApprovalPolicy
...
读取 [operationApprovalPolicy 对象的属性和](../resources/intune-rbac-operationapprovalpolicy.md) 关系。
...
如果成功，此方法在响应 `200 OK` 正文中返回 响应代码和 [operationApprovalPolicy](../resources/intune-rbac-operationapprovalpolicy.md) 对象。
