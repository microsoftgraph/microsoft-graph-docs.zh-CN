...
创建新的 [relation](../resources/termstore-relation.md) 对象。 它们用于在术语之间或术语和集之间创建固定和重复使用的关系。 在术语之间创建固定/重复使用的术语时，发布正文中的 then set fromTerm 必须为 null。
...
如果成功，此方法在响应 `201 Created` 正文中返回 [响应](../resources/termstore-relation.md) 代码和 relation 对象。
