...
ms.locfileid: "54181515"
---
# <a name="list-windows10xscepcertificateprofiles"></a>列出 windows10XSCEPCertificateProfiles
...
列出 [windows10XSCEPCertificateProfile](../resources/intune-rapolicy-windows10xscepcertificateprofile.md) 对象的属性和关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [windows10XSCEPCertificateProfile](../resources/intune-rapolicy-windows10xscepcertificateprofile.md) 对象集合。
