...
ms.locfileid: "42449255"
---
# <a name="update-devicecompliancescheduledactionforrule"></a><span data-ttu-id="65930-103">更新 deviceComplianceScheduledActionForRule</span><span class="sxs-lookup"><span data-stu-id="65930-103">Update deviceComplianceScheduledActionForRule</span></span>
...
<span data-ttu-id="65930-107">更新 [deviceComplianceScheduledActionForRule](../resources/intune-deviceconfig-devicecompliancescheduledactionforrule.md) 对象的属性。</span><span class="sxs-lookup"><span data-stu-id="65930-107">Update the properties of a [deviceComplianceScheduledActionForRule](../resources/intune-deviceconfig-devicecompliancescheduledactionforrule.md) object.</span></span>
...
<span data-ttu-id="65930-128">在请求正文中，提供 [deviceComplianceScheduledActionForRule](../resources/intune-deviceconfig-devicecompliancescheduledactionforrule.md) 对象的 JSON 表示形式。</span><span class="sxs-lookup"><span data-stu-id="65930-128">In the request body, supply a JSON representation for the [deviceComplianceScheduledActionForRule](../resources/intune-deviceconfig-devicecompliancescheduledactionforrule.md) object.</span></span>

<span data-ttu-id="65930-129">下表显示创建 [deviceComplianceScheduledActionForRule](../resources/intune-deviceconfig-devicecompliancescheduledactionforrule.md) 时所需的属性。</span><span class="sxs-lookup"><span data-stu-id="65930-129">The following table shows the properties that are required when you create the [deviceComplianceScheduledActionForRule](../resources/intune-deviceconfig-devicecompliancescheduledactionforrule.md).</span></span>
...
|:---|:---|:---|
|<span data-ttu-id="65930-133">id</span><span class="sxs-lookup"><span data-stu-id="65930-133">id</span></span>|<span data-ttu-id="65930-134">String</span><span class="sxs-lookup"><span data-stu-id="65930-134">String</span></span>|<span data-ttu-id="65930-135">实体的键。</span><span class="sxs-lookup"><span data-stu-id="65930-135">Key of the entity.</span></span>|
|<span data-ttu-id="65930-136">ruleName</span><span class="sxs-lookup"><span data-stu-id="65930-136">ruleName</span></span>|<span data-ttu-id="65930-137">String</span><span class="sxs-lookup"><span data-stu-id="65930-137">String</span></span>|<span data-ttu-id="65930-138">此计划操作适用的规则名称。</span><span class="sxs-lookup"><span data-stu-id="65930-138">Name of the rule which this scheduled action applies to.</span></span>|



## <a name="response"></a><span data-ttu-id="65930-139">响应</span><span class="sxs-lookup"><span data-stu-id="65930-139">Response</span></span>
<span data-ttu-id="65930-140">如果成功，此方法在响应正文中返回 `200 OK` 响应代码和更新的 [deviceComplianceScheduledActionForRule](../resources/intune-deviceconfig-devicecompliancescheduledactionforrule.md) 对象。</span><span class="sxs-lookup"><span data-stu-id="65930-140">If successful, this method returns a `200 OK` response code and an updated [deviceComplianceScheduledActionForRule](../resources/intune-deviceconfig-devicecompliancescheduledactionforrule.md) object in the response body.</span></span>

## <a name="example"></a><span data-ttu-id="65930-141">示例</span><span class="sxs-lookup"><span data-stu-id="65930-141">Example</span></span>

### <a name="request"></a><span data-ttu-id="65930-142">请求</span><span class="sxs-lookup"><span data-stu-id="65930-142">Request</span></span>
<span data-ttu-id="65930-143">下面是一个请求示例。</span><span class="sxs-lookup"><span data-stu-id="65930-143">Here is an example of the request.</span></span>
``` http
...
### <a name="response"></a><span data-ttu-id="65930-144">响应</span><span class="sxs-lookup"><span data-stu-id="65930-144">Response</span></span>
<span data-ttu-id="65930-p102">下面是一个响应示例。注意：为了简单起见，可能会将此处所示的响应对象截断。将从实际调用中返回所有属性。</span><span class="sxs-lookup"><span data-stu-id="65930-p102">Here is an example of the response. Note: The response object shown here may be truncated for brevity. All of the properties will be returned from an actual call.</span></span>
``` http
HTTP/1.1 200 OK
Content-Type: application/json
Content-Length: 163
