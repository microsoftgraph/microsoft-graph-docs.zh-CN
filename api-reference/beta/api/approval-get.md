...
在[Azure AD中](../resources/entitlementmanagement-overview.md)，检索审批[对象](../resources/approval.md)的属性。  此调用由审批者进行，提供访问包分配请求 [的标识符](../resources/accesspackageassignmentrequest.md)。
...
如果成功，此方法在响应 `200 OK` 正文中返回 响应代码和[](../resources/approval.md)请求的审批对象。 但是，如果调用方没有正确的权限，该方法将返回 响应 `403 Forbidden` 代码。
