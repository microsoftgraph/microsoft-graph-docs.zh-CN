...
|source|[deviceAndAppManagementAssignmentSource](../resources/intune-shared-deviceandappmanagementassignmentsource.md)|设备配置、直接或部署/策略集的分配源。 此属性是只读的。 可取值为：`direct`、`policySets`。|
