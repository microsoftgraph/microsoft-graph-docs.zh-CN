...
- 如果 [externalMeetingRegistration](../resources/externalmeetingregistration.md)对象的 **allowedRegistrant** 属性的值为 ，则提供外部注册系统的 `organization` **id、** 注册表用户的 **tenantId** 和 Azure Active Directory 中的 **userId。**
