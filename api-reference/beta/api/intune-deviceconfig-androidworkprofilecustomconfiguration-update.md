...
## <a name="http-request"></a><span data-ttu-id="ba5e9-119">HTTP 请求</span><span class="sxs-lookup"><span data-stu-id="ba5e9-119">HTTP Request</span></span>
<!-- {
  "blockType": "ignored"
}
-->
