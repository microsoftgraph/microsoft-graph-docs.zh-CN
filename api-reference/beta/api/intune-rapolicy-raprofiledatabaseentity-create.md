...
---
# <a name="create-raprofiledatabaseentity"></a>创建 raProfileDatabaseEntity
...
创建新的[raProfileDatabaseEntity](../resources/intune-rapolicy-raprofiledatabaseentity.md)对象。
...
在请求正文中，提供 raProfileDatabaseEntity 对象的 JSON 表示形式。

下表显示创建 raProfileDatabaseEntity 时所需的属性。
...
如果成功，此方法 `201 Created` 在响应正文中返回响应代码和[raProfileDatabaseEntity](../resources/intune-rapolicy-raprofiledatabaseentity.md)对象。
