...
description: 创建新的socialIdentityProvider 对象。
...
### <a name="example-1-create-a-role-assignment-in-intune-over-two-scope-groups-which-are-azure-ad-objects"></a>示例 1：在 Intune 角色分配两个作用域组上创建一个 (，这些作用域组是 Azure AD 对象) 
