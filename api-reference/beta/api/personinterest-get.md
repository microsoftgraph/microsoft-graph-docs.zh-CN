...
在用户的配置文件中检索 [personInterest](../resources/personinterest.md) 对象的属性和 [关系](../resources/profile.md)。
...
如果成功，此方法在响应 `200 OK` 正文中返回响应代码和 [请求的 personInterest](../resources/personinterest.md) 对象。
