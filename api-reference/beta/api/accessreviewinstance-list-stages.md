...
此方法仅支持 `$select`OData `$orderby``$filter` `eq` (、 和) ，以帮助自定义响应。 若要了解一般信息，请参阅 [OData 查询参数](/graph/query-parameters)。
...
如果成功，此方法在响应 `200 OK` 正文中返回 响应代码和 [accessReviewStage](../resources/accessreviewstage.md) 对象集合。
