...
|正文|ItemBody|邮件的正文。 可更新才 isDraft = true。|
...
|singleValueExtendedProperties|[singleValueLegacyExtendedProperty](../resources/singlevaluelegacyextendedproperty.md) 集合| 为邮件定义的单值扩展属性的集合。可为空。|
|主题|String|邮件的主题。 可更新才 isDraft = true。|
