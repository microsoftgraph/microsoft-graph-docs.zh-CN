...
|kioskModeWifiAllowedSsids|String 集合|用户可以在展台模式下配置的受限 WIFI SS ID 集。 该集合最多可包含 500 个元素。|
...
如果成功，此方法在响应正文中返回 响应 `201 Created` 代码和 [androidDeviceOwnerGeneralDeviceConfiguration](../resources/intune-deviceconfig-androiddeviceownergeneraldeviceconfiguration.md) 对象。
