...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [appleUserInitiatedEnrollmentProfile](../resources/intune-enrollment-appleuserinitiatedenrollmentprofile.md) 对象。
