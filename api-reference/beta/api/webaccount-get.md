...
从用户配置文件中检索 [webAccount](../resources/webaccount.md) 对象的属性和 [关系](../resources/profile.md)。
...
如果成功，此方法在响应正文中返回 响应代码和请求的 `200 OK` [webAccount](../resources/webaccount.md) 对象。
