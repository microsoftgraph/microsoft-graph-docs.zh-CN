...
ms.locfileid: "60488176"
---
# <a name="list-windows10xcertificateprofiles"></a>列出 windows10XCertificateProfiles
...
列出 [windows10XCertificateProfile](../resources/intune-rapolicy-windows10xcertificateprofile.md) 对象的属性和关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [windows10XCertificateProfile](../resources/intune-rapolicy-windows10xcertificateprofile.md) 对象集合。
