---
title: 获取 microsoftTunnelHealthThreshold
description: 读取 microsoftTunnelHealthThreshold 对象的属性和关系。
author: dougeby
...
ms.locfileid: "59065132"
---
# <a name="get-microsofttunnelhealththreshold"></a>获取 microsoftTunnelHealthThreshold
...
读取 [microsoftTunnelHealthThreshold 对象的属性和](../resources/intune-mstunnel-microsofttunnelhealththreshold.md) 关系。
...
如果成功，此方法在响应 `200 OK` 正文中返回 响应代码和 [microsoftTunnelHealthThreshold](../resources/intune-mstunnel-microsofttunnelhealththreshold.md) 对象。
