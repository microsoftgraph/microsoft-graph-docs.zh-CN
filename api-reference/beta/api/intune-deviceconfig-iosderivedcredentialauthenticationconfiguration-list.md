...
如果成功, 此方法在响应`200 OK`正文中返回响应代码和[iosDerivedCredentialAuthenticationConfiguration](../resources/intune-deviceconfig-iosderivedcredentialauthenticationconfiguration.md)对象集合。
