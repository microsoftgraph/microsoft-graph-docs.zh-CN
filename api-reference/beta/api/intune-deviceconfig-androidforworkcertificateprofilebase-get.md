...
读取 [androidForWorkCertificateProfileBase 对象的属性和](../resources/intune-deviceconfig-androidforworkcertificateprofilebase.md) 关系。
...
如果成功，此方法在响应 `200 OK` 正文中返回 响应代码和 [androidForWorkCertificateProfileBase](../resources/intune-deviceconfig-androidforworkcertificateprofilebase.md) 对象。
