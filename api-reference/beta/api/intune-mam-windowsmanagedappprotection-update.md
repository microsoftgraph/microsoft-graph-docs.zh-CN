---
title: 更新 windowsManagedAppProtection
description: 更新 windowsManagedAppProtection 对象的属性。
author: dougeby
...
ms.locfileid: "65858686"
---
# <a name="update-windowsmanagedappprotection"></a>更新 windowsManagedAppProtection
...
更新 [windowsManagedAppProtection 对象的](../resources/intune-mam-windowsmanagedappprotection.md) 属性。
...
在请求正文中，为 [windowsManagedAppProtection](../resources/intune-mam-windowsmanagedappprotection.md) 对象提供 JSON 表示形式。

下表显示了创建 [windowsManagedAppProtection](../resources/intune-mam-windowsmanagedappprotection.md) 时所需的属性。
...
如果成功，此方法在响应正文中返回 `200 OK` 响应代码和更新 [的 windowsManagedAppProtection](../resources/intune-mam-windowsmanagedappprotection.md) 对象。
