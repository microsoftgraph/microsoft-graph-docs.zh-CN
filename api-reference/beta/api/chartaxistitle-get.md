...
---
# <a name="get-workbookchartaxistitle"></a>获取 workbookChartAxisTitle
...
如果成功，此方法在响应 `200 OK` 正文中返回 响应代码和 [workbookChartAxisTitle](../resources/workbookchartaxistitle.md) 对象。
## <a name="example"></a>示例
##### <a name="request"></a>请求
下面是一个请求示例。
