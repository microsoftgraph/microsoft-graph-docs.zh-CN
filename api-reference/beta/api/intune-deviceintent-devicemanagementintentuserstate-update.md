...
更新 [deviceManagementIntentUserState 对象](../resources/intune-deviceintent-devicemanagementintentuserstate.md) 的属性。
...
在请求正文中，提供 [deviceManagementIntentUserState 对象的](../resources/intune-deviceintent-devicemanagementintentuserstate.md) JSON 表示形式。

下表显示创建 [deviceManagementIntentUserState 时所需的属性](../resources/intune-deviceintent-devicemanagementintentuserstate.md)。
...
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [deviceManagementIntentUserState](../resources/intune-deviceintent-devicemanagementintentuserstate.md) 对象。
