---
title: 删除 ediscoverySearch
description: 删除 ediscoverySearch 对象。
author: SeunginLyu
...
ms.locfileid: "66838351"
---
# <a name="delete-ediscoverysearch"></a>删除 ediscoverySearch
命名空间：microsoft.graph.security

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

删除 [ediscoverySearch](../resources/security-ediscoverysearch.md) 对象。
