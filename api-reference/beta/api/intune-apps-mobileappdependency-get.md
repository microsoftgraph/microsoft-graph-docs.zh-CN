...
读取 [mobileAppDependency](../resources/intune-apps-mobileappdependency.md) 对象的属性和关系。
...
如果成功，此方法在响应 `200 OK` 正文中返回 [响应代码和 mobileAppDependency](../resources/intune-apps-mobileappdependency.md) 对象。
