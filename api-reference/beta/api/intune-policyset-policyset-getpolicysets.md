...
ms.locfileid: "60489316"
---
# <a name="getpolicysets-action"></a>getPolicySets 操作
...
|属性|类型|说明|
|:---|:---|:---|
|policySetIds|String collection|尚未记录|



## <a name="response"></a>响应
如果成功，此操作在响应正文中返回 响应代码 `200 OK` 和 [policySet](../resources/intune-policyset-policyset.md) 集合。
