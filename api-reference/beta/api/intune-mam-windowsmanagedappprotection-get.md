---
title: 获取 windowsManagedAppProtection
description: 读取 windowsManagedAppProtection 对象的属性和关系。
author: dougeby
...
ms.locfileid: "65858529"
---
# <a name="get-windowsmanagedappprotection"></a>获取 windowsManagedAppProtection
...
读取 [windowsManagedAppProtection](../resources/intune-mam-windowsmanagedappprotection.md) 对象的属性和关系。
...
如果成功，此方法在响应正文中返回 `200 OK` 响应代码和 [windowsManagedAppProtection](../resources/intune-mam-windowsmanagedappprotection.md) 对象。
