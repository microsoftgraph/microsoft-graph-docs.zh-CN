...
获取 [unifiedGroupSource](../resources/ediscovery-unifiedgroupsource.md) 对象及其属性的列表。
...
如果成功，此方法在响应正文中返回响应代码和 `200 OK` [microsoft.graph.ediscovery.unifiedGroupSource](../resources/ediscovery-unifiedgroupsource.md) 对象集合。
