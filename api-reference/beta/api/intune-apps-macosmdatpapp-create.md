...
ms.locfileid: "59018892"
---
# <a name="create-macosmdatpapp"></a>创建 macOSMdatpApp
...
创建新的 [macOSMdatpApp](../resources/intune-apps-macosmdatpapp.md) 对象。
...
在请求正文中，提供 macOSMdatpApp 对象的 JSON 表示形式。

下表显示创建 macOSMdatpApp 时所需的属性。
...
如果成功，此方法在响应正文中返回 响应代码和 `201 Created` [macOSMdatpApp](../resources/intune-apps-macosmdatpapp.md) 对象。
