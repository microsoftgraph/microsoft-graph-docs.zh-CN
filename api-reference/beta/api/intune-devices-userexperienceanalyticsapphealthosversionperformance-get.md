...
ms.locfileid: "58784063"
---
# <a name="get-userexperienceanalyticsapphealthosversionperformance"></a>获取 userExperienceAnalyticsAppHealthOSVersionPerformance
...
读取 [userExperienceAnalyticsAppHealthOSVersionPerformance](../resources/intune-devices-userexperienceanalyticsapphealthosversionperformance.md) 对象的属性和关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [userExperienceAnalyticsAppHealthOSVersionPerformance](../resources/intune-devices-userexperienceanalyticsapphealthosversionperformance.md) 对象。
