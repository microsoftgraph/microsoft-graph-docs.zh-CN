...
列出 [sideLoadingKey 对象的属性和](../resources/intune-onboarding-sideloadingkey.md) 关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [sideLoadingKey](../resources/intune-onboarding-sideloadingkey.md) 对象集合。
