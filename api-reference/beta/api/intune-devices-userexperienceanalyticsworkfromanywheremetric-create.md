...
ms.locfileid: "58264568"
---
# <a name="create-userexperienceanalyticsworkfromanywheremetric"></a>创建 userExperienceAnalyticsWorkFromAnywhereMetric
...
创建新的 [userExperienceAnalyticsWorkFromAnywhereMetric](../resources/intune-devices-userexperienceanalyticsworkfromanywheremetric.md) 对象。
...
在请求正文中，提供 userExperienceAnalyticsWorkFromAnywhereMetric 对象的 JSON 表示形式。

下表显示创建 userExperienceAnalyticsWorkFromAnywhereMetric 时所需的属性。
...
如果成功，此方法在响应正文中返回 响应代码和 `201 Created` [userExperienceAnalyticsWorkFromAnywhereMetric](../resources/intune-devices-userexperienceanalyticsworkfromanywheremetric.md) 对象。
