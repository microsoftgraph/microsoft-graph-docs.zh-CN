...
读取 [windowsPhone81AppX](../resources/intune-apps-windowsphone81appx.md) 对象的属性和关系。
...
如果成功，此方法在响应 `200 OK` 正文中返回 响应代码和 [windowsPhone81AppX](../resources/intune-apps-windowsphone81appx.md) 对象。
