...
下表显示了在用户配置文件中创建新的 [workPosition](../resources/workPosition.md) 对象时可以设置 [的属性](../resources/profile.md)。
...
如果成功，此方法在 `201, Created` 响应正文中返回 响应代码和新 [workPosition](../resources/workposition.md) 对象。
