...
更新[androidForWorkApp](../resources/intune-apps-androidforworkapp.md)对象的属性。
...
在请求正文中，提供[androidForWorkApp](../resources/intune-apps-androidforworkapp.md)对象的 JSON 表示形式。

下表显示时创建[androidForWorkApp](../resources/intune-apps-androidforworkapp.md)所需的属性。
...
如果成功，此方法返回`200 OK`响应代码和响应正文中的更新的[androidForWorkApp](../resources/intune-apps-androidforworkapp.md)对象。
