...
|updatesMinimumAutoInstallClassification|[updateClassification](../resources/intune-deviceconfig-updateclassification.md)|要自动安装的最低更新分类。 可能的值是：`userDefined`、`recommendedAndImportant`、`important`、`none`。|
