...
读取 [importedAppleDeviceIdentityResult 对象的属性和](../resources/intune-enrollment-importedappledeviceidentityresult.md) 关系。
...
如果成功，此方法在响应正文 `200 OK` 中返回 响应代码和 [importedAppleDeviceIdentityResult](../resources/intune-enrollment-importedappledeviceidentityresult.md) 对象。
