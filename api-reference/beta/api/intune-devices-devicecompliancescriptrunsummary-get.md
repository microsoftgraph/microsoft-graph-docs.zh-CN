...
ms.locfileid: "60492854"
---
# <a name="get-devicecompliancescriptrunsummary"></a>获取 deviceComplianceScriptRunSummary
...
读取 [deviceComplianceScriptRunSummary 对象的属性和](../resources/intune-devices-devicecompliancescriptrunsummary.md) 关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [deviceComplianceScriptRunSummary](../resources/intune-devices-devicecompliancescriptrunsummary.md) 对象。
