---
title: 获取 tenantAttachRBAC
description: 读取 tenantAttachRBAC 对象的属性和关系。
author: dougeby
...
ms.locfileid: "64631047"
---
# <a name="get-tenantattachrbac"></a>获取 tenantAttachRBAC
...
读取 [tenantAttachRBAC 对象的属性和](../resources/intune-devices-tenantattachrbac.md) 关系。
...
如果成功，此方法在响应 `200 OK` 正文中返回 响应代码和 [tenantAttachRBAC](../resources/intune-devices-tenantattachrbac.md) 对象。
