...
---
# <a name="delete-rolescopetagautoassignment"></a><span data-ttu-id="d3c26-103">删除 roleScopeTagAutoAssignment</span><span class="sxs-lookup"><span data-stu-id="d3c26-103">Delete roleScopeTagAutoAssignment</span></span>
...
<span data-ttu-id="d3c26-106">删除[roleScopeTagAutoAssignment](../resources/intune-rbac-rolescopetagautoassignment.md)。</span><span class="sxs-lookup"><span data-stu-id="d3c26-106">Deletes a [roleScopeTagAutoAssignment](../resources/intune-rbac-rolescopetagautoassignment.md).</span></span>
...
|:---|:---|
|<span data-ttu-id="d3c26-112">委派（工作或学校帐户）</span><span class="sxs-lookup"><span data-stu-id="d3c26-112">Delegated (work or school account)</span></span>|<span data-ttu-id="d3c26-113">DeviceManagementRBAC.ReadWrite.All</span><span class="sxs-lookup"><span data-stu-id="d3c26-113">DeviceManagementRBAC.ReadWrite.All</span></span>|
...
|<span data-ttu-id="d3c26-116">应用程序</span><span class="sxs-lookup"><span data-stu-id="d3c26-116">Application</span></span>|<span data-ttu-id="d3c26-117">DeviceManagementRBAC.ReadWrite.All</span><span class="sxs-lookup"><span data-stu-id="d3c26-117">DeviceManagementRBAC.ReadWrite.All</span></span>|
...
<span data-ttu-id="d3c26-127">请勿提供此方法的请求正文。</span><span class="sxs-lookup"><span data-stu-id="d3c26-127">Do not supply a request body for this method.</span></span>

## <a name="response"></a><span data-ttu-id="d3c26-128">响应</span><span class="sxs-lookup"><span data-stu-id="d3c26-128">Response</span></span>
<span data-ttu-id="d3c26-129">如果成功，此方法返回 `204 No Content` 响应代码。</span><span class="sxs-lookup"><span data-stu-id="d3c26-129">If successful, this method returns a `204 No Content` response code.</span></span>

## <a name="example"></a><span data-ttu-id="d3c26-130">示例</span><span class="sxs-lookup"><span data-stu-id="d3c26-130">Example</span></span>

### <a name="request"></a><span data-ttu-id="d3c26-131">请求</span><span class="sxs-lookup"><span data-stu-id="d3c26-131">Request</span></span>
<span data-ttu-id="d3c26-132">下面是一个请求示例。</span><span class="sxs-lookup"><span data-stu-id="d3c26-132">Here is an example of the request.</span></span>
``` http
...
### <a name="response"></a><span data-ttu-id="d3c26-133">响应</span><span class="sxs-lookup"><span data-stu-id="d3c26-133">Response</span></span>
