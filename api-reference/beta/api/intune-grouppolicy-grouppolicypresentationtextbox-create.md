...
|默认|字符串|显示在文本框中的本地化默认字符串。 默认值为空白。|
...
如果成功，此方法 `201 Created` 在响应正文中返回响应代码和 [groupPolicyPresentationTextBox](../resources/intune-grouppolicy-grouppolicypresentationtextbox.md) 对象。
