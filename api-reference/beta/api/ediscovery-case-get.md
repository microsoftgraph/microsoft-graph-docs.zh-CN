...
检索 case [对象的属性和](../resources/ediscovery-case.md) 关系。
...
如果成功，此方法在响应正文中返回 响应代码和请求的 `200 OK` [microsoft.graph.ediscovery.case](../resources/ediscovery-case.md) 对象。
