...
更新 [macOSLobApp 对象](../resources/intune-apps-macoslobapp.md) 的属性。
...
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [macOSLobApp](../resources/intune-apps-macoslobapp.md) 对象。
