...
ms.locfileid: "58802871"
---
# <a name="update-devicemanagementconfigurationchoicesettingdefinition"></a>更新 deviceManagementConfigurationChoiceSettingDefinition
...
更新 [deviceManagementConfigurationChoiceSettingDefinition 对象](../resources/intune-deviceconfigv2-devicemanagementconfigurationchoicesettingdefinition.md) 的属性。
...
在请求正文中，提供 [deviceManagementConfigurationChoiceSettingDefinition](../resources/intune-deviceconfigv2-devicemanagementconfigurationchoicesettingdefinition.md) 对象的 JSON 表示形式。

下表显示创建 [deviceManagementConfigurationChoiceSettingDefinition 时所需的属性](../resources/intune-deviceconfigv2-devicemanagementconfigurationchoicesettingdefinition.md)。
...
|选项|[deviceManagementConfigurationOptionDefinition](../resources/intune-deviceconfigv2-devicemanagementconfigurationoptiondefinition.md) 集合|可以选择的设置选项|
|defaultOptionId|String|选项设置的默认选项|



## <a name="response"></a>响应
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [deviceManagementConfigurationChoiceSettingDefinition](../resources/intune-deviceconfigv2-devicemanagementconfigurationchoicesettingdefinition.md) 对象。
