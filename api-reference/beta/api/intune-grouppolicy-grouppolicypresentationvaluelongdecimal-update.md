...
更新 [groupPolicyPresentationValueLongDecimal 对象](../resources/intune-grouppolicy-grouppolicypresentationvaluelongdecimal.md) 的属性。
...
在请求正文中，提供 [groupPolicyPresentationValueLongDecimal 对象的](../resources/intune-grouppolicy-grouppolicypresentationvaluelongdecimal.md) JSON 表示形式。

下表显示创建 [groupPolicyPresentationValueLongDecimal 时所需的属性](../resources/intune-grouppolicy-grouppolicypresentationvaluelongdecimal.md)。
...
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [groupPolicyPresentationValueLongDecimal](../resources/intune-grouppolicy-grouppolicypresentationvaluelongdecimal.md) 对象。
