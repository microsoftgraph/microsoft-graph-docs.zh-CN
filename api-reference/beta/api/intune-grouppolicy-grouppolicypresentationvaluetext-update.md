...
更新 [groupPolicyPresentationValueText 对象](../resources/intune-grouppolicy-grouppolicypresentationvaluetext.md) 的属性。
...
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [groupPolicyPresentationValueText](../resources/intune-grouppolicy-grouppolicypresentationvaluetext.md) 对象。
