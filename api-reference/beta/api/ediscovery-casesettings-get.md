---
title: 获取 caseSettings
description: 读取电子数据展示 caseSettings 对象的属性和关系。
author: mahage-msft
...
ms.locfileid: "61015607"
---
# <a name="get-casesettings"></a>获取 caseSettings

命名空间：microsoft.graph.ediscovery

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

读取电子数据展示 [caseSettings 对象的属性和](../resources/ediscovery-caseSettings.md) 关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [caseSettings](../resources/ediscovery-caseSettings.md) 对象。
