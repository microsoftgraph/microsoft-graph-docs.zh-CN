...
创建新的 [windowsAppX](../resources/intune-apps-windowsappx.md) 对象。
...
在请求正文中，提供 windowsAppX 对象的 JSON 表示形式。

下表显示创建 windowsAppX 时所需的属性。
...
如果成功，此方法在响应正文中返回 响应代码 `201 Created` 和 [windowsAppX](../resources/intune-apps-windowsappx.md) 对象。
