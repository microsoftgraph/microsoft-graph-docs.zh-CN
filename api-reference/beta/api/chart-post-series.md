...
在请求正文中，提供 [workbookChartSeries](../resources/workbookchartseries.md) 对象的 JSON 表示形式。

## <a name="response"></a>响应

如果成功，此方法在 `201 Created` 响应正文中返回 响应代码和 [workbookChartSeries](../resources/workbookchartseries.md) 对象。
