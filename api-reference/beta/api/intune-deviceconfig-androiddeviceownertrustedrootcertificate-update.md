...
---
# <a name="update-androiddeviceownertrustedrootcertificate"></a>更新 androidDeviceOwnerTrustedRootCertificate
...
更新 [androidDeviceOwnerTrustedRootCertificate 对象](../resources/intune-deviceconfig-androiddeviceownertrustedrootcertificate.md) 的属性。
...
在请求正文中，提供 [androidDeviceOwnerTrustedRootCertificate](../resources/intune-deviceconfig-androiddeviceownertrustedrootcertificate.md) 对象的 JSON 表示形式。

下表显示创建 [androidDeviceOwnerTrustedRootCertificate 时所需的属性](../resources/intune-deviceconfig-androiddeviceownertrustedrootcertificate.md)。
...
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [androidDeviceOwnerTrustedRootCertificate](../resources/intune-deviceconfig-androiddeviceownertrustedrootcertificate.md) 对象。
