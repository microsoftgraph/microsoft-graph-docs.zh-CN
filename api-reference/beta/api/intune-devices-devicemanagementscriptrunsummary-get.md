...
读取 [deviceManagementScriptRunSummary 对象的属性和](../resources/intune-devices-devicemanagementscriptrunsummary.md) 关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [deviceManagementScriptRunSummary](../resources/intune-devices-devicemanagementscriptrunsummary.md) 对象。
