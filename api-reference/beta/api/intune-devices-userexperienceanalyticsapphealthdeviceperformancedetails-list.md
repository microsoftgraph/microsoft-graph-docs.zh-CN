...
ms.locfileid: "58257512"
---
# <a name="list-userexperienceanalyticsapphealthdeviceperformancedetailses"></a>列出 userExperienceAnalyticsAppHealthDevicePerformanceDetailses
...
列出 [userExperienceAnalyticsAppHealthDevicePerformanceDetails 对象的属性和](../resources/intune-devices-userexperienceanalyticsapphealthdeviceperformancedetails.md) 关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [userExperienceAnalyticsAppHealthDevicePerformanceDetails](../resources/intune-devices-userexperienceanalyticsapphealthdeviceperformancedetails.md) 对象集合。
