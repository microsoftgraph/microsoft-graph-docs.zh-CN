...
读取 [windows10XVpnConfiguration 对象的属性和](../resources/intune-rapolicy-windows10xvpnconfiguration.md) 关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [windows10XVpnConfiguration](../resources/intune-rapolicy-windows10xvpnconfiguration.md) 对象。
