...
创建新的 [deviceManagementComplexSettingInstance](../resources/intune-deviceintent-devicemanagementcomplexsettinginstance.md) 对象。
...
在请求正文中，提供 deviceManagementComplexSettingInstance 对象的 JSON 表示形式。

下表显示创建 deviceManagementComplexSettingInstance 时所需的属性。

|属性|类型|说明|
|:---|:---|:---|
|id|字符串|设置实例 ID 继承自 [deviceManagementSettingInstance](../resources/intune-deviceintent-devicemanagementsettinginstance.md)|
...
如果成功，此方法在响应正文中返回 响应代码和 `201 Created` [deviceManagementComplexSettingInstance](../resources/intune-deviceintent-devicemanagementcomplexsettinginstance.md) 对象。
