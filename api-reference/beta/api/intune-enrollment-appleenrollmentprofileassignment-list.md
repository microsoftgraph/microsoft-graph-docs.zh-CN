...
ms.locfileid: "60493442"
---
# <a name="list-appleenrollmentprofileassignments"></a>列出 appleEnrollmentProfileAssignments
...
列出 [appleEnrollmentProfileAssignment](../resources/intune-enrollment-appleenrollmentprofileassignment.md) 对象的属性和关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [appleEnrollmentProfileAssignment](../resources/intune-enrollment-appleenrollmentprofileassignment.md) 对象集合。
