...
此方法支持一些 OData 查询参数来帮助自定义响应。 例如，若要检索每个请求的访问包，请`$expand=accessPackage`在查询中包含。  若要仅检索对特定访问包的请求，请在查询中包括中的`$expand=accessPackage&$filter=accessPackage/id eq '9bbe5f7d-f1e7-4eb1-a586-38cdf6f8b1ea'`筛选器。
...
如果成功，此方法在响应`200 OK`正文中返回响应代码和[accessPackageAssignmentRequest](../resources/accesspackageassignmentrequest.md)对象集合。
