...
---
# <a name="create-macospkcscertificateprofile"></a>创建 macOSPkcsCertificateProfile
...
创建新的 [macOSPkcsCertificateProfile](../resources/intune-deviceconfig-macospkcscertificateprofile.md) 对象。
...
下表显示创建 macOSPkcsCertificateProfile 时所需的属性。
...
如果成功，此方法 `201 Created` 在响应正文中返回响应代码和 [macOSPkcsCertificateProfile](../resources/intune-deviceconfig-macospkcscertificateprofile.md) 对象。
