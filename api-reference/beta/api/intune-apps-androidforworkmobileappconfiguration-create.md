...
下表显示创建 androidForWorkMobileAppConfiguration 时所需的属性。
...
如果成功，此方法 `201 Created` 在响应正文中返回响应代码和 [androidForWorkMobileAppConfiguration](../resources/intune-apps-androidforworkmobileappconfiguration.md) 对象。
