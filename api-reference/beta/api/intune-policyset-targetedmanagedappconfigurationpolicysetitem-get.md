...
读取 [targetedManagedAppConfigurationPolicySetItem 对象的属性和](../resources/intune-policyset-targetedmanagedappconfigurationpolicysetitem.md) 关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [targetedManagedAppConfigurationPolicySetItem](../resources/intune-policyset-targetedmanagedappconfigurationpolicysetitem.md) 对象。
