...
更新 [userExperienceAnalyticsModelScores 对象](../resources/intune-devices-userexperienceanalyticsmodelscores.md) 的属性。
...
在请求正文中，提供 [userExperienceAnalyticsModelScores](../resources/intune-devices-userexperienceanalyticsmodelscores.md) 对象的 JSON 表示形式。

下表显示创建 [userExperienceAnalyticsModelScores 时所需的属性](../resources/intune-devices-userexperienceanalyticsmodelscores.md)。
