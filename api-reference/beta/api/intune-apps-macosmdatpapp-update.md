...
ms.locfileid: "54149294"
---
# <a name="update-macosmdatpapp"></a>更新 macOSMdatpApp
...
更新 [macOSMdatpApp 对象](../resources/intune-apps-macosmdatpapp.md) 的属性。
...
在请求正文中，提供 [macOSMdatpApp](../resources/intune-apps-macosmdatpapp.md) 对象的 JSON 表示形式。

下表显示创建 [macOSMdatpApp](../resources/intune-apps-macosmdatpapp.md)时所需的属性。
...
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [macOSMdatpApp](../resources/intune-apps-macosmdatpapp.md) 对象。
