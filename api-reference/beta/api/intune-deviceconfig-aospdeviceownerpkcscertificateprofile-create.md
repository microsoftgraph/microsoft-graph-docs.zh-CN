---
title: 创建 aospDeviceOwnerPkcsCertificateProfile
description: 创建新的 aospDeviceOwnerPkcsCertificateProfile 对象。
author: dougeby
...
---
# <a name="create-aospdeviceownerpkcscertificateprofile"></a>创建 aospDeviceOwnerPkcsCertificateProfile
...
创建新的 [aospDeviceOwnerPkcsCertificateProfile](../resources/intune-deviceconfig-aospdeviceownerpkcscertificateprofile.md) 对象。
...
在请求正文中，提供 aospDeviceOwnerPkcsCertificateProfile 对象的 JSON 表示形式。

下表显示创建 aospDeviceOwnerPkcsCertificateProfile 时所需的属性。
...
如果成功，此方法在响应正文中返回 响应 `201 Created` 代码和 [aospDeviceOwnerPkcsCertificateProfile](../resources/intune-deviceconfig-aospdeviceownerpkcscertificateprofile.md) 对象。
