...
更新 [androidTrustedRootCertificate 对象](../resources/intune-deviceconfig-androidtrustedrootcertificate.md) 的属性。
...
下表显示创建 [androidTrustedRootCertificate](../resources/intune-deviceconfig-androidtrustedrootcertificate.md)时所需的属性。
...
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [androidTrustedRootCertificate](../resources/intune-deviceconfig-androidtrustedrootcertificate.md) 对象。
