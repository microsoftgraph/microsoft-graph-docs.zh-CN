---
title: 获取 macOSDmgApp
description: 读取 macOSDmgApp 对象的属性和关系。
author: dougeby
...
ms.locfileid: "61712130"
---
# <a name="get-macosdmgapp"></a>获取 macOSDmgApp
...
读取 [macOSDmgApp](../resources/intune-apps-macosdmgapp.md) 对象的属性和关系。
...
如果成功，此方法在响应 `200 OK` 正文中返回 响应代码和 [macOSDmgApp](../resources/intune-apps-macosdmgapp.md) 对象。
