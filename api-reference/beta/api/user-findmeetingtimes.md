...
|meetingDuration|Edm.Duration|会议时长，以 [ISO 8601](https://www.iso.org/iso/iso8601) 格式表示。 例如，1 小时表示为"PT1H"，其中"P"是持续时间指示符，"T"是时间指示符，"H"是小时指示符。 使用 M 指示持续时间的分钟数;例如，2 小时 30 分钟为"PT2H30M"。 如果未指定会议持续时间，**findMeetingTimes** 使用默认值 30 分钟。 可选。|
