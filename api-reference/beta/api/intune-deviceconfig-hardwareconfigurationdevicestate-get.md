---
title: 获取 hardwareConfigurationDeviceState
description: 读取 hardwareConfigurationDeviceState 对象的属性和关系。
author: dougeby
...
ms.locfileid: "61348421"
---
# <a name="get-hardwareconfigurationdevicestate"></a>获取 hardwareConfigurationDeviceState
...
读取 [hardwareConfigurationDeviceState 对象的属性和](../resources/intune-deviceconfig-hardwareconfigurationdevicestate.md) 关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [hardwareConfigurationDeviceState](../resources/intune-deviceconfig-hardwareconfigurationdevicestate.md) 对象。
