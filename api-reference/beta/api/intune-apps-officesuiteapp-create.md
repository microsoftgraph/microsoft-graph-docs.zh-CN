...
|localesToInstall|字符串集合|表示安装 Office365 应用时安装区域设置的属性。 它使用标准 RFC 6033。 参考： https://technet.microsoft.com/library/cc179219(v=office.16).aspx|
