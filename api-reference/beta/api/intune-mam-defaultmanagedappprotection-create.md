...
|allowedAndroidDeviceManufacturers|String|以字符串形式允许托管应用工作的设备制造商的分号分隔列表。 （仅限 Android）|
...
|blockAfterCompanyPortalUpdateDeferralInDays|Int32|在设备或应用访问被阻止时可以延迟公司门户更新的最大天数。|
|warnAfterCompanyPortalUpdateDeferralInDays|Int32|在设备上可以延迟公司门户更新的最大天数，否则用户将收到警告|
