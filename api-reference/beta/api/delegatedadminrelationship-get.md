...
读取 [delegatedAdminRelationship 对象的](../resources/delegatedadminrelationship.md) 属性。
...
如果成功，此方法在响应正文中返回 `200 OK` 响应代码和 [delegatedAdminRelationship](../resources/delegatedadminrelationship.md) 对象。

**delegatedAdminRelationship** 对象还包含根据 RFC2616 的 **@odata.etag** 属性。
