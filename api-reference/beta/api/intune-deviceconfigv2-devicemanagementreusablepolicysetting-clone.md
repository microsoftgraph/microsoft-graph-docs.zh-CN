...
如果成功，此操作在响应正文中返回 响应代码和 `200 OK` [deviceManagementReusablePolicySetting。](../resources/intune-deviceconfigv2-devicemanagementreusablepolicysetting.md)
