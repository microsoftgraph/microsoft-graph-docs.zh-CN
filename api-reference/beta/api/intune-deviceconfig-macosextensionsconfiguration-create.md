...
---
# <a name="create-macosextensionsconfiguration"></a>创建 macOSExtensionsConfiguration
...
创建新的 [macOSExtensionsConfiguration](../resources/intune-deviceconfig-macosextensionsconfiguration.md) 对象。
...
在请求正文中，提供 macOSExtensionsConfiguration 对象的 JSON 表示形式。

下表显示创建 macOSExtensionsConfiguration 时所需的属性。
...
如果成功，此方法 `201 Created` 在响应正文中返回响应代码和 [macOSExtensionsConfiguration](../resources/intune-deviceconfig-macosextensionsconfiguration.md) 对象。
