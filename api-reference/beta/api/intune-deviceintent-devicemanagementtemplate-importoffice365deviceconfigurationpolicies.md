...
---
# <a name="importoffice365deviceconfigurationpolicies-action"></a>importOffice365DeviceConfigurationPolicies 操作
...
如果成功，此操作会 `200 OK` 在响应正文中返回响应代码和 [deviceManagementIntent](../resources/intune-deviceintent-devicemanagementintent.md) 集合。
