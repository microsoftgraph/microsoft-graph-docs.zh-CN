...
如果成功，此方法返回 `200 Ok` 响应代码。 它在[响应正文中返回 privilegedRoleAssignmentRequest。](../resources/privilegedroleassignmentrequest.md)
...
| 400 BadRequest | 只能在状态为 Scheduled 和 PendingApproval 时取消。 |
| 403 UnAuthorized | 不允许请求者进行"取消"呼叫或未找到请求。 |
