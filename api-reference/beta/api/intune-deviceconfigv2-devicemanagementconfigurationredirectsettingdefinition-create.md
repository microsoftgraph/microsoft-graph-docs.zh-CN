...
在请求正文中，为 deviceManagementConfigurationRedirectSettingDefinition 对象提供 JSON 表示形式。

下表显示了创建 deviceManagementConfigurationRedirectSettingDefinition 时所需的属性。
...
|deepLink|字符串|指向Intune控制台中必须从中管理功能支持的特定位置的深层链接。|
...
如果成功，此方法在响应正文中返回 `201 Created` 响应代码和 [deviceManagementConfigurationRedirectSettingDefinition](../resources/intune-deviceconfigv2-devicemanagementconfigurationredirectsettingdefinition.md) 对象。
