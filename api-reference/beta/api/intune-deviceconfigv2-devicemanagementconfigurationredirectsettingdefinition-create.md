---
title: 创建 deviceManagementConfigurationRedirectSettingDefinition
description: 创建新的 deviceManagementConfigurationRedirectSettingDefinition 对象。
author: dougeby
...
ms.locfileid: "60688561"
---
# <a name="create-devicemanagementconfigurationredirectsettingdefinition"></a>创建 deviceManagementConfigurationRedirectSettingDefinition
...
创建新的 [deviceManagementConfigurationRedirectSettingDefinition](../resources/intune-deviceconfigv2-devicemanagementconfigurationredirectsettingdefinition.md) 对象。
...
在请求正文中，提供 deviceManagementConfigurationRedirectSettingDefinition 对象的 JSON 表示形式。

下表显示创建 deviceManagementConfigurationRedirectSettingDefinition 时所需的属性。
...
如果成功，此方法在响应正文中返回 响应代码和 `201 Created` [deviceManagementConfigurationRedirectSettingDefinition](../resources/intune-deviceconfigv2-devicemanagementconfigurationredirectsettingdefinition.md) 对象。
