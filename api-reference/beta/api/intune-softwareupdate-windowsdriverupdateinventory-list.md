...
列出 [windowsDriverUpdateInventory](../resources/intune-softwareupdate-windowsdriverupdateinventory.md) 对象的属性和关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [windowsDriverUpdateInventory](../resources/intune-softwareupdate-windowsdriverupdateinventory.md) 对象集合。
