...
检索 operation [对象的属性和](../resources/operation.md) 关系。 目前，这些操作是通过使用重置密码方法启动 [密码重置生成的](passwordauthenticationmethod-resetpassword.md) 。 operation 对象告知调用方密码重置操作的当前状态。 可能的状态包括：
