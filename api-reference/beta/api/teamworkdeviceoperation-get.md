---
title: 获取 teamworkDeviceOperation
description: 获取启用异步的设备上长时间运行的异步Microsoft Teams的详细信息。
...
ms.locfileid: "62262443"
---
# <a name="get-teamworkdeviceoperation"></a>获取 teamworkDeviceOperation
命名空间：microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

获取启用了异步的设备上长时间运行的异步[Microsoft Teams的详细信息。](../resources/teamworkdeviceoperation.md)
...
如果成功，此方法在响应 `200 OK` 正文中返回 响应代码和 [teamworkDeviceOperation](../resources/teamworkdeviceoperation.md) 对象。
