...
更新 [microsoftTunnelServer](../resources/intune-mstunnel-microsofttunnelserver.md) 对象的属性。
...
如果成功，此方法 `200 OK` 在响应正文中返回响应代码和更新的 [microsoftTunnelServer](../resources/intune-mstunnel-microsofttunnelserver.md) 对象。
