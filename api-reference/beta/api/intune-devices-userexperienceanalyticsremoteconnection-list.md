...
ms.locfileid: "58798586"
---
# <a name="list-userexperienceanalyticsremoteconnections"></a>列出 userExperienceAnalyticsRemoteConnections
...
列出 [userExperienceAnalyticsRemoteConnection](../resources/intune-devices-userexperienceanalyticsremoteconnection.md) 对象的属性和关系。
...
如果成功，此方法在响应正文中返回 响应代码和 `200 OK` [userExperienceAnalyticsRemoteConnection](../resources/intune-devices-userexperienceanalyticsremoteconnection.md) 对象集合。
