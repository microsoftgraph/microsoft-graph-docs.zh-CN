...
读取 [managedAppProtectionPolicySetItem 对象的属性和](../resources/intune-policyset-managedappprotectionpolicysetitem.md) 关系。
...
如果成功，此方法在响应正文 `200 OK` 中返回 [响应代码和 managedAppProtectionPolicySetItem](../resources/intune-policyset-managedappprotectionpolicysetitem.md) 对象。
