...
description: "\"开始\"菜单从电子数据展示非存储数据源中删除保留的过程。"
author: SeunginLyu
...
"开始"菜单从电子数据展示非存储数据源中删除保留的过程。 创建操作后，可以通过从响应标头中检索 `Location` 参数来获取事例操作的状态。 该位置提供将返回 [电子数据展示HoldOpertaion 的](../resources/security-ediscoveryholdoperation.md) URL。
