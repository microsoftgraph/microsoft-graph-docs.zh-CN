...
如果成功，此函数会 `200 OK` 在响应正文中返回响应代码和 [managedDeviceSummarizedAppState](../resources/intune-troubleshooting-manageddevicesummarizedappstate.md) 集合。
