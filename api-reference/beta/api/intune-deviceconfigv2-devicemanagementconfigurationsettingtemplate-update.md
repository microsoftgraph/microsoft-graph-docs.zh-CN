...
ms.locfileid: "58262303"
---
# <a name="update-devicemanagementconfigurationsettingtemplate"></a>更新 deviceManagementConfigurationSettingTemplate
...
更新 [deviceManagementConfigurationSettingTemplate 对象](../resources/intune-deviceconfigv2-devicemanagementconfigurationsettingtemplate.md) 的属性。
...
在请求正文中，提供 [deviceManagementConfigurationSettingTemplate](../resources/intune-deviceconfigv2-devicemanagementconfigurationsettingtemplate.md) 对象的 JSON 表示形式。

下表显示创建 [deviceManagementConfigurationSettingTemplate 时所需的属性](../resources/intune-deviceconfigv2-devicemanagementconfigurationsettingtemplate.md)。
...
如果成功，此方法在响应正文中返回 响应代码和更新的 `200 OK` [deviceManagementConfigurationSettingTemplate](../resources/intune-deviceconfigv2-devicemanagementconfigurationsettingtemplate.md) 对象。
