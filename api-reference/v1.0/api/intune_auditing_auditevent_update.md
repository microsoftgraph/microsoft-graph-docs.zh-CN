...
更新 [auditEvent](../resources/intune_auditing_auditevent.md) 对象的属性。
...
下表显示了创建 [auditEvent](../resources/intune_auditing_auditevent.md)时所需的属性。
...
如果成功，此方法在响应正文中返回 `200 OK` 响应代码和更新的 [auditEvent](../resources/intune_auditing_auditevent.md) 对象。
