...
下表显示创建 [deviceInstallState](../resources/intune_books_deviceinstallstate.md) 时所需的属性。
...
如果成功，此方法在响应正文中返回 `200 OK` 响应代码和更新的 [deviceInstallState](../resources/intune_books_deviceinstallstate.md) 对象。
