...
### <a name="example-1-reply-all-in-json-format-to-a-message"></a>示例 1：对邮件使用 JSON 格式全部答复
下面是一个如何调用此 API 的示例。
##### <a name="request"></a>请求
下面是一个请求示例。
...
HTTP/1.1 200 OK
```
### <a name="example-2-reply-all-in-mime-format-to-a-message"></a>示例 2：对邮件使用 MIME 格式全部答复
##### <a name="request"></a>请求
