...
|<span data-ttu-id="a5e56-152">version</span><span class="sxs-lookup"><span data-stu-id="a5e56-152">version</span></span>|<span data-ttu-id="a5e56-153">Int32</span><span class="sxs-lookup"><span data-stu-id="a5e56-153">Int32</span></span>|<span data-ttu-id="a5e56-154">设备配置的版本。</span><span class="sxs-lookup"><span data-stu-id="a5e56-154">Version of the device configuration.</span></span> <span data-ttu-id="a5e56-155">继承自 [deviceConfiguration](../resources/intune-deviceconfig-deviceconfiguration.md)</span><span class="sxs-lookup"><span data-stu-id="a5e56-155">Inherited from [deviceConfiguration](../resources/intune-deviceconfig-deviceconfiguration.md)</span></span>|
...
|<span data-ttu-id="a5e56-185">searchEnableRemoteQueries</span><span class="sxs-lookup"><span data-stu-id="a5e56-185">searchEnableRemoteQueries</span></span>|<span data-ttu-id="a5e56-186">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-186">Boolean</span></span>|<span data-ttu-id="a5e56-187">指示是否阻止此计算机索引的远程查询。</span><span class="sxs-lookup"><span data-stu-id="a5e56-187">Indicates whether or not to block remote queries of this computer’s index.</span></span>|
...
|<span data-ttu-id="a5e56-248">edgeBlockJavaScript</span><span class="sxs-lookup"><span data-stu-id="a5e56-248">edgeBlockJavaScript</span></span>|<span data-ttu-id="a5e56-249">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-249">Boolean</span></span>|<span data-ttu-id="a5e56-250">指示是否阻止用户使用 JavaScript。</span><span class="sxs-lookup"><span data-stu-id="a5e56-250">Indicates whether or not to Block the user from using JavaScript.</span></span>|
...
|<span data-ttu-id="a5e56-280">cellularBlockDataWhenRoaming</span><span class="sxs-lookup"><span data-stu-id="a5e56-280">cellularBlockDataWhenRoaming</span></span>|<span data-ttu-id="a5e56-281">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-281">Boolean</span></span>|<span data-ttu-id="a5e56-282">是否阻止用户在漫游时通过手机网络使用数据。</span><span class="sxs-lookup"><span data-stu-id="a5e56-282">Whether or not to Block the user from using data over cellular while roaming.</span></span>|
...
|<span data-ttu-id="a5e56-350">defenderScheduledQuickScanTime</span><span class="sxs-lookup"><span data-stu-id="a5e56-350">defenderScheduledQuickScanTime</span></span>|<span data-ttu-id="a5e56-351">TimeOfDay</span><span class="sxs-lookup"><span data-stu-id="a5e56-351">TimeOfDay</span></span>|<span data-ttu-id="a5e56-352">执行每日快速扫描的时间。</span><span class="sxs-lookup"><span data-stu-id="a5e56-352">The time to perform a daily quick scan.</span></span>|
...
|<span data-ttu-id="a5e56-383">lockScreenBlockCortana</span><span class="sxs-lookup"><span data-stu-id="a5e56-383">lockScreenBlockCortana</span></span>|<span data-ttu-id="a5e56-384">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-384">Boolean</span></span>|<span data-ttu-id="a5e56-385">指示系统锁定时用户是否可以使用语音与 Cortana 进行交互。</span><span class="sxs-lookup"><span data-stu-id="a5e56-385">Indicates whether or not the user can interact with Cortana using speech while the system is locked.</span></span>|
...
|<span data-ttu-id="a5e56-484">startMenuHideUserTile</span><span class="sxs-lookup"><span data-stu-id="a5e56-484">startMenuHideUserTile</span></span>|<span data-ttu-id="a5e56-485">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-485">Boolean</span></span>|<span data-ttu-id="a5e56-486">启用此策略会将用户磁贴从开始菜单中隐藏。</span><span class="sxs-lookup"><span data-stu-id="a5e56-486">Enabling this policy hides the user tile from appearing in the start menu.</span></span>|
...
|<span data-ttu-id="a5e56-546">settingsBlockSystemPage</span><span class="sxs-lookup"><span data-stu-id="a5e56-546">settingsBlockSystemPage</span></span>|<span data-ttu-id="a5e56-547">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-547">Boolean</span></span>|<span data-ttu-id="a5e56-548">指示是否阻止在“设置”应用中访问系统。</span><span class="sxs-lookup"><span data-stu-id="a5e56-548">Indicates whether or not to block access to System in Settings app.</span></span>|
...
|<span data-ttu-id="a5e56-555">settingsBlockPersonalizationPage</span><span class="sxs-lookup"><span data-stu-id="a5e56-555">settingsBlockPersonalizationPage</span></span>|<span data-ttu-id="a5e56-556">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-556">Boolean</span></span>|<span data-ttu-id="a5e56-557">指示是否阻止在“设置”应用中访问“个性化”。</span><span class="sxs-lookup"><span data-stu-id="a5e56-557">Indicates whether or not to block access to Personalization in Settings app.</span></span>|
|<span data-ttu-id="a5e56-558">settingsBlockAccountsPage</span><span class="sxs-lookup"><span data-stu-id="a5e56-558">settingsBlockAccountsPage</span></span>|<span data-ttu-id="a5e56-559">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-559">Boolean</span></span>|<span data-ttu-id="a5e56-560">指示是否阻止在“设置”应用中访问“帐户”。</span><span class="sxs-lookup"><span data-stu-id="a5e56-560">Indicates whether or not to block access to Accounts in Settings app.</span></span>|
|<span data-ttu-id="a5e56-561">settingsBlockTimeLanguagePage</span><span class="sxs-lookup"><span data-stu-id="a5e56-561">settingsBlockTimeLanguagePage</span></span>|<span data-ttu-id="a5e56-562">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-562">Boolean</span></span>|<span data-ttu-id="a5e56-563">指示是否阻止在“设置”应用中访问“时间和语言”。</span><span class="sxs-lookup"><span data-stu-id="a5e56-563">Indicates whether or not to block access to Time & Language in Settings app.</span></span>|
|<span data-ttu-id="a5e56-564">settingsBlockEaseOfAccessPage</span><span class="sxs-lookup"><span data-stu-id="a5e56-564">settingsBlockEaseOfAccessPage</span></span>|<span data-ttu-id="a5e56-565">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-565">Boolean</span></span>|<span data-ttu-id="a5e56-566">指示是否阻止在“设置”应用中访问“轻松使用”。</span><span class="sxs-lookup"><span data-stu-id="a5e56-566">Indicates whether or not to block access to Ease of Access in Settings app.</span></span>|
|<span data-ttu-id="a5e56-567">settingsBlockPrivacyPage</span><span class="sxs-lookup"><span data-stu-id="a5e56-567">settingsBlockPrivacyPage</span></span>|<span data-ttu-id="a5e56-568">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-568">Boolean</span></span>|<span data-ttu-id="a5e56-569">指示是否阻止在“设置”应用中访问“隐私”。</span><span class="sxs-lookup"><span data-stu-id="a5e56-569">Indicates whether or not to block access to Privacy in Settings app.</span></span>|
|<span data-ttu-id="a5e56-570">settingsBlockUpdateSecurityPage</span><span class="sxs-lookup"><span data-stu-id="a5e56-570">settingsBlockUpdateSecurityPage</span></span>|<span data-ttu-id="a5e56-571">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-571">Boolean</span></span>|<span data-ttu-id="a5e56-572">指示是否阻止在“设置”应用中访问“更新和安全”。</span><span class="sxs-lookup"><span data-stu-id="a5e56-572">Indicates whether or not to block access to Update & Security in Settings app.</span></span>|
|<span data-ttu-id="a5e56-573">settingsBlockAppsPage</span><span class="sxs-lookup"><span data-stu-id="a5e56-573">settingsBlockAppsPage</span></span>|<span data-ttu-id="a5e56-574">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-574">Boolean</span></span>|<span data-ttu-id="a5e56-575">指示是否阻止在“设置”应用中访问“应用”。</span><span class="sxs-lookup"><span data-stu-id="a5e56-575">Indicates whether or not to block access to Apps in Settings app.</span></span>|
|<span data-ttu-id="a5e56-576">settingsBlockGamingPage</span><span class="sxs-lookup"><span data-stu-id="a5e56-576">settingsBlockGamingPage</span></span>|<span data-ttu-id="a5e56-577">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-577">Boolean</span></span>|<span data-ttu-id="a5e56-578">指示是否阻止在“设置”应用中访问“游戏”。</span><span class="sxs-lookup"><span data-stu-id="a5e56-578">Indicates whether or not to block access to Gaming in Settings app.</span></span>|
|<span data-ttu-id="a5e56-579">windowsSpotlightBlockConsumerSpecificFeatures</span><span class="sxs-lookup"><span data-stu-id="a5e56-579">windowsSpotlightBlockConsumerSpecificFeatures</span></span>|<span data-ttu-id="a5e56-580">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-580">Boolean</span></span>|<span data-ttu-id="a5e56-581">允许 IT 管理员阻止通常仅供消费者使用的体验，例如开始建议、会员通知、Post-OOBE 应用安装和重定向磁贴。</span><span class="sxs-lookup"><span data-stu-id="a5e56-581">Allows IT admins to block experiences that are typically for consumers only, such as Start suggestions, Membership notifications, Post-OOBE app install and redirect tiles.</span></span>|
|<span data-ttu-id="a5e56-582">windowsSpotlightBlocked</span><span class="sxs-lookup"><span data-stu-id="a5e56-582">windowsSpotlightBlocked</span></span>|<span data-ttu-id="a5e56-583">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-583">Boolean</span></span>|<span data-ttu-id="a5e56-584">允许 IT 管理员关闭所有 Windows 聚焦功能</span><span class="sxs-lookup"><span data-stu-id="a5e56-584">Allows IT admins to turn off all Windows Spotlight features</span></span>|
|<span data-ttu-id="a5e56-585">windowsSpotlightBlockOnActionCenter</span><span class="sxs-lookup"><span data-stu-id="a5e56-585">windowsSpotlightBlockOnActionCenter</span></span>|<span data-ttu-id="a5e56-586">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-586">Boolean</span></span>|<span data-ttu-id="a5e56-587">阻止 Microsoft 在每次操作系统全新安装、升级或持续推出后显示的建议，以向用户介绍新增功能或更改功能</span><span class="sxs-lookup"><span data-stu-id="a5e56-587">Block suggestions from Microsoft that show after each OS clean install, upgrade or in an on-going basis to introduce users to what is new or changed</span></span>|
|<span data-ttu-id="a5e56-588">windowsSpotlightBlockTailoredExperiences</span><span class="sxs-lookup"><span data-stu-id="a5e56-588">windowsSpotlightBlockTailoredExperiences</span></span>|<span data-ttu-id="a5e56-589">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-589">Boolean</span></span>|<span data-ttu-id="a5e56-590">基于用户的设备使用情况，在 Windows 聚焦中阻止个性化内容。</span><span class="sxs-lookup"><span data-stu-id="a5e56-590">Block personalized content in Windows spotlight based on user’s device usage.</span></span>|
|<span data-ttu-id="a5e56-591">windowsSpotlightBlockThirdPartyNotifications</span><span class="sxs-lookup"><span data-stu-id="a5e56-591">windowsSpotlightBlockThirdPartyNotifications</span></span>|<span data-ttu-id="a5e56-592">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-592">Boolean</span></span>|<span data-ttu-id="a5e56-593">阻止通过 Windows 聚焦投放的第三方内容</span><span class="sxs-lookup"><span data-stu-id="a5e56-593">Block third party content delivered via Windows Spotlight</span></span>|
|<span data-ttu-id="a5e56-594">windowsSpotlightBlockWelcomeExperience</span><span class="sxs-lookup"><span data-stu-id="a5e56-594">windowsSpotlightBlockWelcomeExperience</span></span>|<span data-ttu-id="a5e56-595">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-595">Boolean</span></span>|<span data-ttu-id="a5e56-596">阻止 Windows 聚焦 Windows 欢迎体验</span><span class="sxs-lookup"><span data-stu-id="a5e56-596">Block Windows Spotlight Windows welcome experience</span></span>|
|<span data-ttu-id="a5e56-597">windowsSpotlightBlockWindowsTips</span><span class="sxs-lookup"><span data-stu-id="a5e56-597">windowsSpotlightBlockWindowsTips</span></span>|<span data-ttu-id="a5e56-598">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-598">Boolean</span></span>|<span data-ttu-id="a5e56-599">允许 IT 管理员关闭 Windows 提示的弹出窗口。</span><span class="sxs-lookup"><span data-stu-id="a5e56-599">Allows IT admins to turn off the popup of Windows Tips.</span></span>|
|<span data-ttu-id="a5e56-600">windowsSpotlightConfigureOnLockScreen</span><span class="sxs-lookup"><span data-stu-id="a5e56-600">windowsSpotlightConfigureOnLockScreen</span></span>|[<span data-ttu-id="a5e56-601">windowsSpotlightEnablementSettings</span><span class="sxs-lookup"><span data-stu-id="a5e56-601">windowsSpotlightEnablementSettings</span></span>](../resources/intune-deviceconfig-windowsspotlightenablementsettings.md)|<span data-ttu-id="a5e56-602">指定聚焦的类型。</span><span class="sxs-lookup"><span data-stu-id="a5e56-602">Specifies the type of Spotlight.</span></span> <span data-ttu-id="a5e56-603">可取值为：`notConfigured`、`disabled`、`enabled`。</span><span class="sxs-lookup"><span data-stu-id="a5e56-603">Possible values are: `notConfigured`, `disabled`, `enabled`.</span></span>|
|<span data-ttu-id="a5e56-604">networkProxyApplySettingsDeviceWide</span><span class="sxs-lookup"><span data-stu-id="a5e56-604">networkProxyApplySettingsDeviceWide</span></span>|<span data-ttu-id="a5e56-605">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-605">Boolean</span></span>|<span data-ttu-id="a5e56-606">如果设置，代理设置将应用于设备中的所有进程和帐户。</span><span class="sxs-lookup"><span data-stu-id="a5e56-606">If set, proxy settings will be applied to all processes and accounts in the device.</span></span> <span data-ttu-id="a5e56-607">否则，它将应用于注册到 MDM 中的用户帐户。</span><span class="sxs-lookup"><span data-stu-id="a5e56-607">Otherwise, it will be applied to the user account that’s enrolled into MDM.</span></span>|
|<span data-ttu-id="a5e56-608">networkProxyDisableAutoDetect</span><span class="sxs-lookup"><span data-stu-id="a5e56-608">networkProxyDisableAutoDetect</span></span>|<span data-ttu-id="a5e56-609">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-609">Boolean</span></span>|<span data-ttu-id="a5e56-610">禁用自动检测设置。</span><span class="sxs-lookup"><span data-stu-id="a5e56-610">Disable automatic detection of settings.</span></span> <span data-ttu-id="a5e56-611">如果启用，系统将尝试查找代理自动配置 (PAC) 脚本的路径。</span><span class="sxs-lookup"><span data-stu-id="a5e56-611">If enabled, the system will try to find the path to a proxy auto-config (PAC) script.</span></span>|
|<span data-ttu-id="a5e56-612">networkProxyAutomaticConfigurationUrl</span><span class="sxs-lookup"><span data-stu-id="a5e56-612">networkProxyAutomaticConfigurationUrl</span></span>|<span data-ttu-id="a5e56-613">String</span><span class="sxs-lookup"><span data-stu-id="a5e56-613">String</span></span>|<span data-ttu-id="a5e56-614">指向你要使用的代理自动配置 (PAC) 脚本的地址。</span><span class="sxs-lookup"><span data-stu-id="a5e56-614">Address to the proxy auto-config (PAC) script you want to use.</span></span>|
|<span data-ttu-id="a5e56-615">networkProxyServer</span><span class="sxs-lookup"><span data-stu-id="a5e56-615">networkProxyServer</span></span>|[<span data-ttu-id="a5e56-616">windows10NetworkProxyServer</span><span class="sxs-lookup"><span data-stu-id="a5e56-616">windows10NetworkProxyServer</span></span>](../resources/intune-deviceconfig-windows10networkproxyserver.md)|<span data-ttu-id="a5e56-617">指定手动代理服务器设置。</span><span class="sxs-lookup"><span data-stu-id="a5e56-617">Specifies manual proxy server settings.</span></span>|
|<span data-ttu-id="a5e56-618">accountsBlockAddingNonMicrosoftAccountEmail</span><span class="sxs-lookup"><span data-stu-id="a5e56-618">accountsBlockAddingNonMicrosoftAccountEmail</span></span>|<span data-ttu-id="a5e56-619">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-619">Boolean</span></span>|<span data-ttu-id="a5e56-620">指示是否阻止用户将电子邮件帐户添加到未与 Microsoft 帐户关联的设备。</span><span class="sxs-lookup"><span data-stu-id="a5e56-620">Indicates whether or not to Block the user from adding email accounts to the device that are not associated with a Microsoft account.</span></span>|
|<span data-ttu-id="a5e56-621">antiTheftModeBlocked</span><span class="sxs-lookup"><span data-stu-id="a5e56-621">antiTheftModeBlocked</span></span>|<span data-ttu-id="a5e56-622">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-622">Boolean</span></span>|<span data-ttu-id="a5e56-623">指示是否阻止用户选择 AntiTheft 模式首选项（仅限 Windows 10 移动版）。</span><span class="sxs-lookup"><span data-stu-id="a5e56-623">Indicates whether or not to block the user from selecting an AntiTheft mode preference (Windows 10 Mobile only).</span></span>|
|<span data-ttu-id="a5e56-624">bluetoothBlocked</span><span class="sxs-lookup"><span data-stu-id="a5e56-624">bluetoothBlocked</span></span>|<span data-ttu-id="a5e56-625">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-625">Boolean</span></span>|<span data-ttu-id="a5e56-626">是否阻止用户使用蓝牙。</span><span class="sxs-lookup"><span data-stu-id="a5e56-626">Whether or not to Block the user from using bluetooth.</span></span>|
|<span data-ttu-id="a5e56-627">cameraBlocked</span><span class="sxs-lookup"><span data-stu-id="a5e56-627">cameraBlocked</span></span>|<span data-ttu-id="a5e56-628">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-628">Boolean</span></span>|<span data-ttu-id="a5e56-629">是否阻止用户访问设备的照相机。</span><span class="sxs-lookup"><span data-stu-id="a5e56-629">Whether or not to Block the user from accessing the camera of the device.</span></span>|
|<span data-ttu-id="a5e56-630">connectedDevicesServiceBlocked</span><span class="sxs-lookup"><span data-stu-id="a5e56-630">connectedDevicesServiceBlocked</span></span>|<span data-ttu-id="a5e56-631">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-631">Boolean</span></span>|<span data-ttu-id="a5e56-632">是否阻止能够发现并连接到其他设备、远程消息、远程应用会话和其他跨设备体验的连接设备服务。</span><span class="sxs-lookup"><span data-stu-id="a5e56-632">Whether or not to block Connected Devices Service which enables discovery and connection to other devices, remote messaging, remote app sessions and other cross-device experiences.</span></span>|
|<span data-ttu-id="a5e56-633">certificatesBlockManualRootCertificateInstallation</span><span class="sxs-lookup"><span data-stu-id="a5e56-633">certificatesBlockManualRootCertificateInstallation</span></span>|<span data-ttu-id="a5e56-634">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-634">Boolean</span></span>|<span data-ttu-id="a5e56-635">是否阻止用户执行手动根证书安装。</span><span class="sxs-lookup"><span data-stu-id="a5e56-635">Whether or not to Block the user from doing manual root certificate installation.</span></span>|
|<span data-ttu-id="a5e56-636">copyPasteBlocked</span><span class="sxs-lookup"><span data-stu-id="a5e56-636">copyPasteBlocked</span></span>|<span data-ttu-id="a5e56-637">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-637">Boolean</span></span>|<span data-ttu-id="a5e56-638">是否阻止用户使用复制粘贴。</span><span class="sxs-lookup"><span data-stu-id="a5e56-638">Whether or not to Block the user from using copy paste.</span></span>|
|<span data-ttu-id="a5e56-639">cortanaBlocked</span><span class="sxs-lookup"><span data-stu-id="a5e56-639">cortanaBlocked</span></span>|<span data-ttu-id="a5e56-640">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-640">Boolean</span></span>|<span data-ttu-id="a5e56-641">是否阻止用户使用 Cortana。</span><span class="sxs-lookup"><span data-stu-id="a5e56-641">Whether or not to Block the user from using Cortana.</span></span>|
|<span data-ttu-id="a5e56-642">deviceManagementBlockFactoryResetOnMobile</span><span class="sxs-lookup"><span data-stu-id="a5e56-642">deviceManagementBlockFactoryResetOnMobile</span></span>|<span data-ttu-id="a5e56-643">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-643">Boolean</span></span>|<span data-ttu-id="a5e56-644">指示是否阻止用户重置手机。</span><span class="sxs-lookup"><span data-stu-id="a5e56-644">Indicates whether or not to Block the user from resetting their phone.</span></span>|
|<span data-ttu-id="a5e56-645">deviceManagementBlockManualUnenroll</span><span class="sxs-lookup"><span data-stu-id="a5e56-645">deviceManagementBlockManualUnenroll</span></span>|<span data-ttu-id="a5e56-646">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-646">Boolean</span></span>|<span data-ttu-id="a5e56-647">指示是否阻止用户从设备管理手动取消注册。</span><span class="sxs-lookup"><span data-stu-id="a5e56-647">Indicates whether or not to Block the user from doing manual un-enrollment from device management.</span></span>|
|<span data-ttu-id="a5e56-648">safeSearchFilter</span><span class="sxs-lookup"><span data-stu-id="a5e56-648">safeSearchFilter</span></span>|[<span data-ttu-id="a5e56-649">safeSearchFilterType</span><span class="sxs-lookup"><span data-stu-id="a5e56-649">safeSearchFilterType</span></span>](../resources/intune-deviceconfig-safesearchfiltertype.md)|<span data-ttu-id="a5e56-650">指定需要的安全搜索筛选级别。</span><span class="sxs-lookup"><span data-stu-id="a5e56-650">Specifies what filter level of safe search is required.</span></span> <span data-ttu-id="a5e56-651">可取值为：`userDefined`、`strict`、`moderate`。</span><span class="sxs-lookup"><span data-stu-id="a5e56-651">Possible values are: `userDefined`, `strict`, `moderate`.</span></span>|
|<span data-ttu-id="a5e56-652">edgeBlockPopups</span><span class="sxs-lookup"><span data-stu-id="a5e56-652">edgeBlockPopups</span></span>|<span data-ttu-id="a5e56-653">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-653">Boolean</span></span>|<span data-ttu-id="a5e56-654">指示是否阻止弹出窗口。</span><span class="sxs-lookup"><span data-stu-id="a5e56-654">Indicates whether or not to block popups.</span></span>|
|<span data-ttu-id="a5e56-655">edgeBlockSearchSuggestions</span><span class="sxs-lookup"><span data-stu-id="a5e56-655">edgeBlockSearchSuggestions</span></span>|<span data-ttu-id="a5e56-656">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-656">Boolean</span></span>|<span data-ttu-id="a5e56-657">指示是否阻止用户使用地址栏中的搜索建议。</span><span class="sxs-lookup"><span data-stu-id="a5e56-657">Indicates whether or not to block the user from using the search suggestions in the address bar.</span></span>|
|<span data-ttu-id="a5e56-658">edgeBlockSendingIntranetTrafficToInternetExplorer</span><span class="sxs-lookup"><span data-stu-id="a5e56-658">edgeBlockSendingIntranetTrafficToInternetExplorer</span></span>|<span data-ttu-id="a5e56-659">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-659">Boolean</span></span>|<span data-ttu-id="a5e56-660">指示是否将 Intranet 流量从 Edge 切换到 Internet Explorer。</span><span class="sxs-lookup"><span data-stu-id="a5e56-660">Indicates whether or not to switch the intranet traffic from Edge to Internet Explorer.</span></span> <span data-ttu-id="a5e56-661">注意：此属性的名称令人误解;属性已过时，请改为使用 EdgeSendIntranetTrafficToInternetExplorer。</span><span class="sxs-lookup"><span data-stu-id="a5e56-661">Note: the name of this property is misleading; the property is obsolete, use EdgeSendIntranetTrafficToInternetExplorer instead.</span></span>|
|<span data-ttu-id="a5e56-662">edgeSendIntranetTrafficToInternetExplorer</span><span class="sxs-lookup"><span data-stu-id="a5e56-662">edgeSendIntranetTrafficToInternetExplorer</span></span>|<span data-ttu-id="a5e56-663">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-663">Boolean</span></span>|<span data-ttu-id="a5e56-664">指示是否将 Intranet 流量从 Edge 切换到 Internet Explorer。</span><span class="sxs-lookup"><span data-stu-id="a5e56-664">Indicates whether or not to switch the intranet traffic from Edge to Internet Explorer.</span></span>|
|<span data-ttu-id="a5e56-665">edgeRequireSmartScreen</span><span class="sxs-lookup"><span data-stu-id="a5e56-665">edgeRequireSmartScreen</span></span>|<span data-ttu-id="a5e56-666">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-666">Boolean</span></span>|<span data-ttu-id="a5e56-667">指示是否要求用户使用智能屏蔽筛选器。</span><span class="sxs-lookup"><span data-stu-id="a5e56-667">Indicates whether or not to Require the user to use the smart screen filter.</span></span>|
|<span data-ttu-id="a5e56-668">edgeEnterpriseModeSiteListLocation</span><span class="sxs-lookup"><span data-stu-id="a5e56-668">edgeEnterpriseModeSiteListLocation</span></span>|<span data-ttu-id="a5e56-669">String</span><span class="sxs-lookup"><span data-stu-id="a5e56-669">String</span></span>|<span data-ttu-id="a5e56-670">指示企业模式站点列表位置。</span><span class="sxs-lookup"><span data-stu-id="a5e56-670">Indicates the enterprise mode site list location.</span></span> <span data-ttu-id="a5e56-671">可能是本地文件、本地网络或 http 位置。</span><span class="sxs-lookup"><span data-stu-id="a5e56-671">Could be a local file, local network or http location.</span></span>|
|<span data-ttu-id="a5e56-672">edgeFirstRunUrl</span><span class="sxs-lookup"><span data-stu-id="a5e56-672">edgeFirstRunUrl</span></span>|<span data-ttu-id="a5e56-673">String</span><span class="sxs-lookup"><span data-stu-id="a5e56-673">String</span></span>|<span data-ttu-id="a5e56-674">第一次打开 Edge 浏览器时的首个运行 URL。</span><span class="sxs-lookup"><span data-stu-id="a5e56-674">The first run URL for when Edge browser is opened for the first time.</span></span>|
|<span data-ttu-id="a5e56-675">edgeSearchEngine</span><span class="sxs-lookup"><span data-stu-id="a5e56-675">edgeSearchEngine</span></span>|[<span data-ttu-id="a5e56-676">edgeSearchEngineBase</span><span class="sxs-lookup"><span data-stu-id="a5e56-676">edgeSearchEngineBase</span></span>](../resources/intune-deviceconfig-edgesearchenginebase.md)|<span data-ttu-id="a5e56-677">允许 IT 管理员为 MDM 控制的设备设置默认搜索引擎。</span><span class="sxs-lookup"><span data-stu-id="a5e56-677">Allows IT admins to set a default search engine for MDM-Controlled devices.</span></span> <span data-ttu-id="a5e56-678">如果未设置 AllowSearchEngineCustomization 策略，则用户可以替代此设置并更改其默认搜索引擎。</span><span class="sxs-lookup"><span data-stu-id="a5e56-678">Users can override this and change their default search engine provided the AllowSearchEngineCustomization policy is not set.</span></span>|
|<span data-ttu-id="a5e56-679">edgeHomepageUrls</span><span class="sxs-lookup"><span data-stu-id="a5e56-679">edgeHomepageUrls</span></span>|<span data-ttu-id="a5e56-680">String 集合</span><span class="sxs-lookup"><span data-stu-id="a5e56-680">String collection</span></span>|<span data-ttu-id="a5e56-681">Edge 浏览器上 MDM 注册设备上的主页 URL 列表。</span><span class="sxs-lookup"><span data-stu-id="a5e56-681">The list of URLs for homepages shodwn on MDM-enrolled devices on Edge browser.</span></span>|
|<span data-ttu-id="a5e56-682">edgeBlockAccessToAboutFlags</span><span class="sxs-lookup"><span data-stu-id="a5e56-682">edgeBlockAccessToAboutFlags</span></span>|<span data-ttu-id="a5e56-683">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-683">Boolean</span></span>|<span data-ttu-id="a5e56-684">指示是否阻止访问 Edge 浏览器上关于标志的信息。</span><span class="sxs-lookup"><span data-stu-id="a5e56-684">Indicates whether or not to prevent access to about flags on Edge browser.</span></span>|
|<span data-ttu-id="a5e56-685">smartScreenBlockPromptOverride</span><span class="sxs-lookup"><span data-stu-id="a5e56-685">smartScreenBlockPromptOverride</span></span>|<span data-ttu-id="a5e56-686">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-686">Boolean</span></span>|<span data-ttu-id="a5e56-687">指示用户是否可以替代有关潜在恶意网站的 SmartScreen 筛选器警告。</span><span class="sxs-lookup"><span data-stu-id="a5e56-687">Indicates whether or not users can override SmartScreen Filter warnings about potentially malicious websites.</span></span>|
|<span data-ttu-id="a5e56-688">smartScreenBlockPromptOverrideForFiles</span><span class="sxs-lookup"><span data-stu-id="a5e56-688">smartScreenBlockPromptOverrideForFiles</span></span>|<span data-ttu-id="a5e56-689">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-689">Boolean</span></span>|<span data-ttu-id="a5e56-690">指示用户是否可以覆盖关于下载未验证文件的 SmartScreen 筛选器警告</span><span class="sxs-lookup"><span data-stu-id="a5e56-690">Indicates whether or not users can override the SmartScreen Filter warnings about downloading unverified files</span></span>|
|<span data-ttu-id="a5e56-691">webRtcBlockLocalhostIpAddress</span><span class="sxs-lookup"><span data-stu-id="a5e56-691">webRtcBlockLocalhostIpAddress</span></span>|<span data-ttu-id="a5e56-692">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-692">Boolean</span></span>|<span data-ttu-id="a5e56-693">指示在使用 WebRTC 拨打电话时是否显示用户的本地主机 IP 地址</span><span class="sxs-lookup"><span data-stu-id="a5e56-693">Indicates whether or not user's localhost IP address is displayed while making phone calls using the WebRTC</span></span>|
|<span data-ttu-id="a5e56-694">internetSharingBlocked</span><span class="sxs-lookup"><span data-stu-id="a5e56-694">internetSharingBlocked</span></span>|<span data-ttu-id="a5e56-695">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-695">Boolean</span></span>|<span data-ttu-id="a5e56-696">指示是否阻止用户使用 Internet 共享。</span><span class="sxs-lookup"><span data-stu-id="a5e56-696">Indicates whether or not to Block the user from using internet sharing.</span></span>|
|<span data-ttu-id="a5e56-697">settingsBlockAddProvisioningPackage</span><span class="sxs-lookup"><span data-stu-id="a5e56-697">settingsBlockAddProvisioningPackage</span></span>|<span data-ttu-id="a5e56-698">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-698">Boolean</span></span>|<span data-ttu-id="a5e56-699">指示是否阻止用户安装预配程序包。</span><span class="sxs-lookup"><span data-stu-id="a5e56-699">Indicates whether or not to block the user from installing provisioning packages.</span></span>|
|<span data-ttu-id="a5e56-700">settingsBlockRemoveProvisioningPackage</span><span class="sxs-lookup"><span data-stu-id="a5e56-700">settingsBlockRemoveProvisioningPackage</span></span>|<span data-ttu-id="a5e56-701">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-701">Boolean</span></span>|<span data-ttu-id="a5e56-702">指示是否阻止运行时配置代理删除预配程序包。</span><span class="sxs-lookup"><span data-stu-id="a5e56-702">Indicates whether or not to block the runtime configuration agent from removing provisioning packages.</span></span>|
|<span data-ttu-id="a5e56-703">settingsBlockChangeSystemTime</span><span class="sxs-lookup"><span data-stu-id="a5e56-703">settingsBlockChangeSystemTime</span></span>|<span data-ttu-id="a5e56-704">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-704">Boolean</span></span>|<span data-ttu-id="a5e56-705">指示是否阻止用户更改日期和时间设置。</span><span class="sxs-lookup"><span data-stu-id="a5e56-705">Indicates whether or not to block the user from changing date and time settings.</span></span>|
|<span data-ttu-id="a5e56-706">settingsBlockEditDeviceName</span><span class="sxs-lookup"><span data-stu-id="a5e56-706">settingsBlockEditDeviceName</span></span>|<span data-ttu-id="a5e56-707">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-707">Boolean</span></span>|<span data-ttu-id="a5e56-708">指示是否阻止用户编辑设备名称。</span><span class="sxs-lookup"><span data-stu-id="a5e56-708">Indicates whether or not to block the user from editing the device name.</span></span>|
|<span data-ttu-id="a5e56-709">settingsBlockChangeRegion</span><span class="sxs-lookup"><span data-stu-id="a5e56-709">settingsBlockChangeRegion</span></span>|<span data-ttu-id="a5e56-710">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-710">Boolean</span></span>|<span data-ttu-id="a5e56-711">指示是否阻止用户更改区域设置。</span><span class="sxs-lookup"><span data-stu-id="a5e56-711">Indicates whether or not to block the user from changing the region settings.</span></span>|
|<span data-ttu-id="a5e56-712">settingsBlockChangeLanguage</span><span class="sxs-lookup"><span data-stu-id="a5e56-712">settingsBlockChangeLanguage</span></span>|<span data-ttu-id="a5e56-713">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-713">Boolean</span></span>|<span data-ttu-id="a5e56-714">指示是否阻止用户更改语言设置。</span><span class="sxs-lookup"><span data-stu-id="a5e56-714">Indicates whether or not to block the user from changing the language settings.</span></span>|
|<span data-ttu-id="a5e56-715">settingsBlockChangePowerSleep</span><span class="sxs-lookup"><span data-stu-id="a5e56-715">settingsBlockChangePowerSleep</span></span>|<span data-ttu-id="a5e56-716">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-716">Boolean</span></span>|<span data-ttu-id="a5e56-717">指示是否阻止用户更改电源和睡眠设置。</span><span class="sxs-lookup"><span data-stu-id="a5e56-717">Indicates whether or not to block the user from changing power and sleep settings.</span></span>|
|<span data-ttu-id="a5e56-718">locationServicesBlocked</span><span class="sxs-lookup"><span data-stu-id="a5e56-718">locationServicesBlocked</span></span>|<span data-ttu-id="a5e56-719">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-719">Boolean</span></span>|<span data-ttu-id="a5e56-720">指示是否阻止用户使用位置服务。</span><span class="sxs-lookup"><span data-stu-id="a5e56-720">Indicates whether or not to Block the user from location services.</span></span>|
|<span data-ttu-id="a5e56-721">microsoftAccountBlocked</span><span class="sxs-lookup"><span data-stu-id="a5e56-721">microsoftAccountBlocked</span></span>|<span data-ttu-id="a5e56-722">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-722">Boolean</span></span>|<span data-ttu-id="a5e56-723">指示是否阻止 Microsoft 帐户。</span><span class="sxs-lookup"><span data-stu-id="a5e56-723">Indicates whether or not to Block a Microsoft account.</span></span>|
|<span data-ttu-id="a5e56-724">microsoftAccountBlockSettingsSync</span><span class="sxs-lookup"><span data-stu-id="a5e56-724">microsoftAccountBlockSettingsSync</span></span>|<span data-ttu-id="a5e56-725">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-725">Boolean</span></span>|<span data-ttu-id="a5e56-726">指示是否阻止 Microsoft 帐户设置同步。</span><span class="sxs-lookup"><span data-stu-id="a5e56-726">Indicates whether or not to Block Microsoft account settings sync.</span></span>|
|<span data-ttu-id="a5e56-727">nfcBlocked</span><span class="sxs-lookup"><span data-stu-id="a5e56-727">nfcBlocked</span></span>|<span data-ttu-id="a5e56-728">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-728">Boolean</span></span>|<span data-ttu-id="a5e56-729">指示是否阻止用户使用近场通信。</span><span class="sxs-lookup"><span data-stu-id="a5e56-729">Indicates whether or not to Block the user from using near field communication.</span></span>|
|<span data-ttu-id="a5e56-730">resetProtectionModeBlocked</span><span class="sxs-lookup"><span data-stu-id="a5e56-730">resetProtectionModeBlocked</span></span>|<span data-ttu-id="a5e56-731">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-731">Boolean</span></span>|<span data-ttu-id="a5e56-732">指示是否阻止用户进入重置保护模式。</span><span class="sxs-lookup"><span data-stu-id="a5e56-732">Indicates whether or not to Block the user from reset protection mode.</span></span>|
|<span data-ttu-id="a5e56-733">screenCaptureBlocked</span><span class="sxs-lookup"><span data-stu-id="a5e56-733">screenCaptureBlocked</span></span>|<span data-ttu-id="a5e56-734">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-734">Boolean</span></span>|<span data-ttu-id="a5e56-735">指示是否阻止用户进行屏幕截图。</span><span class="sxs-lookup"><span data-stu-id="a5e56-735">Indicates whether or not to Block the user from taking Screenshots.</span></span>|
|<span data-ttu-id="a5e56-736">storageBlockRemovableStorage</span><span class="sxs-lookup"><span data-stu-id="a5e56-736">storageBlockRemovableStorage</span></span>|<span data-ttu-id="a5e56-737">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-737">Boolean</span></span>|<span data-ttu-id="a5e56-738">指示是否阻止用户使用可移动存储。</span><span class="sxs-lookup"><span data-stu-id="a5e56-738">Indicates whether or not to Block the user from using removable storage.</span></span>|
|<span data-ttu-id="a5e56-739">storageRequireMobileDeviceEncryption</span><span class="sxs-lookup"><span data-stu-id="a5e56-739">storageRequireMobileDeviceEncryption</span></span>|<span data-ttu-id="a5e56-740">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-740">Boolean</span></span>|<span data-ttu-id="a5e56-741">指示是否需要在移动设备上进行加密。</span><span class="sxs-lookup"><span data-stu-id="a5e56-741">Indicating whether or not to require encryption on a mobile device.</span></span>|
|<span data-ttu-id="a5e56-742">usbBlocked</span><span class="sxs-lookup"><span data-stu-id="a5e56-742">usbBlocked</span></span>|<span data-ttu-id="a5e56-743">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-743">Boolean</span></span>|<span data-ttu-id="a5e56-744">指示是否阻止用户使用 USB 连接。</span><span class="sxs-lookup"><span data-stu-id="a5e56-744">Indicates whether or not to Block the user from USB connection.</span></span>|
|<span data-ttu-id="a5e56-745">voiceRecordingBlocked</span><span class="sxs-lookup"><span data-stu-id="a5e56-745">voiceRecordingBlocked</span></span>|<span data-ttu-id="a5e56-746">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-746">Boolean</span></span>|<span data-ttu-id="a5e56-747">指示是否阻止用户进行语音录制。</span><span class="sxs-lookup"><span data-stu-id="a5e56-747">Indicates whether or not to Block the user from voice recording.</span></span>|
|<span data-ttu-id="a5e56-748">wiFiBlockAutomaticConnectHotspots</span><span class="sxs-lookup"><span data-stu-id="a5e56-748">wiFiBlockAutomaticConnectHotspots</span></span>|<span data-ttu-id="a5e56-749">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-749">Boolean</span></span>|<span data-ttu-id="a5e56-750">指示是否阻止自动连接到 Wi-Fi 热点。</span><span class="sxs-lookup"><span data-stu-id="a5e56-750">Indicating whether or not to block automatically connecting to Wi-Fi hotspots.</span></span> <span data-ttu-id="a5e56-751">如果 Wi-Fi 被阻止，没有任何影响。</span><span class="sxs-lookup"><span data-stu-id="a5e56-751">Has no impact if Wi-Fi is blocked.</span></span>|
|<span data-ttu-id="a5e56-752">wiFiBlocked</span><span class="sxs-lookup"><span data-stu-id="a5e56-752">wiFiBlocked</span></span>|<span data-ttu-id="a5e56-753">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-753">Boolean</span></span>|<span data-ttu-id="a5e56-754">指示是否阻止用户使用 Wi-Fi。</span><span class="sxs-lookup"><span data-stu-id="a5e56-754">Indicates whether or not to Block the user from using Wi-Fi.</span></span>|
|<span data-ttu-id="a5e56-755">wiFiBlockManualConfiguration</span><span class="sxs-lookup"><span data-stu-id="a5e56-755">wiFiBlockManualConfiguration</span></span>|<span data-ttu-id="a5e56-756">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-756">Boolean</span></span>|<span data-ttu-id="a5e56-757">指示是否阻止用户使用 Wi-Fi 手动配置。</span><span class="sxs-lookup"><span data-stu-id="a5e56-757">Indicates whether or not to Block the user from using Wi-Fi manual configuration.</span></span>|
|<span data-ttu-id="a5e56-758">wiFiScanInterval</span><span class="sxs-lookup"><span data-stu-id="a5e56-758">wiFiScanInterval</span></span>|<span data-ttu-id="a5e56-759">Int32</span><span class="sxs-lookup"><span data-stu-id="a5e56-759">Int32</span></span>|<span data-ttu-id="a5e56-760">指定设备扫描 Wi-Fi 网络的频率。</span><span class="sxs-lookup"><span data-stu-id="a5e56-760">Specify how often devices scan for Wi-Fi networks.</span></span> <span data-ttu-id="a5e56-761">支持的值是 1-500，其中 100 为默认值，500 为低频率。</span><span class="sxs-lookup"><span data-stu-id="a5e56-761">Supported values are 1-500, where 100 = default, and 500 = low frequency.</span></span> <span data-ttu-id="a5e56-762">有效值为 1 至 500</span><span class="sxs-lookup"><span data-stu-id="a5e56-762">Valid values 1 to 500</span></span>|
|<span data-ttu-id="a5e56-763">wirelessDisplayBlockProjectionToThisDevice</span><span class="sxs-lookup"><span data-stu-id="a5e56-763">wirelessDisplayBlockProjectionToThisDevice</span></span>|<span data-ttu-id="a5e56-764">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-764">Boolean</span></span>|<span data-ttu-id="a5e56-765">指示是否允许其他设备发现此电脑进行投影。</span><span class="sxs-lookup"><span data-stu-id="a5e56-765">Indicates whether or not to allow other devices from discovering this PC for projection.</span></span>|
|<span data-ttu-id="a5e56-766">wirelessDisplayBlockUserInputFromReceiver</span><span class="sxs-lookup"><span data-stu-id="a5e56-766">wirelessDisplayBlockUserInputFromReceiver</span></span>|<span data-ttu-id="a5e56-767">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-767">Boolean</span></span>|<span data-ttu-id="a5e56-768">指示是否允许来自无线显示接收器的用户输入。</span><span class="sxs-lookup"><span data-stu-id="a5e56-768">Indicates whether or not to allow user input from wireless display receiver.</span></span>|
|<span data-ttu-id="a5e56-769">wirelessDisplayRequirePinForPairing</span><span class="sxs-lookup"><span data-stu-id="a5e56-769">wirelessDisplayRequirePinForPairing</span></span>|<span data-ttu-id="a5e56-770">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-770">Boolean</span></span>|<span data-ttu-id="a5e56-771">指示是否需要新设备的 PIN 才能启动配对。</span><span class="sxs-lookup"><span data-stu-id="a5e56-771">Indicates whether or not to require a PIN for new devices to initiate pairing.</span></span>|
|<span data-ttu-id="a5e56-772">windowsStoreBlocked</span><span class="sxs-lookup"><span data-stu-id="a5e56-772">windowsStoreBlocked</span></span>|<span data-ttu-id="a5e56-773">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-773">Boolean</span></span>|<span data-ttu-id="a5e56-774">指示是否阻止用户使用 Windows 应用商店。</span><span class="sxs-lookup"><span data-stu-id="a5e56-774">Indicates whether or not to Block the user from using the Windows store.</span></span>|
|<span data-ttu-id="a5e56-775">appsAllowTrustedAppsSideloading</span><span class="sxs-lookup"><span data-stu-id="a5e56-775">appsAllowTrustedAppsSideloading</span></span>|[<span data-ttu-id="a5e56-776">stateManagementSetting</span><span class="sxs-lookup"><span data-stu-id="a5e56-776">stateManagementSetting</span></span>](../resources/intune-deviceconfig-statemanagementsetting.md)|<span data-ttu-id="a5e56-777">指示是否可以旁加载使用可信证书签名的来自 AppX 程序包的应用。</span><span class="sxs-lookup"><span data-stu-id="a5e56-777">Indicates whether apps from AppX packages signed with a trusted certificate can be side loaded.</span></span> <span data-ttu-id="a5e56-778">可取值为：`notConfigured`、`blocked`、`allowed`。</span><span class="sxs-lookup"><span data-stu-id="a5e56-778">Possible values are: `notConfigured`, `blocked`, `allowed`.</span></span>|
|<span data-ttu-id="a5e56-779">windowsStoreBlockAutoUpdate</span><span class="sxs-lookup"><span data-stu-id="a5e56-779">windowsStoreBlockAutoUpdate</span></span>|<span data-ttu-id="a5e56-780">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-780">Boolean</span></span>|<span data-ttu-id="a5e56-781">指示是否阻止从 Windows 应用商店自动更新应用。</span><span class="sxs-lookup"><span data-stu-id="a5e56-781">Indicates whether or not to block automatic update of apps from Windows Store.</span></span>|
|<span data-ttu-id="a5e56-782">developerUnlockSetting</span><span class="sxs-lookup"><span data-stu-id="a5e56-782">developerUnlockSetting</span></span>|[<span data-ttu-id="a5e56-783">stateManagementSetting</span><span class="sxs-lookup"><span data-stu-id="a5e56-783">stateManagementSetting</span></span>](../resources/intune-deviceconfig-statemanagementsetting.md)|<span data-ttu-id="a5e56-784">指示是否允许开发人员解锁。</span><span class="sxs-lookup"><span data-stu-id="a5e56-784">Indicates whether or not to allow developer unlock.</span></span> <span data-ttu-id="a5e56-785">可取值为：`notConfigured`、`blocked`、`allowed`。</span><span class="sxs-lookup"><span data-stu-id="a5e56-785">Possible values are: `notConfigured`, `blocked`, `allowed`.</span></span>|
|<span data-ttu-id="a5e56-786">sharedUserAppDataAllowed</span><span class="sxs-lookup"><span data-stu-id="a5e56-786">sharedUserAppDataAllowed</span></span>|<span data-ttu-id="a5e56-787">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-787">Boolean</span></span>|<span data-ttu-id="a5e56-788">指示是否阻止同一应用的多个用户共享数据。</span><span class="sxs-lookup"><span data-stu-id="a5e56-788">Indicates whether or not to block multiple users of the same app to share data.</span></span>|
|<span data-ttu-id="a5e56-789">appsBlockWindowsStoreOriginatedApps</span><span class="sxs-lookup"><span data-stu-id="a5e56-789">appsBlockWindowsStoreOriginatedApps</span></span>|<span data-ttu-id="a5e56-790">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-790">Boolean</span></span>|<span data-ttu-id="a5e56-791">指示是否禁用启动 Windows 应用商店中预先安装或已下载的所有应用。</span><span class="sxs-lookup"><span data-stu-id="a5e56-791">Indicates whether or not to disable the launch of all apps from Windows Store that came pre-installed or were downloaded.</span></span>|
|<span data-ttu-id="a5e56-792">windowsStoreEnablePrivateStoreOnly</span><span class="sxs-lookup"><span data-stu-id="a5e56-792">windowsStoreEnablePrivateStoreOnly</span></span>|<span data-ttu-id="a5e56-793">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-793">Boolean</span></span>|<span data-ttu-id="a5e56-794">指示是否启用“仅限专用应用商店”。</span><span class="sxs-lookup"><span data-stu-id="a5e56-794">Indicates whether or not to enable Private Store Only.</span></span>|
|<span data-ttu-id="a5e56-795">storageRestrictAppDataToSystemVolume</span><span class="sxs-lookup"><span data-stu-id="a5e56-795">storageRestrictAppDataToSystemVolume</span></span>|<span data-ttu-id="a5e56-796">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-796">Boolean</span></span>|<span data-ttu-id="a5e56-797">指示应用程序数据是否仅限于系统驱动器。</span><span class="sxs-lookup"><span data-stu-id="a5e56-797">Indicates whether application data is restricted to the system drive.</span></span>|
|<span data-ttu-id="a5e56-798">storageRestrictAppInstallToSystemVolume</span><span class="sxs-lookup"><span data-stu-id="a5e56-798">storageRestrictAppInstallToSystemVolume</span></span>|<span data-ttu-id="a5e56-799">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-799">Boolean</span></span>|<span data-ttu-id="a5e56-800">指示应用程序的安装是否仅限于系统驱动器。</span><span class="sxs-lookup"><span data-stu-id="a5e56-800">Indicates whether the installation of applications is restricted to the system drive.</span></span>|
|<span data-ttu-id="a5e56-801">gameDvrBlocked</span><span class="sxs-lookup"><span data-stu-id="a5e56-801">gameDvrBlocked</span></span>|<span data-ttu-id="a5e56-802">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-802">Boolean</span></span>|<span data-ttu-id="a5e56-803">指示是否阻止 DVR 和广播。</span><span class="sxs-lookup"><span data-stu-id="a5e56-803">Indicates whether or not to block DVR and broadcasting.</span></span>|
|<span data-ttu-id="a5e56-804">experienceBlockDeviceDiscovery</span><span class="sxs-lookup"><span data-stu-id="a5e56-804">experienceBlockDeviceDiscovery</span></span>|<span data-ttu-id="a5e56-805">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-805">Boolean</span></span>|<span data-ttu-id="a5e56-806">指示是否启用设备发现 UX。</span><span class="sxs-lookup"><span data-stu-id="a5e56-806">Indicates whether or not to enable device discovery UX.</span></span>|
|<span data-ttu-id="a5e56-807">experienceBlockErrorDialogWhenNoSIM</span><span class="sxs-lookup"><span data-stu-id="a5e56-807">experienceBlockErrorDialogWhenNoSIM</span></span>|<span data-ttu-id="a5e56-808">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-808">Boolean</span></span>|<span data-ttu-id="a5e56-809">指示是否允许在未检测到 SIM 卡时显示错误对话框。</span><span class="sxs-lookup"><span data-stu-id="a5e56-809">Indicates whether or not to allow the error dialog from displaying if no SIM card is detected.</span></span>|
|<span data-ttu-id="a5e56-810">experienceBlockTaskSwitcher</span><span class="sxs-lookup"><span data-stu-id="a5e56-810">experienceBlockTaskSwitcher</span></span>|<span data-ttu-id="a5e56-811">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-811">Boolean</span></span>|<span data-ttu-id="a5e56-812">指示是否在设备上启用任务切换。</span><span class="sxs-lookup"><span data-stu-id="a5e56-812">Indicates whether or not to enable task switching on the device.</span></span>|
|<span data-ttu-id="a5e56-813">logonBlockFastUserSwitching</span><span class="sxs-lookup"><span data-stu-id="a5e56-813">logonBlockFastUserSwitching</span></span>|<span data-ttu-id="a5e56-814">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-814">Boolean</span></span>|<span data-ttu-id="a5e56-815">禁用在不注销的情况下在同时登录的用户之间快速切换的功能。</span><span class="sxs-lookup"><span data-stu-id="a5e56-815">Disables the ability to quickly switch between users that are logged on simultaneously without logging off.</span></span>|
|<span data-ttu-id="a5e56-816">tenantLockdownRequireNetworkDuringOutOfBoxExperience</span><span class="sxs-lookup"><span data-stu-id="a5e56-816">tenantLockdownRequireNetworkDuringOutOfBoxExperience</span></span>|<span data-ttu-id="a5e56-817">Boolean</span><span class="sxs-lookup"><span data-stu-id="a5e56-817">Boolean</span></span>|<span data-ttu-id="a5e56-818">设备是否需要连接到网络。</span><span class="sxs-lookup"><span data-stu-id="a5e56-818">Whether the device is required to connect to the network.</span></span>|



## <a name="response"></a><span data-ttu-id="a5e56-819">响应</span><span class="sxs-lookup"><span data-stu-id="a5e56-819">Response</span></span>
<span data-ttu-id="a5e56-820">如果成功，此方法在响应正文中返回 `200 OK` 响应代码和更新的 [windows10GeneralConfiguration](../resources/intune-deviceconfig-windows10generalconfiguration.md) 对象。</span><span class="sxs-lookup"><span data-stu-id="a5e56-820">If successful, this method returns a `200 OK` response code and an updated [windows10GeneralConfiguration](../resources/intune-deviceconfig-windows10generalconfiguration.md) object in the response body.</span></span>

## <a name="example"></a><span data-ttu-id="a5e56-821">示例</span><span class="sxs-lookup"><span data-stu-id="a5e56-821">Example</span></span>

### <a name="request"></a><span data-ttu-id="a5e56-822">请求</span><span class="sxs-lookup"><span data-stu-id="a5e56-822">Request</span></span>
<span data-ttu-id="a5e56-823">下面是一个请求示例。</span><span class="sxs-lookup"><span data-stu-id="a5e56-823">Here is an example of the request.</span></span>
``` http
...
### <a name="response"></a><span data-ttu-id="a5e56-824">响应</span><span class="sxs-lookup"><span data-stu-id="a5e56-824">Response</span></span>
<span data-ttu-id="a5e56-p159">下面是一个响应示例。注意：为了简单起见，可能会将此处所示的响应对象截断。将从实际调用中返回所有属性。</span><span class="sxs-lookup"><span data-stu-id="a5e56-p159">Here is an example of the response. Note: The response object shown here may be truncated for brevity. All of the properties will be returned from an actual call.</span></span>
``` http
HTTP/1.1 200 OK
Content-Type: application/json
Content-Length: 9994
