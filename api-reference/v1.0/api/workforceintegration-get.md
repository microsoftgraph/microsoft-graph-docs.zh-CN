...
ms.locfileid: "61022726"
---
# <a name="get-workforceintegration"></a>获取工作人员集成
...
如果成功，此方法在响应正文中返回 响应代码和请求 `200 OK` [的 workforceIntegration](../resources/workforceintegration.md) 对象。
