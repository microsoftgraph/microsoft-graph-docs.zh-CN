...
云视频互操作 (CVI) 机器人代表视频电话会议 (VTC) 设备，并充当电话会议中 VTC 设备的后端到后端代理。 由于 CVI 机器人位于 VTC 中间，并且Microsoft Teams作为 VTC 代理，因此它具有两个媒体段。 一个媒体段位于 CVI 自动程序Teams基础结构之间，例如Teams服务器或 Teams 客户端。 另一个媒体段位于 CVI 机器人和 VTC 设备之间。 
