...
在 Azure AD B2C 中，创建新的 [socialIdentityProvider](../resources/socialidentityprovider.md) 对象。
...
### <a name="example-1-create-a-specific-social-identity-provider-azure-ad-and-azure-ad-b2c"></a>示例 1：在 Azure AD 和 Azure AD B2C (创建特定的社会标识) 
