...
创建新的 [mobileAppContent](../resources/intune-apps-mobileappcontent.md) 对象。
...
如果成功，此方法将在响应正文中返回 `201 Created` 响应代码和 [mobileAppContent](../resources/intune-apps-mobileappcontent.md) 对象。
