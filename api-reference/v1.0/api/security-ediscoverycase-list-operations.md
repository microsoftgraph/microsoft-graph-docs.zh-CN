...
description: 获取 caseOperation 对象及其属性的列表。
author: SeunginLyu
...
ms.locfileid: "66839205"
---
# <a name="list-caseoperations"></a>List caseOperations
命名空间：microsoft.graph.security



获取 [caseOperation](../resources/security-caseoperation.md) 对象及其属性的列表。
...
如果成功，此方法在响应正文中返回 `200 OK` 响应代码和 [microsoft.graph.security.caseOperation](../resources/security-caseoperation.md) 对象集合。
