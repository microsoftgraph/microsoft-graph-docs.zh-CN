...
description: 从 checklistItems 导航属性获取与 todoTask 关联的 checklistItem 资源。
author: avijityadav
...
ms.locfileid: "65821322"
---
# <a name="list-checklistitems"></a>列出 checklistItems
命名空间：microsoft.graph

从 checklistItems 导航属性获取与 [todoTask](../resources/todoTask.md) 关联的 [checklistItem](../resources/checklistitem.md) 资源。
