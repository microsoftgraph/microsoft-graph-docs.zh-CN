...
创建新的 [managedAppOperation](../resources/intune_mam_managedappoperation.md) 对象。
...
在请求正文中，提供 managedAppOperation 对象的 JSON 表示形式。

下表显示创建 managedAppOperation 时所需的属性。
...
如果成功，此方法在响应正文中返回 `201 Created` 响应代码和 [managedAppOperation](../resources/intune_mam_managedappoperation.md) 对象。
