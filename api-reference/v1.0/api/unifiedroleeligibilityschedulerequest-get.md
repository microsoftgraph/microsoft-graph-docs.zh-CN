...
description: 在 PIM 中，阅读通过 unifiedRoleEligibilityScheduleRequest 对象发出的角色资格请求请求的详细信息。
author: rkarim-ms
...
ms.locfileid: "65204727"
---
# <a name="get-unifiedroleeligibilityschedulerequest"></a>获取 unifiedRoleEligibilityScheduleRequest
命名空间：microsoft.graph

在 PIM 中，阅读通过 [unifiedRoleEligibilityScheduleRequest](../resources/unifiedroleeligibilityschedulerequest.md) 对象发出的角色资格请求请求的详细信息。
...
此方法支持 `$select` OData 查询参数， `$expand` 以帮助自定义响应。 可以扩展所有受支持的关系。 若要了解一般信息，请参阅 [OData 查询参数](/graph/query-parameters)。
