...
读取 [iosManagedAppProtection](../resources/intune_mam_iosmanagedappprotection.md) 对象的属性和关系。
...
如果成功，此方法在响应正文中返回 `200 OK` 响应代码和 [iosManagedAppProtection](../resources/intune_mam_iosmanagedappprotection.md) 对象。
