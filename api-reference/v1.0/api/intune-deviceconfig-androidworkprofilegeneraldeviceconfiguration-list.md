...
如果成功，此方法在响应正文中返回 `200 OK` 响应代码和 [androidWorkProfileGeneralDeviceConfiguration](../resources/intune-deviceconfig-androidworkprofilegeneraldeviceconfiguration.md) 对象的集合。
