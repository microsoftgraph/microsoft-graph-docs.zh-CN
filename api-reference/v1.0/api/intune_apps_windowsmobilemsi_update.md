...
更新 [windowsMobileMSI](../resources/intune_apps_windowsmobilemsi.md) 对象的属性。
...
在请求正文中，提供 [windowsMobileMSI](../resources/intune_apps_windowsmobilemsi.md) 对象的 JSON 表示形式。

下表显示创建 [windowsMobileMSI](../resources/intune_apps_windowsmobilemsi.md) 时所需的属性。
...
|ignoreVersionDetection|布尔|控制应用的版本是否将用于检测安装在设备上的应用的布尔值。 对于使用自更新功能的 Windows Mobile MSI 业务线 (LoB) 应用，将此值设置为 true。|



## <a name="response"></a>响应
如果成功，此方法会在响应正文中返回 `200 OK` 响应代码和更新的 [windowsMobileMSI](../resources/intune_apps_windowsmobilemsi.md) 对象。
