...
此方法支持某些 OData 查询参数，包括 `$select` 和 `$expand`帮助自定义响应。 例如： 
...
如果成功，此方法在响应正文中返回 `200 OK` 响应代码和 [printerShare](../resources/printershare.md) 对象。
...
### <a name="example-1-get-a-printershare"></a>示例 1：获取打印机共享
...
### <a name="example-2-get-a-printershare-and-its-capabilities"></a>示例 2：获取打印机共享及其功能
