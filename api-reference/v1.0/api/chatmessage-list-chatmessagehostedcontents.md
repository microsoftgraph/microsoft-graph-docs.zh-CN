...
从邮件中 [检索 chatMessageHostedContent](../resources/chatmessagehostedcontent.md) 对象的列表。
...
| 权限类型                        | 权限（从最低特权到最高特权） |
|:---------------------------------------|:--------------------------------------------|
|委派（工作或学校帐户）| 对于 **通道** 资源：ChannelMessage.Read.All |
|委派（个人 Microsoft 帐户）|不支持。|
|应用程序| 对于 **通道** 资源：ChannelMessage.Read.Group*、ChannelMessage.Read.All |
...
如果成功，此方法在响应正文中返回响应代码和 `200 OK` [chatMessageHostedContent](../resources/chatmessagehostedcontent.md) 对象集合。
