...
创建新的 [resourceOperation](../resources/intune_rbac_resourceoperation.md) 对象。
...
如果成功，此方法在响应正文中返回 `201 Created` 响应代码和 [resourceOperation](../resources/intune_rbac_resourceoperation.md) 对象。
