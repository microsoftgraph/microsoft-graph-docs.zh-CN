...
下表显示创建 [deviceManagement](../resources/intune_shared_devicemanagement.md) 时所需的属性。
...
如果成功，此方法将在响应正文中返回 `200 OK` 响应代码和更新的 [deviceManagement](../resources/intune_shared_devicemanagement.md) 对象。
