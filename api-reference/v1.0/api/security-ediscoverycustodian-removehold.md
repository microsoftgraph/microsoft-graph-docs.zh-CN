...
ms.locfileid: "66839413"
---
# <a name="ediscoverycustodian-removehold"></a>ediscoveryCustodian：removeHold
命名空间：microsoft.graph.security

开始从 [电子数据展示保管人](../resources/security-ediscoverycustodian.md)中删除保留的过程。 创建操作后，可以通过从响应标头中检索 `Location` 参数来获取状态。 该位置提供一个 URL，该 URL 将返回 [电子数据展示HoldOperation](../resources/security-ediscoveryholdoperation.md) 对象。
...
### <a name="example-1-remove-hold-from-multiple-custodians"></a>示例 1：从多个保管人中删除保留
#### <a name="request"></a>请求
请求示例如下所示。
<!-- {
  "blockType": "request",
...
### <a name="example-2-remove-hold-from-a-single-custodian"></a>示例 2：从单个保管人中删除保留
#### <a name="request"></a>请求
请求示例如下所示。
<!-- {
  "blockType": "request",
