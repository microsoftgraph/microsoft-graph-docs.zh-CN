...
在[Azure AD权利管理](../resources/entitlementmanagement-overview.md)中，删除 [accessPackageAssignmentPolicy](../resources/accesspackageassignmentpolicy.md)。
