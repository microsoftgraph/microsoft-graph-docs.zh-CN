...
|customBrowserPackageId|String|要在 Android 上打开 Web 链接的首选自定义浏览器的唯一标识符。 配置此属性时，ManagedBrowserToOpenLinksRequired 应为 true。|
|customBrowserDisplayName|String|要在 Android 上打开 Web 链接的首选自定义浏览器的友好名称。 配置此属性时，ManagedBrowserToOpenLinksRequired 应为 true。|
