...
如果成功， `200 OK` 此方法将返回响应代码和具有为此请求创建的 [inviteParticipantsOperation](../resources/inviteparticipantsoperation.md) 的 URI 的位置标头。 

响应正文包含已创建的 [inviteParticipantsOperation](../resources/inviteparticipantsoperation.md)。
