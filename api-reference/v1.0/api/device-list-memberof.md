...
### <a name="example-3-use-odata-cast-and-search-to-get-membership-with-display-names-that-contain-the-letters-video-including-a-count-of-returned-objects"></a>示例 3：使用 OData 转换$search获取包含字母"Video"的显示名称（包括返回的对象计数）的成员资格
...
### <a name="example-4-use-odata-cast-and-filter-to-get-membership-with-a-display-name-that-starts-with-the-letter-a-including-a-count-of-returned-objects"></a>示例 4：使用 OData cast 和 $filter 获取以字母"A"开头显示名称（包括返回的对象计数）的组成员身份
