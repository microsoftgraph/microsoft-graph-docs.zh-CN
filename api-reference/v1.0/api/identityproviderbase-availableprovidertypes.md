...
如果成功，此函数在响应正文中返回 `200 OK` 响应代码和字符串集合。 字符串集合包含租户中支持的标识提供者的名称。

## <a name="example"></a>示例

### <a name="example-1-list-all-identity-providers-available-in-an-azure-ad-directory"></a>示例 1：列出 Azure AD 目录中可用的所有标识提供者
...
### <a name="example-2-list-all-identity-providers-available-in-an-azure-ad-b2c-directory"></a>示例 2：列出 Azure AD B2C 目录中提供的所有标识提供者
