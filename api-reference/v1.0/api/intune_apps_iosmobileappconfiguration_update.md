...
更新 [iosMobileAppConfiguration](../resources/intune_apps_iosmobileappconfiguration.md) 对象的属性。
...
在请求正文中，提供 [iosMobileAppConfiguration](../resources/intune_apps_iosmobileappconfiguration.md) 对象的 JSON 表示形式。

下表显示创建 [iosMobileAppConfiguration](../resources/intune_apps_iosmobileappconfiguration.md) 时所需的属性。
...
如果成功，此方法在响应正文中返回 `200 OK` 响应代码和更新的 [iosMobileAppConfiguration](../resources/intune_apps_iosmobileappconfiguration.md) 对象。
