# <a name="get-a-group-setting-template"></a><span data-ttu-id="01fb6-101">获取组设置模板</span><span class="sxs-lookup"><span data-stu-id="01fb6-101">Get a group setting template</span></span>
