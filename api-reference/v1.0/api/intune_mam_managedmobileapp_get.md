...
读取 [managedMobileApp](../resources/intune_mam_managedmobileapp.md) 对象的属性和关系。
...
如果成功，此方法会在响应正文中返回 `200 OK` 响应代码和 [managedMobileApp](../resources/intune_mam_managedmobileapp.md) 对象。
