# <a name="update-devicecompliancepolicystate"></a>更新 deviceCompliancePolicyState

> **注意：**使用 Microsoft Graph API 配置 Intune 控件和策略仍需要客户[正确许可](https://go.microsoft.com/fwlink/?linkid=839381) Intune 服务。

更新 [deviceCompliancePolicyState](../resources/intune_deviceconfig_devicecompliancepolicystate.md) 对象的属性。
...
在请求正文中，提供 [deviceCompliancePolicyState](../resources/intune_deviceconfig_devicecompliancepolicystate.md) 对象的 JSON 表示形式。

下表显示创建 [deviceCompliancePolicyState](../resources/intune_deviceconfig_devicecompliancepolicystate.md) 时所需的属性。
...
如果成功，此方法在响应正文中返回 `200 OK` 响应代码和更新的 [deviceCompliancePolicyState](../resources/intune_deviceconfig_devicecompliancepolicystate.md) 对象。
