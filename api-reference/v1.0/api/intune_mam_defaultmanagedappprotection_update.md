...
更新 [defaultManagedAppProtection](../resources/intune_mam_defaultmanagedappprotection.md) 对象的属性。
...
在请求正文中，提供 [defaultManagedAppProtection](../resources/intune_mam_defaultmanagedappprotection.md) 对象的 JSON 表示形式。

下表显示创建 [defaultManagedAppProtection](../resources/intune_mam_defaultmanagedappprotection.md) 时所需的属性。
...
|saveAsBlocked|布尔|指示用户是否可以使用“另存为”菜单项保存受保护文件的副本。 继承自 [managedAppProtection](../resources/intune_mam_managedappprotection.md)|
...
|pinRequired|布尔|指示是否需要应用级 PIN。 继承自 [managedAppProtection](../resources/intune_mam_managedappprotection.md)|
...
|disableAppPinIfDevicePinIsSet|布尔|指示如果设置了设备 PIN，是否需要使用应用 PIN。 继承自 [managedAppProtection](../resources/intune_mam_managedappprotection.md)|
...
|screenCaptureBlocked|布尔|指示是否阻止屏幕截图。 （仅限 Android）|
|encryptAppData|布尔|指示是否应加密托管应用数据。 （仅限 Android）|
|disableAppEncryptionIfDeviceEncryptionIsEnabled|布尔|启用此设置后，如果启用设备级加密，则应用程序级加密将被禁用。 （仅限 Android）|
...
如果成功，此方法在响应正文中返回 `200 OK` 响应代码和更新的 [defaultManagedAppProtection](../resources/intune_mam_defaultmanagedappprotection.md) 对象。
