...
|appDataEncryptionType|String|应该用于托管应用中的数据的加密类型。 （仅限 iOS）可取值为：`useDeviceSettings`、`afterDeviceRestart`、`whenDeviceLockedExceptOpenFiles`、`whenDeviceLocked`。|
|screenCaptureBlocked|Boolean|指示是否阻止捕获屏幕。|
