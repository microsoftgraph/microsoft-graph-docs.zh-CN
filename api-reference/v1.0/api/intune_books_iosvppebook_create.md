...
|lastModifiedDateTime|DateTimeOffset|上次修改电子图书的日期和时间。 继承自 [managedEBook](../resources/intune_books_managedebook.md)|
...
如果成功，此方法在响应正文中返回 `201 Created` 响应代码和 [iosVppEBook](../resources/intune_books_iosvppebook.md) 对象。
