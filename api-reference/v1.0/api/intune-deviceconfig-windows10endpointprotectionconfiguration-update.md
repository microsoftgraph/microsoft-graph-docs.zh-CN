...
|firewallMergeKeyingModuleSettings|布尔|如果键控模块不完全支持身份验证集，请指示模块仅忽略不受支持的身份验证套件而不是整个集|
...
|defenderAttackSurfaceReductionExcludedPaths|String collection|要从攻击面减少规则中排除的 exe 文件和文件夹的列表|
