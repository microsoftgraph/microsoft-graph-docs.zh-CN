...
| squareLogo | Stream | Windows 10 OO) BE (和启用 Windows Autopilot 进行部署时显示在现Windows 10中公司徽标的正方形版本。 允许的类型为 PNG 或 JPEG，不超过 240 x 240 像素，大小不超过 10 KB。 我们建议使用透明图像，徽标周围没有填充。 |
