...
创建新的 [macOSGeneralDeviceConfiguration](../resources/intune_deviceconfig_macosgeneraldeviceconfiguration.md) 对象。
...
|compliantAppListType|[appListType](../resources/intune_deviceconfig_applisttype.md)|CompliantAppsList 中的列表。可能的值为：`none`、`appsInListCompliant`、`appsNotInListCompliant`。|
...
|passwordRequiredType|[requiredPasswordType](../resources/intune_deviceconfig_requiredpasswordtype.md)|所需密码的类型。可能的值为：`deviceDefault`、`alphanumeric`、`numeric`。|
|passwordRequired|布尔值|是否需要密码。|



## <a name="response"></a>响应
如果成功，此方法在响应正文中返回 `201 Created` 响应代码和 [macOSGeneralDeviceConfiguration](../resources/intune_deviceconfig_macosgeneraldeviceconfiguration.md) 对象。
