...
ms.locfileid: "63516449"
---
# <a name="get-approval"></a>获取审批

命名空间：microsoft.graph

在[Azure AD权限管理](../resources/entitlementmanagement-overview.md)中，检索审批[对象](../resources/approval.md)的属性。  此调用由审批者进行，提供访问 [包分配请求的标识符](../resources/accesspackageassignmentrequest.md)。
...
如果成功，此方法在响应 `200 OK` 正文中返回 响应 [代码和请求](../resources/approval.md) 的审批对象。 如果调用方没有适当的权限，该方法将返回 响应 `403 Forbidden` 代码。
