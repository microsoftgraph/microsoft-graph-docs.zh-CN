...
description: 删除指定 bookingBusiness 中的 bookingStaffMember。
...
ms.locfileid: "61526514"
---
# <a name="delete-bookingstaffmember"></a>删除 bookingStaffMember

命名空间：microsoft.graph

删除指定的[bookingBusiness](../resources/bookingbusiness.md)中的[bookingStaffMember。](../resources/bookingstaffmember.md)
