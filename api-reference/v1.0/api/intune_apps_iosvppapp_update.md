...
更新 [iosVppApp](../resources/intune_apps_iosvppapp.md) 对象的属性。
...
在请求正文中，提供 [iosVppApp](../resources/intune_apps_iosvppapp.md) 对象的 JSON 表示形式。

下表显示了创建 [iosVppApp](../resources/intune_apps_iosvppapp.md) 时所需的属性。
...
如果成功，此方法在响应正文中返回 `200 OK` 响应代码和更新的 [iosVppApp](../resources/intune_apps_iosvppapp.md) 对象。
