...
创建新的 [microsoftStoreForBusinessApp](../resources/intune_apps_microsoftstoreforbusinessapp.md) 对象。
...
在请求正文中，提供 microsoftStoreForBusinessApp 对象的 JSON 表示形式。

下表显示了创建 microsoftStoreForBusinessApp 时所需的属性。
...
如果成功，此方法在响应正文中返回 `201 Created` 响应代码和 [microsoftStoreForBusinessApp](../resources/intune_apps_microsoftstoreforbusinessapp.md) 对象。
