---
title: 列出查询
description: 获取与电子数据展示评审集关联的查询列表。
author: SeunginLyu
...
ms.locfileid: "66839134"
---
# <a name="list-queries"></a>列出查询
命名空间：microsoft.graph.security



获取与电子数据展示评审集关联的 [查询](../resources/security-ediscoveryreviewsetquery.md) 列表。
...
如果成功，此方法在响应正文中返回 `200 OK` 响应代码和 [microsoft.graph.security.ediscoveryReviewSetQuery](../resources/security-ediscoveryreviewsetquery.md) 对象的集合。
