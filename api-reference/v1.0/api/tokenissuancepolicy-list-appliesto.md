...
获取[tokenIssuancePolicy](../resources/tokenissuancepolicy.md)对象已应用到的[directoryObject](../resources/directoryObject.md)对象的列表。 tokenIssuancePolicy 只能应用于 [应用程序](../resources/application.md)。
