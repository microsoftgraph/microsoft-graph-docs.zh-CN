...
下表显示创建 [managedDevice](../resources/intune_devices_manageddevice.md) 时所需的属性。
...
如果成功，此方法在响应正文中返回 `200 OK` 响应代码和更新的 [managedDevice](../resources/intune_devices_manageddevice.md) 对象。
