...
读取 [deviceAppManagement](../resources/intune_apps_deviceappmanagement.md) 对象的属性和关系。
...
如果成功，此方法将在响应正文中返回 `200 OK` 响应代码和 [deviceAppManagement](../resources/intune_apps_deviceappmanagement.md) 对象。
