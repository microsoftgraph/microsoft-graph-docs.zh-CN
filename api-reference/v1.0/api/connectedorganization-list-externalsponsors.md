...
description: 检索 connectedOrganization 的 externalSponsors 的列表。
...
检索 [connectedOrganization 的外部](../resources/connectedorganization.md)发起人的列表。  外部 [发起](../resources/externalsponsors.md) 人是一组用户可以代表该已连接的组织的其他用户批准请求。
