...
创建新的 [webApp](../resources/intune_apps_webapp.md) 对象。
...
|useManagedBrowser|布尔值|是否使用托管浏览器。 此属性仅适用于 Android 和 iOS。|



## <a name="response"></a>响应
如果成功，此方法会在响应正文中返回 `201 Created` 响应代码和 [webApp](../resources/intune_apps_webapp.md) 对象。
