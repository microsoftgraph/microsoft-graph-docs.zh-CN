...
创建由 [oAuth2PermissionGrant 对象代表的委派权限](../resources/oauth2permissiongrant.md) 。

委派权限授予授权表示客户端应用程序) 的客户端服务主体 (代表已登录用户的 API) 访问代表 API) 的资源服务主体 () ，从而访问已授予的委派权限限制的访问级别。
