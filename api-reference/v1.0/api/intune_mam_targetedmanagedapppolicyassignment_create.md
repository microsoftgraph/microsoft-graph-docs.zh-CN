# <a name="create-targetedmanagedapppolicyassignment"></a>创建 targetedManagedAppPolicyAssignment

> **注意：**使用 Microsoft Graph API 配置 Intune 控件和策略仍需要客户[正确许可](https://go.microsoft.com/fwlink/?linkid=839381) Intune 服务。

创建新的 [targetedManagedAppPolicyAssignment](../resources/intune_mam_targetedmanagedapppolicyassignment.md) 对象。
...
在请求正文中，提供 targetedManagedAppPolicyAssignment 对象的 JSON 表示形式。

下表显示创建 targetedManagedAppPolicyAssignment 时所需的属性。
...
如果成功，此方法将在响应正文中返回 `201 Created` 响应代码和 [targetedManagedAppPolicyAssignment](../resources/intune_mam_targetedmanagedapppolicyassignment.md) 对象。
