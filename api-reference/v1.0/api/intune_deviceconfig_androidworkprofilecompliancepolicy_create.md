...
创建新的 [androidWorkProfileCompliancePolicy](../resources/intune_deviceconfig_androidworkprofilecompliancepolicy.md) 对象。
...
在请求正文中，为 androidWorkProfileCompliancePolicy 对象提供 JSON 表示形式。

下表显示当你创建  androidWorkProfileCompliancePolicy 时所需的属性。
...
如果成功，此方法在响应正文中返回 `201 Created` 响应代码和 [androidWorkProfileCompliancePolicy](../resources/intune_deviceconfig_androidworkprofilecompliancepolicy.md) 对象。
