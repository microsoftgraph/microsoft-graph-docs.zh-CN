...
更新 [androidCompliancePolicy](../resources/intune_deviceconfig_androidcompliancepolicy.md) 对象的属性。
...
在请求正文中，提供 [androidCompliancePolicy](../resources/intune_deviceconfig_androidcompliancepolicy.md) 对象的 JSON 表示形式。

下表显示了创建 [androidCompliancePolicy](../resources/intune_deviceconfig_androidcompliancepolicy.md) 时所需的属性。
...
如果成功，此方法会在响应正文中返回 `200 OK` 响应代码和更新的 [androidCompliancePolicy](../resources/intune_deviceconfig_androidcompliancepolicy.md) 对象。
