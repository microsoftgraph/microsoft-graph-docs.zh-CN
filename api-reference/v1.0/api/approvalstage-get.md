---
title: 获取 approvalStage
description: 检索 approvalStage 对象的属性。
...
ms.locfileid: "63398075"
---
# <a name="get-approvalstage"></a>获取 approvalStage

命名空间：microsoft.graph

在[Azure AD权限管理](../resources/entitlementmanagement-overview.md)中，检索 [approvalStage 对象](../resources/approvalstage.md)的属性。 审批阶段包含在审批 [对象](../resources/approval.md) 中。
...
如果成功，此方法在响应 `200 OK` 正文中返回 响应代码和 [approvalStage](../resources/approvalstage.md) 对象。 如果调用方没有适当的权限，该方法将返回 响应 `403 Forbidden` 代码。
