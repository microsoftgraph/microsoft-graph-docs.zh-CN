...
description: 获取与 ediscoveryCustodian 关联的 ediscoveryIndexOperations 的列表。
author: SeunginLyu
...
获取与 [ediscoveryCustodian](../resources/security-ediscoverycustodian.md) 关联的 [ediscoveryIndexOperations](../resources/security-ediscoveryindexoperation.md) 的列表。
