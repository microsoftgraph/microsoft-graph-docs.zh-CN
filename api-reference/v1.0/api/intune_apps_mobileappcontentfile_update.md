...
更新 [mobileAppContentFile](../resources/intune_apps_mobileappcontentfile.md) 对象的属性。
...
下表显示了创建 [mobileAppContentFile](../resources/intune_apps_mobileappcontentfile.md) 时所需的属性。
...
如果成功，此方法将在响应正文中返回 `200 OK` 响应代码和更新的 [mobileAppContentFile](../resources/intune_apps_mobileappcontentfile.md) 对象。
