...
如果成功，此方法在响应正文中返回响应代码和请求的 `200 OK` [chatMessageHostedContent](../resources/chatmessagehostedcontent.md) 对象。
...
### <a name="example-2-get-hosted-content-bytes"></a>示例 2：获取托管内容字节
