---
title: 删除 accessPackageAssignmentRequest
description: 删除 accessPackageAssignmentRequest。
...
ms.locfileid: "62101871"
---
# <a name="delete-accesspackageassignmentrequest"></a>删除 accessPackageAssignmentRequest

命名空间：microsoft.graph


删除 [accessPackageAssignmentRequest](../resources/accesspackageassignmentrequest.md) 对象。

此请求可用于删除已拒绝或已完成的请求。  如果访问包分配请求具有任何 **accessPackageAssignment 对象，则不能删除该** 请求。
