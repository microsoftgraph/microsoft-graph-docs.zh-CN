...
返回具有 [`deleted` Facet](../resources/deleted.md) 的已删除邮件。应从本地状态中删除设置此属性的项目。 
...
此方法支持使用 `$select`、`$expand` 和 `$top` [OData 查询参数](http://developer.microsoft.com/en-us/graph/docs/overview/query_parameters)自定义响应。
