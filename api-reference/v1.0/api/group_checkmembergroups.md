...
| 委派（工作或学校帐户）| *Group.Read.All*、Directory.Read.All、Directory.ReadWrite.All、Directory.AccessAsUser.All | |委派（个人 Microsoft 帐户） | 不受支持。    | |应用程序 | *Group.Read.All*、Directory.Read.All。 Directory.ReadWrite.All |
