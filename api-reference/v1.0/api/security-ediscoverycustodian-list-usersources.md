...
ms.locfileid: "66839346"
---
# <a name="list-usersources"></a>列出 userSources
命名空间：microsoft.graph.security



获取与 [ediscoveryCustodian](../resources/security-ediscoverycustodian.md) 关联的 [userSource](../resources/security-usersource.md) 对象的列表。
...
如果成功，此方法在响应正文中返回 `200 OK` 响应代码和 [microsoft.graph.security.userSource](../resources/security-usersource.md) 对象集合。
