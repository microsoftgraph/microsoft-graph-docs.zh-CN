...
|$search|string|按姓名或别名搜索人员。 支持模糊匹配。 参数仅适用于搜索已登录用户的相关人员，而不适用于搜索与其他用户相关的人员。 还支持`topic`关键字，以根据从与此人的电子邮件对话中提取的主题查找人员。 有关信息和示例，请参阅[获取人员的相关信息](../../../concepts/people_example.md#perform-a-fuzzy-search)中的*执行模糊搜索*部分。 |
