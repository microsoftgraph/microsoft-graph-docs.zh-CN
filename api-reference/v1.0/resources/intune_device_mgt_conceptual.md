...
- [设备注册类型](intune_devices_deviceenrollmenttype.md)
...
- [管理设备所有者类型](intune_devices_manageddeviceownertype.md)
- [托管的设备伙伴报告健康状态](intune_devices_manageddevicepartnerreportedhealthstate.md)
...
- [远程协助的白板状态](intune_remoteassistance_remoteassistanceonboardingstatus.md)
