...
|assignments|targetedManagedAppPolicyAssignment 集合|针对策略的安全组列表的导航属性。 继承自 [windowsInformationProtection](../resources/intune_mam_windowsinformationprotection.md)|
