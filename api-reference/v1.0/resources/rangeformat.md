...
|[Update](../api/rangeformat-update.md) | [WorkbookRangeFormat](rangeformat.md) |更新 RangeFormat 对象。 |
...
| 关系 | 类型   |说明|
|:---------------|:--------|:----------|
|边框|[WorkbookRangeBorder](rangeborder.md)集合|应用于所选的整个区域的 border 对象的集合。只读。|
