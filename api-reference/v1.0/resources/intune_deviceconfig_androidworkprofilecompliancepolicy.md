...
|方法|返回类型|说明|
|:---|:---|:---|
|[列表 androidWorkProfileCompliancePolicies](../api/intune_deviceconfig_androidworkprofilecompliancepolicy_list.md)|[androidWorkProfileCompliancePolicy](../resources/intune_deviceconfig_androidworkprofilecompliancepolicy.md)集合|列出属性和[androidWorkProfileCompliancePolicy](../resources/intune_deviceconfig_androidworkprofilecompliancepolicy.md)对象之间的关系。|
|[获取 androidWorkProfileCompliancePolicy](../api/intune_deviceconfig_androidworkprofilecompliancepolicy_get.md)|[androidWorkProfileCompliancePolicy](../resources/intune_deviceconfig_androidworkprofilecompliancepolicy.md)|读取属性和[androidWorkProfileCompliancePolicy](../resources/intune_deviceconfig_androidworkprofilecompliancepolicy.md)对象的关系。|
|[创建 androidWorkProfileCompliancePolicy](../api/intune_deviceconfig_androidworkprofilecompliancepolicy_create.md)|[androidWorkProfileCompliancePolicy](../resources/intune_deviceconfig_androidworkprofilecompliancepolicy.md)|创建新的[androidWorkProfileCompliancePolicy](../resources/intune_deviceconfig_androidworkprofilecompliancepolicy.md)对象。|
|[删除 androidWorkProfileCompliancePolicy](../api/intune_deviceconfig_androidworkprofilecompliancepolicy_delete.md)|无|删除[androidWorkProfileCompliancePolicy](../resources/intune_deviceconfig_androidworkprofilecompliancepolicy.md)。|
|[更新 androidWorkProfileCompliancePolicy](../api/intune_deviceconfig_androidworkprofilecompliancepolicy_update.md)|[androidWorkProfileCompliancePolicy](../resources/intune_deviceconfig_androidworkprofilecompliancepolicy.md)|更新[androidWorkProfileCompliancePolicy](../resources/intune_deviceconfig_androidworkprofilecompliancepolicy.md)对象的属性。|
