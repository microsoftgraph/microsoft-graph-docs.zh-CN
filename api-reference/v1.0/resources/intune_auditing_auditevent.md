...
|[getAuditCategories 函数](../api/intune_auditing_auditevent_getauditcategories.md)|String collection|尚未记录|
|[getAuditActivityTypes 函数](../api/intune_auditing_auditevent_getauditactivitytypes.md)|String collection|尚未记录|
