...
Microsoft Graph 通过权限控制对资源的访问。 必须指定访问报表资源所需的权限。 通常是在 Azure Active Directory (Azure AD) 门户中指定权限。 有关详细信息，请参阅 [Microsoft Graph 权限参考](../../../concepts/permissions_reference.md)和[报表权限](../../../concepts/permissions_reference.md#reports-permissions)。
