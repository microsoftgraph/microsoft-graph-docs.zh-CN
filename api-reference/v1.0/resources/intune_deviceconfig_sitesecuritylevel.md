# <a name="sitesecuritylevel-enum-type"></a><span data-ttu-id="2c398-101">siteSecurityLevel 枚举类型</span><span class="sxs-lookup"><span data-stu-id="2c398-101">siteSecurityLevel enum type</span></span>
