...
|importedWindowsAutopilotDeviceIdentityUploads|[importedWindowsAutopilotDeviceIdentityUpload](../resources/intune_enrollment_importedwindowsautopilotdeviceidentityupload.md)集合|Windows 自动执行某些操作设备上载的集合。|
|**Notifications**|
