...
|holdStatus|microsoft.graph.security.dataSourceHoldStatus|**unifiedGroupSource** 的保留状态。 可能的值为： `notApplied`， `applied`， `applying`， `removing``partial`|
