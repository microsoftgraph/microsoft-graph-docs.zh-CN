...
| 属性 | 类型 | 说明 |
:---------------|:--------|:----------|
|countriesBlockedForMinors|String collection| 指定两 [个字母的 ISO 国家/地区代码](https://www.iso.org/iso-3166-country-codes.html)。 对于此列表中指定的国家/地区中的未成年人，将阻止其访问应用程序。|
