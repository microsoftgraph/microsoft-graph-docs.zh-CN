# <a name="vpptokensyncstatus-enum-type"></a><span data-ttu-id="3a030-101">vppTokenSyncStatus 枚举类型</span><span class="sxs-lookup"><span data-stu-id="3a030-101">vppTokenSyncStatus enum type</span></span>
