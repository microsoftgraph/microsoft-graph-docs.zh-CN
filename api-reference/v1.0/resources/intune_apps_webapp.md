...
|方法|返回类型|说明|
|:---|:---|:---|
|[List webApps](../api/intune_apps_webapp_list.md)|[webApp](../resources/intune_apps_webapp.md) 集合|列出 [webApp](../resources/intune_apps_webapp.md) 对象的属性和关系。|
|[Get webApp](../api/intune_apps_webapp_get.md)|[webApp](../resources/intune_apps_webapp.md)|读取 [webApp](../resources/intune_apps_webapp.md) 对象的属性和关系。|
|[Create webApp](../api/intune_apps_webapp_create.md)|[webApp](../resources/intune_apps_webapp.md)|创建新的 [webApp](../resources/intune_apps_webapp.md) 对象。|
|[Delete webApp](../api/intune_apps_webapp_delete.md)|无|删除 [webApp](../resources/intune_apps_webapp.md)。|
|[Update webApp](../api/intune_apps_webapp_update.md)|[webApp](../resources/intune_apps_webapp.md)|更新 [webApp](../resources/intune_apps_webapp.md) 对象的属性。|
