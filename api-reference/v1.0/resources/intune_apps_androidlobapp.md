...
|方法|返回类型|说明|
|:---|:---|:---|
|[List androidLobApps](../api/intune_apps_androidlobapp_list.md)|[androidLobApp](../resources/intune_apps_androidlobapp.md) 集合|列出 [androidLobApp](../resources/intune_apps_androidlobapp.md) 对象的属性和关系。|
|[Get androidLobApp](../api/intune_apps_androidlobapp_get.md)|[androidLobApp](../resources/intune_apps_androidlobapp.md)|读取 [androidLobApp](../resources/intune_apps_androidlobapp.md) 对象的属性和关系。|
|[Create androidLobApp](../api/intune_apps_androidlobapp_create.md)|[androidLobApp](../resources/intune_apps_androidlobapp.md)|创建新的 [androidLobApp](../resources/intune_apps_androidlobapp.md) 对象。|
|[Delete androidLobApp](../api/intune_apps_androidlobapp_delete.md)|无|删除 [androidLobApp](../resources/intune_apps_androidlobapp.md)。|
|[Update androidLobApp](../api/intune_apps_androidlobapp_update.md)|[androidLobApp](../resources/intune_apps_androidlobapp.md)|更新 [androidLobApp](../resources/intune_apps_androidlobapp.md) 对象的属性。|
...
|versionName|字符串|Android 业务线 (LoB) 应用的版本名称。|
|versionCode|字符串|Android 业务线 (LoB) 应用的版本代码。|
...
|作业|[mobileAppAssignment](../resources/intune_apps_mobileappassignment.md) 集合|此移动应用的组分配的列表。 继承自 [mobileApp](../resources/intune_apps_mobileapp.md)|
