# <a name="requiredpasswordtype-enum-type"></a><span data-ttu-id="87acd-101">requiredPasswordType 枚举类型</span><span class="sxs-lookup"><span data-stu-id="87acd-101">requiredPasswordType enum type</span></span>
