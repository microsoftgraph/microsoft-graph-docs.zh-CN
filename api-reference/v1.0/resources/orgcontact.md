...
| mailNickname                 | String                                                                   | 电子邮件别名 (电子邮件地址的一部分预挂起此组织联系人) @ 符号。 支持 `$filter` （`eq`、 `ne`、 `NOT`、 `ge`、 `le`、 `in`、 `startsWith`）。                                                                                                                                                           |
...
| 关系       | 类型                                             | 说明                                                                                                                                            |
|:-------------------|:-------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------|
| directReports      | [directoryObject](directoryobject.md) collection | 联系人的直接下属。  (其经理属性设置为此联系人的用户和联系人。) 只读。 可为空。 支持 `$expand`。 |
