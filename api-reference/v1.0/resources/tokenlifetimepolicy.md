...
表示一个策略，该策略可以控制 JWT 访问令牌、ID 令牌或由 Azure AD Azure Active Directory (颁发的 SAML 1.1/2.0) 。 可以为组织中的所有应用程序、多租户（多组织）应用程序或组织中的特定服务主体设置令牌生存期。 
