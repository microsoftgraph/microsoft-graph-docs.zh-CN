...
|tvRating|[ratingNewZealandTelevisionType](../resources/intune_deviceconfig_ratingnewzealandtelevisiontype.md)|为新西兰选择的电视分级。 |||UNTRANSLATED_CONTENT_START|||The possible values are: `allAllowed`, `allBlocked`, `general`, `parentalGuidance`, `adults`.|||UNTRANSLATED_CONTENT_END||||
