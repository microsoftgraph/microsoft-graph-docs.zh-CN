...
|complianceState|String|设备的合规性状态。 可取值为：`unknown`、`compliant`、`noncompliant`、`conflict`、`error`、`inGracePeriod`、`configManager`。|
...
|关系|类型|说明|
|:---|:---|:---|
|deviceCategory|[deviceCategory](../resources/intune_devices_devicecategory.md)|设备类别|
