...
|[Create section](../api/notebook-post-sections.md) |[OnenoteSection](section.md)| 通过发布到指定笔记本中的分区集合创建分区。|
|[List sections](../api/notebook-list-sections.md) |[OnenoteSection](section.md)集合| 获取指定笔记本中的分区集合。|
