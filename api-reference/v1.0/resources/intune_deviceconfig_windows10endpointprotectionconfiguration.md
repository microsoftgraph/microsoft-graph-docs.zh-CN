...
|firewallPacketQueueingMethod|[firewallPacketQueueingMethodType](../resources/intune_deviceconfig_firewallpacketqueueingmethodtype.md)|配置数据包排队应如何在隧道网关方案中应用。 可取值为：`deviceDefault`、`disabled`、`queueInbound`、`queueOutbound`、`queueBoth`。|
...
|bitLockerEnableStorageCardEncryptionOnMobile|布尔值|允许管理员要求使用 BitLocker 开启加密功能。 此策略仅适用于移动 SKU。|
|bitLockerEncryptDevice|布尔值|允许管理员要求使用 BitLocker 开启加密功能。|
