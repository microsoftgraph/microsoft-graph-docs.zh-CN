...
|appId|String|表示 Azure Active Directory 中的应用程序 ID 的唯一 GUID。|
...
|correlationId|String|启动登录时从客户端发送的请求 ID;用于对登录活动进行故障排除。|
|createdDateTime|DateTimeOffset|启动登录的日期和时间 (UTC)。 示例: 2014 年1月1日午夜, 报告`'2014-01-01T00:00:00Z'`为。|
