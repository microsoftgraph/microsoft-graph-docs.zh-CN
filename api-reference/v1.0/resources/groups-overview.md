...
|:---------------|:--------|:----------|
| **组对象和方法** | | |
| 创建新组、获取现有组、更新组的属性和删除组。 目前，只有 Outlook 中的安全组和组才能通过 API 创建。 | [group](group.md) | [新建组](../api/group_post_groups.md) <br/> [列出组](../api/group_list.md) <br/> [更新组](../api/group_update.md) <br/> [删除组](../api/group_delete.md) |
| **组成员资格方法** | | |
| 列出组中的成员，并添加或删除成员。 | [user](user.md) <br/> [group](group.md)| [列出成员](../api/group_list_members.md) <br/> [添加成员](../api/group_post_members.md) <br/> [删除成员](../api/group_delete_members.md)|
| 确定用户是否是组成员，并获取用户所属的全部组。 | [user](user.md) <br/> [group](group.md)| [检查成员组](../api/group_checkmembergroups.md) <br/> [获取成员组](../api/group_getmembergroups.md)|
| 列出组的所有者，并添加或删除所有者。 | [user](user.md) <br/> [group](group.md)| [列出所有者](../api/group_list_members.md) <br/> [添加成员](../api/group_post_members.md) <br/> [删除成员](../api/group_delete_members.md)|
