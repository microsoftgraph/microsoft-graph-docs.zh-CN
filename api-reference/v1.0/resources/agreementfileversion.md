...
description: 表示 Azure AD Azure Active Directory (中使用条款协议的本地化策略文件的自定义) 。
...
ms.locfileid: "54197112"
---
# <a name="agreementfileversion-resource-type"></a>agreementFileVersion 资源类型

命名空间：microsoft.graph

表示租户使用 Azure AD Azure Active Directory (管理的使用条款协议文件的自定义) 。 它包含有关协议文件的元数据 (例如，名称、语言以及它是否是协议文件的默认) 。
