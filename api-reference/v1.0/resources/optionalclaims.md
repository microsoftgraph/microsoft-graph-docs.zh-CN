...
应用程序开发人员可以在其 Azure AD 应用中配置可选声明，以在 Microsoft 安全令牌服务向其应用程序发送令牌中指定要使用的声明。 有关详细信息，请参阅向[AZURE AD 应用提供可选声明](https://docs.microsoft.com/en-us/azure/active-directory/develop/active-directory-optional-claims)。
