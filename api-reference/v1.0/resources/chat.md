...
|[升级聊天中的应用](../api/chat-teamsappinstallation-upgrade.md) | None | 更新到聊天会话和关联会议 (安装的应用的) 。|
|[从聊天中卸载应用](../api/chat-delete-installedapps.md) | None | 从 (和) 会议记录中删除 (卸载) 。|
| **选项卡** |||
