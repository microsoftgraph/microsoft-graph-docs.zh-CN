# <a name="prereleasefeatures-enum-type"></a><span data-ttu-id="8bdbd-101">prereleaseFeatures 枚举类型</span><span class="sxs-lookup"><span data-stu-id="8bdbd-101">prereleaseFeatures enum type</span></span>
