...
若要获取与会者邮箱中关联事件的属性，应用可以使用 **eventMessage** 的 **event** 导航属性，如[获取事件邮件示例](../api/eventmessage_get.md#request-2)中所示。 应用程序还可以响应事件代表与会者以编程方式，通过[接受](../api/event_accept.md)、[暂时接受](../api/event_tentativelyaccept.md)或[拒绝](../api/event_decline.md)该事件。
