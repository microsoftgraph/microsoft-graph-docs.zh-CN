...
|links|[recentNotebookLinks](recentnotebooklinks.md)|用于打开笔记本的链接。 链接可以在 OneNote 客户端（如果已安装的话）中打开笔记本。`oneNoteClientURL` 链接可以在 OneNote Online 中打开笔记本。`oneNoteWebURL`|
...
| 方法           | 返回类型    |说明|
|:---------------|:--------|:----------|
|[getRecentNotebooks](../api/notebook_getrecentnotebooks.md) | [notebook](notebook.md) 集合 | 获取用户最近访问过的一组笔记本。 |
