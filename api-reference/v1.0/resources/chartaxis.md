...
| 方法           | 返回类型    |说明|
|:---------------|:--------|:----------|
|[Get ChartAxis](../api/chartaxis_get.md) | [WorkbookChartAxis](chartaxis.md) |读取 chartAxis 对象的属性和关系。|
|[Update](../api/chartaxis_update.md) | [WorkbookChartAxis](chartaxis.md)   |更新 ChartAxis 对象 |
