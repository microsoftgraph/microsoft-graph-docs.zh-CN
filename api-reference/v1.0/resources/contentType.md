...
|[addCopy](../api/contenttype-addcopy.md)|[contentType](../resources/contenttype.md)|将网站[中的 contentType](../resources/contenttype.md) [副本添加到](../resources/site.md)[列表中](../resources/list.md)。|
...
| sealed            | 布尔值              | 如果 `true`为 ，则用户无法通过向下推送操作修改内容类型。 只有网站集管理员可以密封或解封内容类型。|
