...
- [设备应用管理](intune-onboarding-deviceappmanagement.md)
- [设备类别](intune-onboarding-devicecategory.md)
...
- [设备管理](intune-onboarding-devicemanagement.md)
