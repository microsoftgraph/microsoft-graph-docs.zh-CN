...
|averageRoundTripTime|期限|按 [RFC 3550][]指定的平均网络传播往返时间，以 [ISO 8601][] 格式表示。 例如，1 秒表示为 ，其中"P"是持续时间指示符 `'PT1S'` ，"T"是时间指示符，"S"是第二个指示符。|
...
|maxRoundTripTime|期限|按 [RFC 3550][]指定的最大网络传播往返时间，以 [ISO 8601][] 格式表示。 例如，1 秒表示为 ，其中"P"是持续时间指示符 `'PT1S'` ，"T"是时间指示符，"S"是第二个指示符。|
