...
|grantControls|[conditionalAccessGrantControls](conditionalaccessgrantcontrols.md)| 指定通过策略时必须实现的授予控制。 |
...
|sessionControls|[conditionalAccessSessionControls](conditionalaccesssessioncontrols.md)| 指定在登录后强制执行的会话控件。 |
