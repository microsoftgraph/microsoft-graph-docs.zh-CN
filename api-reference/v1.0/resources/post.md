...
|[添加附件](../api/post_post_attachments.md) |[附件](attachment.md)| 将附件添加到帖子中。 |
|**开放扩展**| | |
...
|newParticipants|[收件人](recipient.md)集合|添加到此线程作为帖子一部分的对话参与者。|
