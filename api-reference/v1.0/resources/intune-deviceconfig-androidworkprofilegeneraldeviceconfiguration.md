...
|workProfileBlockNotificationsWhileDeviceLocked|布尔值|指示是否在设备锁定时阻止通知。|
...
|workProfileBlockCrossProfileCopyPaste|布尔值|指示是否启用设置禁止交叉配置文件复制/粘贴的布尔值。|
...
|workProfileRequirePassword|布尔值|工作配置文件需要密码或不使用密码|
