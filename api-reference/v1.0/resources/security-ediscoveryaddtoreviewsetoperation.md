...
description: 表示将电子数据展示Search 添加到电子数据展示ReviewSet的操作。
author: SeunginLyu
...
表示将 [电子数据展示Search](../resources/security-ediscoverysearch.md) 添加到 [电子数据展示ReviewSet的](../resources/security-ediscoveryreviewset.md)操作。
