...
[schedulingGroup](schedulinggroup.md)对象[、shift](shift.md)对象[、timeOffReason](timeoffreason.md)对象和[团队中的 timeOff](timeoff.md) [对象的集合](../resources/team.md)。 
...
|-----------------------|---------------|-------------------------------------------------------------------------------------------------------------------------------------------------|
| id                    |string  |计划的 ID。|
| enabled               |Boolean    | 指示是否为团队启用日程安排。 必填。|
| timeZone              |string  | 使用 tz 数据库格式指示计划团队的时区。 必填。|
