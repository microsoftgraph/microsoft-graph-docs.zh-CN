...
|memberOf|[directoryObject](directoryobject.md) 集合|此设备所属的组。 只读。 可为 NULL。 支持 `$expand`。 |
|transitiveMemberOf |[directoryObject](directoryobject.md) 集合| 设备所属的组。 此操作是可传递的。 支持 `$expand`。  |
