...
|trustType|String| 加入设备的信任类型。 只读。 可能的值： (表示将你自己的个人设备) 、 (仅加入云的设备) 、 (加入 Azure AD) 本地域的设备 `Workplace`  `AzureAd` `ServerAd` 。 如需了解更多详情，请参阅 [Azure Active Directory 中的设备管理简介](/azure/active-directory/device-management-introduction) |
