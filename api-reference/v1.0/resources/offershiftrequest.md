...
|[批准](../api/offershiftrequest-approve.md)|None|批准**offerShiftRequest**。 |
|[拒绝](../api/offershiftrequest-decline.md)|None|拒绝**offerShiftRequest**。 |
...
|recipientActionMessage|字符串| 由服务移动请求的收件人发送的自定义消息。 |
|recipientUserId|字符串| 提供班次请求的收件人的用户 ID。|
|senderShiftId|字符串| 提供班次请求的发件人的用户 ID。|
