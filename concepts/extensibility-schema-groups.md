...
请参阅[分配请求中 **id** 的其他方法示例](/graph/api/schemaextension-post-schemaextensions?view=graph-rest-1.0#request-2)，仅需要提供架构名称。
...
- [获取 schemaExtension](/graph/api/schemaextension-get?view=graph-rest-1.0)
- [更新 schemaExtension](/graph/api/schemaextension-update?view=graph-rest-1.0)
- [删除 schemaExtension](/graph/api/schemaextension-delete?view=graph-rest-1.0)
