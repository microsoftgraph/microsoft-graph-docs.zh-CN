...
在调用 Microsoft Graph API 之前，应首先注册应用程序并获取令牌。 下表列出了 Azure AD Azure Active Directory (终结点的基本 URL) 注册应用程序并获取每个区域云的令牌。
...
\* () 仅对 Exchange 和 OneDrive 服务的支持。 不支持 Azure AD 服务。
