...
ms.locfileid: "59766150"
---
# <a name="national-cloud-deployments"></a>区域云部署

除了全球的数据中心网络外，Microsoft 云服务还可用于三个独立的区域云。 这些区域云版本是 Microsoft 企业云服务的物理和逻辑网络隔离实例，它们限制在特定国家/地区的地理边界内，由本地人员运营。

当前区域云包括：

* Microsoft Cloud for US Government
* Microsoft 云德国
* 由世纪Microsoft 365运营的 Azure 和云

每个国家/区云环境都是唯一的，并且不同于 Microsoft 全球环境。 为国家云环境开发应用程序时，了解其中一些关键差异非常重要;例如，注册应用程序、获取令牌和调用 Microsoft Graph API 可能会有所不同。
...
在调用 Microsoft Graph API 之前，应首先注册应用程序并获取令牌。 下表列出了 Azure AD Azure Active Directory (的基本 URL，) 注册应用程序并获取每个区域云的令牌。
...
若要了解有关 Azure AD 访问令牌和 Microsoft Graph，请参阅[身份验证基础知识](./auth/auth-concepts.md)。 有关 Azure AD 身份验证方案，请参阅 [Azure AD 身份验证基础知识](/azure/active-directory/develop/authentication-scenarios)。
...
> * 如果你正在高Microsoft 365 GCC，请使用： 和 `https://portal.azure.us` `https://graph.microsoft.us` 。
...
以下 Microsoft Graph 功能在 Microsoft 云中国) 终结点上的预览版 (和 Microsoft 云德国 (V1.0 终结点上提供，这些功能仅在 `/beta` Microsoft Cloud for US Government) ：

* 组织联系人
* 应用程序
* 服务主体

\* () 仅对 Exchange 和 OneDrive 有限支持。 不支持 Azure AD 服务。
...
* [Microsoft 365由世纪银行运营](/office365/servicedescriptions/office-365-platform-service-description/office-365-operated-by-21vianet)
