...
- [适用于 Node 的 Passport](https://passportjs.org/)
...
使用 Web 技术生成的快速启动示例提供启动和托管本地 Web 服务器所需的逻辑。 例如，使用 PHP 5.4.0+ 运行时的 PHP 示例包含可用于开发的[内置 Web 服务器](https://php.net/manual/en/features.commandline.webserver.php)。 它不适用于生产环境。 
