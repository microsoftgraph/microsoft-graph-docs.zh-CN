...
| **更改类型** | **版本** | **说明**                          |
| :-------------- | :---------- | :--------------------------------------- |
| 添加项 | beta | 添加了 [user: reprocessLicenseAssignment API](/graph/api/user-reprocesslicenseassignment?view=graph-rest-beta)，它可用于重新处理[用户](/graph/api/resources/mailboxsettings?view=graph-rest-beta)的所有基于组的许可证分配。 |
