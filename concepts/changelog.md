...
| 修补程序             | v1.0 和 beta | 修复了出现 400 错误的用户创建和更新操作故障 (POST/PATCH /v1.0/users)。 |
...
| **更改类型** | **版本**   | **说明**                          |
| :-------------- | :------------ | :--------------------------------------- |
| 添加项        | beta          | 向 [driveItem](../api-reference/beta/resources/driveitem.md) 资源添加了 [socketIo subscription](../api-reference/beta/api/driveItem_subscriptions_socketIo.md) 函数。 |
...
| :-------------- | :------------ | :--------------------------------------- |
| 更改           | beta          | 已将 [subscription](https://developer.microsoft.com/zh-CN/graph/docs/api-reference/beta/resources/subscription) 实体的 **creatorUserId** 属性重命名为 **creatorId**，以更好地反映含义。 |
|更改|v1.0 |向 [subscription](https://developer.microsoft.com/zh-CN/graph/docs/api-reference/v1.0/resources/subscription) 实体添加了 [list](https://developer.microsoft.com/zh-CN/graph/docs/api-reference/v1.0/api/subscription_list) 操作。 |
|更改|v1.0 |向 [subscription](https://developer.microsoft.com/zh-CN/graph/docs/api-reference/v1.0/resources/subscription) 实体添加了 **applicationID** 和 **creatorId** 属性。 |
