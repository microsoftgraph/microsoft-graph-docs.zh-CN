...
| 添加 | Beta 和 v1.0 | 已将以下操作添加到[设备](/graph/api/resources/device)： <br/> [删除注册的所有者](/graph/api/device-delete-registeredowners) <br/> [删除注册的用户](/graph/api/delete-registeredusers)|
...
|添加项|beta|向 [workbookOperation](/graph/api/resources/workbookoperation?view=graph-rest-beta)  实体添加了[Get workbookOperation](/graph/api/resources/workbookoperation-get?view=graph-rest-beta) 方法。 |
