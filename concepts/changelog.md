...
| 新增 | v1.0 | 已添加[读取频道消息 API](/graph/api/resources/chatmessage?view=graph-rest-1.0)。 |
...
| 添加项        | v1.0 和 beta | 收到含有空持有者令牌的请求时，在 _www-authenticate_ 标头中现在返回授权服务终结点的位置。 |
