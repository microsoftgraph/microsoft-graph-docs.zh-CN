...
| **更改类型** | **版本** | **说明**                          |
|:----------------|:------------|:-----------------------------------------|
| 添加项 | beta | 增加了 [orgContact delta 查询](/graph/api/orgcontact-delta.md??view=graph-rest-beta)支持。|
| 添加项 | v1.0 | 增加了 [orgContact delta 查询](/graph/api/orgcontact-delta.md??view=graph-rest-1.0)支持。|
