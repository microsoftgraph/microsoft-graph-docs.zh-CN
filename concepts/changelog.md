...
| **更改类型** | **版本**   | **说明**                          |
| :-------------- | :------------ | :--------------------------------------- |
| Addition | beta | 添加了控制 Azure AD 中的授权设置的[authorizationPolicy](api-reference/beta/resources/authorizationpolicy?view=graph-rest-beta)资源类型。 |
...
|添加项|beta 版本|向 [kerberosSingleSignOnExtension](/graph/api/resources/intune-deviceconfig-kerberossinglesignonextension?view=graph-rest-beta) 复杂类型添加了**passwordChangeUrl**属性|
...
|添加项 |beta| 向 [team](/graph/api/resources/team?view=graph-rest-beta) 添加了 [specialization](/graph/api/resources/teamspecialization?view=graph-rest-beta) 属性。|
...
|添加 |v1.0| 引入了新操作[克隆团队](/graph/api/team-clone?view=graph-rest-1.0)。 |
|添加 |v1.0| 引入了新操作[存档团队](/graph/api/team-archive?view=graph-rest-1.0)。|
