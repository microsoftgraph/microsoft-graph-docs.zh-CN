...
| 添加项 | v1.0 | 添加到[用户](../api-reference/v1.0/resources/user.md)实体的 [onPremisesExtensionAttributes](../api-reference/v1.0/resources/onpremisesprovisioningerror.md) 属性包含 15 个自定义扩展特性的属性。 对于 onPremisesSyncEnabled 用户，此组属性是在本地 Active Directory 中主控并以只读方式同步到 Azure AD。 对于仅限云的用户（其 onPremisesSyncEnabled 为 false），这些属性可以在创建过程中设置或更新。|
|添加项|v1.0|向[用户](../api-reference/v1.0/resources/user.md)实体添加了 **onPremisesDomainName** 属性|
...
|删除项|beta|从 [androidForWorkMobileAppConfiguration](../api-reference/beta/resources/intune_apps_androidforworkmobileappconfiguration.md) 实体删除了 **packageName** 属性|
