...
|添加项|beta|在 [depOnboardingSetting](../api-reference/beta/resources/intune_enrollment_deponboardingsetting.md) 上添加了 [uploadDepToken](../api-reference/beta/api/intune_enrollment_deponboardingsetting_uploaddeptoken.md.md) 操作 |
...
|添加项|beta| **Microsoft365ManagedMdm** 成员添加到 [managementAgentType](../api-reference/beta/resources/intune_devices_managementagenttype.md) 枚举类型|
