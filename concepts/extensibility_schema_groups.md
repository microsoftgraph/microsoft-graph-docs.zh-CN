...
请参阅[分配请求中 **id** 的其他方法示例](../api-reference/v1.0/api/schemaextension_post_schemaextensions.md#request-2)，仅需要提供架构名称。
...
- [创建 schemaExtension](../api-reference/v1.0/api/schemaextension_post_schemaextensions.md)
- [获取 schemaExtension](../api-reference/v1.0/api/schemaextension_get.md)
- [更新 schemaExtension](../api-reference/v1.0/api/schemaextension_update.md)
- [删除 schemaExtension](../api-reference/v1.0/api/schemaextension_delete.md)
