...
[文件处理程序]: https://docs.microsoft.com/onedrive/developer/file-handlers
  ...
  [特殊文件夹]: https://developer.microsoft.com/en-us/graph/docs/api-reference/v1.0/api/drive_get_specialfolder

  [注释 API]: https://developer.microsoft.com/en-us/graph/docs/concepts/integrate_with_onenote
...
[REST API]: https://developer.microsoft.com/en-us/graph/docs/api-reference/v1.0/resources/onedrive
  ...
  [增量 API]: https://developer.microsoft.com/en-us/graph/docs/api-reference/v1.0/api/driveitem_delta

  [视频]: https://developer.microsoft.com/en-us/graph/docs/api-reference/v1.0/resources/video

  [照片]: https://developer.microsoft.com/en-us/graph/docs/api-reference/v1.0/resources/photo

  [音频]: https://developer.microsoft.com/en-us/graph/docs/api-reference/v1.0/resources/audio

  [格式]: https://developer.microsoft.com/en-us/graph/docs/api-reference/v1.0/api/driveitem_get_content_format

  [缩略图]: https://developer.microsoft.com/en-us/graph/docs/api-reference/v1.0/api/driveitem_list_thumbnails

  [预览]: https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/driveitem_preview
