...
* 使用[活动源 API](../api-reference/v1.0/resources/activity-feed-api-overview.md) 读取和写入所有平台中的用户活动
...
为将使用 [Project Rome API](https://developer.microsoft.com/zh-CN/graph/docs/api-reference/v1.0/resources/project_rome_overview) 的每个应用程序和平台收集特定于平台的应用程序 ID。
...
如果你的应用使用 Microsoft Graph 中的活动源 API，则必须在 **activitySourceHost** 属性中提供主机值。 有关详细信息，请参阅[活动资源类型](https://developer.microsoft.com/zh-CN/graph/docs/api-reference/v1.0/resources/projectrome_activity)。
