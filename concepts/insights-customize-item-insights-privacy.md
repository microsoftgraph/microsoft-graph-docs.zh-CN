---
title: 自定义 Microsoft Graph 中的项目见解隐私（预览版）
description: 使用 Microsoft 管理中心、PowerShell 或 REST API userInsightsSettings 资源配置派生自 Microsoft Graph 的见解的可见性。
author: simonhult
...
---
# <a name="customize-item-insights-privacy-in-microsoft-graph-preview"></a>自定义 Microsoft Graph 中的项目见解隐私（预览版）
...
### <a name="configure-item-insights-settings-via-powershell"></a>通过 PowerShell 配置项目见解设置
...
### <a name="configure-item-insights-settings-using-the-rest-api"></a>使用 REST API 配置项见解设置
