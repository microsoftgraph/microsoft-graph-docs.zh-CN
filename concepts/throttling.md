...
## <a name="common-throttling-scenarios"></a><span data-ttu-id="6f0f1-119">常见的限制场景</span><span class="sxs-lookup"><span data-stu-id="6f0f1-119">Common throttling scenarios</span></span>
...
| <span data-ttu-id="6f0f1-160">请求类型</span><span class="sxs-lookup"><span data-stu-id="6f0f1-160">Request type</span></span> | <span data-ttu-id="6f0f1-161">所有租户中的每个应用</span><span class="sxs-lookup"><span data-stu-id="6f0f1-161">Per app across all tenants</span></span>  |
| ------------ | ------------------------ |
...
- [<span data-ttu-id="6f0f1-183">外部项（Microsoft 搜索）</span><span class="sxs-lookup"><span data-stu-id="6f0f1-183">External item (Microsoft Search)</span></span>](/graph/api/resources/externalitem?view=graph-rest-beta)
...
- [<span data-ttu-id="6f0f1-202">contact</span><span class="sxs-lookup"><span data-stu-id="6f0f1-202">contact</span></span>](/graph/api/resources/contact)
...
<span data-ttu-id="6f0f1-232">上述限制适用于下列资源:</span><span class="sxs-lookup"><span data-stu-id="6f0f1-232">The preceding limits apply to the following resources:</span></span>  
...
| <span data-ttu-id="6f0f1-262">DELETE channel, tab, installedApps, appCatalogs</span><span class="sxs-lookup"><span data-stu-id="6f0f1-262">DELETE channel, tab, installedApps, appCatalogs</span></span>      |  <span data-ttu-id="6f0f1-263">15 rps</span><span class="sxs-lookup"><span data-stu-id="6f0f1-263">15 rps</span></span>                         | <span data-ttu-id="6f0f1-264">150 rps</span><span class="sxs-lookup"><span data-stu-id="6f0f1-264">150 rps</span></span>  |
...
- [<span data-ttu-id="6f0f1-320">组</span><span class="sxs-lookup"><span data-stu-id="6f0f1-320">Group</span></span>](/graph/api/resources/group)
...
| <span data-ttu-id="6f0f1-343">限制类型</span><span class="sxs-lookup"><span data-stu-id="6f0f1-343">Limit type</span></span> | <span data-ttu-id="6f0f1-344">资源单元配额</span><span class="sxs-lookup"><span data-stu-id="6f0f1-344">Resource unit quota</span></span> | <span data-ttu-id="6f0f1-345">写入配额</span><span class="sxs-lookup"><span data-stu-id="6f0f1-345">Write quota</span></span> |
| ---------- | ----------- | -------------- |
...
| <span data-ttu-id="6f0f1-433">POST</span><span class="sxs-lookup"><span data-stu-id="6f0f1-433">POST</span></span> | <span data-ttu-id="6f0f1-434">表中未列出的任何身份路径</span><span class="sxs-lookup"><span data-stu-id="6f0f1-434">Any identity path not listed in the table</span></span> | <span data-ttu-id="6f0f1-435">1</span><span class="sxs-lookup"><span data-stu-id="6f0f1-435">1</span></span> | <span data-ttu-id="6f0f1-436">1</span><span class="sxs-lookup"><span data-stu-id="6f0f1-436">1</span></span> |
...
##### <a name="regular-responses-requests"></a><span data-ttu-id="6f0f1-468">正常响应请求</span><span class="sxs-lookup"><span data-stu-id="6f0f1-468">Regular responses requests</span></span>
...
- <span data-ttu-id="6f0f1-488">**x-ms-throttle-information** - 指示限制的原因，可以有任何值（字符串）。</span><span class="sxs-lookup"><span data-stu-id="6f0f1-488">**x-ms-throttle-information** - Indicates the reason for throttling and can have any value (string).</span></span> <span data-ttu-id="6f0f1-489">提供该值是为了进行诊断和故障排除，其中一些示例包括：</span><span class="sxs-lookup"><span data-stu-id="6f0f1-489">The value is provided for diagnostics and troubleshooting purposes, some examples include:</span></span>
  ...
  - <span data-ttu-id="6f0f1-492">ResourceUnitLimitExceeded - 限制因为超过已分配资源单位的限值。</span><span class="sxs-lookup"><span data-stu-id="6f0f1-492">ResourceUnitLimitExceeded - Throttling is because the limit for the allocated resource unit is exceeded.</span></span>
...
<span data-ttu-id="6f0f1-519">上述限制适用于下列资源:</span><span class="sxs-lookup"><span data-stu-id="6f0f1-519">The preceding limits apply to the following resources:</span></span>  
...
<span data-ttu-id="6f0f1-536">以下限制适用于 `/invitations` 上的所有请求。</span><span class="sxs-lookup"><span data-stu-id="6f0f1-536">The following limits apply to any request on `/invitations`.</span></span>

| <span data-ttu-id="6f0f1-537">操作</span><span class="sxs-lookup"><span data-stu-id="6f0f1-537">Operation</span></span>                 | <span data-ttu-id="6f0f1-538">所有应用的每个租户的使用限制</span><span class="sxs-lookup"><span data-stu-id="6f0f1-538">Limit per tenant for all apps</span></span> |
|---------------------------|------------------------------|
| <span data-ttu-id="6f0f1-539">任何操作</span><span class="sxs-lookup"><span data-stu-id="6f0f1-539">Any operation</span></span>             | <span data-ttu-id="6f0f1-540">每 5 秒 150 个请求</span><span class="sxs-lookup"><span data-stu-id="6f0f1-540">150 requests per 5 seconds</span></span>   |

### <a name="security-detections-and-incidents-service-limits"></a><span data-ttu-id="6f0f1-541">安全检测和事件服务限制</span><span class="sxs-lookup"><span data-stu-id="6f0f1-541">Security detections and incidents service limits</span></span>

<span data-ttu-id="6f0f1-542">以下限制适用于 `/security` 上的所有请求。</span><span class="sxs-lookup"><span data-stu-id="6f0f1-542">The following limits apply to any request on `/security`.</span></span>

| <span data-ttu-id="6f0f1-543">操作</span><span class="sxs-lookup"><span data-stu-id="6f0f1-543">Operation</span></span>                  | <span data-ttu-id="6f0f1-544">每个租户每个应用限制</span><span class="sxs-lookup"><span data-stu-id="6f0f1-544">Limit per app per tenant</span></span>     |
|----------------------------|------------------------------|
| <span data-ttu-id="6f0f1-545">`alert`、`securityActions`、`secureScore` 上的任何操作</span><span class="sxs-lookup"><span data-stu-id="6f0f1-545">Any operation on `alert`, `securityActions`,  `secureScore`</span></span> | <span data-ttu-id="6f0f1-546">每分钟 150 个请求</span><span class="sxs-lookup"><span data-stu-id="6f0f1-546">150 requests per minute</span></span>      |
| <span data-ttu-id="6f0f1-547">`tiIndicator` 上的任何操作</span><span class="sxs-lookup"><span data-stu-id="6f0f1-547">Any operation on `tiIndicator`</span></span> | <span data-ttu-id="6f0f1-548">每分钟 1000 个请求</span><span class="sxs-lookup"><span data-stu-id="6f0f1-548">1000 requests per minute</span></span> |
| <span data-ttu-id="6f0f1-549">`secureScore` 或 `secureScorecontrolProfile` 上的任何操作</span><span class="sxs-lookup"><span data-stu-id="6f0f1-549">Any operation on `secureScore` or `secureScorecontrolProfile`</span></span> | <span data-ttu-id="6f0f1-550">10 分钟内的 10,000 个 API 请求</span><span class="sxs-lookup"><span data-stu-id="6f0f1-550">10,000 API requests in a 10 minute period</span></span> |
| <span data-ttu-id="6f0f1-551">`secureScore` 或 `secureScorecontrolProfile` 上的任何操作</span><span class="sxs-lookup"><span data-stu-id="6f0f1-551">Any operation on `secureScore` or `secureScorecontrolProfile`</span></span> | <span data-ttu-id="6f0f1-552">4 个并发请求</span><span class="sxs-lookup"><span data-stu-id="6f0f1-552">4 concurrent requests</span></span> |

### <a name="open-and-schema-extensions-service-limits"></a><span data-ttu-id="6f0f1-553">开放和架构扩展服务限制</span><span class="sxs-lookup"><span data-stu-id="6f0f1-553">Open and schema extensions service limits</span></span>

| <span data-ttu-id="6f0f1-554">请求类型</span><span class="sxs-lookup"><span data-stu-id="6f0f1-554">Request type</span></span> | <span data-ttu-id="6f0f1-555">每个租户每个应用限制</span><span class="sxs-lookup"><span data-stu-id="6f0f1-555">Limit per app per tenant</span></span> |
| ------------ | ------------------------ |
| <span data-ttu-id="6f0f1-556">任何</span><span class="sxs-lookup"><span data-stu-id="6f0f1-556">Any</span></span>          | <span data-ttu-id="6f0f1-557">每 10 秒 455 个请求</span><span class="sxs-lookup"><span data-stu-id="6f0f1-557">455 requests per 10 seconds</span></span> |

<span data-ttu-id="6f0f1-558">上述限制适用于以下资源：openTypeExtension、schemaExtension、administrativeUnit、合同、设备、事件、组、消息、组织、帖子和用户。</span><span class="sxs-lookup"><span data-stu-id="6f0f1-558">The preceding limits apply to the following resources: openTypeExtension, schemaExtension, administrativeUnit, contact, device, event, group, message, organization, post, and user.</span></span>

### <a name="files-and-lists-service-limits"></a><span data-ttu-id="6f0f1-559">文件和列表服务限制</span><span class="sxs-lookup"><span data-stu-id="6f0f1-559">Files and lists service limits</span></span>

<span data-ttu-id="6f0f1-560">OneDrive、OneDrive for Business 和 SharePoint Online 的服务限制不可用。</span><span class="sxs-lookup"><span data-stu-id="6f0f1-560">Service limits for OneDrive, OneDrive for Business, and SharePoint Online are not available.</span></span> <span data-ttu-id="6f0f1-561">有关详细信息，请参阅[为什么不能告诉我确切的限制？](/sharepoint/dev/general-development/how-to-avoid-getting-throttled-or-blocked-in-sharepoint-online#why-cant-you-just-tell-me-the-exact-throttling-limits)。</span><span class="sxs-lookup"><span data-stu-id="6f0f1-561">For more information, see [why can't you just tell me the exact throttling limits?](/sharepoint/dev/general-development/how-to-avoid-getting-throttled-or-blocked-in-sharepoint-online#why-cant-you-just-tell-me-the-exact-throttling-limits).</span></span>

<span data-ttu-id="6f0f1-562">上述信息适用于以下资源：</span><span class="sxs-lookup"><span data-stu-id="6f0f1-562">The preceding information applies to the following resources:</span></span>  
<span data-ttu-id="6f0f1-563">baseItem、baseItemVersion、columnDefinition、columnLink、contentType、drive、driveItem、driveItemVersion、fieldValueSet、itemActivity、itemActivityStat、itemAnalytics、list、listItem、listItemVersion、permission、sharedDriveItem、site 和 thumbnailSet。</span><span class="sxs-lookup"><span data-stu-id="6f0f1-563">baseItem, baseItemVersion, columnDefinition, columnLink, contentType, drive, driveItem, driveItemVersion, fieldValueSet, itemActivity, itemActivityStat, itemAnalytics, list, listItem, listItemVersion, permission, sharedDriveItem, site, and thumbnailSet.</span></span>

### <a name="tasks-and-plans-service-limits"></a><span data-ttu-id="6f0f1-564">任务和计划服务限制</span><span class="sxs-lookup"><span data-stu-id="6f0f1-564">Tasks and plans service limits</span></span>

<span data-ttu-id="6f0f1-565">Planner 的服务限制不可用。</span><span class="sxs-lookup"><span data-stu-id="6f0f1-565">Service limits for Planner are not available.</span></span>

<span data-ttu-id="6f0f1-566">上述信息适用于以下资源：</span><span class="sxs-lookup"><span data-stu-id="6f0f1-566">The preceding information applies to the following resources:</span></span>  
<span data-ttu-id="6f0f1-567">planner、plannerAssignedToTaskBoardTaskFormat、plannerBucket、plannerBucketTaskBoardTaskFormat、plannerGroup、plannerPlan、plannerPlanDetails、plannerProgressTaskBoardTaskFormat、plannerTask、plannerTaskDetails 和 plannerUser。</span><span class="sxs-lookup"><span data-stu-id="6f0f1-567">planner, plannerAssignedToTaskBoardTaskFormat, plannerBucket, plannerBucketTaskBoardTaskFormat, plannerGroup, plannerPlan, plannerPlanDetails, plannerProgressTaskBoardTaskFormat, plannerTask, plannerTaskDetails, and plannerUser.</span></span>

### <a name="identity-and-access-data-policy-operation-service-limits"></a><span data-ttu-id="6f0f1-568">身份和访问数据策略操作服务限制</span><span class="sxs-lookup"><span data-stu-id="6f0f1-568">Identity and access data policy operation service limits</span></span>

| <span data-ttu-id="6f0f1-569">请求类型</span><span class="sxs-lookup"><span data-stu-id="6f0f1-569">Request type</span></span> | <span data-ttu-id="6f0f1-570">每个租户的使用限制</span><span class="sxs-lookup"><span data-stu-id="6f0f1-570">Limit per tenant</span></span> |
| ------------ | ---------------- |
| <span data-ttu-id="6f0f1-571">发布于 `exportPersonalData`</span><span class="sxs-lookup"><span data-stu-id="6f0f1-571">POST on `exportPersonalData`</span></span> | <span data-ttu-id="6f0f1-572">每天 1000 个针对任何主题的请求，每个主题每天 100 个请求</span><span class="sxs-lookup"><span data-stu-id="6f0f1-572">1000 requests per day for any subject and 100 per subject per day</span></span> |
| <span data-ttu-id="6f0f1-573">任何其他请求</span><span class="sxs-lookup"><span data-stu-id="6f0f1-573">Any other request</span></span> | <span data-ttu-id="6f0f1-574">每分钟 10000 个请求</span><span class="sxs-lookup"><span data-stu-id="6f0f1-574">10000 requests per hour</span></span> |

<span data-ttu-id="6f0f1-575">上述限制适用于下列资源：dataPolicyOperation。</span><span class="sxs-lookup"><span data-stu-id="6f0f1-575">The preceding limits apply to the following resources: dataPolicyOperation.</span></span>

> <span data-ttu-id="6f0f1-576">**注意：** 上面列出的资源未在 `429 Too Many Requests` 响应上返回 `Retry-After` 标头。</span><span class="sxs-lookup"><span data-stu-id="6f0f1-576">**Note:** The resources listed above do not return a `Retry-After` header on `429 Too Many Requests` responses.</span></span>

<!-- { "blockType": "throttlinggenstart" } -->
### <a name="education-service-limits"></a><span data-ttu-id="6f0f1-577">教育版服务限制</span><span class="sxs-lookup"><span data-stu-id="6f0f1-577">Education service limits</span></span>

[!INCLUDE [Education rostering APIS throttling documentation](../includes/throttling-education-rostering-apis.md)]

### <a name="excel-service-limits"></a><span data-ttu-id="6f0f1-578">Excel 服务限制</span><span class="sxs-lookup"><span data-stu-id="6f0f1-578">Excel service limits</span></span>

[!INCLUDE [Excel throttling documentation](../includes/throttling-excel.md)]

### <a name="identity-and-access-audit-logs-service-limits"></a><span data-ttu-id="6f0f1-579">标识和访问审核日志的服务限制</span><span class="sxs-lookup"><span data-stu-id="6f0f1-579">Identity and access audit logs service limits</span></span>

[!INCLUDE [Identity and access audit logs throttling documentation](../includes/throttling-Identity-and-access-audit-logs.md)]

### <a name="identity-providers-service-limits"></a><span data-ttu-id="6f0f1-580">身份提供程序的服务限制</span><span class="sxs-lookup"><span data-stu-id="6f0f1-580">Identity providers service limits</span></span>

[!INCLUDE [CPIM throttling documentation](../includes/throttling-cpim.md)]

### <a name="intune-service-limits"></a><span data-ttu-id="6f0f1-581">Intune服务限制</span><span class="sxs-lookup"><span data-stu-id="6f0f1-581">Intune service limits</span></span>
...
### <a name="skype-service-limits"></a><span data-ttu-id="6f0f1-582">Skype 服务限制</span><span class="sxs-lookup"><span data-stu-id="6f0f1-582">Skype service limits</span></span>

[!INCLUDE [Skype calling throttling documentation](../includes/throttling-skype-calling.md)]

### <a name="subscription-service-limits"></a><span data-ttu-id="6f0f1-583">订阅服务</span><span class="sxs-lookup"><span data-stu-id="6f0f1-583">Subscription service limits</span></span>

[!INCLUDE [Subscription services throttling documentation](../includes/throttling-subscription-services.md)]

<!-- { "blockType": "throttlinggenend" } -->

### <a name="assignment-service-limits"></a><span data-ttu-id="6f0f1-584">作业服务限制</span><span class="sxs-lookup"><span data-stu-id="6f0f1-584">Assignment service limits</span></span>

<span data-ttu-id="6f0f1-585">下列的限制适用于关于作业服务测试版 API 的请求：</span><span class="sxs-lookup"><span data-stu-id="6f0f1-585">The following limits apply to requests on the assignment service beta API:</span></span>

| <span data-ttu-id="6f0f1-586">请求类型</span><span class="sxs-lookup"><span data-stu-id="6f0f1-586">Request Type</span></span>                 | <span data-ttu-id="6f0f1-587">每个租户每个应用限制</span><span class="sxs-lookup"><span data-stu-id="6f0f1-587">Limit per app per tenant</span></span>     | <span data-ttu-id="6f0f1-588">所有应用的每个租户的使用限制</span><span class="sxs-lookup"><span data-stu-id="6f0f1-588">Limit per tenant for all apps</span></span> |
|---------------------------|------------------------------|----------------------------|
| <span data-ttu-id="6f0f1-589">任何</span><span class="sxs-lookup"><span data-stu-id="6f0f1-589">Any</span></span>         | <span data-ttu-id="6f0f1-590">每 10 秒 5000 个请求</span><span class="sxs-lookup"><span data-stu-id="6f0f1-590">5000 requests per 10 seconds</span></span>   | <span data-ttu-id="6f0f1-591">每 10 秒 15000 个请求</span><span class="sxs-lookup"><span data-stu-id="6f0f1-591">15 000 requests per 10 seconds</span></span> |
| <span data-ttu-id="6f0f1-592">获取/作业</span><span class="sxs-lookup"><span data-stu-id="6f0f1-592">GET me/Assignment</span></span>  | <span data-ttu-id="6f0f1-593">每 10 秒 50 个请求</span><span class="sxs-lookup"><span data-stu-id="6f0f1-593">50 requests per 10 seconds</span></span> | <span data-ttu-id="6f0f1-594">每 10 秒 150 个请求</span><span class="sxs-lookup"><span data-stu-id="6f0f1-594">150 requests per 10 seconds</span></span> |  

<span data-ttu-id="6f0f1-595">前面的限制适用于以下资源：[educationAssignment](/graph/api/resources/educationassignment?view=graph-rest-beta)
[educationSubmission](/graph/api/resources/educationsubmission?view=graph-rest-beta)
[educationResource](/graph/api/resources/educationresource?view=graph-rest-beta)</span><span class="sxs-lookup"><span data-stu-id="6f0f1-595">The preceding limits apply to the following resources: [educationAssignment](/graph/api/resources/educationassignment?view=graph-rest-beta)
[educationSubmission](/graph/api/resources/educationsubmission?view=graph-rest-beta)
[educationResource](/graph/api/resources/educationresource?view=graph-rest-beta)</span></span>
