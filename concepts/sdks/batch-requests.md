...
## <a name="simple-batching-example"></a><span data-ttu-id="bede0-116">简单的批处理示例</span><span class="sxs-lookup"><span data-stu-id="bede0-116">Simple batching example</span></span>
