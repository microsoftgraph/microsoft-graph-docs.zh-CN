...
|Azure AD Graph <br> (1.6 版) 属性 |Microsoft Graph<br>property|备注|
|---|---|---|
...
| **replyUrls**                      | beta &nbsp; - &nbsp; **web/redirectUris**、 **publicclient 重命名/redirectUris**<br> v1.0 &nbsp; - &nbsp; **web/redirectUris**、 **publicclient 重命名/redirectUris**        | 除了重命名，redirectUris 现在也是新的 web 和 Publicclient 重命名资源的一部分。 这样，开发人员就可以使用其 web 和公共客户端的特定 Uri (如在桌面设备) 上安装的应用程序。                                                                                           |
...
|Azure AD Graph <br> (1.6 版) 属性 |Microsoft Graph<br> property|备注|
|---|---|---|
| **城市** | &nbsp; - &nbsp; ** (城市) **的 beta 地址 <br> &nbsp; - &nbsp; ** (城市) **的1.0 版地址  | City 属性是 "地址" 资源集合的一部分。 |
| **country** | beta &nbsp; - &nbsp; **addresses** &nbsp; ** (countryOrRegion) **<br> &nbsp; - &nbsp; **addresses** &nbsp; ** (countryOrRegion) **的1.0 版地址  | CountryOrRegion 属性是 "地址" 资源集合的一部分。 |
| **dirSyncEnabled** | beta &nbsp; - &nbsp; **onPremisesSyncEnabled** <br> v1.0 &nbsp; - &nbsp; **onPremisesSyncEnabled**   | |
| **facsimileTelephoneNumber** | beta &nbsp; - &nbsp; **手机** &nbsp; ** (businessFax) ** <br> &nbsp; - &nbsp; **phones** &nbsp; ** (businessFax) **的1.0 电话 | 现在是电话集合的一部分，它支持移动、商业和 businessFax。 |
| **physicalDeliveryOfficeName** | beta &nbsp; - &nbsp; **officeLocation** <br> v1.0 &nbsp; - &nbsp; **officeLocation** | |
| **postalCode** | &nbsp; - &nbsp; **addresses** &nbsp; ** (邮政编码) **的 beta 地址<br> &nbsp; - &nbsp; **addresses** &nbsp; ** (邮政编码) **的1.0 版地址 | "邮政编码" 属性是 "地址" 资源集合的一部分。 |
...
| **state** | 测试版 &nbsp; - &nbsp; **地址** &nbsp; ** (状态) **<br> v1.0 &nbsp; - &nbsp; **addresses** &nbsp; ** (状态**的地址)   | State 属性是 "addresses" 资源集合的一部分。 |
| **streetAddress** | &nbsp; - &nbsp; **addresses** &nbsp; ** (街道) **的 beta 地址<br> &nbsp; - &nbsp; **addresses** &nbsp; ** (街道) **的1.0 版地址  | "街道" 属性是 "地址" 资源集合的一部分。 |
| **telephoneNumber** | beta &nbsp; - &nbsp; **手机** &nbsp; ** (商业) ** <br> &nbsp; - &nbsp; **phones** &nbsp; ** (商务) **的1.0 版电话 | 现在是电话集合的一部分，它支持移动、商业和 businessFax。 |
...
|Azure AD Graph <br> (1.6 版) 属性 |Microsoft Graph<br> property|备注|
|---|---|---|
| **name** | beta &nbsp; - &nbsp; **id** <br> 1.0 版 &nbsp; - &nbsp; **id** | 在 Microsoft Graph 中，唯一标识符 (id) 包含域名; `name` 属性不存在。 |
...
在 Microsoft Graph 中，命名策略类型 (如 tokenIssuancePolicy 或 tokenLifetimePolicy) ，而不是通用策略资源类型。 [策略概述](/graph/api/resources/policy-overview?view=graph-rest-1.0)中提供了更多详细信息。
