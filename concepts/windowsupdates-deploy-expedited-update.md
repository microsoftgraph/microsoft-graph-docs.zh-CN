...
description: 使用 Windows Update for Business 部署服务，你可以将加速 Windows 安全更新部署到 Azure AD 租户中的设备，以防出现紧急情况且需要立即部署安全更新。
...
将加速安全更新部署到设备时，Windows更新会向设备提供最新的适用更新（如果设备尚未收到具有指定发布日期的更新）。 例如，如果将 2021 Windows 10 2021 年 4 月 13 日发布的安全更新部署到当前没有更新的设备，设备将收到加速更新。 如果设备已具有指定的更新或更新版本，则它不会收到加速更新。
...
* 设备已安装[KB4023057 - Windows 10 Update Service](https://support.microsoft.com/topic/kb4023057-update-for-windows-10-update-service-components-fccad0ca-dc10-2e46-9ed1-7e392450fb3a)组件的更新 (更新) 。
...
将加速安全更新部署到设备时，Windows更新会提供一个更新，将设备超过指定的最低合规性级别。 根据每个设备扫描和更新时间，某些设备可能会收到更新 (例如，如果有比所需最低合规性级别) 更新，但所有设备都符合指定的安全更新合规性标准。 这种提供最新适用更新的行为（由设置为默认值的属性等效项指示）有助于尽可能确保设备安全，并阻止设备在几天后收到快速更新，后跟另一个 `latestSecurity` 定期更新。
