...
Microsoft Teams 及其 API 的丰富功能为应用开发人员提供了许多方案。 以下部分列出了其中的一些机会。
...
### <a name="types-of-apps-enabled-for-microsoft-teams"></a>为 Microsoft Teams 启用的应用类型
...
## <a name="enable-employee-learning-using-the-collaborative-capabilities-in-teams"></a>使用 Teams 中的协作功能助力员工学习
为 Microsoft Teams 和 Microsoft 365 构建的 Viva Learning 将员工学习引入了工作流。 Viva Learning 允许雇主注册学习提供程序、上传、管理内容元数据、学习器分配、完成记录。 员工可以在 Teams 消息、会议聊天或电子邮件中共享学习内容，从而鼓励同伴学习和指导对话。 

使用适用于 Viva Learning 的员工学习 API 执行以下操作： 
- 注册和管理[学习提供程序](/graph/api/resources/learningprovider)。
- 插入、更新、检索、删除[学习内容](/graph/api/resources/learningcontent)元数据。

## <a name="api-reference"></a>API 参考

在寻找 Teams 和 Viva Learning 的 API 参考？
...
- [使用员工学习 API 与 Viva Learning 集成](/graph/api/resources/viva-learning-api-overview)
