...
| 消息已固定 | [messagePinnedEventMessageDetail](#message-pinned) | 聊天 |
| 消息已取消固定 | [messageUnpinnedEventMessageDetail](#message-unpinned) | 聊天 |
...
### <a name="message-unpinned"></a>消息已取消固定
