...
## <a name="service-hosted-media-remote-hosting"></a>服务承载的媒体（远程承载）
如果您希望您的 bot 在客户拨打您的公司号码时播放自定义提示，或者要检测电话音、录制短语音剪辑或执行各种交互式语音响应（[IVR](/graph/api/resources/calls-api-ivr-overview)）方案，请考虑使用[服务托管的媒体 api](/graph/api/resources/communications-api-overview)。
...
另请参阅应用程序托管媒体 bot 的[要求和注意事项](https://docs.microsoft.com/microsoftteams/platform/concepts/calls-and-meetings/requirements-considerations-application-hosted-media-bots)。
