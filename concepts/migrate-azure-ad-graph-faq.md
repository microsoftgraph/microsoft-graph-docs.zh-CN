...
该Azure AD Graph API 仅提供对 Azure AD 服务的访问权限。 Microsoft Graph API 提供了一个统一终结点，用于访问 Azure AD 服务和其他 Microsoft 服务 如 Microsoft Teams、Microsoft Exchange 和 Microsoft Intune。
