...
>**请注意**：Microsoft Graph 连接器现为个人预览版。 仅可受邀参与预览版计划。 有关连接器的详细信息，请参阅 [Build 2019 大会：Microsoft Graph 为 Microsoft 365 平台助力](https://aka.ms/microsoftgraphbuild2019)。
...
>**请注意：** 使用 Microsoft Graph API 即表示你同意 [Microsoft Graph 使用条款](https://developer.microsoft.com/graph/docs/misc/terms-of-use)和 [Microsoft 隐私声明](https://go.microsoft.com/fwlink/?LinkId=521839)。
